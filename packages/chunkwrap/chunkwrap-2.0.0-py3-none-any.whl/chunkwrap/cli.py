...
def create_parser():
    ...
    parser.add_argument('--output', choices=['clipboard', 'stdout', 'file'], default='clipboard',
                       help='Where to send the output (default: clipboard)')
...
def validate_args(args, config):
    ...
    if args.output == 'file' and not args.output_file:
        return "--output-file must be specified when using --output file"
