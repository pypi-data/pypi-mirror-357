...
class ArgumentParser:
    def parse_arguments(self):
        ...
        parser = CustomArgumentParser(description=f'{C.c}RKPairip Script v3.1') if any(arg.startswith('-') for arg in C.sys.argv[1:]) else C.argparse.ArgumentParser(description=f'{C.c}RKPairip Script v3.1')
