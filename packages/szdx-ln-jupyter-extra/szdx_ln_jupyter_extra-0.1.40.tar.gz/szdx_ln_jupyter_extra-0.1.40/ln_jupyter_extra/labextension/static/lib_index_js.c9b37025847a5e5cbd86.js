...
const getProjectDetail = async (id) => {
    return await _request_index__WEBPACK_IMPORTED_MODULE_0__["default"].get(_baseUrl + '/teaching/project/' + id);
};
// 查询文件列表
...
const getTaskDetail = async (id) => {
    return await _request_index__WEBPACK_IMPORTED_MODULE_0__["default"].get(_baseUrlCommon + '/job/teaching/notebook/' + id);
};
/** 加载选定版本到默认版本 */
const loadProjectVersion = async (data) => {
    return await _request_index__WEBPACK_IMPORTED_MODULE_0__["default"].post(_baseUrl + '/teaching/version/action/load', {
        data
    });
};
...
const VersionList = ({ id, version, createTime, app, projectId }) => {
    const handleVersionClick = async (id) => {
        try {
            await (0,_api_project__WEBPACK_IMPORTED_MODULE_3__.loadProjectVersion)({
                versionId: id,
                projectId: projectId || ''
            });
            // 重置工作区域
            ...
            _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.Notification.error('加载失败', { autoClose: 3000 });
            console.log(e);
        }
    };
    const refreshFn = async (app) => {
        // 使用传入的 app 实例
        for (const widget of app.shell.widgets('main')) {
            widget.close();
        }
        await app.commands.execute('workspace-ui:reset');
        _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.Notification.success('版本加载成功', { autoClose: 3000 });
    };
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "ln-version-list-item" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "ln-version-list-item__btn", onClick: () => handleVersionClick(id) }, "\u52A0\u8F7D\u7248\u672C")));
};
    ...
    if (router) {
        ...
        if (!notebookProjectId) {
            ...
            try {
                ...
                const createVersionBtn = new _widgets_createVersion__WEBPACK_IMPORTED_MODULE_9__["default"](app, notebookProjectId);
...
console.log('baseConfig domain:', domain);
console.log('baseConfig authToken:', authToken);
const baseConfig = {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { style: {
        ...
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { style: {
            ...
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { style: { marginBottom: '15px' } },
                ...
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("input", { type: "text", name: "name", value: formData.name, onChange: handleChange, placeholder: "\u8BF7\u8F93\u5165\u7248\u672C\u540D\u79F0\uFF08\u82F1\u6587\u3001\u6570\u5B57\u3001\u70B9\uFF0C\u6700\u957F10\u5B57\u7B26\uFF09", style: {
                        width: '100%',
                        padding: '8px',
...
class SaveButton extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.CommandToolbarButton {
    constructor(app, notebookProjectId) {
        ...
        app.commands.addCommand(COMMAND_ID, {
            ...
            execute: () => {
                this.handleSave(app, notebookProjectId);
            }
        });
        super({
    ...
    handleSave(app, notebookProjectId) {
        // 创建对话框容器
...
//# sourceMappingURL=lib_index_js.c9b37025847a5e5cbd86.js.map