...
static int import_dpctl__program___program(void) {
  ...
  if (!module) goto bad;
  if (__Pyx_ImportFunction_3_1_1(module, "SyclKernel_GetKernelRef", (void (**)(void))&__pyx_api_f_5dpctl_7program_8_program_SyclKernel_GetKernelRef, "DPCTLSyclKernelRef (struct PySyclKernelObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_1(module, "SyclKernel_Make", (void (**)(void))&__pyx_api_f_5dpctl_7program_8_program_SyclKernel_Make, "struct PySyclKernelObject *(DPCTLSyclKernelRef, char const *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_1(module, "SyclProgram_GetKernelBundleRef", (void (**)(void))&__pyx_api_f_5dpctl_7program_8_program_SyclProgram_GetKernelBundleRef, "DPCTLSyclKernelBundleRef (struct PySyclProgramObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_1(module, "SyclProgram_Make", (void (**)(void))&__pyx_api_f_5dpctl_7program_8_program_SyclProgram_Make, "struct PySyclProgramObject *(DPCTLSyclKernelBundleRef)") < 0) goto bad;
  __pyx_ptype_5dpctl_7program_8_program_SyclKernel = __Pyx_ImportType_3_1_1(module, "dpctl.program._program", "SyclKernel",
  #if defined(PYPY_VERSION_NUM) && PYPY_VERSION_NUM < 0x050B0000
  sizeof(struct PySyclKernelObject), __PYX_GET_STRUCT_ALIGNMENT_3_1_1(struct PySyclKernelObject),
  #elif CYTHON_COMPILING_IN_LIMITED_API
  sizeof(struct PySyclKernelObject), __PYX_GET_STRUCT_ALIGNMENT_3_1_1(struct PySyclKernelObject),
  #else
  sizeof(struct PySyclKernelObject), __PYX_GET_STRUCT_ALIGNMENT_3_1_1(struct PySyclKernelObject),
  #endif
  __Pyx_ImportType_CheckSize_Warn_3_1_1); if (!__pyx_ptype_5dpctl_7program_8_program_SyclKernel) goto bad;
  __pyx_ptype_5dpctl_7program_8_program_SyclProgram = __Pyx_ImportType_3_1_1(module, "dpctl.program._program", "SyclProgram",
  #if defined(PYPY_VERSION_NUM) && PYPY_VERSION_NUM < 0x050B0000
  sizeof(struct PySyclProgramObject), __PYX_GET_STRUCT_ALIGNMENT_3_1_1(struct PySyclProgramObject),
  #elif CYTHON_COMPILING_IN_LIMITED_API
  sizeof(struct PySyclProgramObject), __PYX_GET_STRUCT_ALIGNMENT_3_1_1(struct PySyclProgramObject),
  #else
  sizeof(struct PySyclProgramObject), __PYX_GET_STRUCT_ALIGNMENT_3_1_1(struct PySyclProgramObject),
  #endif
  __Pyx_ImportType_CheckSize_Warn_3_1_1); if (!__pyx_ptype_5dpctl_7program_8_program_SyclProgram) goto bad;
