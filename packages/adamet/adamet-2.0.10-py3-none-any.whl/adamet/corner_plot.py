...
# V1.1.7: Changed definition of `extents` for consistency with Scipy's `bounds`.
#   MC, Oxford, 27 April 2018
# V1.1.8: Dropped support for legacy Python 2.7. MC, Oxford, 21 May 2018
#
##############################################################################
...
def corner_plot(xs, like=None, xstry=None, weights=None, labels=None,
    ...
    if like is not None:
        ...
        if rasterized is None:
            rasterized = True if xsUnique.size > 100 else False
...
def hist2d(x, y, *args, **kwargs):
    ...
    # These default levels correspond to [0.5, 1, 1.5, 2]*sigma
