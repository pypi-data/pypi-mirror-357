...
async function handleGetTime(workflowId, experimentId, panel) {
    ...
    if (typeof jsonStringTime === 'string') {
        ...
        const endTimeUnix = end_time !== null ? dayjs__WEBPACK_IMPORTED_MODULE_0___default()(end_time).unix() : dayjs__WEBPACK_IMPORTED_MODULE_0___default()().unix() + twoHoursUnix;
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_dayjs_dayjs.4f8bdcd4dfd757b01a17.js.map