...
async function handleGetTime(workflowId, experimentId, panel) {
    ...
    if (typeof jsonStringTime === 'string') {
        ...
        const startTimeUnix = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(start_time).unix() + twoHoursUnix;
        const endTimeUnix = end_time !== null
            ? dayjs__WEBPACK_IMPORTED_MODULE_0___default()(end_time).unix()
            : dayjs__WEBPACK_IMPORTED_MODULE_0___default()().unix() + twoHoursUnix;
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_dayjs_dayjs.cfdebe23dfc2bafb5e3e.js.map