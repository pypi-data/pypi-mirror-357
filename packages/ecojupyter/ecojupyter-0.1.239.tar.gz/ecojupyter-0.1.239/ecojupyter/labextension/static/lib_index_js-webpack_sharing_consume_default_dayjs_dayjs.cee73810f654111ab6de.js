...
/* harmony export */   installJqPackage: () => (/* binding */ installJqPackage),
...
async function handleFirstCellExecution(panel) {
    ...
    await handleNotebookSessionContents(panel, _apiScripts__WEBPACK_IMPORTED_MODULE_1__.installJqPackage);
}
...
async function handleGetTime(workflowId, experimentId, panel) {
    ...
    if (typeof jsonStringTime === 'string') {
        ...
        const startTimeUnix = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(start_time).unix();
        const endTimeUnix = end_time !== null ? dayjs__WEBPACK_IMPORTED_MODULE_0___default()(end_time).unix() : dayjs__WEBPACK_IMPORTED_MODULE_0___default()().unix();
...
username, panel }) {
    ...
    async function handleSubmitValues(args) {
        if (selectedWorkflow && selectedExperiment) {
            ...
            if (session_metrics && startEndTime) {
                (0,_api_handleNotebookContents__WEBPACK_IMPORTED_MODULE_3__.handleNotebookSessionContents)(panel, (0,_api_apiScripts__WEBPACK_IMPORTED_MODULE_5__.exportSendJson)({
                    ...args,
                    session_metrics,
    ...
    async function handleInstallMetrics() {
        const result = await (0,_api_handleNotebookContents__WEBPACK_IMPORTED_MODULE_3__.handleNotebookSessionContents)(panel, _api_apiScripts__WEBPACK_IMPORTED_MODULE_5__.installPrometheusScaphandre);
        console.log(result);
    }
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_dayjs_dayjs.cee73810f654111ab6de.js.map