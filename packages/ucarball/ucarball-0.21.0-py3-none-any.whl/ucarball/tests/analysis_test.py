...
from ucarball.controls.controls import ControlsCreator
from ucarball.decompile_replays import analyze_replay_file
from ucarball.json_parser.sanity_check.sanity_check import SanityChecker
...
def __test_replays(BASE_DIR):
    ...
    for filepath in glob.iglob(ROOT_DIR + '/**ucarball/replays/*.replay', recursive=True):
