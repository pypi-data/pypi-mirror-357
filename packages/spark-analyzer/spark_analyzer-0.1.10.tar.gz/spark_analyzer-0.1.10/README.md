...
> **Note**: For EMR, you see both live (running spark applications) and completed applications in the same Spark History Server URL/endpoint, where the live application will be present under incompleted the applications. This tool allows you to select both completed and live applications to analyze. Make sure you choose the correct Application ID from the list.
