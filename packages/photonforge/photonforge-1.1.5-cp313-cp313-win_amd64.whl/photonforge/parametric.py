...
_Dimension = _A(float, {"minimum": 0, "units": "μm"})
_OptDimension = _A(float, {"required": False, "minimum": 0, "units": "μm"})

_NonZeroDimension = _A(float, {"exclusiveMinimum": 0, "units": "μm"})
_OptNonZeroDimension = _A(float, {"required": False, "exclusiveMinimum": 0, "units": "μm"})

_OptSize = _A(_Seq[_Dimension], {"required": False, "minItems": 2, "maxItems": 2})

_Coord = _A(float, {"units": "μm"})
_OptCoord = _A(float, {"required": False, "units": "μm"})

_Coord2D = _A(_Seq[_Coord], {"minItems": 2, "maxItems": 2})

_OptCoords = _A(_Seq[_Coord2D], {"required": False})

_OptOffsets = _A(_Union[_Coord, _Coord2D], {"required": False})

_OptAngle = _A(float, {"required": False, "minimum": -360, "maximum": 360, "units": "°"})

_Fraction = _A(float, {"minimum": 0, "maximum": 1})
_OptFraction = _A(float, {"required": False, "minimum": 0, "maximum": 1})

_OptFractions = _A(
    _Union[_Fraction, _A(_Seq[_Fraction], {"minItems": 2, "maxItems": 2})], {"required": False}
)

_OptIntTurns = _A(int, {"required": False, "minimum": 2})

_OptJoin = _A(_Union[_Lit["round"], float], {"required": False})

_OptBool = _A(bool, {"required": False})

_OptAxis = _A(_Lit["", "x", "y"], {"required": False})

_OptLayer = _A(_Union[str, tuple[int, int]], {"type": "Layer", "required": False})

_OptVariableFraction = _A(
    _Union[str, _pf.Expression],
    {
        "type": "Expression",
        "required": False,
        "description": "String expression parametrized by the independent variable 'u', ranging "
        "from 0 to 1.",
    },
)

_OptVariableOffset = _A(
    _Union[float, str, _pf.Expression], {"type": "Expression", "required": False, "units": "μm"}
)

_PortSpec = _A(_Union[str, _pf.PortSpec], {"type": "PortSpec"})
_PortSpec1 = _A(_Union[str, _pf.PortSpec], {"type": "PortSpec", "title": "Port Spec 1"})
_PortSpec2 = _A(_Union[str, _pf.PortSpec], {"type": "PortSpec", "title": "Port Spec 2"})
_PortSpec_x2 = _A(_Seq[_PortSpec], {"minItems": 2, "maxItems": 2})
_PortSpecPair = _Union[_PortSpec, _PortSpec_x2]

_Port = _A(
    _Union[_pf.Port, tuple[_pf.Reference, str], tuple[_pf.Reference, str, int]], {"type": "Port"}
)

_Terminal = _A(
    _Union[_pf.Terminal, tuple[_pf.Reference, str], tuple[_pf.Reference, str, int]],
    {"type": "Terminal"},
)

_Model = _A(_Lit["Tidy3D", "Waveguide"], {"required": False})
_Technology = _A(_pf.Technology, {"required": False})
_Name = _A(str, {"required": False})
_Kwargs = _A(dict[str, _Any], {"required", False})
...
def straight(
    *,
    port_spec: _Opt[_PortSpec] = None,
    length: _Opt[_NonZeroDimension] = None,
    bulge_width: _Opt[_OptCoord] = None,
    bulge_taper_length: _Opt[_OptDimension] = None,
    bulge_margin: _Opt[_OptDimension] = None,
    active_model: _Opt[_Model] = None,
    technology: _Opt[_Technology] = None,
    name: _Opt[_Name] = None,
    tidy3d_model_kwargs: _Opt[_Kwargs] = None,
    waveguide_model_kwargs: _Opt[_Kwargs] = None,
) -> _pf.Component:
...
def transition(
    *,
    port_spec1: _Opt[_PortSpec1] = None,
    port_spec2: _Opt[_PortSpec2] = None,
    length: _Opt[_NonZeroDimension] = None,
    constant_length: _Opt[_OptDimension] = None,
    profile: _Opt[_OptVariableFraction] = None,
    technology: _Opt[_Technology] = None,
    name: _Opt[_Name] = None,
    tidy3d_model_kwargs: _Opt[_Kwargs] = None,
) -> _pf.Component:
...
def bend(
    *,
    port_spec: _Opt[_PortSpec] = None,
    radius: _Opt[_NonZeroDimension] = None,
    angle: _Opt[_OptAngle] = None,
    euler_fraction: _Opt[_OptFraction] = None,
    port_bends: _Opt[_OptBool] = None,
    active_model: _Opt[_Model] = None,
    technology: _Opt[_Technology] = None,
    name: _Opt[_Name] = None,
    tidy3d_model_kwargs: _Opt[_Kwargs] = None,
...
def s_bend(
    *,
    port_spec: _Opt[_PortSpec] = None,
    length: _Opt[_OptNonZeroDimension] = None,
    offset: _Opt[_Coord] = None,
    euler_fraction: _Opt[_OptFraction] = None,
    active_model: _Opt[_Model] = None,
    technology: _Opt[_Technology] = None,
    name: _Opt[_Name] = None,
...
def crossing(
    *,
    port_spec: _Opt[_PortSpecPair] = None,
    arm_length: _Opt[_NonZeroDimension] = None,
    added_width: _Opt[_OptVariableOffset] = None,
    extra_length: _Opt[_OptDimension] = None,
    technology: _Opt[_Technology] = None,
    name: _Opt[_Name] = None,
    tidy3d_model_kwargs: _Opt[_Kwargs] = None,
) -> _pf.Component:
...
def ring_coupler(
    *,
    port_spec: _Opt[_PortSpecPair] = None,
    coupling_distance: _Opt[_Coord] = None,
    radius: _Opt[_NonZeroDimension] = None,
    bus_length: _Opt[_OptDimension] = None,
    euler_fraction: _Opt[_OptFraction] = None,
    coupling_length: _Opt[_OptDimension] = None,
    port_bends: _Opt[_OptBool] = None,
    technology: _Opt[_Technology] = None,
    name: _Opt[_Name] = None,
    tidy3d_model_kwargs: _Opt[_Kwargs] = None,
...
def s_bend_ring_coupler(
    *,
    ...
    coupling_distance: _Opt[_Coord] = None,
    radius: _Opt[_NonZeroDimension] = None,
    s_bend_length: _Opt[_OptNonZeroDimension] = None,
    s_bend_offset: _Opt[_Coord] = None,
    euler_fraction: _Opt[_OptFraction] = None,
    coupling_length: _Opt[_OptDimension] = None,
    port_bends: _Opt[_OptBool] = None,
    technology: _Opt[_Technology] = None,
...
def rectangular_spiral(
    *,
    port_spec: _Opt[_PortSpec] = None,
    turns: _Opt[_OptIntTurns] = None,
    radius: _Opt[_NonZeroDimension] = None,
    separation: _Opt[_OptDimension] = None,
    size: _Opt[_OptSize] = None,
    full_length: _OptNonZeroDimension = None,
    align_ports: _Opt[_OptAxis] = None,
    active_model: _Opt[_Model] = None,
    technology: _Opt[_Technology] = None,
    name: _Opt[_Name] = None,
    bend_kwargs: _Opt[_Kwargs] = None,
    straight_kwargs: _Opt[_Kwargs] = None,
    tidy3d_model_kwargs: _Opt[_Kwargs] = None,
    circuit_model_kwargs: _Opt[_Kwargs] = None,
) -> _pf.Component:
    """Rectangular spiral.
...
def circular_spiral(
    *,
    port_spec: _Opt[_PortSpec] = None,
    turns: _Opt[_OptDimension] = None,
    radius: _Opt[_NonZeroDimension] = None,
    separation: _Opt[_OptDimension] = None,
    full_length: _OptNonZeroDimension = None,
    align_ports: _Opt[_OptBool] = None,
    active_model: _Opt[_Model] = None,
    technology: _Opt[_Technology] = None,
    name: _Opt[_Name] = None,
    tidy3d_model_kwargs: _Opt[_Kwargs] = None,
...
def _get_port_or_terminal(
    arg: _Union[_pf.Port, _pf.Terminal, tuple[_pf.Reference, str], tuple[_pf.Reference, str, int]],
    get_ports: bool,
) -> _pf.Port:
...
def route(
    *,
    port1: _Opt[_Port] = None,
    port2: _Opt[_Port] = None,
    radius: _Opt[_NonZeroDimension] = None,
    waypoints: _Opt[_OptCoords] = None,
    technology: _Opt[_Technology] = None,
    name: _Opt[_Name] = None,
    straight_kwargs: _Opt[_Kwargs] = None,
    bend_kwargs: _Opt[_Kwargs] = None,
    s_bend_kwargs: _Opt[_Kwargs] = None,
    circuit_model_kwargs: _Opt[_Kwargs] = None,
) -> _pf.Component:
...
def route_taper(
    *,
    terminal1: _Opt[_Terminal] = None,
    terminal2: _Opt[_Terminal] = None,
    layer: _Opt[_OptLayer] = None,
    offset_distance: _Opt[_OptOffsets] = None,
    use_box: _Opt[_OptBool] = None,
    technology: _Opt[_Technology] = None,
    name: _Opt[_Name] = None,
):
...
def route_manhattan(
    *,
    terminal1: _Opt[_Terminal] = None,
    terminal2: _Opt[_Terminal] = None,
    direction1: _Opt[_OptAxis] = None,
    direction2: _Opt[_OptAxis] = None,
    layer: _Opt[_OptLayer] = None,
    width: _Opt[_OptNonZeroDimension] = None,
    overlap_fraction: _Opt[_OptFractions] = None,
    join_limit: _Opt[_OptJoin] = None,
    waypoints: _Opt[_OptCoords] = None,
    technology: _Opt[_Technology] = None,
    name: _Opt[_Name] = None,
):
