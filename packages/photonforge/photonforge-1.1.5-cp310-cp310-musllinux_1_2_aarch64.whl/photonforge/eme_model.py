...
class _EMEModelRunner:
    ...
    def s_matrix(self) -> SMatrix:
        ...
        if self._s_matrix is None:
            ...
            # Temoporary fix for 2.9.0rc1
            eme_modes = (
                eme_data._extract_mode_solver_data(
                    data=eme_data.port_modes.symmetry_expanded_copy, eme_cell_index=0
                ),
                eme_data._extract_mode_solver_data(
                    data=eme_data.port_modes.symmetry_expanded_copy,
                    eme_cell_index=eme_data.simulation.eme_grid.num_cells - 1,
                ),
            )
