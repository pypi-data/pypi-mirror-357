...
class TestBaseOperationsProperties:
    ...
    def test_storage_provider_name_property(self, base_operations, mock_artifact_store):
        ...
        assert base_operations.storage_provider_name == mock_artifact_store._storage_provider_name
    ...
    def test_session_provider_name_property(self, base_operations, mock_artifact_store):
        ...
        assert base_operations.session_provider_name == mock_artifact_store._session_provider_name
...
class TestGetRecord:
    ...
    @pytest.mark.asyncio
    async def test_get_record_corrupted_json(self, base_operations, mock_artifact_store):
    ...
    @pytest.mark.asyncio
    async def test_get_record_session_get_error(self, base_operations, mock_artifact_store):
...
class TestLogging:
    ...
    @pytest.mark.asyncio
    async def test_get_record_logs_corruption_error(self, base_operations, mock_artifact_store):
...
class TestEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_get_record_whitespace_only(self, base_operations, mock_artifact_store):
    ...
    @pytest.mark.asyncio
    async def test_get_record_valid_empty_dict(self, base_operations, mock_artifact_store):
