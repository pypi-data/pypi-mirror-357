...
from szetop_backend_code_mcp.services.coder import Coder
...
async def test_get_code_entire_prompt(mock_coder):
    ...
    test_entities = [
        "/d:/projects/ai/ai-demo-api/yitu-template/src/main/java/com/yitu/template/api/entity/GxrcProjectInfo.java",
