...
class FreeGpt:
    ...
    def mono_chat(self, messages: dict = None, model: str = "o4-mini") -> str:
        ...
        try:
            ...
            full_response = ""
            res = requests.post("https://www.chatwithmono.xyz/api/chat", json=payload, stream=True, timeout=30)
...
class FreeImg:
    ...
    def mono_img(self, prompt: str = None, model: int = 0, filename: str = "image.png") -> bool:
        ...
        try:
            ...
            resp = requests.post("https://www.chatwithmono.xyz/api/image",  json=payload)
            if resp.status_code == 200:
                data = resp.json()
