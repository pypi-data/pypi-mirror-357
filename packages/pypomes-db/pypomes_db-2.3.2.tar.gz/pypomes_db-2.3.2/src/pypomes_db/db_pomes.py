...
def db_select(errors: list[str] | None,
    ...
    of tuples. In SQLServer, for both *offset_count* and *limit_count* to be used together, an *ORDER BY*
    clause must have been specifed, otherwise *offset_count* is ignored.
