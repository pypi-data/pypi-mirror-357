...
SUB_STAGE_IMPORT_TEMPLATE = """from {domain_name}.b_source.{pipeline_name}.orchestrators.sub_stages.{pipeline_name}_{stage_name}_{sub_stage_name}.{pipeline_name}_{stage_name}_{sub_stage_name}_orchestrator import (
    orchestrate_{pipeline_name}_{stage_name}_{sub_stage_name},
)
"""

B_UNIT_CREATOR_IMPORT = """from {domain_name}.b_source.common.operations.b_units.b_unit_creator_and_runner import (
    create_and_run_b_unit,
)
"""

B_UNIT_IMPORT_TEMPLATE = """from {domain_name}.b_source.{pipeline_name}.objects.b_units.{pipeline_name}_{stage_name}.{b_unit_lower}_b_units import (
    {b_unit_class}BUnits,
)
"""
