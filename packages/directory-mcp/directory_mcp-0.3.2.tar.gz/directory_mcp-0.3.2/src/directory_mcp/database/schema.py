...
CREATE INDEX idx_channel_platform ON channel(platform);
CREATE INDEX idx_channel_company ON channel(company_id);
CREATE INDEX idx_channel_project ON channel(project_id);
CREATE INDEX idx_project_company ON project(company_id);
CREATE INDEX idx_project_lead ON project(lead_id);
CREATE INDEX idx_project_status ON project(status);
CREATE INDEX idx_email_domain ON email(domain);
CREATE INDEX idx_email_person ON email(person_id);
...
CREATE TRIGGER company_ai AFTER INSERT ON company BEGIN
...
CREATE TRIGGER company_au AFTER UPDATE ON company BEGIN
...
CREATE TRIGGER channel_ad AFTER DELETE ON channel BEGIN
