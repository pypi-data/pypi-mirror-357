    ...
    async def add_person_to_channel(
        ...
        try:
            ...
            return {
                ...
                "role": role.lower(),
                "message": f"Successfully added {person_data['names'][0]} to {channel_data['name']} as {role}"
            }
    ...
    async def assign_person_to_project(
        ...
        try:
            ...
            return {
                ...
                "message": f"Successfully assigned {person_data['names'][0]} to {project_data['name']} as {role}{allocation_text}"
            }
    ...
    async def link_person_to_company(
        ...
        try:
            ...
            return {
                ...
                "end_date": end_date,
                "message": f"Successfully linked {person_data['names'][0]} to {company_data['name']} as {role}{date_text}"
            }
