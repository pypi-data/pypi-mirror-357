...
class Update(BaseModel):
    ...
    """
    message: Optional[Message] = None
    callback: Optional[CallbackQuery] = None # Используем модель CallbackQuery
    update_type: str
    timestamp: int
...
class Context:
    ...
    def is_callback(self) -> bool:
        """True, если обновление является callback-запросом."""
    ...
    async def reply(self, text: str, reply_markup: Optional[Any] = None, **kwargs):
        ...
        return await self.bot.send_message(text, chat_id=self.chat_id, reply_markup=reply_markup, **kwargs)
    ...
    async def edit_message(self, text: str, reply_markup: Optional[Any] = None, **kwargs):
        ...
        return await self.bot.edit_message(message_id=message_id_to_edit, text=text, reply_markup=reply_markup, **kwargs)
    ...
    async def answer_callback(self, 
        ...
        if not payload:
            ...
            return await self.bot.answer_callback_query(callback_id=self.callback_id)
