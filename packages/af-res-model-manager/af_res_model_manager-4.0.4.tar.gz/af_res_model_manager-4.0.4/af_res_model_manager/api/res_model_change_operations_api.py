...
class ResModelChangeOperationsApi(object):
    ...
    def move_resource(self, body, t_id, res_id, **kwargs):  # noqa: E501
        """move_resource  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.move_resource(body, t_id, res_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.move_resource_with_http_info(body, t_id, res_id, **kwargs)  # noqa: E501
        else:
            (data) = self.move_resource_with_http_info(body, t_id, res_id, **kwargs)  # noqa: E501
            return data

    def move_resource_with_http_info(self, body, t_id, res_id, **kwargs):  # noqa: E501
        """move_resource  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.move_resource_with_http_info(body, t_id, res_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 't_id', 'res_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `move_resource`")  # noqa: E501
        # verify the required parameter 't_id' is set
        if ('t_id' not in params or
                params['t_id'] is None):
    ...
    def move_resource_to_top_level(self, t_id, res_id, **kwargs):  # noqa: E501
        """move_resource_to_top_level  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.move_resource_to_top_level(t_id, res_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.move_resource_to_top_level_with_http_info(t_id, res_id, **kwargs)  # noqa: E501
        else:
            (data) = self.move_resource_to_top_level_with_http_info(t_id, res_id, **kwargs)  # noqa: E501
            return data

    def move_resource_to_top_level_with_http_info(self, t_id, res_id, **kwargs):  # noqa: E501
        """move_resource_to_top_level  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.move_resource_to_top_level_with_http_info(t_id, res_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method move_resource_to_top_level" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 't_id' is set
        if ('t_id' not in params or
                params['t_id'] is None):
            raise ValueError("Missing the required parameter `t_id` when calling `move_resource_to_top_level`")  # noqa: E501
        # verify the required parameter 'res_id' is set
        if ('res_id' not in params or
                params['res_id'] is None):
            raise ValueError("Missing the required parameter `res_id` when calling `move_resource_to_top_level`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ResModelChangeOperations/resource/{tId}/{resId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def start_change_transaction_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ResModelChangeOperations/transaction/start', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
