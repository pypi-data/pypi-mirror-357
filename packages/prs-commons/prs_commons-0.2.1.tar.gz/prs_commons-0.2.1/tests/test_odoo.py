...
class TestOdooRPClientRealConnection:
    ...
    def test_ensure_connection_WithValidCredentials_ShouldConnectSuccessfully(self):
    ...
    def test_OdooRPClient_WhenInstantiatedMultipleTimes_ShouldReturnSameInstance(self):
    ...
    def test_search_read_WithValidUserCredentials_ShouldReturnUserData(self):
