...
def get_font_manager():
    ...
    """
    # Convert to string to ensure compatibility with older Python versions
    fonts_path = str(fonts_dir.absolute())
    print(f"Initializing font manager with fonts directory: {fonts_path}")
    return _get_font_manager(fonts_path)
