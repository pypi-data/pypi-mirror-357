...
def retry_with_exponential_backoff(max_retries=3, base_delay: float = 1.0):
    """
    Decorator for retrying a function with exponential backoff.

    Args:
        max_retries (int): Maximum number of retries
        base_delay (int): Base delay for exponential backoff in seconds
    """
...
def async_retry_with_exponential_backoff(max_retries=3, base_delay: float = 1.0):
    """
