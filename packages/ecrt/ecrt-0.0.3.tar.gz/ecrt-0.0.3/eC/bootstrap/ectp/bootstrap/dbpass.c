...
Compiler_Error(__eCNameSpace__eC__i18n__GetTranslatedString("ec", "Multiple field index requires a name\n", (((void *)0))));
}
else
{
indexed = 1;
...
{
FreeExpContents(exp);
Compiler_Error(__eCNameSpace__eC__i18n__GetTranslatedString("ec", "No database table defined in this module or database_open already used.\n", (((void *)0))));
exp->type = 16;
}
break;
}
