...
class GetWebhook200ResponseInner(BaseModel):
    ...
    __properties = ["webhook_id", "webhook_type", "username", "message"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWebhook200ResponseInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWebhook200ResponseInner:
        """Create an instance of GetWebhook200ResponseInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWebhook200ResponseInner.parse_obj(obj)

        _obj = GetWebhook200ResponseInner.parse_obj({
            "webhook_id": obj.get("webhook_id"),
            "webhook_type": obj.get("webhook_type"),
            "username": obj.get("username"),
            "message": GetWebhook200ResponseInnerMessage.from_dict(obj.get("message")) if obj.get("message") is not None else None
        })
        return _obj
