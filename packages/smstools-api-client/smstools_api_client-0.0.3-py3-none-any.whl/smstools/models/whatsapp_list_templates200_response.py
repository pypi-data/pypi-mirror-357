...
class WhatsappListTemplates200Response(BaseModel):
    ...
    """
    templates: Optional[conlist(WhatsappListTemplates200ResponseTemplatesInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WhatsappListTemplates200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WhatsappListTemplates200Response:
        """Create an instance of WhatsappListTemplates200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WhatsappListTemplates200Response.parse_obj(obj)

        _obj = WhatsappListTemplates200Response.parse_obj({
            "templates": [WhatsappListTemplates200ResponseTemplatesInner.from_dict(_item) for _item in obj.get("templates")] if obj.get("templates") is not None else None
        })
        return _obj
