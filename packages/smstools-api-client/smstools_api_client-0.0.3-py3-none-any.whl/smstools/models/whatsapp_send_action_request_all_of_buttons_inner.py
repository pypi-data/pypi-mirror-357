...
class WhatsappSendActionRequestAllOfButtonsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WhatsappSendActionRequestAllOfButtonsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WhatsappSendActionRequestAllOfButtonsInner:
        """Create an instance of WhatsappSendActionRequestAllOfButtonsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WhatsappSendActionRequestAllOfButtonsInner.parse_obj(obj)

        _obj = WhatsappSendActionRequestAllOfButtonsInner.parse_obj({
            "id": obj.get("id"),
            "title": obj.get("title")
        })
        return _obj
