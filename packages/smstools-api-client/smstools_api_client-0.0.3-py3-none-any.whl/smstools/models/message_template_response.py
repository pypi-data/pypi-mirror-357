...
class MessageTemplateResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MessageTemplateResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MessageTemplateResponse:
        """Create an instance of MessageTemplateResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MessageTemplateResponse.parse_obj(obj)

        _obj = MessageTemplateResponse.parse_obj({
            "id": obj.get("ID"),
            "title": obj.get("title"),
