...
class UpdateMessageTemplateRequest(BaseModel):
    ...
    __properties = ["ID", "title", "message", "order"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateMessageTemplateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateMessageTemplateRequest:
        """Create an instance of UpdateMessageTemplateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateMessageTemplateRequest.parse_obj(obj)

        _obj = UpdateMessageTemplateRequest.parse_obj({
            "id": obj.get("ID"),
            "title": obj.get("title"),
