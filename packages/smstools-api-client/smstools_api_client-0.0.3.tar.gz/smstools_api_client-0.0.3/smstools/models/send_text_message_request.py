...
class SendTextMessageRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SendTextMessageRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SendTextMessageRequest:
        """Create an instance of SendTextMessageRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SendTextMessageRequest.parse_obj(obj)

        _obj = SendTextMessageRequest.parse_obj({
