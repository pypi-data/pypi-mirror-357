...
class MessageResponse(BaseModel):
    ...
    __properties = ["ID", "message", "to", "type", "date", "reference", "messageid"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MessageResponse:
        """Create an instance of MessageResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MessageResponse.parse_obj(obj)

        _obj = MessageResponse.parse_obj({
            "id": obj.get("ID"),
