...
class MessageParameter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MessageParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MessageParameter:
        """Create an instance of MessageParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MessageParameter.parse_obj(obj)

        _obj = MessageParameter.parse_obj({
