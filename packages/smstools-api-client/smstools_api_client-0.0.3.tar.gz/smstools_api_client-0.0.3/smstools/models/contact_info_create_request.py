...
class ContactInfoCreateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactInfoCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactInfoCreateRequest:
        """Create an instance of ContactInfoCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactInfoCreateRequest.parse_obj(obj)

        _obj = ContactInfoCreateRequest.parse_obj({
            "id": obj.get("ID"),
            "phone": obj.get("phone"),
