...
class GroupInfoCreateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupInfoCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupInfoCreateRequest:
        """Create an instance of GroupInfoCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupInfoCreateRequest.parse_obj(obj)

        _obj = GroupInfoCreateRequest.parse_obj({
            "name": obj.get("name")
        })
        return _obj
