...
class WhitelabelAccountResponseInbox(BaseModel):
    """
    WhitelabelAccountResponseInbox
    """
    shared_inbox: Optional[StrictInt] = None
    __properties = ["shared_inbox"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WhitelabelAccountResponseInbox:
        """Create an instance of WhitelabelAccountResponseInbox from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WhitelabelAccountResponseInbox:
        """Create an instance of WhitelabelAccountResponseInbox from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WhitelabelAccountResponseInbox.parse_obj(obj)

        _obj = WhitelabelAccountResponseInbox.parse_obj({
            "shared_inbox": obj.get("shared_inbox")
        })
        return _obj
