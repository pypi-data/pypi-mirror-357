...
class GetConversation200ResponseAllOfConversationInnerFile(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetConversation200ResponseAllOfConversationInnerFile:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetConversation200ResponseAllOfConversationInnerFile:
        """Create an instance of GetConversation200ResponseAllOfConversationInnerFile from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetConversation200ResponseAllOfConversationInnerFile.parse_obj(obj)

        _obj = GetConversation200ResponseAllOfConversationInnerFile.parse_obj({
            "name": obj.get("name"),
            "image": obj.get("image"),
            "mime": obj.get("mime")
        })
