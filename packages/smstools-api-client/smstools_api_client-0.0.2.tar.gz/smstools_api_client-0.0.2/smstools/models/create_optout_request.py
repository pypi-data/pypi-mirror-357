...
class CreateOptoutRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateOptoutRequest:
        """Create an instance of CreateOptoutRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOptoutRequest:
        """Create an instance of CreateOptoutRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateOptoutRequest.parse_obj(obj)

        _obj = CreateOptoutRequest.parse_obj({
