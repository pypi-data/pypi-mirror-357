...
class FormatNumberRequest(BaseModel):
    ...
    countrycode: StrictStr = Field(...)
    __properties = ["number", "countrycode"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FormatNumberRequest:
        """Create an instance of FormatNumberRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FormatNumberRequest:
        """Create an instance of FormatNumberRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FormatNumberRequest.parse_obj(obj)

        _obj = FormatNumberRequest.parse_obj({
