...
class WhatsappSendFileRequest(BaseModel):
    ...
    __properties = ["message", "sender", "to", "date", "reference", "test", "subid", "attachment", "attachment_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WhatsappSendFileRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WhatsappSendFileRequest:
        """Create an instance of WhatsappSendFileRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WhatsappSendFileRequest.parse_obj(obj)

        _obj = WhatsappSendFileRequest.parse_obj({
