...
class GetGroup200Response(BaseModel):
    ...
    __properties = ["total", "shown", "page", "limit", "groupinfo", "contacts"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetGroup200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetGroup200Response:
        """Create an instance of GetGroup200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetGroup200Response.parse_obj(obj)

        _obj = GetGroup200Response.parse_obj({
            "total": obj.get("total"),
            "shown": obj.get("shown"),
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "groupinfo": GroupInfoResponse.from_dict(obj.get("groupinfo")) if obj.get("groupinfo") is not None else None,
