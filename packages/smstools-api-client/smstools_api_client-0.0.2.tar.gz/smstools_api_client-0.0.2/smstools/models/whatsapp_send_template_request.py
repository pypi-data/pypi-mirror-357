...
class WhatsappSendTemplateRequest(BaseModel):
    ...
    template_name: StrictStr = Field(..., description="The name of the template you want to send")
    image: Optional[StrictStr] = Field(None, description="Only required if your template has a header_type of 'image'")
    video: Optional[StrictStr] = Field(None, description="Only required if your template has a header_type of 'video'")
    document: Optional[StrictStr] = Field(None, description="Only required if your template has a header_type of 'document'")
    __properties = ["sender", "to", "date", "reference", "test", "subid", "template_name", "image", "video", "document"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WhatsappSendTemplateRequest:
        """Create an instance of WhatsappSendTemplateRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WhatsappSendTemplateRequest:
        """Create an instance of WhatsappSendTemplateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WhatsappSendTemplateRequest.parse_obj(obj)

        _obj = WhatsappSendTemplateRequest.parse_obj({
