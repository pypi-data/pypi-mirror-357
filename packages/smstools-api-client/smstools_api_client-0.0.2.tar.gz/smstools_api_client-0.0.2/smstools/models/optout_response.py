...
class OptoutResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OptoutResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OptoutResponse:
        """Create an instance of OptoutResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OptoutResponse.parse_obj(obj)

        _obj = OptoutResponse.parse_obj({
