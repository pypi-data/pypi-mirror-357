...
class ListStatistics200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListStatistics200Response:
        """Create an instance of ListStatistics200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListStatistics200Response:
        """Create an instance of ListStatistics200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListStatistics200Response.parse_obj(obj)

        _obj = ListStatistics200Response.parse_obj({
            "sent": obj.get("sent"),
