...
class GetInbox200Response(BaseModel):
    ...
    messages: Optional[conlist(GetInbox200ResponseAllOfMessagesInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetInbox200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetInbox200Response:
        """Create an instance of GetInbox200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetInbox200Response.parse_obj(obj)

        _obj = GetInbox200Response.parse_obj({
            "total": obj.get("total"),
            "shown": obj.get("shown"),
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "messages": [GetInbox200ResponseAllOfMessagesInner.from_dict(_item) for _item in obj.get("messages")] if obj.get("messages") is not None else None
        })
        return _obj
