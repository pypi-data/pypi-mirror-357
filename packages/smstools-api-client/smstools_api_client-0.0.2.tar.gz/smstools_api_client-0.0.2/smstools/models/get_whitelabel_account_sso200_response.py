...
class GetWhitelabelAccountSSO200Response(BaseModel):
    """
    GetWhitelabelAccountSSO200Response
    """
    loginurl: Optional[StrictStr] = None
    __properties = ["loginurl"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWhitelabelAccountSSO200Response:
        """Create an instance of GetWhitelabelAccountSSO200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWhitelabelAccountSSO200Response:
        """Create an instance of GetWhitelabelAccountSSO200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWhitelabelAccountSSO200Response.parse_obj(obj)

        _obj = GetWhitelabelAccountSSO200Response.parse_obj({
