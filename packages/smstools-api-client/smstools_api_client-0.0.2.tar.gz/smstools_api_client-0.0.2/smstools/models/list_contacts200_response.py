...
class ListContacts200Response(BaseModel):
    ...
    contacts: Optional[conlist(ContactInfoResponse)] = None
    __properties = ["total", "shown", "page", "limit", "contacts"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListContacts200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListContacts200Response:
        """Create an instance of ListContacts200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListContacts200Response.parse_obj(obj)

        _obj = ListContacts200Response.parse_obj({
            "total": obj.get("total"),
            "shown": obj.get("shown"),
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "contacts": [ContactInfoResponse.from_dict(_item) for _item in obj.get("contacts")] if obj.get("contacts") is not None else None
        })
        return _obj
