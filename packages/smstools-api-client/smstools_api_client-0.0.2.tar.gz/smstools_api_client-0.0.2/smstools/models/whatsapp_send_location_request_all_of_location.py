...
class WhatsappSendLocationRequestAllOfLocation(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WhatsappSendLocationRequestAllOfLocation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WhatsappSendLocationRequestAllOfLocation:
        """Create an instance of WhatsappSendLocationRequestAllOfLocation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WhatsappSendLocationRequestAllOfLocation.parse_obj(obj)

        _obj = WhatsappSendLocationRequestAllOfLocation.parse_obj({
            "name": obj.get("name"),
