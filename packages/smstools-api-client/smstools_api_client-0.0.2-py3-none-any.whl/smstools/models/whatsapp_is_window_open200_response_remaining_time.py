...
class WhatsappIsWindowOpen200ResponseRemainingTime(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WhatsappIsWindowOpen200ResponseRemainingTime:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WhatsappIsWindowOpen200ResponseRemainingTime:
        """Create an instance of WhatsappIsWindowOpen200ResponseRemainingTime from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WhatsappIsWindowOpen200ResponseRemainingTime.parse_obj(obj)

        _obj = WhatsappIsWindowOpen200ResponseRemainingTime.parse_obj({
            "hours": obj.get("hours"),
