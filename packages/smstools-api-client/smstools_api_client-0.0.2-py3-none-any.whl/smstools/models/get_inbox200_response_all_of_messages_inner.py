...
class GetInbox200ResponseAllOfMessagesInner(BaseModel):
    """
    ...
    __properties = ["ID", "message", "sender", "type", "date", "receiver"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetInbox200ResponseAllOfMessagesInner:
        """Create an instance of GetInbox200ResponseAllOfMessagesInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetInbox200ResponseAllOfMessagesInner:
        """Create an instance of GetInbox200ResponseAllOfMessagesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetInbox200ResponseAllOfMessagesInner.parse_obj(obj)

        _obj = GetInbox200ResponseAllOfMessagesInner.parse_obj({
            "id": obj.get("ID"),
