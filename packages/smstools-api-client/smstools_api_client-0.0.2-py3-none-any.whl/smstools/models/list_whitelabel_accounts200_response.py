...
class ListWhitelabelAccounts200Response(BaseModel):
    ...
    accounts: Optional[conlist(WhitelabelAccountResponse)] = None
    __properties = ["total", "shown", "page", "limit", "accounts"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWhitelabelAccounts200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWhitelabelAccounts200Response:
        """Create an instance of ListWhitelabelAccounts200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWhitelabelAccounts200Response.parse_obj(obj)

        _obj = ListWhitelabelAccounts200Response.parse_obj({
            "total": obj.get("total"),
            "shown": obj.get("shown"),
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "accounts": [WhitelabelAccountResponse.from_dict(_item) for _item in obj.get("accounts")] if obj.get("accounts") is not None else None
        })
        return _obj
