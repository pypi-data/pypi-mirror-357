...
class GetSpecificInbox200Response(BaseModel):
    """
    ...
    messages: Optional[conlist(GetSpecificInbox200ResponseAllOfMessagesInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetSpecificInbox200Response:
        """Create an instance of GetSpecificInbox200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetSpecificInbox200Response:
        """Create an instance of GetSpecificInbox200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetSpecificInbox200Response.parse_obj(obj)

        _obj = GetSpecificInbox200Response.parse_obj({
            "total": obj.get("total"),
            "shown": obj.get("shown"),
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "messages": [GetSpecificInbox200ResponseAllOfMessagesInner.from_dict(_item) for _item in obj.get("messages")] if obj.get("messages") is not None else None
        })
        return _obj
