...
class CreateSubaccountRequest(BaseModel):
    ...
    """
    subusername: StrictStr = Field(...)
    password: StrictStr = Field(...)
    email: StrictStr = Field(...)
    memo: Optional[StrictStr] = None
    __properties = ["subusername", "password", "email", "memo"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSubaccountRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSubaccountRequest:
        """Create an instance of CreateSubaccountRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSubaccountRequest.parse_obj(obj)

        _obj = CreateSubaccountRequest.parse_obj({
            "subusername": obj.get("subusername"),
