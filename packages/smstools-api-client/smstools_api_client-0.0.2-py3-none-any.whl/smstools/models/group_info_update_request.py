...
class GroupInfoUpdateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupInfoUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupInfoUpdateRequest:
        """Create an instance of GroupInfoUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupInfoUpdateRequest.parse_obj(obj)

        _obj = GroupInfoUpdateRequest.parse_obj({
            "name": obj.get("name"),
            "id": obj.get("ID")
        })
        return _obj
