...
class WhatsappListNumbers200Response(BaseModel):
    ...
    """
    numbers: Optional[conlist(WhatsappListNumbers200ResponseNumbersInner)] = None
    __properties = ["numbers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WhatsappListNumbers200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WhatsappListNumbers200Response:
        """Create an instance of WhatsappListNumbers200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WhatsappListNumbers200Response.parse_obj(obj)

        _obj = WhatsappListNumbers200Response.parse_obj({
            "numbers": [WhatsappListNumbers200ResponseNumbersInner.from_dict(_item) for _item in obj.get("numbers")] if obj.get("numbers") is not None else None
        })
        return _obj
