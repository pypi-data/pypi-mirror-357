...
class GetSpecificInbox200ResponseAllOfMessagesInner(BaseModel):
    ...
    __properties = ["ID", "message", "sender", "type", "date"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetSpecificInbox200ResponseAllOfMessagesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetSpecificInbox200ResponseAllOfMessagesInner:
        """Create an instance of GetSpecificInbox200ResponseAllOfMessagesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetSpecificInbox200ResponseAllOfMessagesInner.parse_obj(obj)

        _obj = GetSpecificInbox200ResponseAllOfMessagesInner.parse_obj({
            "id": obj.get("ID"),
