...
class ContactInfoUpdateRequest(BaseModel):
    ...
    __properties = ["ID", "phone", "firstname", "lastname", "unsubscribed", "groupid", "email", "extra1", "extra2", "extra3", "extra4", "extra5", "extra6", "extra7", "extra8", "extra9", "extra10", "birthday"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactInfoUpdateRequest:
        """Create an instance of ContactInfoUpdateRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactInfoUpdateRequest:
        """Create an instance of ContactInfoUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactInfoUpdateRequest.parse_obj(obj)

        _obj = ContactInfoUpdateRequest.parse_obj({
            "id": obj.get("ID"),
            "phone": obj.get("phone"),
