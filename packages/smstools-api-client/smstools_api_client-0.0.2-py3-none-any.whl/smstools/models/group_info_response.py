...
class GroupInfoResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupInfoResponse:
        """Create an instance of GroupInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupInfoResponse.parse_obj(obj)

        _obj = GroupInfoResponse.parse_obj({
            "name": obj.get("name"),
            "id": obj.get("ID"),
