...
class WhatsappSendListRequest(BaseModel):
    ...
    __properties = ["message", "sender", "to", "date", "reference", "test", "subid", "list", "button_text", "header", "footer"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WhatsappSendListRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WhatsappSendListRequest:
        """Create an instance of WhatsappSendListRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WhatsappSendListRequest.parse_obj(obj)

        _obj = WhatsappSendListRequest.parse_obj({
