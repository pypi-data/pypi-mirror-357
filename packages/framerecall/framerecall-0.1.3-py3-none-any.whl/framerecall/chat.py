"""
FramerecallChat - Enhanced conversational interface with multi-provider LLM support
"""
...
class FramerecallChat:
    """Enhanced FramerecallChat with multi-provider LLM support"""
    ...
    def __init__(
        ...
        """
        Initialize FramerecallChat with flexible LLM provider support
        ...
        Args:
            ...
            retriever_kwargs: Additional arguments for FramerecallRetriever
        """
