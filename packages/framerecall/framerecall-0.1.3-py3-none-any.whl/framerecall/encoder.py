"""
FramerecallEncoder - Unified encoding with native OpenCV and FFmpeg (Docker/native) support
"""
...
class FramerecallEncoder:
    """
    Unified FramerecallEncoder with clean separation between encoding logic and Docker management.
    ...
    def from_file(cls, file_path: str, chunk_size: int = DEFAULT_CHUNK_SIZE, overlap: int = DEFAULT_OVERLAP,
        ...
        Returns:
            FramerecallEncoder instance with chunks loaded
        """
        encoder = cls(config)
