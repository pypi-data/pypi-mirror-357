...
def train(
    ...
    model_scheduler: Union[ModelScheduler, Callable[[Optimizer], ModelScheduler]],
    ...
    Args:
        ...
        model_scheduler (Union[ModelScheduler, Callable[[Optimizer], ModelScheduler]]): The model
            scheduler or a function that receives a module instance and returns a model scheduler.
    ...
    runner.set_model_scheduler(model_scheduler)
