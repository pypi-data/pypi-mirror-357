...
class AgentNode:
    ...
    def __init__(self, name: str, dialogue: DialogueBus, handle_send_cb=None):
        self.name = name
        self.dialogue = dialogue
        self.broadcast_allowed = True
        self.handle_send_cb = handle_send_cb
        run_async_function(self.dialogue.subscribe,subject="send",callback={self.name:self.handle_send})
