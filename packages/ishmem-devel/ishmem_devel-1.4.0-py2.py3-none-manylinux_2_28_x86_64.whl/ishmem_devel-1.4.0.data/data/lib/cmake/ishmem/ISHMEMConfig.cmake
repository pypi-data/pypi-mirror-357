...
#     default: ON (determined at ishmem build time)
# ISHMEM_SPIRV_COMPILATION_TARGETS
#     The target devices for SPIR-V compilation.
#     default: pvc (determined at ishmem build time)
...
option(ISHMEM_ENABLE_SPIRV_COMPILATION          "Enables SPIR-V compilation"           ON)
option(ISHMEM_SPIRV_SUPPRESS_COMPILATION_OUTPUT "Suppress SPIR-V compilation messages" ON)

ishmem_set_default_var(ISHMEM_SPIRV_COMPILATION_TARGETS "pvc")
...
if (ISHMEM_ENABLE_SPIRV_COMPILATION)
    list(APPEND _ISHMEM_SPIRV_ARGS -fsycl-targets=spir64_gen --start-no-unused-arguments -Xs "-device pvc" --end-no-unused-arguments)
