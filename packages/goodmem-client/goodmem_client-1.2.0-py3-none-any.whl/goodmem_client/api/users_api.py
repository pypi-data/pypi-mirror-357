...
class UsersApi:
    ...
    def get_user(
        ...
        email: Annotated[Optional[StrictStr], Field(description="Alternative lookup by email address (if ID is not specified)")] = None,
        ...
        :type id: str
        :param email: Alternative lookup by email address (if ID is not specified)
        :type email: str
