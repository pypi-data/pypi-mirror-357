...
class CalculateTheoreticalOutletPressure(UnitModuleAbstract):
    """ Class of CalculateTheoreticalOutletPressure

    Class to calculate theoretical outlet pressure of ESP by
    adding theoretical calculated pump head to the measure inlet pressure

    theoretical pump head were calculated using
    esp_head_coefficient, flow and frequency
    """
