...
class LlamaCpp(generic.Middleware):
    ...
    def __init__(
        ...
        url
            URL of the llama.cpp-instance where the model may be accessed.
        ...
        authenticator
            ...
            llama.cpp-instance requests for authentication.
    ...
    def exec(
        ...
        if self.client is None:
            ...
            # Import OpenAI client, and use it to make a connection to the llama.cpp instance.
            ...
            if txt is None:
                ...
                request : dict = dict(
                    ...
                    **{
                    ...
                    logit_bias = [[k, v] for k, v in prompt_params.get("logit_bias", {}).items()],
