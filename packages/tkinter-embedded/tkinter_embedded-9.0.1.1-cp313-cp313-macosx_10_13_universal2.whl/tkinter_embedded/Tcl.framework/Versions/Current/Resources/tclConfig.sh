...
TCL_EXTRA_CFLAGS='-arch arm64 -arch x86_64 -pipe  -finput-charset=UTF-8  -mmacosx-version-min=10.13 '
...
# build directory.
TCL_BUILD_LIB_SPEC='-F/Users/culler/projects/tkinter-embedded/dev/3.13/build/tcl/Deployment -framework Tcl'
...
TCL_INCLUDE_SPEC='-I/Frameworks/Tcl.framework/Versions/9.0/Headers'
...
# compiled.
TCL_SRC_DIR='/Users/culler/projects/tkinter-embedded/dev/3.13/Tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/culler/projects/tkinter-embedded/dev/3.13/build/tcl/Deployment -ltclstub'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Frameworks/Tcl.framework/Versions/9.0 -ltclstub'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/culler/projects/tkinter-embedded/dev/3.13/build/tcl/Deployment/libtclstub.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Frameworks/Tcl.framework/Versions/9.0/libtclstub.a'
