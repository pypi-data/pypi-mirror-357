...
def add_function_to_capability_group(name: str, 
    ...
    function (Dict): Function to add to the capability group.
...
def update_function_in_capability_group(name: str, 
    ...
    source_code (str): the source code of the updated function.
    new_function (Dict): the new function details.
