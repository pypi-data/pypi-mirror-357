...
class PartnerOrdersTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.status_combo.addItems(["Все", "новая", "выполнено", "отклонено"])
        ...
        self.sort_combo.addItems(["Сначала новые", "Сначала выполненные", "Сначала отклоненные", "По сумме (убыв.)", "По сумме (возр.)"])
