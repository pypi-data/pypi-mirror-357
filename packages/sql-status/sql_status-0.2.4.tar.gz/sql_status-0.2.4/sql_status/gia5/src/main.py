...
# from manager_window import ManagerWindow  # Отключено по новому ТЗ
from admin_window import AdminWindow 
# from worker_window import WorkerWindow  # Отключено по новому ТЗ
...
def main():
    ...
    def open_role_window(user):
        ...
        if role == 'admin':
            ...
            return
        # Подключаем сигнал выхода к функции show_login, если есть
        if hasattr(win, 'switch_account_signal'):
