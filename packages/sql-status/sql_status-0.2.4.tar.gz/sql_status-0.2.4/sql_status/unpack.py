...
def unpack_project(*args, **kwargs):
    """
    Распаковать содержимое выбранного шаблона (gia3, gia4 или gia5) в целевую папку.
    Можно вызывать:
        unpack_project()  # по умолчанию gia3 в текущую папку
        unpack_project('gia4')  # gia4 в текущую папку
        unpack_project('gia5')  # gia5 в текущую папку
    ...
    if template not in ('gia3', 'gia4', 'gia5'):
        raise ValueError("template должен быть 'gia3', 'gia4' или 'gia5'")
