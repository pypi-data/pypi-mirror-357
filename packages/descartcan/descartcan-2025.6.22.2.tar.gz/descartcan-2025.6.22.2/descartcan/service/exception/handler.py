...
async def mysql_validation_error_handler(_: Request, exc: MysqlValidationError) -> Response:
...
async def mysql_operational_error_handler(_: Request, exc: OperationalError) -> Response:
