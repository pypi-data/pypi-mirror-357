...
class ModelStrategy(ABC):
    ...
    @abstractmethod
    async def chat(self, question: str, system: Optional[str] = None, history: Optional[List[Dict]] = None, **kwargs) -> ChatResponse:
        pass

    @abstractmethod
    async def chat_stream(self, question: str, system: Optional[str] = None, history: Optional[List[Dict]] = None, **kwargs) -> ChatStreamResponse:
        pass
