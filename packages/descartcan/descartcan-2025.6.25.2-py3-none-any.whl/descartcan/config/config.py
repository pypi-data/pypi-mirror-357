...
MYSQL_DB = os.getenv("MYSQL_DB", "descartcan")
MYSQL_TABLE_MODELS_PATH = os.getenv("MYSQL_TABLE_MODELS_PATH", "app.models")
MYSQL_TABLE_MODELS = [f"{MYSQL_TABLE_MODELS_PATH}.{m}" for m in os.getenv("MYSQL_TABLE_MODELS", "").split(",")]
...
MILVUS_PORT = int(os.getenv("MILVUS_HOST", 19530))
