...
from descartcan.service.core import events, config
...
application.add_exception_handler(ValidationError, handler.mysql_validation_error_handler)
application.add_exception_handler(OperationalError, handler.mysql_operational_error_handler)
application.add_exception_handler(ValidationError, handler.pydantic_validation_handler)
...
if __name__ == '__main__':
    import uvicorn
    uvicorn.run(application, host="0.0.0.0", port=8006)
