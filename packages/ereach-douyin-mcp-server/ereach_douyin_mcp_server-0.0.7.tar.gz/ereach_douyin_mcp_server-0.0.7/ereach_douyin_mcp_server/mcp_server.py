...
# 创建 MCP 服务器实例
mcp = FastMCP("eReach Douyin MCP Server", 
...
@mcp.tool()
def dearch_douyin(keyword: str, count: int = 20) -> str:
    """
    查询抖音关键词的视频列表
    ...
    [
        {
            "author_avatar": "https://p3-pc.douyinpic.com/aweme/100x100/aweme-avatar/tos-cn-i-0813c000-ce_oIAAvIAXSuoAfYc8m7EpEFUA9EBDKwAe6EfB0B.jpeg?from=327834062",
            "author_nickname": "心中有术",
            "author_uid": "MS4wLjABAAAAMqsBIZGfVFDWYE-Ll7MB7Dluw-2NczQA_aChqPye0qbcMgyGbHjpyBtGL55tGJ-k",
            "collect_count": 1982,
            "comment_count": 1870,
            "cover": "https://p9-pc-sign.douyinpic.com/image-cut-tos-priv/4762b68a7465c21e91313154f9a2a3ab~tplv-dy-resize-origshort-autoq-75:330.jpeg?lk3s=138a59ce&x-expires=2066022000&x-signature=cfWIOhJABMhCfDNVjmV90lqwcvg%3D&from=327834062&s=PackSourceEnum_SEARCH&se=false&sc=cover&biz_tag=pcweb_cover&l=2025062315525158C5D5716890A54AB996",
            "desc": "甲状腺癌是懒癌？ 曾经的我也因跟癌症抗争过，希望所有朋友都远离癌症。#抖出健康知识宝藏 #医学科普 #医生日常 #医路向前巍子 #心中有术",
            "digg_count": 30515,
            "download_addr": "https://www.douyin.com/aweme/v1/play/?video_id=v1e00fgi0000d0663hnog65mar2i351g&line=0&file_id=c9e719dd4f5f413b8a93723f620538a8&sign=121bd1f309c213ee3db6bf0eb4659987&is_play_url=1&source=PackSourceEnum_SEARCH",
            "download_count": 8,
            "duration": 144313,
            "id": "7497475833457315130",
            "music_title": "@心中有术创作的原声",
            "music_url": "https://lf26-music-east.douyinstatic.com/obj/ies-music-hj/7497475852523817786.mp3",
            "share_count": 1527,
            "text_extra": [
                {
                    "tag_id": "7453023475343575078",
                    "tag_name": "抖出健康知识宝藏"
                },
                {
                    "tag_id": "1627453632599052",
                    "tag_name": "医学科普"
                },
                {
                    "tag_id": "1596160083876877",
                    "tag_name": "医生日常"
                },
                {
                    "tag_id": "1654980846365726",
                    "tag_name": "医路向前巍子"
                },
                {
                    "tag_id": "1626197702475784",
                    "tag_name": "心中有术"
                }
            ],
            "time": 1745642129,
    ...
    """
    try:
        results = douyin_search(keyword,count)
        return json.dumps({
            "status":"success",
            "data":results
        })
