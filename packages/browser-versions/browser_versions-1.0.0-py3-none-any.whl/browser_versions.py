#!/usr/bin/env python3
"""
Browser Versions - A Comprehensive Web Browser Version Detection Tool

A robust Python package to programmatically detect the version of web browsers
(Chrome, Firefox, Edge, Internet Explorer) installed on the system. Compatible 
with Windows, Windows Server 2019/2022, macOS, and Linux.

Features:
- Native OS detection without requiring Selenium or WebDrivers
- Multiple detection methods for each platform (registry, executable, folder-based)
...
Usage Examples:
    ...
    # Command-line usage
    # python browser_versions.py --browser chrome
    # python browser_versions.py --browser all --version-only
    # python browser_versions.py --script-version
...
__license__ = "MIT"
__url__ = "https://github.com/pandiyarajk/browser-versions"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="Examples:\n"
               ...
               "  browser-versions --browser all --version-only\n"
               "  browser-versions --script-version\n\n"
               "For more information, visit: https://github.com/pandiyarajk/browser-versions"
    )
