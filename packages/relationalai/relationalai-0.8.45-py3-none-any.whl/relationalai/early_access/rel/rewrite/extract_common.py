...
from relationalai.early_access.rel.rewrite import flatten
            ...
            if len(binders) > 1 and composites:
                ...
                if extractables:
                    ...
                    if plan and len(composites) > 1:
                        ...
                        plan.common_reference = f.lookup(metamodel_utils.extract(task, plan.common_body, exposed_vars, ctx.rewrite_ctx, "common"), exposed_vars)
