...
from relationalai.early_access.builder.std.math import abs
...
class Graph():
    ...
    def _define_edge_relationships(self):
        ...
        if self.directed and self.weighted:
            define(
                self._weight(Edge.src, Edge.dst, Edge.weight | 1.0),
            ...
            define(
                self._weight(Edge.src, Edge.dst, Edge.weight | 1.0),
                self._weight(Edge.dst, Edge.src, Edge.weight | 1.0),
                self._edge(Edge.src, Edge.dst),
