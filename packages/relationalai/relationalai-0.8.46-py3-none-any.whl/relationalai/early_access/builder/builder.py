...
class RelationshipReading(Producer):
    ...
    def __init__(self, madlib:Any, alt_of:Relationship, short_name:str, fields:list[Field]|None=None, model:Model|None=None, parent:Producer|None=None,):
        ...
        self._madlib = madlib
        self._passed_short_name = short_name
        self._fields:list[Field] = fields if fields is not None else alt_of._parse_schema_format(madlib)
