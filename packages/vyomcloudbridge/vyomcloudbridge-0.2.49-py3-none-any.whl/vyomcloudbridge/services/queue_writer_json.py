...
class QueueWriterJson:
    ...
    def write_message(
        ...
        expiry_time_ms: Union[int, str] = None,
        expiry_time: Union[
            int, str
        ...
        try:
            ...
            self.logger.info(
                f"Data enqueueing... data_source={data_source}, data_type={data_type}, filename={filename}, destination_ids=[{destination_ids_str}], message_data_type={type(message_data)}, isinstance_of_bytes={isinstance(message_data, bytes)}"
            )
