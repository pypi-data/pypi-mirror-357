...
class MspManagedDeviceManager(BaseModel):
    """
    ...
    device_manager_type: Optional[EntityType] = Field(default=None, alias="deviceManagerType")
    fmc_domain_uid: Optional[StrictStr] = Field(default=None, description="(FMC-only) The Domain UID of the FMC.", alias="fmcDomainUid")
    ...
    managed_tenant_region: Optional[StrictStr] = Field(default=None, description="The region of the managed tenant in CDO. This is the region where the device manager is located.", alias="managedTenantRegion")
    managed_tenant_uid: Optional[StrictStr] = Field(default=None, description="The unique identifier, represented as a UUID, of the managed tenant in Security Cloud Control that this device manager belongs to.", alias="managedTenantUid")
    name: StrictStr = Field(description="The name of the device manager in CDO. Device manager names are unique in Security Cloud Control.")
    ...
    uid: Optional[StrictStr] = Field(default=None, description="The unique identifier, represented as a UUID, of the device manager in Security Cloud Control.")
    __properties: ClassVar[List[str]] = ["address", "connectivityState", "deviceManagerType", "fmcDomainUid", "managedTenantDisplayName", "managedTenantName", "managedTenantRegion", "managedTenantUid", "name", "softwareVersion", "tenantUid", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deviceManagerType": obj.get("deviceManagerType"),
