...
class MspManagedCloudService(BaseModel):
    ...
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="The address of the cloud service (if applicable), in `host:port` format. Security Cloud Control connects to the cloud service at this address.")
