...
The REST API documentation can be found on [shortgenius.com](https://shortgenius.com/developers). The full API of this library can be found in [api.md](api.md).
