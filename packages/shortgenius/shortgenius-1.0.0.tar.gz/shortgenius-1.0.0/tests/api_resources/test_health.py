...
class TestHealth:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_check(self, client: Shortgenius) -> None:
        health = client.health.check()
        assert_matches_type(HealthCheckResponse, health, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_check(self, client: Shortgenius) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_check(self, client: Shortgenius) -> None:
...
class TestAsyncHealth:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_check(self, async_client: AsyncShortgenius) -> None:
        health = await async_client.health.check()
        assert_matches_type(HealthCheckResponse, health, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_check(self, async_client: AsyncShortgenius) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_check(self, async_client: AsyncShortgenius) -> None:
