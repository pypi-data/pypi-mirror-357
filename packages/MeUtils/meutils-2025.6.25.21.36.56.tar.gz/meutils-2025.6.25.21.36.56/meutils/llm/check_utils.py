...
@retrying()
async def check_token_for_zhipu(api_key, threshold: float = 1):
    if not isinstance(api_key, str):
        return await check_tokens(api_key, check_token_for_ppinfra)
    try:
...
if __name__ == '__main__':
    ...
    # arun(check_token_for_volc("d3f38e03-01e0-4789-9329-eab8f7d69786"))
    # arun(check_token_for_ppinfra("sk_mCb5sRGTi6GXkSRp5F679Rbs0V_Hfee3p85lccGXCOo"))

    arun(check_token_for_zhipu(api_key="88b82799f3234a5aad130b0f74c7eb85.tBMTRh0h1IqbvMaw"))
