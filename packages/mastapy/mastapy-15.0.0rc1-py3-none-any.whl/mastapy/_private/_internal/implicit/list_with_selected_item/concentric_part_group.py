...
class ListWithSelectedItem_ConcentricPartGroup(
    _2720.ConcentricPartGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ConcentricPartGroup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2720.ConcentricPartGroup.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2720.ConcentricPartGroup":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2720.ConcentricPartGroup]":
