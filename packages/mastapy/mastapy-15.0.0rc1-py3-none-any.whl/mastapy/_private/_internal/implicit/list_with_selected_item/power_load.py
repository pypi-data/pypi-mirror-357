...
class ListWithSelectedItem_PowerLoad(_2701.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_PowerLoad]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2701.PowerLoad.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2701.PowerLoad":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2701.PowerLoad]":
