...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _2998.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2998.GearMeshSystemDeflection.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2998.GearMeshSystemDeflection":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2998.GearMeshSystemDeflection]":
