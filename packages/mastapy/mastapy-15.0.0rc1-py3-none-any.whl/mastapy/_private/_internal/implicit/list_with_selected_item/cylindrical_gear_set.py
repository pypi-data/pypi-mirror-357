...
class ListWithSelectedItem_CylindricalGearSet(
    _2761.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGearSet]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2761.CylindricalGearSet.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2761.CylindricalGearSet":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2761.CylindricalGearSet]":
