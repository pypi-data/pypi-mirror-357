...
from mastapy._private.system_model.part_model.acoustics import _2865
...
class ListWithSelectedItem_AcousticAnalysisSetup(
    _2865.AcousticAnalysisSetup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_AcousticAnalysisSetup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2865.AcousticAnalysisSetup.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2865.AcousticAnalysisSetup":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2865.AcousticAnalysisSetup]":
