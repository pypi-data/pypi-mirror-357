...
class ListWithSelectedItem_CylindricalGear(
    _2760.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGear]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2760.CylindricalGear.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2760.CylindricalGear":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2760.CylindricalGear]":
