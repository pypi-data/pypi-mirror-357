...
class Overridable_UnbalancedMassInclusionOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2708.UnbalancedMassInclusionOption
        """
        return _2708.UnbalancedMassInclusionOption
    ...
    def implicit_type(cls: "Type[Overridable_UnbalancedMassInclusionOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2708.UnbalancedMassInclusionOption.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_2708.UnbalancedMassInclusionOption":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_2708.UnbalancedMassInclusionOption":
        """mastapy.system_model.part_model.UnbalancedMassInclusionOption
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_2708.UnbalancedMassInclusionOption":
        """mastapy.system_model.part_model.UnbalancedMassInclusionOption
