...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueSpecificationForSystemDeflection]",
    ) -> "_7844.TorqueSpecificationForSystemDeflection":
        ...
        Returns:
            _7844.TorqueSpecificationForSystemDeflection
        """
        return _7844.TorqueSpecificationForSystemDeflection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7844.TorqueSpecificationForSystemDeflection.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_7844.TorqueSpecificationForSystemDeflection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_7844.TorqueSpecificationForSystemDeflection]":
