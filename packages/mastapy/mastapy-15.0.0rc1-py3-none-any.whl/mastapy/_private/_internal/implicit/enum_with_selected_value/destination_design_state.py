...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    def wrapped_type(
        ...
        Returns:
            _7858.DestinationDesignState
        """
        return _7858.DestinationDesignState
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7858.DestinationDesignState.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_7858.DestinationDesignState":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_7858.DestinationDesignState]":
