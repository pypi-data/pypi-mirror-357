...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorToothSpacingType]",
    ) -> "_2834.RigidConnectorToothSpacingType":
        ...
        Returns:
            _2834.RigidConnectorToothSpacingType
        """
        return _2834.RigidConnectorToothSpacingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2834.RigidConnectorToothSpacingType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2834.RigidConnectorToothSpacingType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2834.RigidConnectorToothSpacingType]":
