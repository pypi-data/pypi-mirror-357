...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorStiffnessType]",
    ) -> "_2831.RigidConnectorStiffnessType":
        ...
        Returns:
            _2831.RigidConnectorStiffnessType
        """
        return _2831.RigidConnectorStiffnessType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2831.RigidConnectorStiffnessType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2831.RigidConnectorStiffnessType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2831.RigidConnectorStiffnessType]":
