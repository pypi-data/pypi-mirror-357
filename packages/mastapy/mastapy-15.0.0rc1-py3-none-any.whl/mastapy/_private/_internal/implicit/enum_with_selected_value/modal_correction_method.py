...
class EnumWithSelectedValue_ModalCorrectionMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _6076.ModalCorrectionMethod
        """
        return _6076.ModalCorrectionMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _6076.ModalCorrectionMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6076.ModalCorrectionMethod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_6076.ModalCorrectionMethod]":
