...
class EnumWithSelectedValue_ShaftAndHousingFlexibilityOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ShaftAndHousingFlexibilityOption]",
    ) -> "_5767.ShaftAndHousingFlexibilityOption":
        ...
        Returns:
            _5767.ShaftAndHousingFlexibilityOption
        """
        return _5767.ShaftAndHousingFlexibilityOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5767.ShaftAndHousingFlexibilityOption.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5767.ShaftAndHousingFlexibilityOption":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5767.ShaftAndHousingFlexibilityOption]":
