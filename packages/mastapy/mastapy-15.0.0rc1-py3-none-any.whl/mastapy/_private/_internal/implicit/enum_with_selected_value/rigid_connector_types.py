...
from mastapy._private.system_model.part_model.couplings import _2835
...
class EnumWithSelectedValue_RigidConnectorTypes(
    ...
    def wrapped_type(
        ...
        Returns:
            _2835.RigidConnectorTypes
        """
        return _2835.RigidConnectorTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_RigidConnectorTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2835.RigidConnectorTypes.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2835.RigidConnectorTypes":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2835.RigidConnectorTypes]":
