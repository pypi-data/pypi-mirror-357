...
class EnumWithSelectedValue_StiffnessOptionsForHarmonicAnalysis_StepCreation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_StiffnessOptionsForHarmonicAnalysis_StepCreation]",
    ) -> "_6109.StiffnessOptionsForHarmonicAnalysis.StepCreation":
        ...
        Returns:
            _6109.StiffnessOptionsForHarmonicAnalysis.StepCreation
        """
        return _6109.StiffnessOptionsForHarmonicAnalysis.StepCreation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _6109.StiffnessOptionsForHarmonicAnalysis.StepCreation.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_6109.StiffnessOptionsForHarmonicAnalysis.StepCreation]":
