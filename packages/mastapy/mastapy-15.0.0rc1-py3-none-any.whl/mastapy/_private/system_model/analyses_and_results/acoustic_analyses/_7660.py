...
class HarmonicAcousticAnalysis(_0.APIBase):
    ...
    @property
    @exception_bridge
    def analysis_run_type(self: "Self") -> "_7656.AcousticAnalysisRunType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7656",
    ...
    def analysis_run_type(self: "Self", value: "_7656.AcousticAnalysisRunType") -> None:
    ...
    def harmonic_analysis_frequency_options(
        self: "Self",
    ) -> "_6040.FrequencyOptionsForHarmonicAnalysisResults":
    ...
    def reference_speed_options(
        self: "Self",
    ) -> "_6102.SpeedOptionsForHarmonicAnalysisResults":
    ...
    def excitation_details_to_run(
        self: "Self",
    ) -> "List[_7665.SingleExcitationDetails]":
