...
class AssemblyAdvancedTimeSteppingAnalysisForModulation(
    ...
    def bevel_differential_gear_sets(
        ...
        "List[_7137.BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation]"
    ):
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_7144.BoltedJointAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def clutches(
        self: "Self",
    ) -> "List[_7145.ClutchAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_7150.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_7155.ConceptGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_7173.CylindricalGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_7181.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_7189.HypoidGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_7196.KlingelnbergCycloPalloidHypoidGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def mass_discs(
        self: "Self",
    ) -> "List[_7200.MassDiscAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_7201.MeasurementComponentAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def microphones(
        self: "Self",
    ) -> "List[_7202.MicrophoneAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def oil_seals(
        self: "Self",
    ) -> "List[_7205.OilSealAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_7207.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_7214.PowerLoadAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def ring_pins(
        self: "Self",
    ) -> "List[_7216.RingPinsAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_7219.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_7223.ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def shafts(
        self: "Self",
    ) -> "List[_7222.ShaftAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7228.SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def straight_bevel_diff_gear_sets(
        ...
        "List[_7234.StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation]"
    ):
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7237.StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_7240.SynchroniserAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_7252.WormGearSetAdvancedTimeSteppingAnalysisForModulation]":
