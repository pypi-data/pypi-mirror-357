...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    @exception_bridge
    def analysis_type(self: "Self") -> "_5663.AnalysisTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5663",
            "AnalysisTypes",
        )(value)
    ...
    def analysis_type(self: "Self", value: "_5663.AnalysisTypes") -> None:
    ...
    @enforce_parameter_types
    def bearing_stiffness_model(
        self: "Self", value: "_5667.BearingStiffnessModel"
    ) -> None:
    ...
    @enforce_parameter_types
    def gear_mesh_stiffness_model(
        self: "Self", value: "_5719.GearMeshStiffnessModel"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def include_shaft_and_housing_flexibilities(
        self: "Self", value: "_5767.ShaftAndHousingFlexibilityOption"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def method_to_define_period(
        self: "Self",
    ) -> "_5726.InertiaAdjustedLoadCasePeriodMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5726",
    ...
    @enforce_parameter_types
    def method_to_define_period(
        self: "Self", value: "_5726.InertiaAdjustedLoadCasePeriodMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod",
    ...
    @enforce_parameter_types
    def reference_power_load_to_define_period(
        self: "Self", value: "_2701.PowerLoad"
    ) -> None:
        generic_type = (
    ...
    def static_load_cases_to_create(
        self: "Self",
    ) -> "_5727.InertiaAdjustedLoadCaseResultsToCreate":
    ...
    @enforce_parameter_types
    def static_load_cases_to_create(
        self: "Self", value: "_5727.InertiaAdjustedLoadCaseResultsToCreate"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate",
    ...
    def external_interface_options(
        self: "Self",
    ) -> "_5813.DynamicExternalInterfaceOptions":
    ...
    def frequency_response_options(
        self: "Self",
    ) -> "_4902.FrequencyResponseAnalysisOptions":
    ...
    @property
    @exception_bridge
    def run_up_analysis_options(self: "Self") -> "_5743.MBDRunUpAnalysisOptions":
    ...
    @property
    @exception_bridge
    def spline_damping_options(self: "Self") -> "_5776.SplineDampingOptions":
