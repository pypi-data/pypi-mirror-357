...
class _Cast_DynamicForceResultAtTime:
    ...
    def abstract_measured_dynamic_response_at_time(
        self: "CastSelf",
    ) -> "_5807.AbstractMeasuredDynamicResponseAtTime":
        return self.__parent__._cast(_5807.AbstractMeasuredDynamicResponseAtTime)
...
class DynamicForceResultAtTime(_5807.AbstractMeasuredDynamicResponseAtTime):
    """DynamicForceResultAtTime
