...
class AssemblyCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5664.AssemblyMultibodyDynamicsAnalysis]":
    ...
    def bearings(
        self: "Self",
    ) -> "List[_5822.BearingCompoundMultibodyDynamicsAnalysis]":
    ...
    def belt_drives(
        self: "Self",
    ) -> "List[_5824.BeltDriveCompoundMultibodyDynamicsAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_5827.BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_5834.BoltedJointCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_5833.BoltCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_5855.CVTCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_5835.ClutchCompoundMultibodyDynamicsAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5840.ConceptCouplingCompoundMultibodyDynamicsAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_5845.ConceptGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5857.CycloidalAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_5859.CycloidalDiscCompoundMultibodyDynamicsAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5863.CylindricalGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_5870.FEPartCompoundMultibodyDynamicsAnalysis]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_5869.FaceGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5871.FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5878.HypoidGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5885.KlingelnbergCycloPalloidHypoidGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5888.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def mass_discs(
        self: "Self",
    ) -> "List[_5889.MassDiscCompoundMultibodyDynamicsAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5890.MeasurementComponentCompoundMultibodyDynamicsAnalysis]":
    ...
    def microphones(
        self: "Self",
    ) -> "List[_5892.MicrophoneCompoundMultibodyDynamicsAnalysis]":
    ...
    def oil_seals(
        self: "Self",
    ) -> "List[_5894.OilSealCompoundMultibodyDynamicsAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5896.PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_5901.PlanetCarrierCompoundMultibodyDynamicsAnalysis]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_5902.PointLoadCompoundMultibodyDynamicsAnalysis]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_5903.PowerLoadCompoundMultibodyDynamicsAnalysis]":
    ...
    def ring_pins(
        self: "Self",
    ) -> "List[_5905.RingPinsCompoundMultibodyDynamicsAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5907.RollingRingAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5912.ShaftHubConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_5911.ShaftCompoundMultibodyDynamicsAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5917.SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_5918.SpringDamperCompoundMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5923.StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5926.StraightBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_5929.SynchroniserCompoundMultibodyDynamicsAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5933.TorqueConverterCompoundMultibodyDynamicsAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_5937.UnbalancedMassCompoundMultibodyDynamicsAnalysis]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_5941.WormGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5944.ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis]":
