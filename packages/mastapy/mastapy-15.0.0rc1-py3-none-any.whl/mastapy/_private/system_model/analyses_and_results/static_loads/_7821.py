...
class SpiralBevelGearSetLoadCase(_7693.BevelGearSetLoadCase):
    """SpiralBevelGearSetLoadCase
    ...
    @property
    @exception_bridge
    def bevel_gears_load_case(self: "Self") -> "List[_7819.SpiralBevelGearLoadCase]":
    ...
    def spiral_bevel_gears_load_case(
        self: "Self",
    ) -> "List[_7819.SpiralBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.SpiralBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        self: "Self",
    ) -> "List[_7820.SpiralBevelGearMeshLoadCase]":
