...
class TimeSeriesLoadCase(_7668.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    @exception_bridge
    def driva_analysis_options(self: "Self") -> "_5742.MBDAnalysisOptions":
    ...
    @property
    @exception_bridge
    def time_series_load_case_group(self: "Self") -> "_5958.TimeSeriesLoadCaseGroup":
    ...
    def duplicate(
        self: "Self",
        new_load_case_group: "_5958.TimeSeriesLoadCaseGroup",
        name: "str" = "None",
    ) -> "TimeSeriesLoadCase":
