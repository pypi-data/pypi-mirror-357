...
class LoadCase(_2889.Context):
    ...
    @property
    @exception_bridge
    def bearing_element_orbit_model(self: "Self") -> "_5665.BearingElementOrbitModel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5665",
    ...
    def bearing_element_orbit_model(
        self: "Self", value: "_5665.BearingElementOrbitModel"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.BearingElementOrbitModel",
    ...
    @property
    @exception_bridge
    def additional_acceleration(self: "Self") -> "_7674.AdditionalAccelerationOptions":
    ...
    @property
    @exception_bridge
    def input_power_load(self: "Self") -> "_7805.PowerLoadLoadCase":
    ...
    @property
    @exception_bridge
    def output_power_load(self: "Self") -> "_7805.PowerLoadLoadCase":
        """mastapy.system_model.analyses_and_results.static_loads.PowerLoadLoadCase
    ...
    def parametric_study_tool_options(
        self: "Self",
    ) -> "_4654.ParametricStudyToolOptions":
    ...
    def transmission_efficiency_settings(
        self: "Self",
    ) -> "_7845.TransmissionEfficiencySettings":
    ...
    @property
    @exception_bridge
    def parametric_study_tool(self: "Self") -> "_4653.ParametricStudyTool":
    ...
    @exception_bridge
    @enforce_parameter_types
    def inputs_for_cvt(self: "Self", design_entity: "_2824.CVT") -> "_7719.CVTLoadCase":
