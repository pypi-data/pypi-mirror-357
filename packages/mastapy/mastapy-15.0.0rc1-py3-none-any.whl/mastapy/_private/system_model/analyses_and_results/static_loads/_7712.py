...
class ConicalGearSetLoadCase(_7759.GearSetLoadCase):
    """ConicalGearSetLoadCase
    ...
    @property
    @exception_bridge
    def gears_load_case(self: "Self") -> "List[_7708.ConicalGearLoadCase]":
    ...
    @property
    @exception_bridge
    def conical_gears_load_case(self: "Self") -> "List[_7708.ConicalGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConicalGearLoadCase]
    ...
    @property
    @exception_bridge
    def meshes_load_case(self: "Self") -> "List[_7710.ConicalGearMeshLoadCase]":
    ...
    @property
    @exception_bridge
    def conical_meshes_load_case(self: "Self") -> "List[_7710.ConicalGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConicalGearMeshLoadCase]
