...
class _Cast_ShaftHubConnectionCompoundModalAnalysisAtAStiffness:
    ...
    def connector_compound_modal_analysis_at_a_stiffness(
        self: "CastSelf",
    ) -> "_5298.ConnectorCompoundModalAnalysisAtAStiffness":
        return self.__parent__._cast(_5298.ConnectorCompoundModalAnalysisAtAStiffness)
...
class ShaftHubConnectionCompoundModalAnalysisAtAStiffness(
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5228.ShaftHubConnectionModalAnalysisAtAStiffness]":
