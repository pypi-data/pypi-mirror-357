...
class CylindricalGearSetParametricStudyTool(_4626.GearSetParametricStudyTool):
    """CylindricalGearSetParametricStudyTool
    ...
    def gears_parametric_study_tool(
        self: "Self",
    ) -> "List[_4607.CylindricalGearParametricStudyTool]":
    ...
    def meshes_parametric_study_tool(
        self: "Self",
    ) -> "List[_4606.CylindricalGearMeshParametricStudyTool]":
