...
class SpiralBevelGearSetCompoundParametricStudyTool(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4681.SpiralBevelGearSetParametricStudyTool]":
    ...
    def spiral_bevel_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4810.SpiralBevelGearCompoundParametricStudyTool]":
    ...
    def spiral_bevel_meshes_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4811.SpiralBevelGearMeshCompoundParametricStudyTool]":
