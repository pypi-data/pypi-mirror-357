...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6602
...
class SpiralBevelGearSetDynamicAnalysis(_6602.BevelGearSetDynamicAnalysis):
    """SpiralBevelGearSetDynamicAnalysis
    ...
    def bevel_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6687.SpiralBevelGearDynamicAnalysis]":
    ...
    def bevel_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6688.SpiralBevelGearMeshDynamicAnalysis]":
