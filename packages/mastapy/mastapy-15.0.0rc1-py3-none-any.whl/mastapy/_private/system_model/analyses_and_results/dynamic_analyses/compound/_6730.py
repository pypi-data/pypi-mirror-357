...
class BevelDifferentialGearSetCompoundDynamicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6597.BevelDifferentialGearSetDynamicAnalysis]":
    ...
    def bevel_differential_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6728.BevelDifferentialGearCompoundDynamicAnalysis]":
    ...
    def bevel_differential_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6729.BevelDifferentialGearMeshCompoundDynamicAnalysis]":
