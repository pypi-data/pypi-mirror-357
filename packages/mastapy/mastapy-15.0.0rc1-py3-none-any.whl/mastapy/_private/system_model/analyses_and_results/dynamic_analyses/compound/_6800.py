...
class _Cast_PartToPartShearCouplingConnectionCompoundDynamicAnalysis:
    ...
    def coupling_connection_compound_dynamic_analysis(
        self: "CastSelf",
    ) -> "_6755.CouplingConnectionCompoundDynamicAnalysis":
        return self.__parent__._cast(_6755.CouplingConnectionCompoundDynamicAnalysis)
...
class PartToPartShearCouplingConnectionCompoundDynamicAnalysis(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6668.PartToPartShearCouplingConnectionDynamicAnalysis]":
