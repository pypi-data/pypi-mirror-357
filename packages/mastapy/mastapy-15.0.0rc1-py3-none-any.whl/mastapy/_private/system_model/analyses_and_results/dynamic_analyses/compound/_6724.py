...
class AssemblyCompoundDynamicAnalysis(_6717.AbstractAssemblyCompoundDynamicAnalysis):
    """AssemblyCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6591.AssemblyDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_6725.BearingCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_6727.BeltDriveCompoundDynamicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_6730.BevelDifferentialGearSetCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def bolted_joints(self: "Self") -> "List[_6737.BoltedJointCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_6736.BoltCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_6758.CVTCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_6738.ClutchCompoundDynamicAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_6743.ConceptCouplingCompoundDynamicAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_6748.ConceptGearSetCompoundDynamicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_6760.CycloidalAssemblyCompoundDynamicAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_6762.CycloidalDiscCompoundDynamicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_6766.CylindricalGearSetCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_6773.FEPartCompoundDynamicAnalysis]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_6772.FaceGearSetCompoundDynamicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_6774.FlexiblePinAssemblyCompoundDynamicAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_6781.HypoidGearSetCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_6788.KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_6791.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis]"
    ):
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_6792.MassDiscCompoundDynamicAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_6793.MeasurementComponentCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def microphones(self: "Self") -> "List[_6795.MicrophoneCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_6797.OilSealCompoundDynamicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_6799.PartToPartShearCouplingCompoundDynamicAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_6804.PlanetCarrierCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_6805.PointLoadCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_6806.PowerLoadCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_6808.RingPinsCompoundDynamicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_6810.RollingRingAssemblyCompoundDynamicAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_6815.ShaftHubConnectionCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_6814.ShaftCompoundDynamicAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6820.SpiralBevelGearSetCompoundDynamicAnalysis]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_6821.SpringDamperCompoundDynamicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_6826.StraightBevelDiffGearSetCompoundDynamicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6829.StraightBevelGearSetCompoundDynamicAnalysis]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_6832.SynchroniserCompoundDynamicAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_6836.TorqueConverterCompoundDynamicAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_6840.UnbalancedMassCompoundDynamicAnalysis]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_6844.WormGearSetCompoundDynamicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6847.ZerolBevelGearSetCompoundDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_6591.AssemblyDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.AssemblyDynamicAnalysis]
