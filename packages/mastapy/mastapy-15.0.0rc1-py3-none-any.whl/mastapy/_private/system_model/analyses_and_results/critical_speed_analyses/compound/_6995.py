...
class AssemblyCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6861.AssemblyCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_6996.BearingCompoundCriticalSpeedAnalysis]":
    ...
    def belt_drives(
        self: "Self",
    ) -> "List[_6998.BeltDriveCompoundCriticalSpeedAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_7001.BevelDifferentialGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_7008.BoltedJointCompoundCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_7007.BoltCompoundCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_7029.CVTCompoundCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_7009.ClutchCompoundCriticalSpeedAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_7014.ConceptCouplingCompoundCriticalSpeedAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_7019.ConceptGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_7031.CycloidalAssemblyCompoundCriticalSpeedAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_7033.CycloidalDiscCompoundCriticalSpeedAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_7037.CylindricalGearSetCompoundCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_7044.FEPartCompoundCriticalSpeedAnalysis]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_7043.FaceGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_7045.FlexiblePinAssemblyCompoundCriticalSpeedAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_7052.HypoidGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        ...
        "List[_7059.KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis]"
    ):
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7062.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_7063.MassDiscCompoundCriticalSpeedAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_7064.MeasurementComponentCompoundCriticalSpeedAnalysis]":
    ...
    def microphones(
        self: "Self",
    ) -> "List[_7066.MicrophoneCompoundCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_7068.OilSealCompoundCriticalSpeedAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_7070.PartToPartShearCouplingCompoundCriticalSpeedAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_7075.PlanetCarrierCompoundCriticalSpeedAnalysis]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_7076.PointLoadCompoundCriticalSpeedAnalysis]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_7077.PowerLoadCompoundCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_7079.RingPinsCompoundCriticalSpeedAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_7081.RollingRingAssemblyCompoundCriticalSpeedAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_7086.ShaftHubConnectionCompoundCriticalSpeedAnalysis]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_7085.ShaftCompoundCriticalSpeedAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7091.SpiralBevelGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_7092.SpringDamperCompoundCriticalSpeedAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_7097.StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7100.StraightBevelGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_7103.SynchroniserCompoundCriticalSpeedAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_7107.TorqueConverterCompoundCriticalSpeedAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_7111.UnbalancedMassCompoundCriticalSpeedAnalysis]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_7115.WormGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7118.ZerolBevelGearSetCompoundCriticalSpeedAnalysis]":
