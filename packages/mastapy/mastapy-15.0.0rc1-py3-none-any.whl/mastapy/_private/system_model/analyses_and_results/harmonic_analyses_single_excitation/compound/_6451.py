...
class AssemblyCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6318.AssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def bearings(
        self: "Self",
    ) -> "List[_6452.BearingCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def belt_drives(
        self: "Self",
    ) -> "List[_6454.BeltDriveCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def bevel_differential_gear_sets(
        ...
        "List[_6457.BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation]"
    ):
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_6464.BoltedJointCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def bolts(
        self: "Self",
    ) -> "List[_6463.BoltCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def cv_ts(
        self: "Self",
    ) -> "List[_6485.CVTCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def clutches(
        self: "Self",
    ) -> "List[_6465.ClutchCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_6470.ConceptCouplingCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_6475.ConceptGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_6487.CycloidalAssemblyCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_6489.CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_6493.CylindricalGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def fe_parts(
        self: "Self",
    ) -> "List[_6500.FEPartCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_6499.FaceGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_6501.FlexiblePinAssemblyCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_6508.HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_6515.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6518.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def mass_discs(
        self: "Self",
    ) -> "List[_6519.MassDiscCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_6520.MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def microphones(
        self: "Self",
    ) -> "List[_6522.MicrophoneCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def oil_seals(
        self: "Self",
    ) -> "List[_6524.OilSealCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def part_to_part_shear_couplings(
        ...
        "List[_6526.PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation]"
    ):
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_6531.PlanetCarrierCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_6532.PointLoadCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_6533.PowerLoadCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def ring_pins(
        self: "Self",
    ) -> "List[_6535.RingPinsCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_6537.RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_6542.ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def shafts(
        self: "Self",
    ) -> "List[_6541.ShaftCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6547.SpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_6548.SpringDamperCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def straight_bevel_diff_gear_sets(
        ...
        "List[_6553.StraightBevelDiffGearSetCompoundHarmonicAnalysisOfSingleExcitation]"
    ):
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6556.StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_6559.SynchroniserCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_6563.TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_6567.UnbalancedMassCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_6571.WormGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6574.ZerolBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
