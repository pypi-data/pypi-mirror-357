...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _6128
...
class PowerLoadHarmonicAnalysis(_6128.VirtualComponentHarmonicAnalysis):
    """PowerLoadHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7805.PowerLoadLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3033.PowerLoadSystemDeflection":
