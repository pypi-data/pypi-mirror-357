...
class BoltedJointHarmonicAnalysis(_6101.SpecialisedAssemblyHarmonicAnalysis):
    """BoltedJointHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def assembly_load_case(self: "Self") -> "_7694.BoltedJointLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2948.BoltedJointSystemDeflection":
