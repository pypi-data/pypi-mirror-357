...
class BoltHarmonicAnalysis(_5992.ComponentHarmonicAnalysis):
    """BoltHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7695.BoltLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2949.BoltSystemDeflection":
