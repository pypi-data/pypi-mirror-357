...
class DatumHarmonicAnalysis(_5992.ComponentHarmonicAnalysis):
    """DatumHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7733.DatumLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2990.DatumSystemDeflection":
