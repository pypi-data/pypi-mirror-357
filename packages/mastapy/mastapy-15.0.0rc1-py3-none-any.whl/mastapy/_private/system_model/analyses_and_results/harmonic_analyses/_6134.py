...
class ZerolBevelGearSetHarmonicAnalysis(_5984.BevelGearSetHarmonicAnalysis):
    """ZerolBevelGearSetHarmonicAnalysis
    ...
    def bevel_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_6132.ZerolBevelGearHarmonicAnalysis]":
    ...
    def bevel_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6133.ZerolBevelGearMeshHarmonicAnalysis]":
