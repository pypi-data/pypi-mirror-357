...
class ShaftHarmonicAnalysis(
    _5967.AbstractShaftHarmonicAnalysis, _2895.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def coupled_modal_analysis(self: "Self") -> "_4949.ShaftModalAnalysis":
    ...
    @property
    @exception_bridge
    def export(self: "Self") -> "_6056.HarmonicAnalysisShaftExportOptions":
