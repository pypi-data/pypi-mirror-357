...
class GearSetHarmonicAnalysis(_6101.SpecialisedAssemblyHarmonicAnalysis):
    """GearSetHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def gears_harmonic_analysis(self: "Self") -> "List[_6041.GearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6043.GearMeshHarmonicAnalysis]":
