...
class _Cast_FlexiblePinAnalysisGearAndBearingRating:
    ...
    @property
    def flexible_pin_analysis(self: "CastSelf") -> "_6576.FlexiblePinAnalysis":
        return self.__parent__._cast(_6576.FlexiblePinAnalysis)
...
class FlexiblePinAnalysisGearAndBearingRating(_6576.FlexiblePinAnalysis):
    """FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    @exception_bridge
    def bearing_analyses(self: "Self") -> "List[_3100.BearingCompoundSystemDeflection]":
