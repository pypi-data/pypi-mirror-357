...
class StraightBevelDiffGearSetSystemDeflection(_2946.BevelGearSetSystemDeflection):
    """StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4405.StraightBevelDiffGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_3056.StraightBevelDiffGearSystemDeflection]":
