...
class ZerolBevelGearMeshSystemDeflection(_2945.BevelGearMeshSystemDeflection):
    """ZerolBevelGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def connection_load_case(self: "Self") -> "_7853.ZerolBevelGearMeshLoadCase":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4425.ZerolBevelGearMeshPowerFlow":
