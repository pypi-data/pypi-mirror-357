...
class CylindricalMeshedGearSystemDeflection(_0.APIBase):
    ...
    @property
    @exception_bridge
    def left_flank(self: "Self") -> "_2987.CylindricalMeshedGearFlankSystemDeflection":
    ...
    @property
    @exception_bridge
    def right_flank(self: "Self") -> "_2987.CylindricalMeshedGearFlankSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalMeshedGearFlankSystemDeflection
    ...
    def compression_side_fillet_results(
        self: "Self",
    ) -> "List[_948.GearRootFilletStressResults]":
    ...
    def flanks(
        self: "Self",
    ) -> "List[_2987.CylindricalMeshedGearFlankSystemDeflection]":
    ...
    @property
    @exception_bridge
    def both_flanks(self: "Self") -> "_2987.CylindricalMeshedGearFlankSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalMeshedGearFlankSystemDeflection
