...
class SynchroniserSystemDeflection(_3047.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4413.SynchroniserPowerFlow":
    ...
    @property
    @exception_bridge
    def cones(self: "Self") -> "List[_3062.SynchroniserHalfSystemDeflection]":
