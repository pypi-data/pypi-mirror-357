...
class AbstractAssemblyCompoundSystemDeflection(_3174.PartCompoundSystemDeflection):
    """AbstractAssemblyCompoundSystemDeflection
    ...
    @property
    @exception_bridge
    def all_components(self: "Self") -> "List[_3117.ComponentCompoundSystemDeflection]":
    ...
    def all_connections(
        self: "Self",
    ) -> "List[_3127.ConnectionCompoundSystemDeflection]":
    ...
    def assembly_analysis_cases(
        self: "Self",
    ) -> "List[_2924.AbstractAssemblySystemDeflection]":
