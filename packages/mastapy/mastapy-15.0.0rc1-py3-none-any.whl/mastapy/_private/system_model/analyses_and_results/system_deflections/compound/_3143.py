...
class DatumCompoundSystemDeflection(_3117.ComponentCompoundSystemDeflection):
    """DatumCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2990.DatumSystemDeflection]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_2990.DatumSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.DatumSystemDeflection]
