...
class SystemDeflection(_7881.FEAnalysis):
    """SystemDeflection
    ...
    @property
    @exception_bridge
    def analysis_options(self: "Self") -> "_3068.SystemDeflectionOptions":
    ...
    def overall_efficiency_results(
        self: "Self",
    ) -> "_3016.LoadCaseOverallEfficiencyResult":
