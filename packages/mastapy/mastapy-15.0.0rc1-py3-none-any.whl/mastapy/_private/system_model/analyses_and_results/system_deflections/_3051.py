...
class SpringDamperConnectionSystemDeflection(_2968.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4400.SpringDamperConnectionPowerFlow":
