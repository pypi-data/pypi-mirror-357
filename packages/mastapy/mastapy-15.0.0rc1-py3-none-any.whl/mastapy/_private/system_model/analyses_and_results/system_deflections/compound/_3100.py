...
class BearingCompoundSystemDeflection(_3128.ConnectorCompoundSystemDeflection):
    """BearingCompoundSystemDeflection
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_2937.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
