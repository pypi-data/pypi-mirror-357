...
class PulleyCompoundSystemDeflection(_3131.CouplingHalfCompoundSystemDeflection):
    """PulleyCompoundSystemDeflection
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_3034.PulleySystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.PulleySystemDeflection]
