...
class CycloidalAssemblySystemDeflection(_3047.SpecialisedAssemblySystemDeflection):
    """CycloidalAssemblySystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4334.CycloidalAssemblyPowerFlow":
    ...
    def ring_pins_to_disc_connections(
        self: "Self",
    ) -> "List[_3036.RingPinsToDiscConnectionSystemDeflection]":
