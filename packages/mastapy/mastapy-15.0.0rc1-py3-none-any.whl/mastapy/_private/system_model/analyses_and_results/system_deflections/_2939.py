...
class BeltDriveSystemDeflection(_3047.SpecialisedAssemblySystemDeflection):
    """BeltDriveSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4301.BeltDrivePowerFlow":
    ...
    @property
    @exception_bridge
    def belts(self: "Self") -> "List[_2938.BeltConnectionSystemDeflection]":
