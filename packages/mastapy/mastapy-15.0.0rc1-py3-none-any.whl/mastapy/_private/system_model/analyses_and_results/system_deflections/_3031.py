...
class PlanetCarrierSystemDeflection(_3023.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7801.PlanetCarrierLoadCase":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4381.PlanetCarrierPowerFlow":
    ...
    @property
    @exception_bridge
    def windup(self: "Self") -> "List[_3087.PlanetCarrierWindup]":
