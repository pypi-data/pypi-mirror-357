...
class ShaftCompoundSystemDeflection(_3093.AbstractShaftCompoundSystemDeflection):
    """ShaftCompoundSystemDeflection
    ...
    def shaft_duty_cycle_damage_results(
        self: "Self",
    ) -> "_3191.ShaftDutyCycleSystemDeflection":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_3045.ShaftSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection]
