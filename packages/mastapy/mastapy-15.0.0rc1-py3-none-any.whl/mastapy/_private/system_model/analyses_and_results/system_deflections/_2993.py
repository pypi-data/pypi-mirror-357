...
class FaceGearMeshSystemDeflection(_2998.GearMeshSystemDeflection):
    """FaceGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def connection_load_case(self: "Self") -> "_7749.FaceGearMeshLoadCase":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4345.FaceGearMeshPowerFlow":
