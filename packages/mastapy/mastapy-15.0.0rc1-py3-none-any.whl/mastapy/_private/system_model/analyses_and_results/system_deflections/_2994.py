...
class FaceGearSetSystemDeflection(_2999.GearSetSystemDeflection):
    """FaceGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4347.FaceGearSetPowerFlow":
    ...
    @property
    @exception_bridge
    def gears_system_deflection(self: "Self") -> "List[_2995.FaceGearSystemDeflection]":
    ...
    def face_gears_system_deflection(
        self: "Self",
    ) -> "List[_2995.FaceGearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.FaceGearSystemDeflection]
    ...
    def meshes_system_deflection(
        self: "Self",
    ) -> "List[_2993.FaceGearMeshSystemDeflection]":
