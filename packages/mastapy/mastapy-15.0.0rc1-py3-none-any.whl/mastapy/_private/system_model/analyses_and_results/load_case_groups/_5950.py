...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5945
...
class _Cast_DesignState:
    ...
    @property
    def abstract_load_case_group(self: "CastSelf") -> "_5946.AbstractLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5946,
        )

        return self.__parent__._cast(_5946.AbstractLoadCaseGroup)
...
class DesignState(_5945.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_5948.ClutchEngagementStatus]":
    ...
    def concept_synchro_gear_engagement_status_for(
        self: "Self", gear: "_2760.CylindricalGear"
    ) -> "_5949.ConceptSynchroGearEngagementStatus":
