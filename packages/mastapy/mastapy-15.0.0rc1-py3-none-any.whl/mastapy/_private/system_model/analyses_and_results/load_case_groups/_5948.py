...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5952
...
class _Cast_ClutchEngagementStatus:
    ...
    def generic_clutch_engagement_status(
        self: "CastSelf",
    ) -> "_5952.GenericClutchEngagementStatus":
        return self.__parent__._cast(_5952.GenericClutchEngagementStatus)
...
class ClutchEngagementStatus(
    _5952.GenericClutchEngagementStatus[_2563.ClutchConnection]
):
    """ClutchEngagementStatus
