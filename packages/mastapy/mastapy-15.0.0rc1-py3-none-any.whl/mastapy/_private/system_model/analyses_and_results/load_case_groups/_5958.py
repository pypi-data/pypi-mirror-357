...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5946
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2886, _2914
...
class TimeSeriesLoadCaseGroup(_5946.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    @exception_bridge
    def load_cases(self: "Self") -> "List[_7838.TimeSeriesLoadCase]":
