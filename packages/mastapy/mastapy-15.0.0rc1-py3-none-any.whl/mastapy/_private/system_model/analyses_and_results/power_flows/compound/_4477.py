...
class CylindricalGearSetCompoundPowerFlow(_4488.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    def cylindrical_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4475.CylindricalGearCompoundPowerFlow]":
    ...
    def cylindrical_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4476.CylindricalGearMeshCompoundPowerFlow]":
