...
class RollingRingConnectionPowerFlow(_4359.InterMountableComponentConnectionPowerFlow):
    """RollingRingConnectionPowerFlow
    ...
    @property
    @exception_bridge
    def connection_load_case(self: "Self") -> "_7812.RollingRingConnectionLoadCase":
