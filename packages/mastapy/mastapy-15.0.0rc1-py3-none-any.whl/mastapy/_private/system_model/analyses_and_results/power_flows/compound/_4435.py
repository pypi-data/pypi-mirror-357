...
class AssemblyCompoundPowerFlow(_4428.AbstractAssemblyCompoundPowerFlow):
    """AssemblyCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4298.AssemblyPowerFlow]":
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_4436.BearingCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_4438.BeltDriveCompoundPowerFlow]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_4441.BevelDifferentialGearSetCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def bolted_joints(self: "Self") -> "List[_4448.BoltedJointCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_4447.BoltCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_4469.CVTCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_4449.ClutchCompoundPowerFlow]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_4454.ConceptCouplingCompoundPowerFlow]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_4459.ConceptGearSetCompoundPowerFlow]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_4471.CycloidalAssemblyCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def cycloidal_discs(self: "Self") -> "List[_4473.CycloidalDiscCompoundPowerFlow]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_4477.CylindricalGearSetCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_4484.FEPartCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def face_gear_sets(self: "Self") -> "List[_4483.FaceGearSetCompoundPowerFlow]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_4485.FlexiblePinAssemblyCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def hypoid_gear_sets(self: "Self") -> "List[_4492.HypoidGearSetCompoundPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4499.KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4502.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_4503.MassDiscCompoundPowerFlow]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_4504.MeasurementComponentCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def microphones(self: "Self") -> "List[_4506.MicrophoneCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_4508.OilSealCompoundPowerFlow]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_4510.PartToPartShearCouplingCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def planet_carriers(self: "Self") -> "List[_4515.PlanetCarrierCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_4516.PointLoadCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_4517.PowerLoadCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_4519.RingPinsCompoundPowerFlow]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_4521.RollingRingAssemblyCompoundPowerFlow]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_4526.ShaftHubConnectionCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_4525.ShaftCompoundPowerFlow]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4531.SpiralBevelGearSetCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def spring_dampers(self: "Self") -> "List[_4532.SpringDamperCompoundPowerFlow]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_4537.StraightBevelDiffGearSetCompoundPowerFlow]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4540.StraightBevelGearSetCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def synchronisers(self: "Self") -> "List[_4543.SynchroniserCompoundPowerFlow]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_4547.TorqueConverterCompoundPowerFlow]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_4551.UnbalancedMassCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def worm_gear_sets(self: "Self") -> "List[_4555.WormGearSetCompoundPowerFlow]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4558.ZerolBevelGearSetCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4298.AssemblyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.AssemblyPowerFlow]
