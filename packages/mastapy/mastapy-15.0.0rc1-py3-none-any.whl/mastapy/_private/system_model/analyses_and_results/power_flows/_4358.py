...
class HypoidGearSetPowerFlow(_4297.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    def agma_gleason_conical_gears_power_flow(
        self: "Self",
    ) -> "List[_4357.HypoidGearPowerFlow]":
    ...
    @property
    @exception_bridge
    def hypoid_gears_power_flow(self: "Self") -> "List[_4357.HypoidGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearPowerFlow]
    ...
    @property
    @exception_bridge
    def hypoid_meshes_power_flow(self: "Self") -> "List[_4356.HypoidGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearMeshPowerFlow]
