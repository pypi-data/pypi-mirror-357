...
class StraightBevelGearSetCompoundPowerFlow(_4446.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    def straight_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4538.StraightBevelGearCompoundPowerFlow]":
    ...
    def straight_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4539.StraightBevelGearMeshCompoundPowerFlow]":
