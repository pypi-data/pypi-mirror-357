...
class BevelGearSetCompoundPowerFlow(_4434.AGMAGleasonConicalGearSetCompoundPowerFlow):
    """BevelGearSetCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4309.BevelGearSetPowerFlow]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4309.BevelGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearSetPowerFlow]
