...
class WormGearSetCompoundPowerFlow(_4488.GearSetCompoundPowerFlow):
    """WormGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4424.WormGearSetPowerFlow]":
    ...
    def worm_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4553.WormGearCompoundPowerFlow]":
    ...
    def worm_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4554.WormGearMeshCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4424.WormGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearSetPowerFlow]
