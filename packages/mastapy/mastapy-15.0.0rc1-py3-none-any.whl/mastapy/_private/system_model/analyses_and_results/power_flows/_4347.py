...
class FaceGearSetPowerFlow(_4354.GearSetPowerFlow):
    """FaceGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def gears_power_flow(self: "Self") -> "List[_4346.FaceGearPowerFlow]":
    ...
    @property
    @exception_bridge
    def face_gears_power_flow(self: "Self") -> "List[_4346.FaceGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearPowerFlow]
    ...
    @property
    @exception_bridge
    def meshes_power_flow(self: "Self") -> "List[_4345.FaceGearMeshPowerFlow]":
    ...
    @property
    @exception_bridge
    def face_meshes_power_flow(self: "Self") -> "List[_4345.FaceGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearMeshPowerFlow]
