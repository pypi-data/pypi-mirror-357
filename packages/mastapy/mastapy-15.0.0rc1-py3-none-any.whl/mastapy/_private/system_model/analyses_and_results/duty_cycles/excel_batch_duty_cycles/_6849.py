...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    @exception_bridge
    def excel_file_details(self: "Self") -> "_6850.ExcelFileDetails":
    ...
    @property
    @exception_bridge
    def masta_file_details(self: "Self") -> "_6853.MASTAFileDetails":
    ...
    def excel_sheet_design_state_selection(
        self: "Self",
    ) -> "List[_6852.ExcelSheetDesignStateSelector]":
