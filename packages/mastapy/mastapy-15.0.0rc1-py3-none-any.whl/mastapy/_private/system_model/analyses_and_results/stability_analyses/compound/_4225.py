...
class KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4090.KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4223.KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4224.KlingelnbergCycloPalloidHypoidGearMeshCompoundStabilityAnalysis]":
