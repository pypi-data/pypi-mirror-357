...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _4051
...
class AGMAGleasonConicalGearSetStabilityAnalysis(_4051.ConicalGearSetStabilityAnalysis):
    """AGMAGleasonConicalGearSetStabilityAnalysis
    ...
    def conical_gears_stability_analysis(
        self: "Self",
    ) -> "List[_4024.AGMAGleasonConicalGearStabilityAnalysis]":
    ...
    def conical_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4022.AGMAGleasonConicalGearMeshStabilityAnalysis]":
