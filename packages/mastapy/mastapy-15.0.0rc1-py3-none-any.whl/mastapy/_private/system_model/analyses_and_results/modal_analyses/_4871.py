...
class ConceptGearSetModalAnalysis(_4905.GearSetModalAnalysis):
    """ConceptGearSetModalAnalysis
    ...
    @property
    @exception_bridge
    def gears_modal_analysis(self: "Self") -> "List[_4870.ConceptGearModalAnalysis]":
    ...
    def concept_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4870.ConceptGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ConceptGearModalAnalysis]
