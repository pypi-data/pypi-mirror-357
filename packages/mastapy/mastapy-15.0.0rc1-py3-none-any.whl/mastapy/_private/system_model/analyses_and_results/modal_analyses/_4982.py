...
class WormGearSetModalAnalysis(_4905.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3078.WormGearSetSystemDeflection":
    ...
    @property
    @exception_bridge
    def gears_modal_analysis(self: "Self") -> "List[_4981.WormGearModalAnalysis]":
    ...
    @property
    @exception_bridge
    def worm_gears_modal_analysis(self: "Self") -> "List[_4981.WormGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
    ...
    @property
    @exception_bridge
    def meshes_modal_analysis(self: "Self") -> "List[_4980.WormGearMeshModalAnalysis]":
    ...
    def worm_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4980.WormGearMeshModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearMeshModalAnalysis]
