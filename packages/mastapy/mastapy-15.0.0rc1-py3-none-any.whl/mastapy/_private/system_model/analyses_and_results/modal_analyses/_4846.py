...
class AGMAGleasonConicalGearSetModalAnalysis(_4874.ConicalGearSetModalAnalysis):
    """AGMAGleasonConicalGearSetModalAnalysis
    ...
    def conical_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4845.AGMAGleasonConicalGearModalAnalysis]":
    ...
    def conical_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4844.AGMAGleasonConicalGearMeshModalAnalysis]":
