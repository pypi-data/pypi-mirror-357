...
class HypoidGearModalAnalysis(_4845.AGMAGleasonConicalGearModalAnalysis):
    """HypoidGearModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7769.HypoidGearLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3004.HypoidGearSystemDeflection":
