...
class SpiralBevelGearSetCompoundModalAnalysis(_5016.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4955.SpiralBevelGearSetModalAnalysis]":
    ...
    def spiral_bevel_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5099.SpiralBevelGearCompoundModalAnalysis]":
    ...
    def spiral_bevel_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5100.SpiralBevelGearMeshCompoundModalAnalysis]":
