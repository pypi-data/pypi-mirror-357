...
class BevelGearCompoundModalAnalysis(_5002.AGMAGleasonConicalGearCompoundModalAnalysis):
    """BevelGearCompoundModalAnalysis
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4857.BevelGearModalAnalysis]":
