...
class ConnectionModalAnalysis(_7878.ConnectionStaticLoadAnalysisCase):
    """ConnectionModalAnalysis
    ...
    def excited_modes_summary(
        self: "Self",
    ) -> "List[_4996.SingleExcitationResultsModalAnalysis]":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2966.ConnectionSystemDeflection":
