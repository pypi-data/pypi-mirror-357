...
class ModalAnalysis(_7887.StaticLoadAnalysisCase):
    """ModalAnalysis
    ...
    @property
    @exception_bridge
    def analysis_settings(self: "Self") -> "_4927.ModalAnalysisOptions":
    ...
    @property
    @exception_bridge
    def bar_model_export(self: "Self") -> "_4925.ModalAnalysisBarModelFEExportOptions":
    ...
    @property
    @exception_bridge
    def modal_analysis_results(self: "Self") -> "_6636.DynamicAnalysis":
