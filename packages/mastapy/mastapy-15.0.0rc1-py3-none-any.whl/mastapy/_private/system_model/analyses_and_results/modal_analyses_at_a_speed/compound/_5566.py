...
class _Cast_CVTCompoundModalAnalysisAtASpeed:
    ...
    def belt_drive_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_5535.BeltDriveCompoundModalAnalysisAtASpeed":
        return self.__parent__._cast(_5535.BeltDriveCompoundModalAnalysisAtASpeed)
...
class CVTCompoundModalAnalysisAtASpeed(_5535.BeltDriveCompoundModalAnalysisAtASpeed):
    """CVTCompoundModalAnalysisAtASpeed
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5434.CVTModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_5434.CVTModalAnalysisAtASpeed]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.CVTModalAnalysisAtASpeed]
