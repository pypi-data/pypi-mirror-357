...
class CylindricalGearSetModalAnalysisAtASpeed(_5453.GearSetModalAnalysisAtASpeed):
    """CylindricalGearSetModalAnalysisAtASpeed
    ...
    def gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5441.CylindricalGearModalAnalysisAtASpeed]":
    ...
    def meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5440.CylindricalGearMeshModalAnalysisAtASpeed]":
