...
class ConicalGearSetAdvancedSystemDeflection(_7452.GearSetAdvancedSystemDeflection):
    """ConicalGearSetAdvancedSystemDeflection
    ...
    def gears_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7422.ConicalGearAdvancedSystemDeflection]":
    ...
    def meshes_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7423.ConicalGearMeshAdvancedSystemDeflection]":
