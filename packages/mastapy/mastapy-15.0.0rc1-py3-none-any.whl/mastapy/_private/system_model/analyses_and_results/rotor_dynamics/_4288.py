...
from mastapy._private.system_model.analyses_and_results.rotor_dynamics import _4286
...
class _Cast_ShaftModalComplexShape:
    ...
    @property
    def shaft_complex_shape(self: "CastSelf") -> "_4286.ShaftComplexShape":
        return self.__parent__._cast(_4286.ShaftComplexShape)

    @property
    def shaft_modal_complex_shape_at_speeds(
        self: "CastSelf",
    ) -> "_4289.ShaftModalComplexShapeAtSpeeds":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4289,
        )

        return self.__parent__._cast(_4289.ShaftModalComplexShapeAtSpeeds)

    @property
    def shaft_modal_complex_shape_at_stiffness(
        self: "CastSelf",
    ) -> "_4290.ShaftModalComplexShapeAtStiffness":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4290,
        )

        return self.__parent__._cast(_4290.ShaftModalComplexShapeAtStiffness)
...
class ShaftModalComplexShape(_4286.ShaftComplexShape[_1881.Number, _1881.Number]):
    """ShaftModalComplexShape
