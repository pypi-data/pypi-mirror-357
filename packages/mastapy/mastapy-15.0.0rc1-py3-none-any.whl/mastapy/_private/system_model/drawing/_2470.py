...
class HarmonicAnalysisViewable(_2469.DynamicAnalysisViewable):
    ...
    @enforce_parameter_types
    def excitation(
        self: "Self", value: "_5966.AbstractPeriodicExcitationDetail"
    ) -> None:
    ...
    @enforce_parameter_types
    def harmonic_analysis_with_varying_stiffness_step(
        self: "Self", value: "_6058.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase"
    ) -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def sound_response_type(self: "Self", value: "_4895.DynamicsResponseType") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def uncoupled_mesh(self: "Self", value: "_2998.GearMeshSystemDeflection") -> None:
    ...
    @property
    @exception_bridge
    def dynamic_analysis_draw_style(self: "Self") -> "_6637.DynamicAnalysisDrawStyle":
