...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    @exception_bridge
    def node_detail(self: "Self") -> "_1744.ForceAndDisplacementResults":
    ...
    @property
    @exception_bridge
    def section_to_the_left_side(self: "Self") -> "_3044.ShaftSectionSystemDeflection":
    ...
    @property
    @exception_bridge
    def section_to_the_right_side(self: "Self") -> "_3044.ShaftSectionSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSectionSystemDeflection
