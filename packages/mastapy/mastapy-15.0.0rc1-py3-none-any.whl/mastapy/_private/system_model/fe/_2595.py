...
if TYPE_CHECKING:
    ...
    from mastapy._private.units_and_measurements import _7898
...
class ElectricMachineDataSet(_0.APIBase):
    ...
    @property
    @exception_bridge
    def torque_ripple_input_type(self: "Self") -> "_7843.TorqueRippleInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7843",
    ...
    def torque_ripple_input_type(
        self: "Self", value: "_7843.TorqueRippleInputType"
    ) -> None:
    ...
    def add_or_replace_excitation_data_with_amplitudes_phases_and_fe_node(
        ...
        fourier_series_measurement_type: "_7898.MeasurementType",
    ) -> None:
