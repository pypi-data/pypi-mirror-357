...
from mastapy._private.system_model.part_model import _2669, _2673
...
class FESubstructure(_69.FEStiffness):
    ...
    @exception_bridge
    @enforce_parameter_types
    def component_to_align_to(self: "Self", value: "_2669.Component") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def datum(self: "Self", value: "_2673.Datum") -> None:
        generic_type = (
    ...
    def alignment_to_component(
        self: "Self",
    ) -> "_2431.RelativeComponentAlignment[_2669.Component]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2669.Component](temp)
    ...
    @property
    @exception_bridge
    def fe_part(self: "Self") -> "_2679.FEPart":
    ...
    @property
    @exception_bridge
    def replaced_shafts(self: "Self") -> "List[_2712.Shaft]":
    ...
    def import_fe_mesh(
        ...
        progress: Optional["_7896.TaskProgress"] = None,
    ) -> None:
        """Method does not return.
    ...
    def load_existing_masta_fe_file_with_progress(
        self: "Self", file_name: "PathLike", progress: "_7896.TaskProgress"
    ) -> None:
        """Method does not return.
