...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5951
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2761, _2767
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(
        self: "Self", value: "_5951.DutyCycle"
    ) -> None:
        generic_type = (
    ...
    @property
    @exception_bridge
    def cylindrical_gear_sets(self: "Self") -> "List[_2761.CylindricalGearSet]":
    ...
    @property
    @exception_bridge
    def gear_sets(self: "Self") -> "List[_2767.GearSet]":
    ...
    def system_optimisation_gear_sets(
        self: "Self",
    ) -> "List[_5955.SystemOptimisationGearSet]":
    ...
    @property
    @exception_bridge
    def system_optimiser_duty_cycle(self: "Self") -> "_5951.DutyCycle":
    ...
    @exception_bridge
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: "Self", value: "_5951.DutyCycle") -> None:
