...
class SuperchargerRotorSet(_2028.NamedDatabaseItem):
    """SuperchargerRotorSet
    ...
    @property
    @exception_bridge
    def supercharger_map_chart(self: "Self") -> "_2068.ThreeDChartDefinition":
    ...
    @property
    @exception_bridge
    def y_variable_for_imported_data(self: "Self") -> "_2801.YVariableForImportedData":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.gears.supercharger_rotor_set._2801",
    ...
    def y_variable_for_imported_data(
        self: "Self", value: "_2801.YVariableForImportedData"
    ) -> None:
    ...
    @property
    @exception_bridge
    def boost_pressure(self: "Self") -> "_2791.BoostPressureInputOptions":
    ...
    @property
    @exception_bridge
    def file(self: "Self") -> "_2794.RotorSetDataInputFileOptions":
    ...
    @property
    @exception_bridge
    def input_power(self: "Self") -> "_2792.InputPowerInputOptions":
    ...
    @property
    @exception_bridge
    def pressure_ratio(self: "Self") -> "_2793.PressureRatioInputOptions":
    ...
    @property
    @exception_bridge
    def rotor_speed(self: "Self") -> "_2796.RotorSpeedInputOptions":
    ...
    @property
    @exception_bridge
    def measured_points(self: "Self") -> "List[_2795.RotorSetMeasuredPoint]":
