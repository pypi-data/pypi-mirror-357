...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2864, _2866, _2869
...
class AcousticAnalysisSetup(_0.APIBase):
    ...
    @property
    @exception_bridge
    def analysis_options(self: "Self") -> "_2864.AcousticAnalysisOptions":
    ...
    @property
    @exception_bridge
    def cache_reporting(self: "Self") -> "_2866.AcousticAnalysisSetupCacheReporting":
    ...
    @property
    @exception_bridge
    def input_surface_options(self: "Self") -> "_2869.AcousticInputSurfaceOptions":
