...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2871, _2873
...
class AcousticInputSurfaceOptions(_0.APIBase):
    ...
    @property
    @exception_bridge
    def fe_part_options(self: "Self") -> "List[_2871.FEPartInputSurfaceOptions]":
    ...
    @property
    @exception_bridge
    def hole_meshes(self: "Self") -> "List[_2873.HoleInFaceGroup]":
