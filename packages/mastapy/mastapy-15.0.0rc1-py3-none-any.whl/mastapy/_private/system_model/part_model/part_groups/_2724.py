...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2719, _2722, _2725
...
class _Cast_ParallelPartGroupSelection:
    ...
    @property
    def part_group(self: "CastSelf") -> "_2725.PartGroup":
        from mastapy._private.system_model.part_model.part_groups import _2725

        return self.__parent__._cast(_2725.PartGroup)
...
class ParallelPartGroupSelection(_2723.ParallelPartGroup):
    """ParallelPartGroupSelection
    ...
    @property
    @exception_bridge
    def design_measurements(self: "Self") -> "List[_2722.DesignMeasurements]":
