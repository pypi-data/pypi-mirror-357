...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2720, _2724, _2725
...
class ParallelPartGroup(_2719.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    @exception_bridge
    def concentric_part_groups(self: "Self") -> "List[_2720.ConcentricPartGroup]":
