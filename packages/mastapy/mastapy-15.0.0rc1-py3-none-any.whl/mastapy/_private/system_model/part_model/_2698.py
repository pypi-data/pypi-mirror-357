...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2669, _2687, _2696
...
class PlanetCarrier(_2692.MountableComponent):
    """PlanetCarrier
    ...
    @property
    @exception_bridge
    def load_sharing_settings(self: "Self") -> "_2687.LoadSharingSettings":
    ...
    @property
    @exception_bridge
    def planetary_sockets(self: "Self") -> "List[_2509.PlanetarySocket]":
