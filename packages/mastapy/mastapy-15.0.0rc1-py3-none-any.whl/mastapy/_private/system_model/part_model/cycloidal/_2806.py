...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1647, _1648
...
class RingPins(_2692.MountableComponent):
    """RingPins
    ...
    @property
    @exception_bridge
    def ring_pins_design(self: "Self") -> "_1647.RingPinsDesign":
    ...
    @property
    @exception_bridge
    def ring_pins_material(self: "Self") -> "_1648.RingPinsMaterial":
