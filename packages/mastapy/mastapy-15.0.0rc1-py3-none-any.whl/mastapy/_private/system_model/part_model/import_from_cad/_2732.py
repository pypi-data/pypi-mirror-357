...
class CylindricalGearFromCAD(_2738.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    @exception_bridge
    @enforce_parameter_types
    def existing_gear_set(self: "Self", value: "_2761.CylindricalGearSet") -> None:
    ...
    @property
    @exception_bridge
    def internal_external(self: "Self") -> "_401.InternalExternalType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.geometry.two_d._401", "InternalExternalType"
        )(value)

    @internal_external.setter
    @exception_bridge
    @enforce_parameter_types
    def internal_external(self: "Self", value: "_401.InternalExternalType") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def meshing_gear(self: "Self", value: "_2760.CylindricalGear") -> None:
        generic_type = (
