...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2659, _2690, _2696
...
class MicrophoneArray(_2706.SpecialisedAssembly):
    """MicrophoneArray
    ...
    @property
    @exception_bridge
    def array_design(self: "Self") -> "_2878.MicrophoneArrayDesign":
