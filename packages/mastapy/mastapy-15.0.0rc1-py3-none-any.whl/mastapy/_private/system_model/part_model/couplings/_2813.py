...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2814, _2824, _2829
...
class BeltDrive(_2706.SpecialisedAssembly):
    """BeltDrive
    ...
    @property
    @exception_bridge
    def type_of_belt(self: "Self") -> "_2814.BeltDriveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.couplings._2814", "BeltDriveType"
        )(value)

    @type_of_belt.setter
    @exception_bridge
    @enforce_parameter_types
    def type_of_belt(self: "Self", value: "_2814.BeltDriveType") -> None:
    ...
    @property
    @exception_bridge
    def belt_connections(self: "Self") -> "List[_2489.BeltConnection]":
    ...
    @property
    @exception_bridge
    def pulleys(self: "Self") -> "List[_2829.Pulley]":
