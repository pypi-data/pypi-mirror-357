...
from mastapy._private.system_model.part_model import _2660, _2681
...
class Shaft(_2660.AbstractShaft):
    """Shaft
    ...
    @exception_bridge
    @enforce_parameter_types
    def cad_model(self: "Self", value: "_2681.GuideDxfModel") -> None:
        generic_type = (
    ...
    @property
    @exception_bridge
    def guide_image(self: "Self") -> "_2682.GuideImage":
    ...
    @property
    @exception_bridge
    def fe_substructure_replacing_this(self: "Self") -> "_2605.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: "Self", component: "_2692.MountableComponent", offset: "float"
    ) -> None:
        """Method does not return.
