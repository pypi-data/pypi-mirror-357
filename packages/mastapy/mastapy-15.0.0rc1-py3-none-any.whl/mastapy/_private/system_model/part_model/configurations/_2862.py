...
class _Cast_PartDetailConfiguration:
    ...
    def active_gear_set_design_selection_group(
        self: "CastSelf",
    ) -> "_2747.ActiveGearSetDesignSelectionGroup":
        from mastapy._private.system_model.part_model.gears import _2747

        return self.__parent__._cast(_2747.ActiveGearSetDesignSelectionGroup)

    @property
    def active_fe_substructure_selection_group(
        self: "CastSelf",
    ) -> "_2856.ActiveFESubstructureSelectionGroup":
        from mastapy._private.system_model.part_model.configurations import _2856

        return self.__parent__._cast(_2856.ActiveFESubstructureSelectionGroup)

    @property
    def active_shaft_design_selection_group(
        self: "CastSelf",
    ) -> "_2858.ActiveShaftDesignSelectionGroup":
        from mastapy._private.system_model.part_model.configurations import _2858

        return self.__parent__._cast(_2858.ActiveShaftDesignSelectionGroup)

    @property
    def bearing_detail_configuration(
        self: "CastSelf",
    ) -> "_2859.BearingDetailConfiguration":
        from mastapy._private.system_model.part_model.configurations import _2859

        return self.__parent__._cast(_2859.BearingDetailConfiguration)
