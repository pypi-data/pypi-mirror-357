...
class _Cast_DrawStyle:
    ...
    def cylindrical_gear_geometric_entity_draw_style(
        self: "CastSelf",
    ) -> "_4338.CylindricalGearGeometricEntityDrawStyle":
        from mastapy._private.system_model.analyses_and_results.power_flows import _4338

        return self.__parent__._cast(_4338.CylindricalGearGeometricEntityDrawStyle)

    @property
    def power_flow_draw_style(self: "CastSelf") -> "_4384.PowerFlowDrawStyle":
        from mastapy._private.system_model.analyses_and_results.power_flows import _4384

        return self.__parent__._cast(_4384.PowerFlowDrawStyle)
...
class DrawStyle(_397.DrawStyleBase):
    """DrawStyle
