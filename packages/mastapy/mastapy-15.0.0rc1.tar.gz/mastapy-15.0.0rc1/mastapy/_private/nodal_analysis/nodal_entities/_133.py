...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.nodal_entities import _132, _155
...
class _Cast_BarBase:
    ...
    def shaft_section_system_deflection(
        self: "CastSelf",
    ) -> "_3044.ShaftSectionSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.system_deflections import (
            _3044,
        )

        return self.__parent__._cast(_3044.ShaftSectionSystemDeflection)
...
class BarBase(_153.NodalComponent):
    """BarBase
