...
class _Cast_ResultsForOrderIncludingNodes:
    ...
    @property
    def results_for_order(self: "CastSelf") -> "_6170.ResultsForOrder":
        return self.__parent__._cast(_6170.ResultsForOrder)

    @property
    def results_for_order_including_surfaces(
        self: "CastSelf",
    ) -> "_6173.ResultsForOrderIncludingSurfaces":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _6173,
        )

        return self.__parent__._cast(_6173.ResultsForOrderIncludingSurfaces)
...
class ResultsForOrderIncludingNodes(_6170.ResultsForOrder):
    """ResultsForOrderIncludingNodes
    ...
    def node_results_global_coordinate_system(
        self: "Self",
    ) -> "List[_6164.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]":
