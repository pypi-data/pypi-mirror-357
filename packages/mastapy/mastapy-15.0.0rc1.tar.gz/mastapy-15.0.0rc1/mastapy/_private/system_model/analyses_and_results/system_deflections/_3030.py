...
from mastapy._private.system_model.analyses_and_results.system_deflections import _3046
...
class PlanetaryConnectionSystemDeflection(
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4379.PlanetaryConnectionPowerFlow":
