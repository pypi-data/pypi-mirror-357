...
class _Cast_ClutchCompoundModalAnalysisAtASpeed:
    ...
    def coupling_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_5562.CouplingCompoundModalAnalysisAtASpeed":
        return self.__parent__._cast(_5562.CouplingCompoundModalAnalysisAtASpeed)
...
class ClutchCompoundModalAnalysisAtASpeed(_5562.CouplingCompoundModalAnalysisAtASpeed):
    """ClutchCompoundModalAnalysisAtASpeed
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2815.Clutch":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5416.ClutchModalAnalysisAtASpeed]":
