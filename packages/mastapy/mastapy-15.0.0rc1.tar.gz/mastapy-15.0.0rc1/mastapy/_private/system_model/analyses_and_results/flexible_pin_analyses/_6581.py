...
class FlexiblePinAnalysisOptions(_0.APIBase):
    ...
    def extreme_load_case(self: "Self", value: "_7669.StaticLoadCase") -> None:
        generic_type = (
    ...
    @property
    @exception_bridge
    def extreme_load_case_for_stop_start(self: "Self") -> "_7669.StaticLoadCase":
    ...
    @exception_bridge
    @enforce_parameter_types
    def ldd(self: "Self", value: "_5951.DutyCycle") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def nominal_load_case(self: "Self", value: "_7669.StaticLoadCase") -> None:
        generic_type = (
            list_with_selected_item.ListWithSelectedItem_StaticLoadCase.implicit_type()
        )
        value = promote_to_list_with_selected_item(value)
    ...
    @property
    @exception_bridge
    def nominal_load_case_for_stop_start(self: "Self") -> "_7669.StaticLoadCase":
        """mastapy.system_model.analyses_and_results.static_loads.StaticLoadCase"""
