...
class _Cast_AbstractLoadCaseGroup:
    ...
    def abstract_design_state_load_case_group(
        self: "CastSelf",
    ) -> "_5945.AbstractDesignStateLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5945,
        )

        return self.__parent__._cast(_5945.AbstractDesignStateLoadCaseGroup)

    @property
    def abstract_static_load_case_group(
        self: "CastSelf",
    ) -> "_5947.AbstractStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5947,
        )

        return self.__parent__._cast(_5947.AbstractStaticLoadCaseGroup)

    @property
    def design_state(self: "CastSelf") -> "_5950.DesignState":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5950,
        )

        return self.__parent__._cast(_5950.DesignState)

    @property
    def duty_cycle(self: "CastSelf") -> "_5951.DutyCycle":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5951,
        )

        return self.__parent__._cast(_5951.DutyCycle)

    @property
    def sub_group_in_single_design_state(
        self: "CastSelf",
    ) -> "_5954.SubGroupInSingleDesignState":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5954,
        )

        return self.__parent__._cast(_5954.SubGroupInSingleDesignState)

    @property
    def time_series_load_case_group(
        self: "CastSelf",
    ) -> "_5958.TimeSeriesLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5958,
        )

        return self.__parent__._cast(_5958.TimeSeriesLoadCaseGroup)
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    @property
    @exception_bridge
    def load_case_root_assemblies(self: "Self") -> "List[_7814.RootAssemblyLoadCase]":
    ...
    def create_load_cases(
        self: "Self", number_of_load_cases: "int", token: "_7896.TaskProgress"
    ) -> "List[_7668.LoadCase]":
    ...
    @exception_bridge
    @enforce_parameter_types
    def perform_pst_with_progress(self: "Self", progress: "_7896.TaskProgress") -> None:
        """Method does not return.
