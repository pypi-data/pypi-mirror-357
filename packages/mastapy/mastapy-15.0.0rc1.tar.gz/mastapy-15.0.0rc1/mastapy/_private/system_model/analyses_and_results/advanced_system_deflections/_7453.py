...
class GuideDxfModelAdvancedSystemDeflection(_7415.ComponentAdvancedSystemDeflection):
    """GuideDxfModelAdvancedSystemDeflection
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7760.GuideDxfModelLoadCase":
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_3001.GuideDxfModelSystemDeflection]":
