...
class _Cast_ConnectionCompoundCriticalSpeedAnalysis:
    ...
    def abstract_shaft_to_mountable_component_connection_compound_critical_speed_analysis(
        ...
        "_6991.AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis"
    ):
        from mastapy._private.system_model.analyses_and_results.critical_speed_analyses.compound import (
            _6991,
        )
...
class ConnectionCompoundCriticalSpeedAnalysis(_7876.ConnectionCompoundAnalysis):
    """ConnectionCompoundCriticalSpeedAnalysis
    ...
    def connection_analysis_cases(
        self: "Self",
    ) -> "List[_6889.ConnectionCriticalSpeedAnalysis]":
