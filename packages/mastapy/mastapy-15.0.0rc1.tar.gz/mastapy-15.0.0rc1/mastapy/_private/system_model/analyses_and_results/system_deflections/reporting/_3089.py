...
class RigidlyConnectedComponentGroupSystemDeflection(_2891.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    @exception_bridge
    def mass_properties(self: "Self") -> "_1702.MassProperties":
    ...
    @property
    @exception_bridge
    def components(self: "Self") -> "List[_2954.ComponentSystemDeflection]":
