...
class StraightBevelDiffGearMeshStabilityAnalysis(_4034.BevelGearMeshStabilityAnalysis):
    """StraightBevelDiffGearMeshStabilityAnalysis
    ...
    @property
    @exception_bridge
    def connection_load_case(self: "Self") -> "_7826.StraightBevelDiffGearMeshLoadCase":
