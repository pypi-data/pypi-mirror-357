...
class StraightBevelDiffGearMeshSystemDeflection(_2945.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4403.StraightBevelDiffGearMeshPowerFlow":
