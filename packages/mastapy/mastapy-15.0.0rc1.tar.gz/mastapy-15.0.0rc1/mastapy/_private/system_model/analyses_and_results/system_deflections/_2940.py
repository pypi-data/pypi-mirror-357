...
class BevelDifferentialGearMeshSystemDeflection(_2945.BevelGearMeshSystemDeflection):
    """BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4302.BevelDifferentialGearMeshPowerFlow":
