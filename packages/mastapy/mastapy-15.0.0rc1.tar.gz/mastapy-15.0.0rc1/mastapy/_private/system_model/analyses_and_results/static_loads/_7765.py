...
T = TypeVar("T", bound="_7744.ElectricMachineHarmonicLoadImportOptionsBase")
...
class _Cast_HarmonicLoadDataImportBase:
    ...
    def harmonic_load_data_csv_import(
        self: "CastSelf",
    ) -> "_7762.HarmonicLoadDataCSVImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7762,
        )

        return self.__parent__._cast(_7762.HarmonicLoadDataCSVImport)

    @property
    def harmonic_load_data_excel_import(
        self: "CastSelf",
    ) -> "_7763.HarmonicLoadDataExcelImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7763,
        )

        return self.__parent__._cast(_7763.HarmonicLoadDataExcelImport)

    @property
    def harmonic_load_data_flux_import(
        self: "CastSelf",
    ) -> "_7764.HarmonicLoadDataFluxImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7764,
        )

        return self.__parent__._cast(_7764.HarmonicLoadDataFluxImport)

    @property
    def harmonic_load_data_import_from_motor_packages(
        self: "CastSelf",
    ) -> "_7766.HarmonicLoadDataImportFromMotorPackages":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7766,
        )

        return self.__parent__._cast(_7766.HarmonicLoadDataImportFromMotorPackages)

    @property
    def harmonic_load_data_jmag_import(
        self: "CastSelf",
    ) -> "_7767.HarmonicLoadDataJMAGImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7767,
        )

        return self.__parent__._cast(_7767.HarmonicLoadDataJMAGImport)

    @property
    def harmonic_load_data_motor_cad_import(
        self: "CastSelf",
    ) -> "_7768.HarmonicLoadDataMotorCADImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7768,
        )

        return self.__parent__._cast(_7768.HarmonicLoadDataMotorCADImport)
