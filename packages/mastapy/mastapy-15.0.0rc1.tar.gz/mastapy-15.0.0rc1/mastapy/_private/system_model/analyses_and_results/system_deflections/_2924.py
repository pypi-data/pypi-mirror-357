...
class AbstractAssemblySystemDeflection(_3026.PartSystemDeflection):
    """AbstractAssemblySystemDeflection
    ...
    def rigidly_connected_groups(
        self: "Self",
    ) -> "List[_3089.RigidlyConnectedComponentGroupSystemDeflection]":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4291.AbstractAssemblyPowerFlow":
