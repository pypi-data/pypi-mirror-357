...
class ConceptGearSetPowerFlow(_4354.GearSetPowerFlow):
    """ConceptGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def gears_power_flow(self: "Self") -> "List[_4321.ConceptGearPowerFlow]":
    ...
    @property
    @exception_bridge
    def concept_gears_power_flow(self: "Self") -> "List[_4321.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
    ...
    @property
    @exception_bridge
    def meshes_power_flow(self: "Self") -> "List[_4320.ConceptGearMeshPowerFlow]":
    ...
    def concept_meshes_power_flow(
        self: "Self",
    ) -> "List[_4320.ConceptGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearMeshPowerFlow]
