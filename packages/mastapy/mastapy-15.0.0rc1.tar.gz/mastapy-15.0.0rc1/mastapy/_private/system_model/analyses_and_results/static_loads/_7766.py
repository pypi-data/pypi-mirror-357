...
class _Cast_HarmonicLoadDataImportFromMotorPackages:
    ...
    def harmonic_load_data_import_base(
        self: "CastSelf",
    ) -> "_7765.HarmonicLoadDataImportBase":
        return self.__parent__._cast(_7765.HarmonicLoadDataImportBase)
...
class HarmonicLoadDataImportFromMotorPackages(_7765.HarmonicLoadDataImportBase[T]):
    """HarmonicLoadDataImportFromMotorPackages
