...
class BoltCompoundParametricStudyTool(_4734.ComponentCompoundParametricStudyTool):
    """BoltCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7695.BoltLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4579.BoltParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4579.BoltParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.BoltParametricStudyTool]
