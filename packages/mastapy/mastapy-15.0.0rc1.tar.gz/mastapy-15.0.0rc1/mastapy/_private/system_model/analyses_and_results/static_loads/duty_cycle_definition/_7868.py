...
class TimeSeriesImporter(_0.APIBase):
    ...
    @enforce_parameter_types
    def destination_design_state_column(
        self: "Self", value: "_7858.DestinationDesignState"
    ) -> None:
    ...
    @property
    @exception_bridge
    def import_type(self: "Self") -> "_7772.ImportType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7772",
            "ImportType",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def import_type(self: "Self", value: "_7772.ImportType") -> None:
    ...
    @property
    @exception_bridge
    def design_state_options(self: "Self") -> "_7857.DesignStateOptions":
    ...
    @property
    @exception_bridge
    def gear_ratio_options(self: "Self") -> "_7860.GearRatioInputOptions":
    ...
    @property
    @exception_bridge
    def load_case_name_inputs(self: "Self") -> "_7861.LoadCaseNameOptions":
    ...
    @property
    @exception_bridge
    def time_step_input(self: "Self") -> "_7869.TimeStepInputOptions":
    ...
    def boost_pressure_inputs(
        self: "Self",
    ) -> "List[_7856.BoostPressureLoadCaseInputOptions]":
    ...
    @property
    @exception_bridge
    def file_inputs(self: "Self") -> "List[_7863.MultiTimeSeriesDataInputFileOptions]":
    ...
    @property
    @exception_bridge
    def force_inputs(self: "Self") -> "List[_7859.ForceInputOptions]":
    ...
    @property
    @exception_bridge
    def moment_inputs(self: "Self") -> "List[_7862.MomentInputOptions]":
    ...
    @property
    @exception_bridge
    def speed_inputs(self: "Self") -> "List[_7867.SpeedInputOptions]":
    ...
    @property
    @exception_bridge
    def torque_inputs(self: "Self") -> "List[_7870.TorqueInputOptions]":
