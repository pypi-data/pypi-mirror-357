...
class _Cast_HarmonicAnalysisFEExportOptions:
    ...
    def harmonic_analysis_export_options(
        self: "CastSelf",
    ) -> "_6051.HarmonicAnalysisExportOptions":
        return self.__parent__._cast(_6051.HarmonicAnalysisExportOptions)
...
class HarmonicAnalysisFEExportOptions(
    _6051.HarmonicAnalysisExportOptions[
        _2893.IHaveFEPartHarmonicAnalysisResults, _2679.FEPart
    ]
):
    """HarmonicAnalysisFEExportOptions
