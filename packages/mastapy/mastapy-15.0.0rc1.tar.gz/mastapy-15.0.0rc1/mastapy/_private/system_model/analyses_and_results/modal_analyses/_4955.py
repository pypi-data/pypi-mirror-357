...
class SpiralBevelGearSetModalAnalysis(_4858.BevelGearSetModalAnalysis):
    """SpiralBevelGearSetModalAnalysis
    ...
    def bevel_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4954.SpiralBevelGearModalAnalysis]":
    ...
    def bevel_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4953.SpiralBevelGearMeshModalAnalysis]":
