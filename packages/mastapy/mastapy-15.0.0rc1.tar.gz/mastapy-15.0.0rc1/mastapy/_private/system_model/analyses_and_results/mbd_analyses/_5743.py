...
class MBDRunUpAnalysisOptions(_7873.AbstractAnalysisOptions[_7838.TimeSeriesLoadCase]):
    """MBDRunUpAnalysisOptions
    ...
    def input_velocity_processing_type(
        self: "Self",
    ) -> "_5729.InputVelocityForRunUpProcessingType":
    ...
    @enforce_parameter_types
    def input_velocity_processing_type(
        self: "Self", value: "_5729.InputVelocityForRunUpProcessingType"
    ) -> None:
    ...
    @property
    @exception_bridge
    def run_up_driving_mode(self: "Self") -> "_5766.RunUpDrivingMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5766",
            "RunUpDrivingMode",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def run_up_driving_mode(self: "Self", value: "_5766.RunUpDrivingMode") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.RunUpDrivingMode",
        )
    ...
    def shape_of_initial_acceleration_period(
        self: "Self",
    ) -> "_5771.ShapeOfInitialAccelerationPeriodForRunUp":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5771",
    ...
    @enforce_parameter_types
    def shape_of_initial_acceleration_period(
        self: "Self", value: "_5771.ShapeOfInitialAccelerationPeriodForRunUp"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ShapeOfInitialAccelerationPeriodForRunUp",
