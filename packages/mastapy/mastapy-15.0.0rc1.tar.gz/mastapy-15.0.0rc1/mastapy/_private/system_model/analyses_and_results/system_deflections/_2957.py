...
class ConceptCouplingHalfSystemDeflection(_2969.CouplingHalfSystemDeflection):
    """ConceptCouplingHalfSystemDeflection
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7703.ConceptCouplingHalfLoadCase":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4318.ConceptCouplingHalfPowerFlow":
