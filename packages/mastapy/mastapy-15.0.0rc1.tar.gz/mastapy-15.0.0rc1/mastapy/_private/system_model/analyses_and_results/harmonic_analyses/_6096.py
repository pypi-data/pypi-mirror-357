...
class RootAssemblyHarmonicAnalysis(
    _5973.AssemblyHarmonicAnalysis, _2894.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def export(self: "Self") -> "_6055.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    @exception_bridge
    def harmonic_analysis_inputs(self: "Self") -> "_6049.HarmonicAnalysis":
    ...
    def results(
        self: "Self",
    ) -> "_6177.RootAssemblyHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3041.RootAssemblySystemDeflection":
