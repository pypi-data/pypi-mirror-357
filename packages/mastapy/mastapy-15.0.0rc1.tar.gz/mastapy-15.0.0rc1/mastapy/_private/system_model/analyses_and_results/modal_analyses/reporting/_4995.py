...
class _Cast_ShaftPerModeResult:
    ...
    @property
    def component_per_mode_result(self: "CastSelf") -> "_4988.ComponentPerModeResult":
        return self.__parent__._cast(_4988.ComponentPerModeResult)
...
class ShaftPerModeResult(_4988.ComponentPerModeResult):
    """ShaftPerModeResult
