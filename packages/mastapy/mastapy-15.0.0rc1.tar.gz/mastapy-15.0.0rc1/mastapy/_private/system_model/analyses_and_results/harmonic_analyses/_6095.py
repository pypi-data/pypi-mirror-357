...
class RollingRingHarmonicAnalysis(_6005.CouplingHalfHarmonicAnalysis):
    """RollingRingHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7813.RollingRingLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3040.RollingRingSystemDeflection":
