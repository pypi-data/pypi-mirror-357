...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @exception_bridge
    @enforce_parameter_types
    def chart_type(self: "Self", value: "_4894.DynamicsResponse3DChartType") -> None:
    ...
    @property
    @exception_bridge
    def connected_component_type(self: "Self") -> "_6145.ConnectedComponentType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses.results._6145",
    ...
    def connected_component_type(
        self: "Self", value: "_6145.ConnectedComponentType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ConnectedComponentType",
    ...
    @property
    @exception_bridge
    def coordinate_system(self: "Self") -> "_4877.CoordinateSystemForWhine":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4877",
    ...
    def coordinate_system(
        self: "Self", value: "_4877.CoordinateSystemForWhine"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.CoordinateSystemForWhine",
    ...
    @exception_bridge
    @enforce_parameter_types
    def response_type(self: "Self", value: "_4895.DynamicsResponseType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def speed_range_for_combining_excitations(
        self: "Self",
    ) -> "_4929.MultipleExcitationsSpeedRangeOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4929",
    ...
    @enforce_parameter_types
    def speed_range_for_combining_excitations(
        self: "Self", value: "_4929.MultipleExcitationsSpeedRangeOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.MultipleExcitationsSpeedRangeOption",
    ...
    def whine_waterfall_export_option(
        self: "Self",
    ) -> "_4978.WhineWaterfallExportOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4978",
    ...
    @enforce_parameter_types
    def whine_waterfall_export_option(
        self: "Self", value: "_4978.WhineWaterfallExportOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.WhineWaterfallExportOption",
    ...
    @property
    @exception_bridge
    def order_cuts_chart_settings(self: "Self") -> "_4931.OrderCutsChartSettings":
    ...
    def result_location_selection_groups(
        self: "Self",
    ) -> "_6153.ResultLocationSelectionGroups":
    ...
    @property
    @exception_bridge
    def selected_excitations(self: "Self") -> "_6148.ExcitationSourceSelectionGroup":
    ...
    @property
    @exception_bridge
    def waterfall_chart_settings(self: "Self") -> "_4977.WaterfallChartSettings":
    ...
    @property
    @exception_bridge
    def active_result_locations(self: "Self") -> "List[_6154.ResultNodeSelection]":
