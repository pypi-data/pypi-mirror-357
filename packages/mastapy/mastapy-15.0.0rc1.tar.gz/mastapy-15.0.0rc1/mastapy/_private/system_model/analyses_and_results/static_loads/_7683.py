...
class BearingLoadCase(_7714.ConnectorLoadCase):
    """BearingLoadCase
    ...
    def bearing_element_orbit_model(
        self: "Self",
        value: "Union[_5665.BearingElementOrbitModel, Tuple[_5665.BearingElementOrbitModel, bool]]",
    ) -> None:
    ...
    @property
    @exception_bridge
    def bearing_stiffness_model(self: "Self") -> "_5667.BearingStiffnessModel":
    ...
    @property
    @exception_bridge
    def elements(self: "Self") -> "List[_2703.RollingBearingElementLoadCase]":
