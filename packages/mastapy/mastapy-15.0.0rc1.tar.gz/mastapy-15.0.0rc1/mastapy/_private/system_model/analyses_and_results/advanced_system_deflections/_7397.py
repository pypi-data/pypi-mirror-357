...
class AssemblyAdvancedSystemDeflection(_7387.AbstractAssemblyAdvancedSystemDeflection):
    """AssemblyAdvancedSystemDeflection
    ...
    def assembly_system_deflection_results(
        self: "Self",
    ) -> "List[_2931.AssemblySystemDeflection]":
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_7398.BearingAdvancedSystemDeflection]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_7400.BeltDriveAdvancedSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_7403.BevelDifferentialGearSetAdvancedSystemDeflection]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_7410.BoltedJointAdvancedSystemDeflection]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_7409.BoltAdvancedSystemDeflection]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_7431.CVTAdvancedSystemDeflection]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_7411.ClutchAdvancedSystemDeflection]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_7416.ConceptCouplingAdvancedSystemDeflection]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_7421.ConceptGearSetAdvancedSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_7434.CycloidalAssemblyAdvancedSystemDeflection]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_7435.CycloidalDiscAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_7440.CylindricalGearSetAdvancedSystemDeflection]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_7448.FEPartAdvancedSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_7449.FlexiblePinAssemblyAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_7463.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_7466.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection]"
    ):
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_7468.MassDiscAdvancedSystemDeflection]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_7469.MeasurementComponentAdvancedSystemDeflection]":
    ...
    @property
    @exception_bridge
    def microphones(self: "Self") -> "List[_7470.MicrophoneAdvancedSystemDeflection]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_7473.OilSealAdvancedSystemDeflection]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_7480.PlanetCarrierAdvancedSystemDeflection]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_7481.PointLoadAdvancedSystemDeflection]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_7482.PowerLoadAdvancedSystemDeflection]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_7484.RingPinsAdvancedSystemDeflection]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_7487.RollingRingAssemblyAdvancedSystemDeflection]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_7490.ShaftAdvancedSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7496.SpiralBevelGearSetAdvancedSystemDeflection]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_7497.SpringDamperAdvancedSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_7502.StraightBevelDiffGearSetAdvancedSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7505.StraightBevelGearSetAdvancedSystemDeflection]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_7508.SynchroniserAdvancedSystemDeflection]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_7512.TorqueConverterAdvancedSystemDeflection]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_7521.WormGearSetAdvancedSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7524.ZerolBevelGearSetAdvancedSystemDeflection]":
