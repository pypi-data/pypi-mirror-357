...
from mastapy._private.system_model.analyses_and_results.acoustic_analyses import _7665
...
class _Cast_SingleHarmonicExcitationAnalysisDetail:
    ...
    @property
    def single_excitation_details(self: "CastSelf") -> "_7665.SingleExcitationDetails":
        return self.__parent__._cast(_7665.SingleExcitationDetails)
...
class SingleHarmonicExcitationAnalysisDetail(_7665.SingleExcitationDetails):
    """SingleHarmonicExcitationAnalysisDetail
