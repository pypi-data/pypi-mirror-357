...
class AssemblySystemDeflection(_2924.AbstractAssemblySystemDeflection):
    """AssemblySystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4298.AssemblyPowerFlow":
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_2937.BearingSystemDeflection]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_2939.BeltDriveSystemDeflection]":
    ...
    @property
    @exception_bridge
    def bolted_joints(self: "Self") -> "List[_2948.BoltedJointSystemDeflection]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_2949.BoltSystemDeflection]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_2973.CVTSystemDeflection]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_2952.ClutchSystemDeflection]":
    ...
    @property
    @exception_bridge
    def component_details(self: "Self") -> "List[_2954.ComponentSystemDeflection]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_2958.ConceptCouplingSystemDeflection]":
    ...
    @property
    @exception_bridge
    def concept_gear_sets(self: "Self") -> "List[_2960.ConceptGearSetSystemDeflection]":
    ...
    @property
    @exception_bridge
    def connection_details(self: "Self") -> "List[_2966.ConnectionSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_2974.CycloidalAssemblySystemDeflection]":
    ...
    @property
    @exception_bridge
    def cycloidal_discs(self: "Self") -> "List[_2977.CycloidalDiscSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_2981.CylindricalGearSetSystemDeflection]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_2996.FEPartSystemDeflection]":
    ...
    @property
    @exception_bridge
    def face_gear_sets(self: "Self") -> "List[_2994.FaceGearSetSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_2997.FlexiblePinAssemblySystemDeflection]":
    ...
    @property
    @exception_bridge
    def hypoid_gear_sets(self: "Self") -> "List[_3003.HypoidGearSetSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3011.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3014.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]":
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_3018.MassDiscSystemDeflection]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_3019.MeasurementComponentSystemDeflection]":
    ...
    @property
    @exception_bridge
    def microphones(self: "Self") -> "List[_3022.MicrophoneSystemDeflection]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_3025.OilSealSystemDeflection]":
    ...
    @property
    @exception_bridge
    def planet_carriers(self: "Self") -> "List[_3031.PlanetCarrierSystemDeflection]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_3032.PointLoadSystemDeflection]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_3033.PowerLoadSystemDeflection]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_3035.RingPinsSystemDeflection]":
    ...
    @property
    @exception_bridge
    def rolling_bearings(self: "Self") -> "List[_2937.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_3038.RollingRingAssemblySystemDeflection]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_3045.ShaftSystemDeflection]":
    ...
    def shafts_and_housings(
        self: "Self",
    ) -> "List[_2925.AbstractShaftOrHousingSystemDeflection]":
    ...
    def sorted_converged_connection_details(
        self: "Self",
    ) -> "List[_2966.ConnectionSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.ConnectionSystemDeflection]
    ...
    @property
    @exception_bridge
    def spring_dampers(self: "Self") -> "List[_3053.SpringDamperSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_3055.StraightBevelDiffGearSetSystemDeflection]":
    ...
    @property
    @exception_bridge
    def synchronisers(self: "Self") -> "List[_3065.SynchroniserSystemDeflection]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_3071.TorqueConverterSystemDeflection]":
    ...
    @property
    @exception_bridge
    def unbalanced_masses(self: "Self") -> "List[_3075.UnbalancedMassSystemDeflection]":
    ...
    def unconverged_bearings_sorted_by_load(
        self: "Self",
    ) -> "List[_2937.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    @property
    @exception_bridge
    def worm_gear_sets(self: "Self") -> "List[_3078.WormGearSetSystemDeflection]":
