...
class ConicalGearSetCompoundPowerFlow(_4488.GearSetCompoundPowerFlow):
    """ConicalGearSetCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4325.ConicalGearSetPowerFlow]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4325.ConicalGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConicalGearSetPowerFlow]
