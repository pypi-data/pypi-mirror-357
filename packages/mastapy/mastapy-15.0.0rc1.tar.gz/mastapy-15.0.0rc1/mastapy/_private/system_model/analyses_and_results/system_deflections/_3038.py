...
class RollingRingAssemblySystemDeflection(_3047.SpecialisedAssemblySystemDeflection):
    """RollingRingAssemblySystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4389.RollingRingAssemblyPowerFlow":
