...
class _Cast_HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation:
    ...
    @property
    def harmonic_analysis_options(self: "CastSelf") -> "_6054.HarmonicAnalysisOptions":
        return self.__parent__._cast(_6054.HarmonicAnalysisOptions)
