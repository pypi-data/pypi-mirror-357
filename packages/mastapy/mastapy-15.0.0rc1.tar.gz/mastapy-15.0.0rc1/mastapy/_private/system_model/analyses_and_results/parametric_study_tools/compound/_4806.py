...
class ShaftCompoundParametricStudyTool(_4710.AbstractShaftCompoundParametricStudyTool):
    """ShaftCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7816.ShaftLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4676.ShaftParametricStudyTool]":
