...
class _Cast_RootAssemblyCompoundAdvancedSystemDeflection:
    ...
    def assembly_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7532.AssemblyCompoundAdvancedSystemDeflection":
        return self.__parent__._cast(_7532.AssemblyCompoundAdvancedSystemDeflection)
...
class RootAssemblyCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7489.RootAssemblyAdvancedSystemDeflection]":
