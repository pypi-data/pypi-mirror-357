...
class _Cast_ResultsForMultipleOrdersForFESurface:
    ...
    def results_for_multiple_orders(
        self: "CastSelf",
    ) -> "_6167.ResultsForMultipleOrders":
        return self.__parent__._cast(_6167.ResultsForMultipleOrders)
...
class ResultsForMultipleOrdersForFESurface(_6167.ResultsForMultipleOrders):
    """ResultsForMultipleOrdersForFESurface
    ...
    def default_fe_surface(
        self: "Self",
    ) -> "_6165.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic":
    ...
    def fe_surfaces(
        self: "Self",
    ) -> "List[_6165.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]":
