...
class RollingRingAssemblyStabilityAnalysis(_4120.SpecialisedAssemblyStabilityAnalysis):
    """RollingRingAssemblyStabilityAnalysis
    ...
    @property
    @exception_bridge
    def assembly_load_case(self: "Self") -> "_7811.RollingRingAssemblyLoadCase":
