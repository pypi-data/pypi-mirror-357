...
class BevelGearSetPowerFlow(_4297.AGMAGleasonConicalGearSetPowerFlow):
    """BevelGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def bevel_gears_power_flow(self: "Self") -> "List[_4308.BevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearPowerFlow]
    ...
    @property
    @exception_bridge
    def bevel_meshes_power_flow(self: "Self") -> "List[_4307.BevelGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearMeshPowerFlow]
