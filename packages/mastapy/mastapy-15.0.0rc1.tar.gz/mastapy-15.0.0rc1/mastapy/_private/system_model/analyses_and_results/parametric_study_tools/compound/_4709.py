...
class _Cast_AbstractAssemblyCompoundParametricStudyTool:
    ...
    def root_assembly_compound_parametric_study_tool(
        self: "CastSelf",
    ) -> "_4805.RootAssemblyCompoundParametricStudyTool":
        from mastapy._private.system_model.analyses_and_results.parametric_study_tools.compound import (
            _4805,
        )

        return self.__parent__._cast(_4805.RootAssemblyCompoundParametricStudyTool)
...
class AbstractAssemblyCompoundParametricStudyTool(
    ...
    def assembly_analysis_cases(
        self: "Self",
    ) -> "List[_4559.AbstractAssemblyParametricStudyTool]":
