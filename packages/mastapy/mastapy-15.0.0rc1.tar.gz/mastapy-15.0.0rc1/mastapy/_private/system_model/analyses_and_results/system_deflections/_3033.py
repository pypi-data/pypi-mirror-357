...
class PowerLoadSystemDeflection(_3076.VirtualComponentSystemDeflection):
    """PowerLoadSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4385.PowerLoadPowerFlow":
    ...
    def transmission_error_to_other_power_loads(
        self: "Self",
    ) -> "List[_3074.TransmissionErrorResult]":
