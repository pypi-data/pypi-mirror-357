...
class FEPartHarmonicAnalysis(
    _5968.AbstractShaftOrHousingHarmonicAnalysis,
    _2893.IHaveFEPartHarmonicAnalysisResults,
):
    """FEPartHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def coupled_modal_analysis(self: "Self") -> "_4900.FEPartModalAnalysis":
    ...
    @property
    @exception_bridge
    def export(self: "Self") -> "_6052.HarmonicAnalysisFEExportOptions":
    ...
    @property
    @exception_bridge
    def results(self: "Self") -> "_6158.FEPartHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2996.FEPartSystemDeflection":
