...
class AssemblyCompoundSystemDeflection(_3092.AbstractAssemblyCompoundSystemDeflection):
    """AssemblyCompoundSystemDeflection
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_3100.BearingCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_3102.BeltDriveCompoundSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_3105.BevelDifferentialGearSetCompoundSystemDeflection]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_3112.BoltedJointCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_3111.BoltCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_3133.CVTCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_3113.ClutchCompoundSystemDeflection]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_3118.ConceptCouplingCompoundSystemDeflection]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_3123.ConceptGearSetCompoundSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_3135.CycloidalAssemblyCompoundSystemDeflection]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_3137.CycloidalDiscCompoundSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_3141.CylindricalGearSetCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_3149.FEPartCompoundSystemDeflection]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_3148.FaceGearSetCompoundSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_3150.FlexiblePinAssemblyCompoundSystemDeflection]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3157.HypoidGearSetCompoundSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3164.KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_3167.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection]"
    ):
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_3168.MassDiscCompoundSystemDeflection]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_3169.MeasurementComponentCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def microphones(self: "Self") -> "List[_3171.MicrophoneCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_3173.OilSealCompoundSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_3175.PartToPartShearCouplingCompoundSystemDeflection]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_3180.PlanetCarrierCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_3181.PointLoadCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_3182.PowerLoadCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_3184.RingPinsCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def rolling_bearings(self: "Self") -> "List[_3100.BearingCompoundSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.compound.BearingCompoundSystemDeflection]
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_3186.RollingRingAssemblyCompoundSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_3192.ShaftHubConnectionCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_3190.ShaftCompoundSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3197.SpiralBevelGearSetCompoundSystemDeflection]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_3198.SpringDamperCompoundSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_3203.StraightBevelDiffGearSetCompoundSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3206.StraightBevelGearSetCompoundSystemDeflection]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_3209.SynchroniserCompoundSystemDeflection]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_3213.TorqueConverterCompoundSystemDeflection]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_3217.UnbalancedMassCompoundSystemDeflection]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_3221.WormGearSetCompoundSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3224.ZerolBevelGearSetCompoundSystemDeflection]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_2931.AssemblySystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.AssemblySystemDeflection]
