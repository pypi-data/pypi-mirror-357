...
class ZerolBevelGearSetCriticalSpeedAnalysis(_6872.BevelGearSetCriticalSpeedAnalysis):
    """ZerolBevelGearSetCriticalSpeedAnalysis
    ...
    def bevel_gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6985.ZerolBevelGearCriticalSpeedAnalysis]":
    ...
    def bevel_meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6986.ZerolBevelGearMeshCriticalSpeedAnalysis]":
