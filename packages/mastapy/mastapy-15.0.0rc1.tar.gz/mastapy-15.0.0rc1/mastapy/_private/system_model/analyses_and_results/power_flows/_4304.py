...
class BevelDifferentialGearSetPowerFlow(_4309.BevelGearSetPowerFlow):
    """BevelDifferentialGearSetPowerFlow
    ...
    def bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4303.BevelDifferentialGearPowerFlow]":
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4302.BevelDifferentialGearMeshPowerFlow]":
