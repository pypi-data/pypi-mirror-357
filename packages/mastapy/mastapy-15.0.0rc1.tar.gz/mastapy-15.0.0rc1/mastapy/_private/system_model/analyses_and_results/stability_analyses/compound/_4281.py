...
class WormGearSetCompoundStabilityAnalysis(_4214.GearSetCompoundStabilityAnalysis):
    """WormGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4149.WormGearSetStabilityAnalysis]":
    ...
    def worm_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4279.WormGearCompoundStabilityAnalysis]":
    ...
    def worm_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4280.WormGearMeshCompoundStabilityAnalysis]":
