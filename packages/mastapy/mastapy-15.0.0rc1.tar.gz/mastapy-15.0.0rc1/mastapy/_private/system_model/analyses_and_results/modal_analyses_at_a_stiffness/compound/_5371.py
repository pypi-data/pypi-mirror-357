...
class StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5240.StraightBevelDiffGearSetModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_diff_gears_compound_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_5369.StraightBevelDiffGearCompoundModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_diff_meshes_compound_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_5370.StraightBevelDiffGearMeshCompoundModalAnalysisAtAStiffness]":
