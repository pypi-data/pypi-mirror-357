...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    def analysis_type(self: "Self", value: "_7681.AnalysisType") -> None:
    ...
    @property
    @exception_bridge
    def parametric_study_type(self: "Self") -> "_7793.ParametricStudyType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7793",
            "ParametricStudyType",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def parametric_study_type(self: "Self", value: "_7793.ParametricStudyType") -> None:
    ...
    @property
    @exception_bridge
    def step_save_method(self: "Self") -> "_4657.ParametricStudyToolStepSaveMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.parametric_study_tools._4657",
    ...
    def step_save_method(
        self: "Self", value: "_4657.ParametricStudyToolStepSaveMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.ParametricStudyToolStepSaveMethod",
    ...
    @property
    @exception_bridge
    def step_results(self: "Self") -> "List[_4656.ParametricStudyToolStepResult]":
    ...
    @property
    @exception_bridge
    def study_variables(self: "Self") -> "List[_4658.ParametricStudyVariable]":
    ...
    def parametric_study_logging_variables(
        self: "Self",
    ) -> "List[_2887.AnalysisCaseVariable]":
    ...
    def move_study_variable_down(
        self: "Self", study_variable: "_4658.ParametricStudyVariable"
    ) -> None:
        """Method does not return.
    ...
    def remove_logging_variable(
        self: "Self", analysis_variable: "_2887.AnalysisCaseVariable"
    ) -> None:
        """Method does not return.
