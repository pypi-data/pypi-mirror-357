...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2889, _2922
...
class StaticLoadCase(_7668.LoadCase):
    """StaticLoadCase
    ...
    def unbalanced_mass_inclusion(
        self: "Self",
        value: "Union[_2708.UnbalancedMassInclusionOption, Tuple[_2708.UnbalancedMassInclusionOption, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    def advanced_system_deflection_options(
        self: "Self",
    ) -> "_7392.AdvancedSystemDeflectionOptions":
    ...
    def harmonic_analysis_options_for_atsam(
        self: "Self",
    ) -> "_7186.HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation":
    ...
    def te_set_up_for_dynamic_analyses_options(
        self: "Self",
    ) -> "_2922.TESetUpForDynamicAnalysisOptions":
    ...
    @property
    @exception_bridge
    def clutch_engagements(self: "Self") -> "List[_5948.ClutchEngagementStatus]":
    ...
    def concept_clutch_engagements(
        self: "Self",
    ) -> "List[_5949.ConceptSynchroGearEngagementStatus]":
    ...
    @property
    @exception_bridge
    def design_state_load_case_group(self: "Self") -> "_5950.DesignState":
    ...
    @property
    @exception_bridge
    def modal_analysis(self: "Self") -> "_4924.ModalAnalysis":
    ...
    @property
    @exception_bridge
    def stability_analysis(self: "Self") -> "_4127.StabilityAnalysis":
    ...
    @enforce_parameter_types
    def analysis_of(
        self: "Self", analysis_type: "_7681.AnalysisType"
    ) -> "_7872.AnalysisCase":
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_design_state_group: "_5950.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":
