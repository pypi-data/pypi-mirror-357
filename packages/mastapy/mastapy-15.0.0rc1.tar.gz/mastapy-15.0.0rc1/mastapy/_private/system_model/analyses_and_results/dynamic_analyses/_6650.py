...
class HypoidGearSetDynamicAnalysis(_6590.AGMAGleasonConicalGearSetDynamicAnalysis):
    """HypoidGearSetDynamicAnalysis
    ...
    def agma_gleason_conical_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6648.HypoidGearDynamicAnalysis]":
    ...
    def agma_gleason_conical_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6649.HypoidGearMeshDynamicAnalysis]":
