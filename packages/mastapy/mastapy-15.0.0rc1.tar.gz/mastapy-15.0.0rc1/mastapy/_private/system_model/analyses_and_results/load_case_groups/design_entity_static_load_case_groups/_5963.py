...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2765, _2767
...
TGearSet = TypeVar("TGearSet", bound="_2767.GearSet")
TGear = TypeVar("TGear", bound="_2765.Gear")
TGearStaticLoad = TypeVar("TGearStaticLoad", bound="_7754.GearLoadCase")
TGearMesh = TypeVar("TGearMesh", bound="_2534.GearMesh")
TGearMeshStaticLoad = TypeVar("TGearMeshStaticLoad", bound="_7756.GearMeshLoadCase")
TGearSetStaticLoad = TypeVar("TGearSetStaticLoad", bound="_7759.GearSetLoadCase")
...
class GearSetStaticLoadCaseGroup(
    ...
    def gears_load_cases(
        self: "Self",
    ) -> "List[_5960.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]":
    ...
    def meshes_load_cases(
        self: "Self",
    ) -> "List[_5961.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]":
