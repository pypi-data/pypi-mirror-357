...
class CylindricalGearSetCompoundModalAnalysis(_5058.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4890.CylindricalGearSetModalAnalysis]":
    ...
    def cylindrical_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5045.CylindricalGearCompoundModalAnalysis]":
    ...
    def cylindrical_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_5046.CylindricalGearMeshCompoundModalAnalysis]":
