...
class WormGearSetDynamicAnalysis(_6646.GearSetDynamicAnalysis):
    """WormGearSetDynamicAnalysis
    ...
    @property
    @exception_bridge
    def gears_dynamic_analysis(self: "Self") -> "List[_6711.WormGearDynamicAnalysis]":
    ...
    def worm_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6711.WormGearDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.WormGearDynamicAnalysis]
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6712.WormGearMeshDynamicAnalysis]":
