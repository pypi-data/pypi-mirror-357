...
class ClutchHalfHarmonicAnalysis(_6005.CouplingHalfHarmonicAnalysis):
    """ClutchHalfHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2816.ClutchHalf":
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7697.ClutchHalfLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2951.ClutchHalfSystemDeflection":
