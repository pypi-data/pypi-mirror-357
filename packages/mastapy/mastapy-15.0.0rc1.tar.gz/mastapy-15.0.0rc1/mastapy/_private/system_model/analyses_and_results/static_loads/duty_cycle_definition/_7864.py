...
class PointLoadInputOptions(_2050.ColumnInputOptions):
    ...
    @property
    @exception_bridge
    def conversion_to_load_case(self: "Self") -> "_7855.AdditionalForcesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition._7855",
    ...
    def conversion_to_load_case(
        self: "Self", value: "_7855.AdditionalForcesObtainedFrom"
    ) -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def point_load(self: "Self", value: "_2700.PointLoad") -> None:
        generic_type = (
