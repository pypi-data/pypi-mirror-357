...
class GearMeshExcitationDetail(_5966.AbstractPeriodicExcitationDetail):
    """GearMeshExcitationDetail
    ...
    @property
    @exception_bridge
    def uncoupled_modal_analysis(self: "Self") -> "_4924.ModalAnalysis":
    ...
    @property
    @exception_bridge
    def gear_mesh(self: "Self") -> "_2998.GearMeshSystemDeflection":
    ...
    @exception_bridge
    def get_compliance_and_force_data(self: "Self") -> "_5991.ComplianceAndForceData":
