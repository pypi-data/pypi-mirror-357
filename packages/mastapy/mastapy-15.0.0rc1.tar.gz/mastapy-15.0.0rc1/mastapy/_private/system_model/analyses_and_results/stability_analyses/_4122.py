...
class SpiralBevelGearSetStabilityAnalysis(_4035.BevelGearSetStabilityAnalysis):
    """SpiralBevelGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_4123.SpiralBevelGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4121.SpiralBevelGearMeshStabilityAnalysis]":
