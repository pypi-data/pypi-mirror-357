...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling.dysla import _2324
...
class BearingDynamicResultsUIWrapper(_0.APIBase):
    ...
    @property
    @exception_bridge
    def revolutions_type(self: "Self") -> "_2324.RevolutionsType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_results.rolling.dysla._2324",
            "RevolutionsType",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def revolutions_type(self: "Self", value: "_2324.RevolutionsType") -> None:
    ...
    @property
    @exception_bridge
    def bearing_system_deflection(self: "Self") -> "_2937.BearingSystemDeflection":
    ...
    def bearing_results(
        self: "Self",
    ) -> "List[_2935.BearingDynamicResultsPropertyWrapper]":
    ...
    def element_results(
        self: "Self",
    ) -> "List[_2933.BearingDynamicElementPropertyWrapper]":
    ...
    def post_analysis_results(
        self: "Self",
    ) -> "List[_2934.BearingDynamicPostAnalysisResultWrapper]":
