...
class SynchroniserHarmonicAnalysis(_6101.SpecialisedAssemblyHarmonicAnalysis):
    """SynchroniserHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def assembly_load_case(self: "Self") -> "_7834.SynchroniserLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3065.SynchroniserSystemDeflection":
