...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    def acoustic_analysis_setup(
        self: "Self", value: "_2865.AcousticAnalysisSetup"
    ) -> None:
    ...
    @enforce_parameter_types
    def damping_specification(
        self: "Self", value: "_6018.DampingSpecification"
    ) -> None:
    ...
    @enforce_parameter_types
    def modal_correction_method(
        self: "Self", value: "_6076.ModalCorrectionMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    @exception_bridge
    def response_cache_level(self: "Self") -> "_6090.ResponseCacheLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses._6090",
            "ResponseCacheLevel",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def response_cache_level(self: "Self", value: "_6090.ResponseCacheLevel") -> None:
    ...
    @property
    @exception_bridge
    def excitation_selection(self: "Self") -> "_6148.ExcitationSourceSelectionGroup":
    ...
    @property
    @exception_bridge
    def modal_analysis_options(self: "Self") -> "_4927.ModalAnalysisOptions":
    ...
    @property
    @exception_bridge
    def stiffness_options(self: "Self") -> "_6109.StiffnessOptionsForHarmonicAnalysis":
