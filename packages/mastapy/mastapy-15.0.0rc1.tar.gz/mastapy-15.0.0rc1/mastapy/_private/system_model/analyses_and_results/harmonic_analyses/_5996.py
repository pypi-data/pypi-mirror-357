...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _6041
...
class ConceptGearHarmonicAnalysis(_6041.GearHarmonicAnalysis):
    """ConceptGearHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2756.ConceptGear":
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7705.ConceptGearLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_2961.ConceptGearSystemDeflection":
