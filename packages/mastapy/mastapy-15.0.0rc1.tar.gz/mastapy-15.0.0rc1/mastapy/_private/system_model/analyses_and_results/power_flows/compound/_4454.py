...
class ConceptCouplingCompoundPowerFlow(_4465.CouplingCompoundPowerFlow):
    """ConceptCouplingCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2818.ConceptCoupling":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4319.ConceptCouplingPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4319.ConceptCouplingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptCouplingPowerFlow]
