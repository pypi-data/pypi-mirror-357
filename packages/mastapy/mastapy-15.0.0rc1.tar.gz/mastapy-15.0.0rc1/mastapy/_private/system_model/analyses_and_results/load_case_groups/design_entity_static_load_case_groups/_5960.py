...
TReal = TypeVar("TReal", bound="_2669.Component")
TComponentStaticLoad = TypeVar("TComponentStaticLoad", bound="_7701.ComponentLoadCase")
...
class _Cast_ComponentStaticLoadCaseGroup:
    ...
    def part_static_load_case_group(
        self: "CastSelf",
    ) -> "_5964.PartStaticLoadCaseGroup":
        return self.__parent__._cast(_5964.PartStaticLoadCaseGroup)

    @property
    def design_entity_static_load_case_group(
        self: "CastSelf",
    ) -> "_5962.DesignEntityStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import (
            _5962,
        )

        return self.__parent__._cast(_5962.DesignEntityStaticLoadCaseGroup)
...
class ComponentStaticLoadCaseGroup(
    _5964.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]
):
    """ComponentStaticLoadCaseGroup
