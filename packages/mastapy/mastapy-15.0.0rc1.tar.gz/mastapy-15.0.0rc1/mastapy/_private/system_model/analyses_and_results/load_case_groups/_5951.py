...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5947
...
class DutyCycle(_5947.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    def duty_cycle_design_states(
        self: "Self",
    ) -> "List[_5954.SubGroupInSingleDesignState]":
    ...
    @property
    @exception_bridge
    def time_series_importer(self: "Self") -> "_7868.TimeSeriesImporter":
    ...
    def add_static_load(self: "Self", static_load: "_7669.StaticLoadCase") -> None:
        """Method does not return.
    ...
    def remove_design_state_sub_group(
        self: "Self", sub_group: "_5954.SubGroupInSingleDesignState"
    ) -> None:
        """Method does not return.
    ...
    @exception_bridge
    @enforce_parameter_types
    def remove_static_load(self: "Self", static_load: "_7669.StaticLoadCase") -> None:
        """Method does not return.
