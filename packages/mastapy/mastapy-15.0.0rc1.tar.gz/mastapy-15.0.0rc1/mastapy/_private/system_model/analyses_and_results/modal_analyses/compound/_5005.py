...
class AssemblyCompoundModalAnalysis(_4998.AbstractAssemblyCompoundModalAnalysis):
    """AssemblyCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4847.AssemblyModalAnalysis]":
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_5006.BearingCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_5008.BeltDriveCompoundModalAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_5011.BevelDifferentialGearSetCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def bolted_joints(self: "Self") -> "List[_5018.BoltedJointCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_5017.BoltCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_5039.CVTCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_5019.ClutchCompoundModalAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5024.ConceptCouplingCompoundModalAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_5029.ConceptGearSetCompoundModalAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5041.CycloidalAssemblyCompoundModalAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_5043.CycloidalDiscCompoundModalAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5047.CylindricalGearSetCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_5054.FEPartCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def face_gear_sets(self: "Self") -> "List[_5053.FaceGearSetCompoundModalAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5055.FlexiblePinAssemblyCompoundModalAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5062.HypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5069.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5072.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_5073.MassDiscCompoundModalAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5074.MeasurementComponentCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def microphones(self: "Self") -> "List[_5076.MicrophoneCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_5078.OilSealCompoundModalAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5080.PartToPartShearCouplingCompoundModalAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_5085.PlanetCarrierCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_5086.PointLoadCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_5087.PowerLoadCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_5089.RingPinsCompoundModalAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5091.RollingRingAssemblyCompoundModalAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5096.ShaftHubConnectionCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_5095.ShaftCompoundModalAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5101.SpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def spring_dampers(self: "Self") -> "List[_5102.SpringDamperCompoundModalAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5107.StraightBevelDiffGearSetCompoundModalAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5110.StraightBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def synchronisers(self: "Self") -> "List[_5113.SynchroniserCompoundModalAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5117.TorqueConverterCompoundModalAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_5121.UnbalancedMassCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def worm_gear_sets(self: "Self") -> "List[_5125.WormGearSetCompoundModalAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5128.ZerolBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4847.AssemblyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.AssemblyModalAnalysis]
