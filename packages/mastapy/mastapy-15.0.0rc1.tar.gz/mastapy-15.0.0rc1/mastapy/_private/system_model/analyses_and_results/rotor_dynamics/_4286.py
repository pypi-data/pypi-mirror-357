...
TLinearMeasurement = TypeVar("TLinearMeasurement", bound="_1797.MeasurementBase")
TAngularMeasurement = TypeVar("TAngularMeasurement", bound="_1797.MeasurementBase")
...
class _Cast_ShaftComplexShape:
    ...
    @property
    def shaft_forced_complex_shape(self: "CastSelf") -> "_4287.ShaftForcedComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4287,
        )

        return self.__parent__._cast(_4287.ShaftForcedComplexShape)

    @property
    def shaft_modal_complex_shape(self: "CastSelf") -> "_4288.ShaftModalComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4288,
        )

        return self.__parent__._cast(_4288.ShaftModalComplexShape)
