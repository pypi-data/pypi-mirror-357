...
class ShaftSectionSystemDeflection(_133.BarBase):
    """ShaftSectionSystemDeflection
    ...
    @property
    @exception_bridge
    def left_end(self: "Self") -> "_3043.ShaftSectionEndResultsSystemDeflection":
    ...
    @property
    @exception_bridge
    def right_end(self: "Self") -> "_3043.ShaftSectionEndResultsSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSectionEndResultsSystemDeflection
