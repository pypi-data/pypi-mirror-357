...
class _Cast_CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtASpeed:
    ...
    def coaxial_connection_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_5549.CoaxialConnectionCompoundModalAnalysisAtASpeed":
    ...
    def shaft_to_mountable_component_connection_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_5624.ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed":
        from mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import (
            _5624,
        )
    ...
    def abstract_shaft_to_mountable_component_connection_compound_modal_analysis_at_a_speed(
        ...
        "_5528.AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed"
    ):
        from mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import (
            _5528,
        )
...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtASpeed(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5437.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed]":
