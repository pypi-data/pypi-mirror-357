...
class _Cast_RootAssemblyCompoundModalAnalysisAtASpeed:
    ...
    def assembly_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_5532.AssemblyCompoundModalAnalysisAtASpeed":
        return self.__parent__._cast(_5532.AssemblyCompoundModalAnalysisAtASpeed)
...
class RootAssemblyCompoundModalAnalysisAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5490.RootAssemblyModalAnalysisAtASpeed]":
