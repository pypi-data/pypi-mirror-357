...
class AssemblyCompoundParametricStudyTool(
    ...
    def all_duty_cycle_results(
        self: "Self",
    ) -> "_4613.DutyCycleResultsForAllComponents":
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7682.AssemblyLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4566.AssemblyParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_4717.BearingCompoundParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def belt_drives(self: "Self") -> "List[_4719.BeltDriveCompoundParametricStudyTool]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_4722.BevelDifferentialGearSetCompoundParametricStudyTool]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_4729.BoltedJointCompoundParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_4728.BoltCompoundParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_4750.CVTCompoundParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_4730.ClutchCompoundParametricStudyTool]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_4735.ConceptCouplingCompoundParametricStudyTool]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_4740.ConceptGearSetCompoundParametricStudyTool]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_4752.CycloidalAssemblyCompoundParametricStudyTool]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_4754.CycloidalDiscCompoundParametricStudyTool]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_4758.CylindricalGearSetCompoundParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_4765.FEPartCompoundParametricStudyTool]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_4764.FaceGearSetCompoundParametricStudyTool]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_4766.FlexiblePinAssemblyCompoundParametricStudyTool]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4773.HypoidGearSetCompoundParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4780.KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4783.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_4784.MassDiscCompoundParametricStudyTool]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_4785.MeasurementComponentCompoundParametricStudyTool]":
    ...
    def microphones(
        self: "Self",
    ) -> "List[_4787.MicrophoneCompoundParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_4789.OilSealCompoundParametricStudyTool]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_4791.PartToPartShearCouplingCompoundParametricStudyTool]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_4796.PlanetCarrierCompoundParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def point_loads(self: "Self") -> "List[_4797.PointLoadCompoundParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def power_loads(self: "Self") -> "List[_4798.PowerLoadCompoundParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_4800.RingPinsCompoundParametricStudyTool]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_4802.RollingRingAssemblyCompoundParametricStudyTool]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_4807.ShaftHubConnectionCompoundParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_4806.ShaftCompoundParametricStudyTool]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4812.SpiralBevelGearSetCompoundParametricStudyTool]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_4813.SpringDamperCompoundParametricStudyTool]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_4818.StraightBevelDiffGearSetCompoundParametricStudyTool]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4821.StraightBevelGearSetCompoundParametricStudyTool]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_4824.SynchroniserCompoundParametricStudyTool]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_4828.TorqueConverterCompoundParametricStudyTool]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_4832.UnbalancedMassCompoundParametricStudyTool]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_4836.WormGearSetCompoundParametricStudyTool]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4839.ZerolBevelGearSetCompoundParametricStudyTool]":
