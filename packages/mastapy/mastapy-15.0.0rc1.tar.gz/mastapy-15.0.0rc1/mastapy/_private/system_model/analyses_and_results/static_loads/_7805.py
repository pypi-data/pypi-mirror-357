...
from mastapy._private.system_model.analyses_and_results.static_loads import _7844, _7848
...
class PowerLoadLoadCase(_7848.VirtualComponentLoadCase):
    """PowerLoadLoadCase
    ...
    @enforce_parameter_types
    def system_deflection_torque_method(
        self: "Self", value: "_7844.TorqueSpecificationForSystemDeflection"
    ) -> None:
    ...
    @property
    @exception_bridge
    def wheel_slip_model(self: "Self") -> "_5800.WheelSlipType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5800",
            "WheelSlipType",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def wheel_slip_model(self: "Self", value: "_5800.WheelSlipType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.WheelSlipType",
        )
