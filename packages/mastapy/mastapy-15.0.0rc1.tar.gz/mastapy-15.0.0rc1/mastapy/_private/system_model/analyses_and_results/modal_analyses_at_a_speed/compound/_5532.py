...
class _Cast_AssemblyCompoundModalAnalysisAtASpeed:
    ...
    def root_assembly_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_5621.RootAssemblyCompoundModalAnalysisAtASpeed":
        from mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import (
            _5621,
        )

        return self.__parent__._cast(_5621.RootAssemblyCompoundModalAnalysisAtASpeed)
...
class AssemblyCompoundModalAnalysisAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5400.AssemblyModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def bearings(self: "Self") -> "List[_5533.BearingCompoundModalAnalysisAtASpeed]":
    ...
    def belt_drives(
        self: "Self",
    ) -> "List[_5535.BeltDriveCompoundModalAnalysisAtASpeed]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_5538.BevelDifferentialGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_5545.BoltedJointCompoundModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def bolts(self: "Self") -> "List[_5544.BoltCompoundModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def cv_ts(self: "Self") -> "List[_5566.CVTCompoundModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def clutches(self: "Self") -> "List[_5546.ClutchCompoundModalAnalysisAtASpeed]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5551.ConceptCouplingCompoundModalAnalysisAtASpeed]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_5556.ConceptGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5568.CycloidalAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_5570.CycloidalDiscCompoundModalAnalysisAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5574.CylindricalGearSetCompoundModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def fe_parts(self: "Self") -> "List[_5581.FEPartCompoundModalAnalysisAtASpeed]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_5580.FaceGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5582.FlexiblePinAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5589.HypoidGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        ...
        "List[_5596.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed]"
    ):
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5599.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def mass_discs(self: "Self") -> "List[_5600.MassDiscCompoundModalAnalysisAtASpeed]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5601.MeasurementComponentCompoundModalAnalysisAtASpeed]":
    ...
    def microphones(
        self: "Self",
    ) -> "List[_5603.MicrophoneCompoundModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def oil_seals(self: "Self") -> "List[_5605.OilSealCompoundModalAnalysisAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5607.PartToPartShearCouplingCompoundModalAnalysisAtASpeed]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_5612.PlanetCarrierCompoundModalAnalysisAtASpeed]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_5613.PointLoadCompoundModalAnalysisAtASpeed]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_5614.PowerLoadCompoundModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def ring_pins(self: "Self") -> "List[_5616.RingPinsCompoundModalAnalysisAtASpeed]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5618.RollingRingAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5623.ShaftHubConnectionCompoundModalAnalysisAtASpeed]":
    ...
    @property
    @exception_bridge
    def shafts(self: "Self") -> "List[_5622.ShaftCompoundModalAnalysisAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5628.SpiralBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_5629.SpringDamperCompoundModalAnalysisAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5634.StraightBevelDiffGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5637.StraightBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_5640.SynchroniserCompoundModalAnalysisAtASpeed]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5644.TorqueConverterCompoundModalAnalysisAtASpeed]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_5648.UnbalancedMassCompoundModalAnalysisAtASpeed]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_5652.WormGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5655.ZerolBevelGearSetCompoundModalAnalysisAtASpeed]":
