...
class MassDiscCompoundSystemDeflection(_3218.VirtualComponentCompoundSystemDeflection):
    """MassDiscCompoundSystemDeflection
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2688.MassDisc":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3018.MassDiscSystemDeflection]":
