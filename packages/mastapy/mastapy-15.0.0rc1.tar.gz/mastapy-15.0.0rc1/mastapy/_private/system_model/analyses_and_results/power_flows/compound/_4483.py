...
class FaceGearSetCompoundPowerFlow(_4488.GearSetCompoundPowerFlow):
    """FaceGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4347.FaceGearSetPowerFlow]":
    ...
    def face_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4481.FaceGearCompoundPowerFlow]":
    ...
    def face_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4482.FaceGearMeshCompoundPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4347.FaceGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearSetPowerFlow]
