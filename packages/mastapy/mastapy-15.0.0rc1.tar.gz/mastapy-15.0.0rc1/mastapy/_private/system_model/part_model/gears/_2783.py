...
class StraightBevelGear(_2754.BevelGear):
    """StraightBevelGear
    ...
    @property
    @exception_bridge
    def bevel_gear_design(self: "Self") -> "_1065.StraightBevelGearDesign":
    ...
    @property
    @exception_bridge
    def straight_bevel_gear_design(self: "Self") -> "_1065.StraightBevelGearDesign":
        """mastapy.gears.gear_designs.straight_bevel.StraightBevelGearDesign
