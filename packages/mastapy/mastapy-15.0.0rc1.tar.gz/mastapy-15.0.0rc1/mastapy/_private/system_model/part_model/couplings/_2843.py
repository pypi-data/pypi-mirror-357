...
from mastapy._private.system_model.part_model.couplings import _2842
...
class SplinePitchErrorOptions(_0.APIBase):
    ...
    def pitch_error_input_type(
        self: "Self",
        value: "Union[_2842.SplinePitchErrorInputType, Tuple[_2842.SplinePitchErrorInputType, bool]]",
    ) -> None:
    ...
    @property
    @exception_bridge
    def pitch_error_options_left_flank(self: "Self") -> "_2828.PitchErrorFlankOptions":
    ...
    @property
    @exception_bridge
    def pitch_error_options_right_flank(self: "Self") -> "_2828.PitchErrorFlankOptions":
        """mastapy.system_model.part_model.couplings.PitchErrorFlankOptions
    ...
    @property
    @exception_bridge
    def pitch_error_flank_options(self: "Self") -> "List[_2828.PitchErrorFlankOptions]":
