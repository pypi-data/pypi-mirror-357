...
class Clutch(_2821.Coupling):
    ...
    @property
    @exception_bridge
    def clutch_type(self: "Self") -> "_2817.ClutchType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.couplings._2817", "ClutchType"
        )(value)

    @clutch_type.setter
    @exception_bridge
    @enforce_parameter_types
    def clutch_type(self: "Self", value: "_2817.ClutchType") -> None:
    ...
    @property
    @exception_bridge
    def spring_type(self: "Self") -> "_5683.ClutchSpringType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5683",
            "ClutchSpringType",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def spring_type(self: "Self", value: "_5683.ClutchSpringType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ClutchSpringType",
        )
