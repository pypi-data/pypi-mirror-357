...
from mastapy._private.system_model import _2415
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2880, _2881
...
class _Cast_ResultSurfaceOptions:
    ...
    @property
    def result_plane_options(self: "CastSelf") -> "_2880.ResultPlaneOptions":
        from mastapy._private.system_model.part_model.acoustics import _2880

        return self.__parent__._cast(_2880.ResultPlaneOptions)

    @property
    def result_sphere_options(self: "CastSelf") -> "_2881.ResultSphereOptions":
        from mastapy._private.system_model.part_model.acoustics import _2881

        return self.__parent__._cast(_2881.ResultSphereOptions)
...
class ResultSurfaceOptions(_0.APIBase):
    ...
    @exception_bridge
    @enforce_parameter_types
    def reference_component(self: "Self", value: "_2669.Component") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def reference_component_type(self: "Self", value: "_2415.DesignEntityId") -> None:
