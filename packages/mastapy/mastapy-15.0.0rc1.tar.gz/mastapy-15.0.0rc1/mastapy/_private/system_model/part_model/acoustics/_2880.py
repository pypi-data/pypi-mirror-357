...
from mastapy._private.system_model.part_model.acoustics import _2883
...
class _Cast_ResultPlaneOptions:
    ...
    @property
    def result_surface_options(self: "CastSelf") -> "_2883.ResultSurfaceOptions":
        return self.__parent__._cast(_2883.ResultSurfaceOptions)
...
class ResultPlaneOptions(_2883.ResultSurfaceOptions):
    """ResultPlaneOptions
