...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2874, _2875, _2883
...
T = TypeVar("T", bound="_2883.ResultSurfaceOptions")
...
class _Cast_MeshedResultSurface:
    ...
    @property
    def meshed_result_surface_base(self: "CastSelf") -> "_2877.MeshedResultSurfaceBase":
        return self.__parent__._cast(_2877.MeshedResultSurfaceBase)

    @property
    def meshed_result_plane(self: "CastSelf") -> "_2874.MeshedResultPlane":
        from mastapy._private.system_model.part_model.acoustics import _2874

        return self.__parent__._cast(_2874.MeshedResultPlane)

    @property
    def meshed_result_sphere(self: "CastSelf") -> "_2875.MeshedResultSphere":
        from mastapy._private.system_model.part_model.acoustics import _2875

        return self.__parent__._cast(_2875.MeshedResultSphere)
...
class MeshedResultSurface(_2877.MeshedResultSurfaceBase, Generic[T]):
    """MeshedResultSurface
