...
from mastapy._private.system_model.part_model.import_from_cad import _2726
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.import_from_cad import _2728, _2729
...
class _Cast_PlanetShaftFromCAD:
    ...
    @property
    def abstract_shaft_from_cad(self: "CastSelf") -> "_2726.AbstractShaftFromCAD":
        return self.__parent__._cast(_2726.AbstractShaftFromCAD)
...
class PlanetShaftFromCAD(_2726.AbstractShaftFromCAD):
    """PlanetShaftFromCAD
