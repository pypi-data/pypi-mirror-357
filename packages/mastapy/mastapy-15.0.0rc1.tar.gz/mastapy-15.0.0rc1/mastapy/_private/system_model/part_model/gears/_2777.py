...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2760, _2762, _2767
...
class PlanetaryGearSet(_2761.CylindricalGearSet):
    """PlanetaryGearSet
    ...
    @property
    @exception_bridge
    def annuluses(self: "Self") -> "List[_2760.CylindricalGear]":
    ...
    @property
    @exception_bridge
    def planets(self: "Self") -> "List[_2762.CylindricalPlanetGear]":
    ...
    @property
    @exception_bridge
    def suns(self: "Self") -> "List[_2760.CylindricalGear]":
        """List[mastapy.system_model.part_model.gears.CylindricalGear]
    ...
    @exception_bridge
    def add_annulus(self: "Self") -> "_2760.CylindricalGear":
    ...
    @exception_bridge
    def add_planet(self: "Self") -> "_2760.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear"""
    ...
    @exception_bridge
    def add_sun(self: "Self") -> "_2760.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear"""
