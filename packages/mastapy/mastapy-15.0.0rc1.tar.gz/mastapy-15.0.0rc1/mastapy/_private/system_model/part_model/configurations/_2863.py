...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2745, _2746
...
TPart = TypeVar("TPart", bound="_2696.Part")
...
class _Cast_PartDetailSelection:
    ...
    def active_cylindrical_gear_set_design_selection(
        self: "CastSelf",
    ) -> "_2745.ActiveCylindricalGearSetDesignSelection":
        from mastapy._private.system_model.part_model.gears import _2745

        return self.__parent__._cast(_2745.ActiveCylindricalGearSetDesignSelection)

    @property
    def active_gear_set_design_selection(
        self: "CastSelf",
    ) -> "_2746.ActiveGearSetDesignSelection":
        from mastapy._private.system_model.part_model.gears import _2746

        return self.__parent__._cast(_2746.ActiveGearSetDesignSelection)

    @property
    def active_fe_substructure_selection(
        self: "CastSelf",
    ) -> "_2855.ActiveFESubstructureSelection":
        from mastapy._private.system_model.part_model.configurations import _2855

        return self.__parent__._cast(_2855.ActiveFESubstructureSelection)

    @property
    def active_shaft_design_selection(
        self: "CastSelf",
    ) -> "_2857.ActiveShaftDesignSelection":
        from mastapy._private.system_model.part_model.configurations import _2857

        return self.__parent__._cast(_2857.ActiveShaftDesignSelection)

    @property
    def bearing_detail_selection(self: "CastSelf") -> "_2860.BearingDetailSelection":
        from mastapy._private.system_model.part_model.configurations import _2860

        return self.__parent__._cast(_2860.BearingDetailSelection)
