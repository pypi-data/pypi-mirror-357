...
class ZerolBevelGearSet(_2755.BevelGearSet):
    """ZerolBevelGearSet
    ...
    @property
    @exception_bridge
    def conical_gear_set_design(self: "Self") -> "_1058.ZerolBevelGearSetDesign":
    ...
    @property
    @exception_bridge
    def zerol_bevel_gear_set_design(self: "Self") -> "_1058.ZerolBevelGearSetDesign":
        """mastapy.gears.gear_designs.zerol_bevel.ZerolBevelGearSetDesign
    ...
    @property
    @exception_bridge
    def zerol_bevel_gears(self: "Self") -> "List[_2789.ZerolBevelGear]":
    ...
    @property
    @exception_bridge
    def zerol_bevel_meshes(self: "Self") -> "List[_2552.ZerolBevelGearMesh]":
