...
from mastapy._private.system_model.part_model.couplings import _2831, _2834, _2835
...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.interference_fits import _1630
    from mastapy._private.detailed_rigid_connectors.splines import _1595, _1600
...
class ShaftHubConnection(_2672.Connector):
    """ShaftHubConnection
    ...
    @property
    @exception_bridge
    def spline_type(self: "Self") -> "_1595.SplineDesignTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.splines._1595",
            "SplineDesignTypes",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def spline_type(self: "Self", value: "_1595.SplineDesignTypes") -> None:
    ...
    @enforce_parameter_types
    def stiffness_type(
        self: "Self", value: "_2831.RigidConnectorStiffnessType"
    ) -> None:
    ...
    @property
    @exception_bridge
    def tilt_stiffness_type(self: "Self") -> "_2832.RigidConnectorTiltStiffnessTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.couplings._2832",
    ...
    def tilt_stiffness_type(
        self: "Self", value: "_2832.RigidConnectorTiltStiffnessTypes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.RigidConnectorTiltStiffnessTypes",
    ...
    @enforce_parameter_types
    def tooth_spacing_type(
        self: "Self", value: "_2834.RigidConnectorToothSpacingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @exception_bridge
    @enforce_parameter_types
    def type_(self: "Self", value: "_2835.RigidConnectorTypes") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    @exception_bridge
    def interference_fit_design(self: "Self") -> "_1630.InterferenceFitDesign":
    ...
    @property
    @exception_bridge
    def left_flank_lead_relief(self: "Self") -> "_2841.SplineLeadRelief":
    ...
    @property
    @exception_bridge
    def major_fit_options(self: "Self") -> "_2839.SplineFitOptions":
    ...
    @property
    @exception_bridge
    def minor_fit_options(self: "Self") -> "_2839.SplineFitOptions":
        """mastapy.system_model.part_model.couplings.SplineFitOptions
    ...
    @property
    @exception_bridge
    def right_flank_lead_relief(self: "Self") -> "_2841.SplineLeadRelief":
        """mastapy.system_model.part_model.couplings.SplineLeadRelief
    ...
    @property
    @exception_bridge
    def spline_joint_design(self: "Self") -> "_1600.SplineJointDesign":
    ...
    @property
    @exception_bridge
    def spline_pitch_error_options(self: "Self") -> "_2843.SplinePitchErrorOptions":
    ...
    @property
    @exception_bridge
    def fit_options(self: "Self") -> "List[_2839.SplineFitOptions]":
    ...
    @property
    @exception_bridge
    def lead_reliefs(self: "Self") -> "List[_2841.SplineLeadRelief]":
    ...
    def spline_half_manufacturing_errors(
        self: "Self",
    ) -> "List[_2840.SplineHalfManufacturingError]":
    ...
    def tooth_locations_external_spline_half(
        self: "Self",
    ) -> "List[_2833.RigidConnectorToothLocation]":
