...
from mastapy._private.bearings.bearing_results import _2169, _2170
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2684, _2695
...
class _Cast_BearingRaceMountingOptions:
    ...
    def inner_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2684.InnerBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2684

        return self.__parent__._cast(_2684.InnerBearingRaceMountingOptions)

    @property
    def outer_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2695.OuterBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2695

        return self.__parent__._cast(_2695.OuterBearingRaceMountingOptions)
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    def axial_mounting(self: "Self", value: "_2169.RaceAxialMountingType") -> None:
    ...
    @enforce_parameter_types
    def simple_radial_mounting(
        self: "Self", value: "_2170.RaceRadialMountingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    @exception_bridge
    def mounting_sleeve_material(self: "Self") -> "_332.BearingMaterial":
