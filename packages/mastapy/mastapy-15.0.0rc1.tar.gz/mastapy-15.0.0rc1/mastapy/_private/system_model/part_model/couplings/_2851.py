...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2852, _2854
...
class TorqueConverter(_2821.Coupling):
    """TorqueConverter
    ...
    @property
    @exception_bridge
    def pump(self: "Self") -> "_2852.TorqueConverterPump":
    ...
    @property
    @exception_bridge
    def turbine(self: "Self") -> "_2854.TorqueConverterTurbine":
