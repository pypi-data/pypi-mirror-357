...
class AcousticAnalysisOptions(_0.APIBase):
    ...
    @property
    @exception_bridge
    def initial_guess(self: "Self") -> "_7661.InitialGuessOption":
    ...
    @exception_bridge
    @enforce_parameter_types
    def initial_guess(self: "Self", value: "_7661.InitialGuessOption") -> None:
    ...
    @property
    @exception_bridge
    def m2l_cache_type(self: "Self") -> "_7662.M2LHfCacheType":
    ...
    @exception_bridge
    @enforce_parameter_types
    def m2l_cache_type(self: "Self", value: "_7662.M2LHfCacheType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.M2LHfCacheType",
        )
    ...
    def near_field_integrals_cache_type(
        self: "Self",
    ) -> "_7663.NearFieldIntegralsCacheType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7663",
    ...
    @enforce_parameter_types
    def near_field_integrals_cache_type(
        self: "Self", value: "_7663.NearFieldIntegralsCacheType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.NearFieldIntegralsCacheType",
    ...
    @property
    @exception_bridge
    def octree_creation_method(self: "Self") -> "_7664.OctreeCreationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7664",
    ...
    def octree_creation_method(
        self: "Self", value: "_7664.OctreeCreationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.OctreeCreationMethod",
    ...
    @property
    @exception_bridge
    def preconditioner(self: "Self") -> "_7657.AcousticPreconditionerType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7657",
    ...
    @exception_bridge
    @enforce_parameter_types
    def preconditioner(self: "Self", value: "_7657.AcousticPreconditionerType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.AcousticAnalyses.AcousticPreconditionerType",
        )
