...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2760, _2765
...
class WindageLossCalculationParametersForCurvedSurfaceOfSection(_0.APIBase):
    ...
    @property
    @exception_bridge
    def has_mounted_cylindrical_gear(self: "Self") -> "bool":
        """bool

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "HasMountedCylindricalGear")
    ...
    @property
    @exception_bridge
    def has_mounted_gear(self: "Self") -> "bool":
        """bool

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "HasMountedGear")
    ...
    @property
    @exception_bridge
    def mounted_cylindrical_gear(self: "Self") -> "_2760.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "MountedCylindricalGear")
    ...
    @property
    @exception_bridge
    def mounted_gear(self: "Self") -> "_2765.Gear":
        """mastapy.system_model.part_model.gears.Gear

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "MountedGear")
