...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2721, _2725
...
class ConcentricPartGroup(_2719.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    def parallel_groups(
        self: "Self",
    ) -> "List[_2721.ConcentricPartGroupParallelToThis]":
