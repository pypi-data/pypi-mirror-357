...
class _Cast_RadialInternalClearanceTolerance:
    ...
    def internal_clearance_tolerance(
        self: "CastSelf",
    ) -> "_2685.InternalClearanceTolerance":
        return self.__parent__._cast(_2685.InternalClearanceTolerance)
...
class RadialInternalClearanceTolerance(_2685.InternalClearanceTolerance):
    """RadialInternalClearanceTolerance
