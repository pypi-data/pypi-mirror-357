...
class SystemOptimiserDetails(_0.APIBase):
    ...
    def criteria_for_selecting_configurations_to_keep(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.load_case_groups._5957",
    ...
    @enforce_parameter_types
    def criteria_for_selecting_configurations_to_keep(
        self: "Self", value: "_5957.SystemOptimiserTargets"
    ) -> None:
    ...
    def gear_set_optimisation(
        self: "Self",
    ) -> "_5956.SystemOptimiserGearSetOptimisation":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.load_case_groups._5956",
    ...
    @enforce_parameter_types
    def gear_set_optimisation(
        self: "Self", value: "_5956.SystemOptimiserGearSetOptimisation"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.LoadCaseGroups.SystemOptimiserGearSetOptimisation",
