...
class EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing]",
    ) -> "_2705.ShaftDiameterModificationDueToRollingBearingRing":
        ...
        Returns:
            _2705.ShaftDiameterModificationDueToRollingBearingRing
        """
        return _2705.ShaftDiameterModificationDueToRollingBearingRing
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2705.ShaftDiameterModificationDueToRollingBearingRing.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2705.ShaftDiameterModificationDueToRollingBearingRing]":
