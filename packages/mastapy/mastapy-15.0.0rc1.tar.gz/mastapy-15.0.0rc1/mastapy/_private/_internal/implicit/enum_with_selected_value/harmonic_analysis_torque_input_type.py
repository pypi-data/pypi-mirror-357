...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisTorqueInputType]",
    ) -> "_6057.HarmonicAnalysisTorqueInputType":
        ...
        Returns:
            _6057.HarmonicAnalysisTorqueInputType
        """
        return _6057.HarmonicAnalysisTorqueInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _6057.HarmonicAnalysisTorqueInputType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6057.HarmonicAnalysisTorqueInputType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_6057.HarmonicAnalysisTorqueInputType]":
