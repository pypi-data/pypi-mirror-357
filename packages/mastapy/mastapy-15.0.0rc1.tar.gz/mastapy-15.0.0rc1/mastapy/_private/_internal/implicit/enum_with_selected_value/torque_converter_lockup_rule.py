...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueConverterLockupRule]",
    ) -> "_5793.TorqueConverterLockupRule":
        ...
        Returns:
            _5793.TorqueConverterLockupRule
        """
        return _5793.TorqueConverterLockupRule
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5793.TorqueConverterLockupRule.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5793.TorqueConverterLockupRule":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_5793.TorqueConverterLockupRule]":
