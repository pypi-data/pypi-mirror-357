...
class EnumWithSelectedValue_ProfileToothDrawingMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ProfileToothDrawingMethod]",
    ) -> "_2778.ProfileToothDrawingMethod":
        ...
        Returns:
            _2778.ProfileToothDrawingMethod
        """
        return _2778.ProfileToothDrawingMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2778.ProfileToothDrawingMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2778.ProfileToothDrawingMethod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2778.ProfileToothDrawingMethod]":
