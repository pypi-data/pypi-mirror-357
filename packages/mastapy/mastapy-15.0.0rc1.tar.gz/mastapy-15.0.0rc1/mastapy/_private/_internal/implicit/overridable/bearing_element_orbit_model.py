...
class Overridable_BearingElementOrbitModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_5665.BearingElementOrbitModel":
        ...
        Returns:
            _5665.BearingElementOrbitModel
        """
        return _5665.BearingElementOrbitModel
    ...
    def implicit_type(cls: "Type[Overridable_BearingElementOrbitModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5665.BearingElementOrbitModel.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_5665.BearingElementOrbitModel":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_5665.BearingElementOrbitModel":
        """mastapy.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_5665.BearingElementOrbitModel":
        """mastapy.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
