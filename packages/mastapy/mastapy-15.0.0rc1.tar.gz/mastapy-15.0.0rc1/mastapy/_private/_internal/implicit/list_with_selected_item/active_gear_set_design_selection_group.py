...
class ListWithSelectedItem_ActiveGearSetDesignSelectionGroup(
    _2747.ActiveGearSetDesignSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2747.ActiveGearSetDesignSelectionGroup.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2747.ActiveGearSetDesignSelectionGroup":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2747.ActiveGearSetDesignSelectionGroup]":
