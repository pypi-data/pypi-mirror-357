...
class ListWithSelectedItem_AbstractPeriodicExcitationDetail(
    _5966.AbstractPeriodicExcitationDetail, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5966.AbstractPeriodicExcitationDetail.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5966.AbstractPeriodicExcitationDetail":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5966.AbstractPeriodicExcitationDetail]":
