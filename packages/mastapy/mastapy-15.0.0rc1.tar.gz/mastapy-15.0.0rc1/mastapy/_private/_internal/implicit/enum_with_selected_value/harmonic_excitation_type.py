...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7761.HarmonicExcitationType
        """
        return _7761.HarmonicExcitationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7761.HarmonicExcitationType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_7761.HarmonicExcitationType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_7761.HarmonicExcitationType]":
