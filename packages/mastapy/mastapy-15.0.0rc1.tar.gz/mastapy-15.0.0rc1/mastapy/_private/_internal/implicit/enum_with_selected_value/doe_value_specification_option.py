...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DoeValueSpecificationOption]",
    ) -> "_4612.DoeValueSpecificationOption":
        ...
        Returns:
            _4612.DoeValueSpecificationOption
        """
        return _4612.DoeValueSpecificationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4612.DoeValueSpecificationOption.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_4612.DoeValueSpecificationOption":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_4612.DoeValueSpecificationOption]":
