...
class ListWithSelectedItem_DutyCycle(_5951.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DutyCycle]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5951.DutyCycle.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5951.DutyCycle":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_5951.DutyCycle]":
