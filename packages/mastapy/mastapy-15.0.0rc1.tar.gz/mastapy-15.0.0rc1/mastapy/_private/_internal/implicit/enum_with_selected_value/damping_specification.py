...
class EnumWithSelectedValue_DampingSpecification(
    ...
    def wrapped_type(
        ...
        Returns:
            _6018.DampingSpecification
        """
        return _6018.DampingSpecification
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DampingSpecification]") -> "Any":
        ...
        Returns:
            Any
        """
        return _6018.DampingSpecification.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6018.DampingSpecification":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_6018.DampingSpecification]":
