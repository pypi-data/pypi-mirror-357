...
#test functions
from rl_with_panda_gym.test_models.panda_reach_test.test_dqn_single_network import test_dqn_single_network
from rl_with_panda_gym.test_models.panda_reach_test.test_dqn_double_network import test_dqn_double_network
from rl_with_panda_gym.test_models.panda_reach_test.test_reinforce import test_reinforce
from rl_with_panda_gym.test_models.panda_reach_test.test_reinforce_discrete import test_reinforce_discrete
...
def compare_test_results(new_test=False):
    num_episodes = 100
    models = ["DQN Single Net", "DQN Double Net",  "Reinforce Continuous","Reinforce Disc",]
    colors = sns.color_palette("colorblind")[:4]
    
    if new_test:   
        print('==TEST REINFORCE DISCRETE==')
        reward_rd, success_rd = test_reinforce_discrete(render=False, num_episodes=num_episodes)
        print('==TEST DQN DOUBLE NETWORK==')
        reward_dqn_tn, success_dqn_tn = test_dqn_double_network(render=False, num_episodes=num_episodes)
        print('==TEST DQN SINGLE NETWORK==')
        reward_dqn_sn, success_dqn_sn = test_dqn_single_network(render=False, num_episodes=num_episodes)
        print('==TEST REINFORCE==')
        reward_reinforce, success_reinforce = test_reinforce(render=False, num_episodes=num_episodes)
    else:
...
if __name__ == "__main__":
    ...
    compare_test_results(new_test=False)