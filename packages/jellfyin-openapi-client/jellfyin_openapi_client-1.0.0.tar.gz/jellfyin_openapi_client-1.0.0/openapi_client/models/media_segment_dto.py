...
class MediaSegmentDto(BaseModel):
    ...
    type: Optional[MediaSegmentType] = Field(default=MediaSegmentType.UNKNOWN, description="Defines the types of content an individual Jellyfin.Database.Implementations.Entities.MediaSegment represents.", alias="Type")
