...
class InstanceControlApi(object):
    ...
    def check_for_and_fix_inconsistencies_with_http_info(self, inst_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/InstanceControlRest/consistency-check/{instId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def resume_instance_with_http_info(self, inst_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/InstanceControlRest/continuation/simple/{instId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def start_instance(self, body, templ_id, **kwargs):  # noqa: E501
        """start_instance  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_instance(body, templ_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param InstanceCreationData body: (required)
        :param str templ_id: (required)
        :return: InstIdPair
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.start_instance_with_http_info(body, templ_id, **kwargs)  # noqa: E501
        else:
            (data) = self.start_instance_with_http_info(body, templ_id, **kwargs)  # noqa: E501
            return data

    def start_instance_with_http_info(self, body, templ_id, **kwargs):  # noqa: E501
        """start_instance  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_instance_with_http_info(body, templ_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('templ_id' not in params or
                params['templ_id'] is None):
            raise ValueError("Missing the required parameter `templ_id` when calling `start_instance`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='InstIdPair',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def start_instance_callback(self, body, templ_id, **kwargs):  # noqa: E501
        """start_instance_callback  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_instance_callback(body, templ_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.start_instance_callback_with_http_info(body, templ_id, **kwargs)  # noqa: E501
        else:
            (data) = self.start_instance_callback_with_http_info(body, templ_id, **kwargs)  # noqa: E501
            return data

    def start_instance_callback_with_http_info(self, body, templ_id, **kwargs):  # noqa: E501
        """start_instance_callback  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_instance_callback_with_http_info(body, templ_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method start_instance_callback" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `start_instance_callback`")  # noqa: E501
        # verify the required parameter 'templ_id' is set
        if ('templ_id' not in params or
                params['templ_id'] is None):
            raise ValueError("Missing the required parameter `templ_id` when calling `start_instance_callback`")  # noqa: E501
    ...
    def start_instance_simple(self, templ_id, **kwargs):  # noqa: E501
        """start_instance_simple  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_instance_simple(templ_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.start_instance_simple_with_http_info(templ_id, **kwargs)  # noqa: E501
        else:
            (data) = self.start_instance_simple_with_http_info(templ_id, **kwargs)  # noqa: E501
            return data

    def start_instance_simple_with_http_info(self, templ_id, **kwargs):  # noqa: E501
        """start_instance_simple  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_instance_simple_with_http_info(templ_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method start_instance_simple" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'templ_id' is set
        if ('templ_id' not in params or
                params['templ_id'] is None):
            raise ValueError("Missing the required parameter `templ_id` when calling `start_instance_simple`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/InstanceControlRest/instance-start/simple/{templId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def start_instance_sse(self, body, templ_id, **kwargs):  # noqa: E501
        """start_instance_sse  # noqa: E501

        You have to be registered to receive events via operation /sse. The events sent via SSE are JSON encoded ActivityStateNotification (or subclasses). Event names will be 'instance-finished', 'instance-suspended', 'instance-resumed', 'instance-failed', 'autostart-pending'. This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_instance_sse(body, templ_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.start_instance_sse_with_http_info(body, templ_id, **kwargs)  # noqa: E501
        else:
            (data) = self.start_instance_sse_with_http_info(body, templ_id, **kwargs)  # noqa: E501
            return data

    def start_instance_sse_with_http_info(self, body, templ_id, **kwargs):  # noqa: E501
        """start_instance_sse  # noqa: E501

        You have to be registered to receive events via operation /sse. The events sent via SSE are JSON encoded ActivityStateNotification (or subclasses). Event names will be 'instance-finished', 'instance-suspended', 'instance-resumed', 'instance-failed', 'autostart-pending'. This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_instance_sse_with_http_info(body, templ_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method start_instance_sse" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `start_instance_sse`")  # noqa: E501
        # verify the required parameter 'templ_id' is set
        if ('templ_id' not in params or
                params['templ_id'] is None):
            raise ValueError("Missing the required parameter `templ_id` when calling `start_instance_sse`")  # noqa: E501
    ...
    def stop_and_abort_instance_with_http_info(self, inst_id, error_code, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/InstanceControlRest/abortion/{instId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def suspend_instance_with_http_info(self, inst_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/InstanceControlRest/suspension/{instId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
