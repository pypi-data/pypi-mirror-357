...
class TestInstanceControlApi(unittest.TestCase):
    ...
    def test_start_instance_callback(self):
        """Test case for start_instance_callback

        """
        pass

    def test_start_instance_simple(self):
        """Test case for start_instance_simple

        """
        pass

    def test_start_instance_sse(self):
        """Test case for start_instance_sse
