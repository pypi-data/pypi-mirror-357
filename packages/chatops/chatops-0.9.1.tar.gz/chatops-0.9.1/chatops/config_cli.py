...
USER_CONFIG_FILE = Path.home() / ".chatops" / "config.yaml"
REPO_CONFIG_FILE = Path(__file__).resolve().parent.parent / "config.yaml"

DEFAULT_CONFIG_FILE = USER_CONFIG_FILE if USER_CONFIG_FILE.exists() else REPO_CONFIG_FILE
