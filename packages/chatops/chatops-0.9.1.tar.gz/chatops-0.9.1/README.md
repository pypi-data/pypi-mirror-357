...
Copy or symlink this file to ``~/.chatops/config.yaml`` to get started. If the
home directory file is missing, the CLI automatically falls back to the
repo-local sample. Then define environments in that file:
