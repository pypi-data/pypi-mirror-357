...
class TestHeartbeatRequestMetadata(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HeartbeatRequestMetadata:
        """Test HeartbeatRequestMetadata
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HeartbeatRequestMetadata`
        """
        model = HeartbeatRequestMetadata()
        if include_optional:
            return HeartbeatRequestMetadata(
    ...
    def testHeartbeatRequestMetadata(self):
        """Test HeartbeatRequestMetadata"""
