...
class DecoratorAgentMetadata(BaseModel):
    ...
    decorators: Annotated[list[DecoratorInfo], Field(min_length=1)] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "decorators": (
                    [DecoratorInfo.from_dict(_item) for _item in obj["decorators"]]
                    if obj.get("decorators") is not None
                    else None
                ),
            }
        )
