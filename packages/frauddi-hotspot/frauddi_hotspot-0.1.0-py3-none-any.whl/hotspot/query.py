...
class QueryBuilder:
    """Fluent interface for building complex queries for Hotspot analysis.

    Examples:
        # Simple query
        patterns = QueryBuilder(hotspot) \
            .field("country", "US") \
            .min_percentage(20) \
            .execute()
    ...
    def __init__(self, hotspot_instance):
        """Initialize QueryBuilder with a Hotspot instance.

        Args:
            hotspot_instance: Instance of Hotspot class

        """
        self.hotspot = hotspot_instance
        self.data_filters = {}
    ...
    def execute(self, data: List[Dict[str, Any]], fields: List[str]):
        ...
        # Execute the query
        return self.hotspot.find(data, fields, query=data_query, **pattern_kwargs)
    ...
    def analyze(self, data: List[Dict[str, Any]], fields: List[str]):
        ...
        return self.hotspot.analyze(data, fields, query=data_query, **pattern_kwargs)
    ...
    def copy(self):
        ...
        """
        new_builder = QueryBuilder(self.hotspot)
...
def create_fraud_query(hotspot_instance):
...
def create_business_query(hotspot_instance):
...
def create_data_quality_query(hotspot_instance):
