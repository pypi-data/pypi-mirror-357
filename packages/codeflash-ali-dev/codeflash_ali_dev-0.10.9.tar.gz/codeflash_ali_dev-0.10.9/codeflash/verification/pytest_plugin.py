...
class PytestPatches:
    def __init__(self) -> None:
        self.patches = []
        self.fixed_datetime = datetime(2024, 1, 1, 12, 0, 0, tzinfo=timezone.utc)
        self.fixed_uuid = UUID("12345678-1234-5678-9012-123456789012")
        self.fixed_random_state = 42

    def start_patches(self) -> None:
        # Patch time.time()
        time_patch = patch("time.time", return_value=1750771621)
        self.patches.append(time_patch.start())

        # Set random seed for consistency
        random.seed(self.fixed_random_state)
