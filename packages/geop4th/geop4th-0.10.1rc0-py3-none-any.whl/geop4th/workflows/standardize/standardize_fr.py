...
def bdalti(data):
    ...
    ds_list = []
    for f in filelist:
        ds_list.append(geo.load_any(os.path.join(data_folder, f), name = 'elev'))
        print(c)
        c += 1
        if c == 10:
    ...
    _, y_var = geo.main_space_dims(merged_ds)
    ...
    temp = geo.load_any(os.path.join(data_folder, filelist[0]), name = 'elev')
...
def sim2(data):
    ...
    ds = georef(ds, data_type = 'other', crs = 27572)
# =============================================================================
...
# =============================================================================
    ...
    for var in list(ds.data_vars): # batch_var: 
        ...
        if units_by_var[var][0] == 'mm':
            ds[var] = geo.convert_unit(ds[var], '/1000')
# =============================================================================
#             elif units_by_var[var][0] == '°C':
#                 ds[var] = convert_unit(ds[var], '+273.15')
# =============================================================================
        elif units_by_var[var][0] == 'J/cm2':
            # convert J/cm² (daily sum) to W/m²
            ds[var] = geo.convert_unit(ds[var], '/8.64')
