...
"x86_64\-linux-6\.11\.0\-1015\-azure" or
	die "Errno architecture (x86_64\-linux-6\.11\.0\-1015\-azure) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
