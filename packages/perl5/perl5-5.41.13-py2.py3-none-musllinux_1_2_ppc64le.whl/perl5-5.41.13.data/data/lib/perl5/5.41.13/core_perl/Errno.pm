...
"ppc64le\-linux-6\.11\.0\-1015\-azure" or
	die "Errno architecture (ppc64le\-linux-6\.11\.0\-1015\-azure) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
