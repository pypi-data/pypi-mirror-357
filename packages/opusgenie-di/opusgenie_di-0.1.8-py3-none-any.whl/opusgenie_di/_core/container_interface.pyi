import abc
from .._base import ComponentMetadataProtocol as ComponentMetadataProtocol, ComponentProviderProtocol as ComponentProviderProtocol, ComponentScope as ComponentScope
...
class ContainerInterface[T](ABC, metaclass=abc.ABCMeta):
    """
    ...
    def register(self, interface: type[TInterface], implementation: type[TImplementation] | None = None, *, scope: ComponentScope = ..., name: str | None = None, tags: dict[str, Any] | None = None, factory: Any = None) -> None:
        ...
        """
    @abstractmethod
    def register_provider(self, interface: type[TInterface], provider: ComponentProviderProtocol[TInterface], *, name: str | None = None, tags: dict[str, Any] | None = None) -> None:
        """
