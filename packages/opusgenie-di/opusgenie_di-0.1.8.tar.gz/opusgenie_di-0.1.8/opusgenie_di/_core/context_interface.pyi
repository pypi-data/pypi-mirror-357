...
class ContextInterface(ABC, metaclass=abc.ABCMeta):
    """
    ...
    def create_child_context(self, name: str) -> ContextInterface:
        ...
        """
    @abstractmethod
    def register_component(self, interface: type[TInterface], implementation: type[TInterface] | None = None, **kwargs: Any) -> None:
        """
