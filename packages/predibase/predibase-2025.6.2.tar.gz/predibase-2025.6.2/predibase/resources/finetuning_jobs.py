        ...
        for resp in self._client.listen_websocket(
            ...
            try:
                ...
                if (
                    ...
                    if metrics.data.train_metrics_accuracy:
                        table["train_accuracy"] = metrics.data.train_metrics_accuracy
                    if metrics.data.validation_metrics_accuracy:
                        table["validation_accuracy"] = metrics.data.validation_metrics_accuracy
                    table.next_row()
