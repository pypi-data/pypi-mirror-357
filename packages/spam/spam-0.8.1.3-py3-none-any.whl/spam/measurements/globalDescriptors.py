...
#
#         # angle
#         ang_tri[i,0]=numpy.acos(numpy.dot(v0[i,:]/l_edg[i,0], -v2[i,:]/l_edg[i,2]))
#         ang_tri[i,1]=numpy.acos(numpy.dot(-v0[i,:]/l_edg[i,0], v1[i,:]/l_edg[i,1]))
#         ang_tri[i,2]=numpy.pi-ang_tri[i,0]-ang_tri[i,1]
#
#         # incenter
...
#             if k==0:
#                 mc_vec=mc_vec+(v0[neib,:]/numpy.tan(ang_tri[neib,2])-v2[neib,:]/numpy.tan(ang_tri[neib,1]))
#             elif k==1:
#                 mc_vec=mc_vec+(v1[neib,:]/numpy.tan(ang_tri[neib,0])-v0[neib,:]/numpy.tan(ang_tri[neib,2]))
#             elif k==2:
#                 mc_vec=mc_vec+(v2[neib,:]/numpy.tan(ang_tri[neib,1])-v1[neib,:]/numpy.tan(ang_tri[neib,0]))
#
#             # A_mixed calculation
#             if (ang_tri[neib,k]>=numpy.pi/2.0):
#                 a_mixed[i]=a_mixed[i]+area_tri[neib]/2.0
#             else:
#                 if  any(ang >=numpy.pi/2.0 for ang in ang_tri[neib,:]):
...
#                             if ll==3:
#                                 ll=0
#                             sum=sum+(l_edg[neib,ll]**2/numpy.tan(ang_tri[neib,m]))
...
#
#         GC[i]=(2.0*numpy.pi-alf[i])/a_mixed[i]
#
