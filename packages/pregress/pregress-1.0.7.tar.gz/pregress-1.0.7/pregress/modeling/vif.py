...
def vif(formula=None, data=None, plot=False, xlab='Predictor', ylab='VIF Value', main='Variance Inflation Factors', ascending=True):
    ...
    if plot:
        barplot(data=vif_data.T, ylab=ylab, xlab=xlab, main=main)
