# $Id: stratos.py 79205 2025-06-24 18:39:14Z pomakis $
...
class DataStore:
    ...
    def addVectorLayerWithData(self, id: str,
                               ...
                               updateTiles: bool | None = None) -> Layer:
        ...
        Args:
            ...
            dataCoordSys: The coordinate system that the data is in (e.g.
                ...
                to auto-detect.
            nominalResM: The nominal resoution of this data in metres, or
    ...
    def removeLayer(self, layer: Layer | str) -> bool:
        ...
        done for data stores whose canBeManaged property is True.
        The layer is immediately removed from the Stratos Geospatial
        Data Server; there's no need to call Stratos.updateDataStore()
...
class Layer:
    ...
    def getMap(self, width: int | None = None, height: int | None = None,
               ...
               styleId: str | None = None) -> Image.Image:
        ...
        Args:
            ...
            styleId: The name/ID of the style to use, or None to use the
                default style.
        Returns:
    ...
    def getVectorFeatures(self, wgs84Extent: list[float] | None = None,
                          limit: int | None = None, offset: int = 0,
                          simplifyToScale: float | None = None
        ...
        Args:
            wgs84Extent: The WGS 84 Geographic spatial extent of the area
                of interest (expressed as [minLon, minLat, maxLon, maxLat]),
                or None to request the features of the entire layer.
        ...
        """
        itemsUrl = self.__collectionUrl + "/items"
        params = { "crs": "CRS:84" }
        if isinstance(wgs84Extent, list) and len(wgs84Extent) == 4:
            # Unfortunately, this encodes the commas.  Fortunately, our
            # server will accept bbox values with either encoded or unencoded
    ...
    def addVectorFeatures(self,
        ...
        not update the wgs84Extent propery of the `Layer` object.
        ...
        if isinstance(filePathsOrFeatureCollection, list):
            ...
            requestHeaders["Content-Type"] = "application/zip"
            response = requests.post(itemsUrl, headers=requestHeaders,
                params=params, data=zipFile)
            ServerException.raise_for_status(response)
    ...
    def addSourceImages(self, filePaths: list[str],
        ...
        Also note that this does not update the wgs84Extent propery of
        the `Layer` object.
    ...
    def removeSourceImages(self, sourceImages: list[SourceImage|str],
        ...
        that this does not update the wgs84Extent propery of the
        `Layer` object.
