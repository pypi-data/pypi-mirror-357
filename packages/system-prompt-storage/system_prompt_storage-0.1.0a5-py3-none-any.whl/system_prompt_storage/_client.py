...
class SystemPromptStorage(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous SystemPromptStorage client instance.

        This automatically infers the `api_key` argument from the `SYSTEM_PROMPT_STORAGE_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("SYSTEM_PROMPT_STORAGE_API_KEY")
        self.api_key = api_key

        if base_url is None:
            base_url = os.environ.get("SYSTEM_PROMPT_STORAGE_BASE_URL")
        if base_url is None:
            base_url = f"https://api.cruzluna.dev"
...
class AsyncSystemPromptStorage(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncSystemPromptStorage client instance.
...
AsyncClient = AsyncSystemPromptStorage
