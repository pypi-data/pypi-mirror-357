...
# GUI setup
app = tk.Tk()
app.title("Amount Extractor v1 by CRYPT_ATU")
...
header = tk.Label(app, text="💸 Amount Extractor v1 by CRYPT_ATU", font=("Helvetica", 20, "bold"), fg="lime", bg="#1e1e1e", image=header_logo)
