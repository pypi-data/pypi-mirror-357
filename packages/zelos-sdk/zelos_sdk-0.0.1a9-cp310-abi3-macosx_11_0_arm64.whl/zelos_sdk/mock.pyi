...
class MockBmsSource:
    ...
    Examples:
        ...
        >>> bms_source.generate_at(1234567890)  # Generate data at specific time
    """
...
class MockDcdcSource:
    ...
    Examples:
        ...
        >>> dcdc_source.generate_at(1234567890)  # Generate data at specific time
    """
    def __new__(cls,sender = ...): ...
    def generate(self) -> None:
        r"""
...
class MockInverterSource:
    ...
    Examples:
        ...
        >>> inverter_source.generate_at(1234567890)  # Generate data at specific time
    """
    def __new__(cls,sender = ...): ...
    def generate(self) -> None:
        r"""
...
class MockSensorSource:
    ...
    Examples:
        ...
        >>> sensor_source.generate_at(1234567890)  # Generate data at specific time
    """
    def __new__(cls,sender = ...): ...
    def generate(self) -> None:
        r"""
