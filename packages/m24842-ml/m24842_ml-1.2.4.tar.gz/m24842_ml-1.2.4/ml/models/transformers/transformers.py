...
class DiffusionTransformer(nn.Module):
    def __init__(self, emb_dim, input_dim, output_dim,
        ...
        encoder_dims = torch.linspace(input_dim, emb_dim, encoder_decoder_depth, device=device)
        ...
        decoder_dims = torch.linspace(emb_dim, output_dim, encoder_decoder_depth, device=device)
