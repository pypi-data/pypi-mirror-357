...
export class Test {
    ...
    render() {
        ...
        return (h("section", null,
            h("limel-button", { id: "scrive_esign_button", label: esignLabel, outlined: true, icon: "signature", onClick: () => { var _a; return this.goToScrive(this.context.id, (_a = this.document) === null || _a === void 0 ? void 0 : _a.scrive_document_id); } }),
            h("hr", null),
            h("p", null,
