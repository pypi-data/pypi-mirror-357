...
def calculate_brokerage(buy_price, sell_price, quantity, broker="zerodha", market_type="options", order_type="MARKET", lot_size=100, trade_type="LONG"):
    ...
    try:
        if broker in ["zerodha", "dhan", "icici direct"]:
            ...
            fee_rates = {
                "equity": {"maker": 0.001, "taker": 0.001},
            ...
            entry_price = buy_price if trade_type.upper() == "LONG" else sell_price
...
def calculate_liquidation_price(entry_price, leverage=10, trade_type="LONG", mmr=0.005):
