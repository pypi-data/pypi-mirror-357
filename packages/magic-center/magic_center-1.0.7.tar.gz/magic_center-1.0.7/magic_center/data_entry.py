...
MAGIC_CENTER_ENTRY_LOG_DIR = os.getenv("MAGIC_CENTER_LOG_DIR")
if not os.path.exists(MAGIC_CENTER_ENTRY_LOG_DIR):
    os.makedirs(MAGIC_CENTER_ENTRY_LOG_DIR)
logger = logging.Logger("magic_center_entry")
log_handler = RotatingFileHandler(f"{MAGIC_CENTER_ENTRY_LOG_DIR}/data_entry.log",
