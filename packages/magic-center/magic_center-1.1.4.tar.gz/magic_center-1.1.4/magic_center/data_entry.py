...
MAGIC_CENTER_LOG_DIR = os.getenv("MAGIC_CENTER_LOG_DIR")
print(222222)
print(MAGIC_CENTER_LOG_DIR)
if not os.path.exists(MAGIC_CENTER_LOG_DIR):
    os.makedirs(MAGIC_CENTER_LOG_DIR)
logger = logging.Logger("magic_center_entry")
log_handler = RotatingFileHandler(f"{MAGIC_CENTER_LOG_DIR}/data_entry.log",
...
async def kousuanti(limit: int):
    ...
    if environment == "prod":
        sheet_path = os.getenv("CLOUD_SHEET_PATH")
    else:
        sheet_path = os.getenv("LOCAL_SHEET_PATH")
