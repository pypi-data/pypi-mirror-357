...
class HealthCheckConfig:
    ...
    ip_address: str | None = None  # IP address to check
    port: int | None = None  # Port to check (1-65535)
    resource_path: str | None = None  # Resource path for HTTP(S) checks
    fqdn: str | None = None  # Fully qualified domain name to check
    search_string: str | None = None  # String to search for in response
...
class FailoverConfig:
    ...
    health_check_id: str | None = None  # Associated health check ID
...
class RoutingConfig:
    ...
    weighted: WeightedConfig | None = None  # Weighted routing configuration
    latency: LatencyConfig | None = None  # Latency-based routing configuration
    health_check_id: str | None = None  # Optional health check ID
...
class ExtendedDNSRecordSet:
    ...
    alias_target: AliasTarget | None = None  # Alias target configuration
    failover: FailoverConfig | None = None  # Failover configuration
    routing: RoutingConfig | None = None  # Routing configuration
