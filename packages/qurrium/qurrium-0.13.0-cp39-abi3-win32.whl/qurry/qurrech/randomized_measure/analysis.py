...
class ELRAnalysisInput(NamedTuple):
    """To set the analysis."""
...
class ELRAnalysisContent(NamedTuple):
    ...
    def __repr__(self):
        return f"ELRAnalysisContent(echo={self.echo}, and others)"


class EchoListenRandomizedAnalysis(AnalysisPrototype[ELRAnalysisInput, ELRAnalysisContent]):
