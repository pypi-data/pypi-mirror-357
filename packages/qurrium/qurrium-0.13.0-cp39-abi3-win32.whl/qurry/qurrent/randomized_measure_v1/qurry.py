...
class EntropyMeasureRandomizedV1(
    QurriumPrototype[
        EntropyMeasureRandomizedV1Experiment,
        EntropyMeasureRandomizedV1MeasureArgs,
        EntropyMeasureRandomizedV1OutputArgs,
    ...
    def multiAnalysis(
        ...
        *,
        ...
        specific_analysis_args: SpecificAnalsisArgs[EntropyMeasureRandomizedV1AnalyzeArgs] = None,
        ...
        **analysis_args,
        ...
        Args:
            ...
            specific_analysis_args
                SpecificAnalsisArgs[EntropyMeasureRandomizedV1AnalyzeArgs], optional
            ):
