...
if( fckit_IS_BUILD_DIR_EXPORT )
  set( FCTEST_GENERATOR /opt/homebrew/Frameworks/Python.framework/Versions/3.13/bin/python3.13 /opt/actions-runner/work/_work/fckit/fckit/proj/tools/fctest-generate-runner.py )
  set( FYPP /opt/actions-runner/work/_work/fckit/fckit/proj/tools/fckit-eval.sh;/opt/actions-runner/work/_work/fckit/fckit/proj/contrib/fypp-3.2-b8dd58b-20230822/bin/fypp )
  if( 0 )
     set( FCKIT_VENV_EXE  )
  endif()
else()
  ...
  set( FCTEST_GENERATOR /opt/homebrew/Frameworks/Python.framework/Versions/3.13/bin/python3.13 ${fckit_BASE_DIR}/libexec/fctest-generate-runner.py )
endif()
...
if( fckit_HAVE_ECKIT )
  ...
  find_dependency( eckit HINTS ${CMAKE_CURRENT_LIST_DIR}/../eckit /tmp/fckit/prereqs/eckitlib/lib/cmake/eckit  )
endif()
