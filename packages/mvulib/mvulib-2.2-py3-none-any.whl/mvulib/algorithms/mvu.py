...
class Mvu:
    ...
    def __init__(self, n_neighbors=5, angles=False, maxiter=150, verbose=True, save=True):
        ...
        # Da li spremit matrice jezgre K i susjedstva A.
        self.save=save
        ...
        # Matrica susjedstva A povezanog neusmjerenog grafa koji koristi MVU.
    ...
    def fit(self, X):
        ...
        saveStr="save"
        save=matlab.double([1.0 if self.save else 0.0], size=(1,1))

        if self.verbose:
            print("Solving problem...")

        YOut, infoOut=lib.mvu(XIn, kIn, anglesStrIn, anglesIn, \
                              maxIterStrIn, maxIterIn, saveStr, save, nargout=2)
        if self.verbose:
