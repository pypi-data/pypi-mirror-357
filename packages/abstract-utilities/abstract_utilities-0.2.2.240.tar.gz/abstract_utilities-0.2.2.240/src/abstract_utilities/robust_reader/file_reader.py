...
class shoudSkipManager(metaclass=SingletonMeta):
    def __init__(self,exclude_type=None,exclude_file_pattern=None,exclude_dirs=None):
    ...
    def should_skip(self,exclude_item=None,exclude_type=None,exclude_file_pattern=None,exclude_dirs=None):
        if (exclude_dirs==None and exclude_file_pattern == None and exclude_type == None) and exclude_item:
