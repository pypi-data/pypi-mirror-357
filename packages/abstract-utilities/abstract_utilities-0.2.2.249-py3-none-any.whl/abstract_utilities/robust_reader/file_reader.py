...
class shoudSkipManager(metaclass=SingletonMeta):
    def __init__(self,exclude_type=None,exclude_file_patterns=None,exclude_dirs=None):
    ...
    def should_skip(self,exclude_item=None,exclude_type=None,exclude_file_patterns=None,exclude_dirs=None):
        if (exclude_dirs==None and exclude_file_patterns == None and exclude_type == None) and exclude_item:
            if isinstance(item,str):
               ...
               if _should_skip_file(filename=exclude_item, exclude_patterns=self.exclude_file_patterns):
                   return True
               return False
        elif exclude_type or exclude_file_patterns:
...
def read_directory(
    ...
    for dirpath, dirnames, filenames in os.walk(root_path):
        ...
        for fname in filenames:
            ...
            if should_skip(exclude_type=fname,exclude_file_patterns=fname):
