...
class shoudSkipManager(metaclass=SingletonMeta):
    ...
    def should_skip(self,exclude_item=None,exclude_types=None,exclude_file_pattern=None,exclude_dirs=None):
        if (exclude_dirs==None and exclude_file_pattern == None and exclude_types == None) and exclude_item:
            if isinstance(item,str):
               ...
               if _should_skip_file(filename=exclude_item, exclude_patterns=self.exclude_file_patterns):
                   return True
               return False
        elif exclude_types or exclude_file_pattern:
...
def read_directory(
    ...
    for dirpath, dirnames, filenames in os.walk(root_path):
        ...
        for fname in filenames:
            ...
            if should_skip(exclude_types=fname,exclude_file_pattern=fname):
