...
CLICommands = [
    ...
    ### Device Groups
    {
        ...
        "commands": [
            ...
            {
                "name": ["device-group-update-devices", "dguds"],
                "cmdFile": "%s/../d2c/device_group/cli.py" % (os.path.dirname(__file__)),
                "cmdClass": "ModifyDevicesCLI"
            },                 
            {
                "name": ["device-group-update-applications", "dguas"],
                "cmdFile": "%s/../d2c/device_group/cli.py" % (os.path.dirname(__file__)),
                "cmdClass": "ModifyApplicationsCLI"
            }, 
        ]
    },
    # Admin
    ...
    # Test
    {
        ...
        "commands": [
            ...
            {
                "name": ["test-application-00"],
                "cmdFile": "%s/../d2c/test/application.py" % (os.path.dirname(__file__)),
                "cmdClass": "FunctionalTest_Application00CLI"
            },    
            {
                "name": ["test-application-01"],
                "cmdFile": "%s/../d2c/test/application.py" % (os.path.dirname(__file__)),
                "cmdClass": "FunctionalTest_Application01CLI"
            },    
            {
                "name": ["test-device-00"],
                "cmdFile": "%s/../d2c/test/device.py" % (os.path.dirname(__file__)),
                "cmdClass": "Tests00_CLI"
            },                             
            {
                "name": ["test-device-01"],
                "cmdFile": "%s/../d2c/test/device.py" % (os.path.dirname(__file__)),
                "cmdClass": "Tests01_CLI"
            },                             
            {
                "name": ["test-device-group-01"],
                "cmdFile": "%s/../d2c/test/device_group.py" % (os.path.dirname(__file__)),
                "cmdClass": "Tests01_CLI"
            },                
            {
                "name": ["test-device-group-02"],
                "cmdFile": "%s/../d2c/test/device_group.py" % (os.path.dirname(__file__)),
                "cmdClass": "Tests02_CLI"
            },                
            {
                "name": ["device-group-test-03"],
                "cmdFile": "%s/../d2c/test/device_group.py" % (os.path.dirname(__file__)),
                "cmdClass": "Tests03_CLI"
            },                   
            {
                "name": ["test-device-group-04"],
                "cmdFile": "%s/../d2c/test/device_group.py" % (os.path.dirname(__file__)),
                "cmdClass": "Tests04_CLI"
            },                   
            {
