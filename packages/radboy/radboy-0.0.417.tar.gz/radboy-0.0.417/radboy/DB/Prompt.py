...
{Fore.grey_70}**{Fore.light_green}'order dates','ord dt','orddt','ordt','or dt'{Fore.light_green}print hard-coded order dates{Style.reset}'''

                        print(extra)
                        print(helpText)
                        continue
                    elif cmd.lower() in ['order dates','ord dt','orddt','ordt','or dt']:
                        dta=MWR.WaterMilkOrder()
                        print(dta.orderMsg)
                        continue
