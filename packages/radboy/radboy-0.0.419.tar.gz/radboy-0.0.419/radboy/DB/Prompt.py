...
{Fore.grey_70}**{Fore.light_green}'fbht','fmbh','formbuilder help','form helptext'{Fore.light_green}FormBuilderHelpText; extra keywords when asked for time and date{Style.reset}
{Fore.grey_70}**{Fore.light_green}'order date cw/mlk','ord dt cw/mlk','orddt cw/mlk','ordt cw/mlk','or dt cw/mlk'{Fore.light_green}print hard-coded order dates for cw/mlk{Style.reset}
{Fore.grey_70}**{Fore.light_green}'order date grocery','ord dt grcry','orddt grcry','ordt grcry','or dt grcry'{Fore.light_green}print hard-coded order dates grocery load{Style.reset}
{Fore.grey_70}**{Fore.light_green}'order date frozen','ord dt fzn','orddt fzn','ordt fzn','or dt fzn'{Fore.light_green}print hard-coded order dates frozen load{Style.reset}'''
                        ...
                        tmp=datetime.today()
                        today=Prompt.__init2__(None,func=FormBuilderMkText,ptext=f"What is the order datetime for 'Crate Water'/'Milk'[default={tmp}]?",helpText=f"a datetime(default={tmp})",data="datetime")
                        if today in [None,]:
                            continue
                        elif today in ['d',]:
                            today=tmp
                        ...
                        tmp=datetime.today()
                        today=Prompt.__init2__(None,func=FormBuilderMkText,ptext=f"What is the order datetime for 'Grocery'[default={tmp}]?",helpText=f"a datetime(default={tmp})",data="datetime")
                        if today in [None,]:
                            continue
                        elif today in ['d',]:
                            today=tmp
