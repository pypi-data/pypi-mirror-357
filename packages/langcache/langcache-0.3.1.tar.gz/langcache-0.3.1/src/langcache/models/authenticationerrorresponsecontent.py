...
class AuthenticationErrorResponseContent(Exception):
    data: AuthenticationErrorResponseContentData

    def __init__(self, data: AuthenticationErrorResponseContentData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, AuthenticationErrorResponseContentData)
