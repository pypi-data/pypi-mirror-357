...
class InternalServerErrorResponseContent(Exception):
    data: InternalServerErrorResponseContentData

    def __init__(self, data: InternalServerErrorResponseContentData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, InternalServerErrorResponseContentData)
