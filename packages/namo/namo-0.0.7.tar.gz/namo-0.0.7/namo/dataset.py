...
import transformers
from namo.params import DataArguments
    ...
    def _sample_item(self, i) -> Dict[str, torch.Tensor]:
        ...
        if "image" in sources[0]:
            ...
            if (
                ...
                elif "RealData" in ds or "real_data" in ds or "vln-ce" in ds:
                    ds = ds.split(" | ")[0]
                elif "vla_v3" in ds:
                    ds = "real_data_all"
                elif "m4_instruct" in ds:
                    ds = "M4-Instruct/"
        ...
        if "image" in instances[0]:
            if isinstance(instances[0]["image"], torch.Tensor):
                ...
                if self.data_args.dynamic_size:
                    ...
                    elif self.data_args.native_size_batched:
                ...
                if not isinstance(batch["pixel_values"], list):
                    ...
                    if "spatial_shapes" in images_tensor:
                        batch["image_sizes"] = images_tensor["spatial_shapes"]
