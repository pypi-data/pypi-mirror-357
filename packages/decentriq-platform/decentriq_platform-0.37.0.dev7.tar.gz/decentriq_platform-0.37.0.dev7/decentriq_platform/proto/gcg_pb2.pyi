...
class GcgResponse(google.protobuf.message.Message):
    ...
    EXPORTRESULTASDATASETRESPONSE_FIELD_NUMBER: builtins.int
    ...
    @property
    def exportResultAsDatasetResponse(self) -> global___ExportResultAsDatasetResponse: ...
    @property
