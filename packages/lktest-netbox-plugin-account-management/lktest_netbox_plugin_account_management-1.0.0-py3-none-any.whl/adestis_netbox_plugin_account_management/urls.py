...
urlpatterns = (
    ...
    path(
        'login-credentials/<int:pk>/changelog/',
        ObjectChangeLogView.as_view(),
        name='logincredentials_changelog',
        kwargs={'model': LoginCredentials},
    ),
    # SSH Keys
    ...
    path('ssh-keys/import/', SshKeyBulkImportView.as_view(), name='sshkey_import'),
