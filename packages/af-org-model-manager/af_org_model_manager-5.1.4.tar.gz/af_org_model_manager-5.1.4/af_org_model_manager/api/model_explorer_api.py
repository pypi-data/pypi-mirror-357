...
class ModelExplorerApi(object):
    ...
    def get_entities_filtered_with_http_info(self, body, entity_type, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ModelExplorer/EntityIterator/{entityType}/filter', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_entities_for_policy_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ModelExplorer/EntityIterator/policy', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_entities_for_type(self, body, entity_type, **kwargs):  # noqa: E501
        """get_entities_for_type  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entities_for_type(body, entity_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_entities_for_type_with_http_info(body, entity_type, **kwargs)  # noqa: E501
        else:
            (data) = self.get_entities_for_type_with_http_info(body, entity_type, **kwargs)  # noqa: E501
            return data

    def get_entities_for_type_with_http_info(self, body, entity_type, **kwargs):  # noqa: E501
        """get_entities_for_type  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entities_for_type_with_http_info(body, entity_type, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `get_entities_for_type`")  # noqa: E501
        # verify the required parameter 'entity_type' is set
        if ('entity_type' not in params or
                params['entity_type'] is None):
        ...
        return self.api_client.call_api(
            '/ModelExplorer/EntityIterator/{entityType}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_entities_for_type_all_attrs(self, entity_type, **kwargs):  # noqa: E501
        """get_entities_for_type_all_attrs  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entities_for_type_all_attrs(entity_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_entities_for_type_all_attrs_with_http_info(entity_type, **kwargs)  # noqa: E501
        else:
            (data) = self.get_entities_for_type_all_attrs_with_http_info(entity_type, **kwargs)  # noqa: E501
            return data

    def get_entities_for_type_all_attrs_with_http_info(self, entity_type, **kwargs):  # noqa: E501
        """get_entities_for_type_all_attrs  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entities_for_type_all_attrs_with_http_info(entity_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['entity_type', 'exclude_disabled', 'count', 'alive_time']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_entities_for_type_all_attrs" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'entity_type' is set
        if ('entity_type' not in params or
                params['entity_type'] is None):
            raise ValueError("Missing the required parameter `entity_type` when calling `get_entities_for_type_all_attrs`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ModelExplorer/EntityIterator/{entityType}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_entity(self, body, entity_type, id, **kwargs):  # noqa: E501
        """get_entity  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entity(body, entity_type, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_entity_with_http_info(body, entity_type, id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_entity_with_http_info(body, entity_type, id, **kwargs)  # noqa: E501
            return data

    def get_entity_with_http_info(self, body, entity_type, id, **kwargs):  # noqa: E501
        """get_entity  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entity_with_http_info(body, entity_type, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `get_entity`")  # noqa: E501
        # verify the required parameter 'entity_type' is set
        if ('entity_type' not in params or
                params['entity_type'] is None):
        ...
        return self.api_client.call_api(
            '/ModelExplorer/{entityType}/{id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_entity_all_attrs(self, entity_type, id, **kwargs):  # noqa: E501
        """get_entity_all_attrs  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entity_all_attrs(entity_type, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_entity_all_attrs_with_http_info(entity_type, id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_entity_all_attrs_with_http_info(entity_type, id, **kwargs)  # noqa: E501
            return data

    def get_entity_all_attrs_with_http_info(self, entity_type, id, **kwargs):  # noqa: E501
        """get_entity_all_attrs  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entity_all_attrs_with_http_info(entity_type, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_entity_all_attrs" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'entity_type' is set
        if ('entity_type' not in params or
                params['entity_type'] is None):
            raise ValueError("Missing the required parameter `entity_type` when calling `get_entity_all_attrs`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_entity_all_attrs`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ModelExplorer/{entityType}/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_related_entities(self, body, id, relation_type, left_to_right, **kwargs):  # noqa: E501
        """get_related_entities  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_related_entities(body, id, relation_type, left_to_right, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_related_entities_with_http_info(body, id, relation_type, left_to_right, **kwargs)  # noqa: E501
        else:
            (data) = self.get_related_entities_with_http_info(body, id, relation_type, left_to_right, **kwargs)  # noqa: E501
            return data

    def get_related_entities_with_http_info(self, body, id, relation_type, left_to_right, **kwargs):  # noqa: E501
        """get_related_entities  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_related_entities_with_http_info(body, id, relation_type, left_to_right, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'id', 'relation_type', 'left_to_right', 'exclude_disabled', 'count', 'alive_time']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `get_related_entities`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
        ...
        return self.api_client.call_api(
            '/ModelExplorer/EntityIterator/{relationType}/{leftToRight}/{id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_related_entities_all_attrs(self, id, relation_type, left_to_right, **kwargs):  # noqa: E501
        """get_related_entities_all_attrs  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_related_entities_all_attrs(id, relation_type, left_to_right, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_related_entities_all_attrs_with_http_info(id, relation_type, left_to_right, **kwargs)  # noqa: E501
        else:
            (data) = self.get_related_entities_all_attrs_with_http_info(id, relation_type, left_to_right, **kwargs)  # noqa: E501
            return data

    def get_related_entities_all_attrs_with_http_info(self, id, relation_type, left_to_right, **kwargs):  # noqa: E501
        """get_related_entities_all_attrs  # noqa: E501

        This operation has additional header data: x-AF-Accept-Version (optional), x-AF-Caller-URI (required, may be a cookie), x-AF-Security-Token (required, may be a cookie), x-AF-Add-UrlEnc-Attr (optional). See operation /header-data for the corresponding data structures.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_related_entities_all_attrs_with_http_info(id, relation_type, left_to_right, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'relation_type', 'left_to_right', 'exclude_disabled', 'count', 'alive_time']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_related_entities_all_attrs" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_related_entities_all_attrs`")  # noqa: E501
        # verify the required parameter 'relation_type' is set
        if ('relation_type' not in params or
                params['relation_type'] is None):
            raise ValueError("Missing the required parameter `relation_type` when calling `get_related_entities_all_attrs`")  # noqa: E501
        # verify the required parameter 'left_to_right' is set
        if ('left_to_right' not in params or
                params['left_to_right'] is None):
            raise ValueError("Missing the required parameter `left_to_right` when calling `get_related_entities_all_attrs`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ModelExplorer/EntityIterator/{relationType}/{leftToRight}/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_rich_agents(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param list[QualifiedAgentIds] body: (required)
        :param int count:
        :param int alive_time:
    ...
    def get_rich_agents_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ModelExplorer/RichAgentIterator/rich-agent', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
