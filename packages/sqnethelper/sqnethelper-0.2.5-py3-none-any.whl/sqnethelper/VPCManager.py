...
class VPCManager:
    ...
    def add_security_group_rule(self, security_group_id):
        ...
        if not self.is_security_group_accept_rule_exist(security_group_id, 'TCP', '5432/5432'):
            self.add_security_group_accept_rule(security_group_id, 'TCP', '5432/5432')
            
        if not self.is_security_group_accept_rule_exist(security_group_id, 'TCP', '3000/3000'):
            self.add_security_group_accept_rule(security_group_id, 'TCP', '3000/3000')
