...
class ConnectorFactory:
    ...
    def _register_connectors(self):
        ...
        try:
            from ..plugins.connectors.bluesky.connector import BlueskyConnector
            self._connectors['bluesky'] = BlueskyConnector
        except ImportError as e:
            logger.warning(f"Bluesky connector not available: {e}")
