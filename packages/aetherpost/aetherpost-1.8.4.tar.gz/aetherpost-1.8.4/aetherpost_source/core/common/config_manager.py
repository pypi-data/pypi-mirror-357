...
class PlatformCredentials:
    ...
    def is_valid(self) -> bool:
        ...
        elif self.platform == Platform.BLUESKY:
            # Bluesky uses identifier and password in additional_params
            if self.additional_params:
                return bool(self.additional_params.get('identifier') and self.additional_params.get('password'))
            return False
