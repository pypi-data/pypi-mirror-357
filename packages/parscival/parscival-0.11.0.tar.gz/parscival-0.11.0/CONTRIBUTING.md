...
Welcome to ``parscival`` contributor's guide.
...
If you experience bugs or general issues with ``parscival``, please have a look
...
You can help improve ``parscival`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``parscival`` documentation uses Sphinx_ as its main documentation compiler.
...
that any documentation update is done in the same way was a code contribution.
   ...
   .. tip::
      ...
      propose changes in ``parscival``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n parscival python=3 six virtualenv pytest pytest-cov
    conda activate parscival
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/parscival.git
    cd parscival
...
.. _repository: https://github.com/<USERNAME>/parscival
.. _issue tracker: https://github.com/<USERNAME>/parscival/issues
.. <-- end -->
