...
# ${MKL_ROOT}/lib/ is added because that is the folder structure for oneAPI mkl installed from conda or pyPI
find_library(MKL_RT_LIBRARY NAMES libmkl_rt.so libmkl_rt.so.1 libmkl_rt.so.2 PATHS ${MKL_ROOT}/${MKL_LIB_ARCH} ${MKL_ROOT}/lib/)

# set(MKL_LIBRARIES ${MKL_AVX2_LIBRARY} ${MKL_VML_AVX2_LIBRARY} ${MKL_INTERFACE_LIBRARY} ${MKL_THREADING_LIBRARY} ${MKL_CORE_LIBRARY})
# AR: only linking against the runtime library is much simpler - making use of the Single Dynamic Library
set(MKL_LIBRARIES ${MKL_RT_LIBRARY})

find_package_handle_standard_args(MKL DEFAULT_MSG MKL_INCLUDE_DIRS MKL_LIBRARIES)

if(MKL_FOUND)
  message("-- Will use Eigen3 with interface to SMP parallel MKL libraries, using Single Dynamic Library Linking:")
