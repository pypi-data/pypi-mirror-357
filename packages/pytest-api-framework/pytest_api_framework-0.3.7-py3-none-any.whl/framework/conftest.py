...
def pytest_runtest_setup(item):
    if item.funcargs.get("first"):
        ...
        test_object.scenario = Box(convert_numbers_to_decimal(data.get("_scenario")))
...
def pytest_runtest_call(item):
    ...
    item.funcargs["scenario"] = item.instance.scenario = Box(convert_numbers_to_decimal(rendered_data.get("_scenario")))
    item.funcargs["belong_app"] = item.instance.belong_app = origin_data.get("_belong_app")
