...
class ALC():
    ...
    def register(self, args):
        ...
        if args.update:
            ...
            if response.status_code == 200:
                ...
                zip_current_directory(f'{api_name}.zip', exclude_files=['.env', '.token', '.venv', '.workspace'])
    ...
    def deploy(self, args):
        ...
        if args.list and not any([args.get, args.update, args.delete]):
            deploy_list_url = f"{self.url}/api/v1/{workspace_id}/{deployments}"
        ...
        # alm deploy get
            ...
            deploy_get_url = f"{self.url}/api/v1/{workspace_id}/{deployments}"
            ...
            deploy_get_aipack_url = f"{self.url}/api/v1/{workspace_id}/{deployments}/{stream_id}"
        ...
        # alm deploy
            ...
            if response.status_code == 200:
                ...
                deploy_create_url = f"{self.url}/api/v1/{workspace_id}/{deployments}"
                data = {
                    "name": args.name,
    ...
    def activate(self, args):
        ...
        if args.list and not any([args.get]):
            deploy_create_url = f"{self.url}/api/v1/{workspace_id}/activations"
            # Bearer 토큰이 필요할 경우 헤더에 추가
        ...
        # activate gets
            ...
            activate_list_url = f"{self.url}/api/v1/{workspace_id}/{deployments}/{stream_id}/aactivation"
        ...
        # activate
            ...
            activate_url = f"{self.url}/api/v1/{workspace_id}/deployments/{stream_id}/activations"
    ...
    def deactivate(self, args):
        ...
        activate_list_url = f"{self.url}/api/v1/{workspace_id}/{deployments}/{stream_id}/activations"
        ...
        if response_stream_his.status_code == 200:
            ...
            activate_delete_url = f"{self.url}/api/v1/{workspace_id}/activations/{stream_his_id}"
            # POST 요청 보내기
