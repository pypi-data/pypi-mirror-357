from aimms.model.enums.identifier_flags import Flag
from aimms.model.enums.me_attribute_types import AttributeType
from aimms.model.identifiers.identifier import Identifier
from aimms.utils import get_flags_from_int
...
class DataIdentifier(Identifier):
    ...
    def assign( self, data : dict[tuple[str], float] | pl.DataFrame | pd.DataFrame | float, options : dict[str, bool] = None) -> None:
        """
