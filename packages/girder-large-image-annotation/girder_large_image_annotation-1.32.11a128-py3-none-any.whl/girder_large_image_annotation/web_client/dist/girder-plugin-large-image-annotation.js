...
const pe = girder.events, fe = girder.router, { exposePluginConfig: Fe } = girder.utilities.PluginUtils;
Fe("large_image_annotation", "plugins/large_image_annotation/config");
fe.route("plugins/large_image_annotation/config", "largeImageAnnotationConfig", function() {
  pe.trigger("g:navigateTo", nt);
});
function qt(a, t, n, e) {
  if (!(a instanceof Error)) throw a;
  if (!(typeof window > "u" && t || e)) throw a.message += " on line " + n, a;
  ...
  (function(t) {
    ...
    u.prototype = {
      ...
      getLuminance: function() {
        var r = this.toRgb(), c, s, _, m, f, x;
        return c = r.r / 255, s = r.g / 255, _ = r.b / 255, c <= 0.03928 ? m = c / 12.92 : m = t.pow((c + 0.055) / 1.055, 2.4), s <= 0.03928 ? f = s / 12.92 : f = t.pow((s + 0.055) / 1.055, 2.4), _ <= 0.03928 ? x = _ / 12.92 : x = t.pow((_ + 0.055) / 1.055, 2.4), 0.2126 * m + 0.7152 * f + 0.0722 * x;
      },
      setAlpha: function(r) {
      ...
      toHslString: function() {
        var r = p(this._r, this._g, this._b), c = o(r.h * 360), s = o(r.s * 100), _ = o(r.l * 100);
    ...
    function h(r) {
      var c = { r: 0, g: 0, b: 0 }, s = 1, _ = null, m = null, f = null, x = !1, O = !1;
      return typeof r == "string" && (r = re(r)), typeof r == "object" && (B(r.r) && B(r.g) && B(r.b) ? (c = y(r.r, r.g, r.b), x = !0, O = String(r.r).substr(-1) === "%" ? "prgb" : "rgb") : B(r.h) && B(r.s) && B(r.v) ? (_ = ot(r.s), m = ot(r.v), c = L(r.h, _, m), x = !0, O = "hsv") : B(r.h) && B(r.s) && B(r.l) && (_ = ot(r.s), f = ot(r.l), c = b(r.h, _, f), x = !0, O = "hsl"), r.hasOwnProperty("a") && (s = r.a)), s = N(s), {
        ok: x,
        format: r.format || O,
        r: l(255, g(c.r, 0)),
        g: l(255, g(c.g, 0)),
    ...
    function p(r, c, s) {
      ...
      var _ = g(r, c, s), m = l(r, c, s), f, x, O = (_ + m) / 2;
      if (_ == m)
        f = x = 0;
      else {
        var T = _ - m;
        switch (x = O > 0.5 ? T / (2 - _ - m) : T / (_ + m), _) {
          case r:
            f = (c - s) / T + (c < s ? 6 : 0);
            break;
          case c:
    ...
    function b(r, c, s) {
      ...
      if (c === 0)
        ...
        var O = s < 0.5 ? s * (1 + c) : s + c - s * c, T = 2 * s - O;
        _ = x(T, O, r + 1 / 3), m = x(T, O, r), f = x(T, O, r - 1 / 3);
      }
      return { r: _ * 255, g: m * 255, b: f * 255 };
    }
    function w(r, c, s) {
      r = j(r, 255), c = j(c, 255), s = j(s, 255);
      var _ = g(r, c, s), m = l(r, c, s), f, x, O = _, T = _ - m;
      if (x = _ === 0 ? 0 : T / _, _ == m)
        f = 0;
      else {
        switch (_) {
    ...
    function L(r, c, s) {
      ...
      var _ = t.floor(r), m = r - _, f = s * (1 - c), x = s * (1 - m * c), O = s * (1 - (1 - m) * c), T = _ % 6, P = [s, x, f, f, O, s][T], rt = [O, s, s, x, f, f][T], V = [f, f, O, s, s, x][T];
    ...
    function S(r, c, s, _, m) {
      ...
      return m && f[0].charAt(0) == f[0].charAt(1) && f[1].charAt(0) == f[1].charAt(1) && f[2].charAt(0) == f[2].charAt(1) && f[3].charAt(0) == f[3].charAt(1) ? f[0].charAt(0) + f[1].charAt(0) + f[2].charAt(0) + f[3].charAt(0) : f.join("");
    }
    function W(r, c, s, _) {
      var m = [
        D(lt(_)),
    ...
    function E(r, c, s) {
      c = c || 6, s = s || 30;
      var _ = u(r).toHsl(), m = 360 / s, f = [u(r)];
      for (_.h = (_.h - (m * c >> 1) + 720) % 360; --c; )
        _.h = (_.h + m) % 360, f.push(u(_));
      return f;
    }
    function Ft(r, c) {
      c = c || 6;
      for (var s = u(r).toHsv(), _ = s.h, m = s.s, f = s.v, x = [], O = 1 / c; c--; )
        x.push(u({ h: _, s: m, v: f })), f = (f + O) % 1;
      return x;
    }
    u.mix = function(r, c, s) {
      s = s === 0 ? 0 : s || 50;
      var _ = u(r).toRgb(), m = u(c).toRgb(), f = s / 100, x = {
        r: (m.r - _.r) * f + _.r,
        g: (m.g - _.g) * f + _.g,
        b: (m.b - _.b) * f + _.b,
        a: (m.a - _.a) * f + _.a
      ...
      var _ = u.readability(r, c), m, f;
      switch (f = !1, m = se(s), m.level + m.size) {
        case "AAsmall":
        case "AAAlarge":
          f = _ >= 4.5;
          break;
      ...
      var _ = null, m = 0, f, x, O, T;
      s = s || {}, x = s.includeFallbackColors, O = s.level, T = s.size;
      for (var P = 0; P < c.length; P++)
        f = u.readability(r, c[P]), f > m && (m = f, _ = u(c[P]));
      return u.isReadable(r, _, { level: O, size: T }) || !x ? _ : (s.includeFallbackColors = !1, u.mostReadable(r, ["#fff", "#000"], s));
    };
    var mt = u.names = {
      aliceblue: "f0f8ff",
      antiquewhite: "faebd7",
...
function He(a, t, n) {
  const e = n.map(), i = e.createLayer("feature", { features: ["heatmap"] }), o = (a.origin || [0, 0, 0])[0] || 0, l = (a.origin || [0, 0, 0])[1] || 0, g = (a.origin || [0, 0, 0])[2] || 0, d = a.dx || 1, u = a.dy || 1, h = $t(a, a.values), y = e.layers().find((w) => w instanceof window.geo.tileLayer && w.options && w.options.maxLevel !== void 0), p = y ? 2 ** -y.options.maxLevel : 1, b = i.createFeature("heatmap", {
    style: {
      radius: (a.radius || 25) * (a.scaleWithZoom ? p : 1),
      blurRadius: 0,
      gaussian: !0,
      color: h.color,
      scaleWithZoom: a.scaleWithZoom || !1
...
const st = Ve.extend({
  ...
  handleElementChanged: function(a, t, n) {
    ...
    if (a.get("center"))
      ...
      let y = h[0][0], p = h[0][0], b = h[0][1], w = h[0][1];
      for (const [L, R] of h)
        y = Math.min(y, L), b = Math.min(b, R), p = Math.max(p, L), w = Math.max(w, R);
      g = (p + y) / 2, d = (w + b) / 2, u = Math.max(1, ((p - y) ** 2 + (w - b) ** 2) ** 0.5);
    }
    if (l === this._centroids.centroids.id.length) {
      ...
      p.set(this._centroids.centroids.r), p[l] = u, this._centroids.centroids.r = p;
  ...
  fetch: function(a) {
    ...
    return a.extraPath && (t.url += "/" + a.extraPath), a.ignoreError && (t.error = null), this._inFetch = !0, this._refresh && (delete this._pageElements, delete this._centroids, this._refresh = !1), gt(t).done((n) => {
      const i = (n.annotation || {}).elements || [];
      this._fromFetch = !0, this.set(n), this._fromFetch = null, this._pageElements === void 0 && n._elementQuery && (this._pageElements = n._elementQuery.count > n._elementQuery.returned, this._pageElements ? (this._inFetch = "centroids", this.fetchCentroids().then(() => (this._inFetch = !0, a.extraPath ? this.trigger("g:fetched." + a.extraPath) : this.trigger("g:fetched"), null)).always(() => {
        if (this._inFetch = !1, this._nextFetch) {
          var o = this._nextFetch;
          this._nextFetch = null, o();
        }
        return null;
      })) : this._nextFetch = null), this._inFetch !== "centroids" && (a.extraPath ? this.trigger("g:fetched." + a.extraPath) : this.trigger("g:fetched")), this._fromFetch = !0, this._elements.reset(i, et.extend({ sync: !0 }, a)), this._fromFetch = null;
    }).fail((n) => {
  ...
  save(a) {
    ...
    if (e && this._changeLog && delete this._changeLog, e) {
      ...
      t = `annotation/${this.id}`, n = "PUT", K() && (this.attributes.updated = "" + Date.now(), this.attributes.updatedId = K().id);
    let i;
    if (this._changeLog) {
      n = "PATCH";
  ...
  geojson() {
    ...
    return Zt(t, { annotation: this.id });
  },
  /**
  ...
  non_geojson(a) {
    ...
    return Qt(n, { annotation: this.id }, a);
  },
  /**
  ...
  setView(a, t, n, e, i, o) {
    if (!(this._pageElements === !1 || this.isNew())) {
      var l = a.right - a.left, g = a.bottom - a.top, d = l * (this._viewArea - 1) / 2, u = g * (this._viewArea - 1) / 2, h = d / 2, y = u / 2, p = this._region.left !== void 0 && a.left >= this._region.left + h && a.top >= this._region.top + y && a.right <= this._region.right - h && a.bottom <= this._region.bottom - y && Math.abs(this._lastZoom - t) < 1;
      if (!(p && !this._inFetch)) {
...
function pt(a, t) {
  return Array.isArray(a) ? Ge(a, t) : a && typeof a == "object" ? Je(a) : a || "";
}
function Ge(a, t) {
  for (var n, e = "", i = "", o = Array.isArray(t), l = 0; l < a.length; l++) (n = pt(a[l])) && (o && t[l] && (n = $(n)), e = e + i + n, i = " ");
  return e;
}
function Je(a) {
  var t = "", n = "";
  for (var e in a) e && a[e] && Ze.call(a, e) && (t = t + n + e, n = " ");
  return t;
}
function $(a) {
  var t = "" + a, n = Qe.exec(t);
                ...
                if (typeof Z.length == "number")
                  ...
                  for (var Q in Z) {
                    ...
                    if (i = 55, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", C.type !== "record" || C.value !== "controls") {
                      i = 56, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug";
                      var E;
                      C.type === "record" && C.value === "creator" ? E = H : C.type === "record" && C.value === "updatedId" ? E = J || H : C.type === "record" && C.value === "updated" ? E = F.get("updated") || F.get("created") : C.type === "metadata" ? (E = F.get("annotation").attributes || {}, C.value.split(".").forEach((N) => {
                        E = (E || {})[N];
                      })) : E = C.type === "record" ? F.get(C.value) || F.get("annotation")[C.value] : "", i = 72, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + "<td" + (' class="g-annotation-entry"' + I("title", E, !0, !1)) + ">", i = 73, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", C.format === "user" ? (i = 74, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + "<a" + I("href", `#user/${F.get(C.value) || F.get(C.value + "Id")}`, !0, !1) + ">", i = 75, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + $((n = E) == null ? "" : n) + "</a>") : C.format === "datetime" ? (i = 77, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + $((n = new g(E).toLocaleString()) == null ? "" : n)) : C.format === "date" ? (i = 79, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + $((n = new g(E).toLocaleDateString()) == null ? "" : n)) : C.format === "time" ? (i = 81, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + $((n = new g(E).toLocaleTimeString()) == null ? "" : n)) : (i = 83, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + $((n = E) == null ? "" : n)), t = t + "</td>";
                    }
                  }
                ...
                if (typeof Y.length == "number")
                  ...
                  for (var N in Y) {
                    ...
                    if (i = 55, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", v.type !== "record" || v.value !== "controls") {
                      i = 56, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug";
                      var A;
                      v.type === "record" && v.value === "creator" ? A = H : v.type === "record" && v.value === "updatedId" ? A = J || H : v.type === "record" && v.value === "updated" ? A = F.get("updated") || F.get("created") : v.type === "metadata" ? (A = F.get("annotation").attributes || {}, v.value.split(".").forEach((lt) => {
                        A = (A || {})[lt];
                      })) : A = v.type === "record" ? F.get(v.value) || F.get("annotation")[v.value] : "", i = 72, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + "<td" + (' class="g-annotation-entry"' + I("title", A, !0, !1)) + ">", i = 73, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", v.format === "user" ? (i = 74, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + "<a" + I("href", `#user/${F.get(v.value) || F.get(v.value + "Id")}`, !0, !1) + ">", i = 75, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + $((n = A) == null ? "" : n) + "</a>") : v.format === "datetime" ? (i = 77, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + $((n = new g(A).toLocaleString()) == null ? "" : n)) : v.format === "date" ? (i = 79, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + $((n = new g(A).toLocaleDateString()) == null ? "" : n)) : v.format === "time" ? (i = 81, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + $((n = new g(A).toLocaleTimeString()) == null ? "" : n)) : (i = 83, e = "/root/project/girder_annotation/girder_large_image_annotation/web_client/templates/annotationListWidget.pug", t = t + $((n = A) == null ? "" : n)), t = t + "</td>";
                    }
                  }
...
const z = girder.$, ct = girder._, { AccessType: Xe } = girder.constants, zt = girder.utilities.EventStream, { getCurrentUser: Ke } = girder.auth, { confirm: Ht } = girder.dialog, { getApiRoot: vt, restRequest: tn } = girder.rest, en = girder.views.widgets.AccessWidget, nn = girder.events, an = girder.collections.UserCollection, on = girder.views.widgets.UploadWidget, rn = girder.views.View, sn = rn.extend({
  events: {
...
function St(a) {
  ...
  const o = n[i % 4], l = n[(i + 1) % 4], g = n[(i + 2) % 4], d = n[(i + 3) % 4], u = [g.x - l.x, g.y - l.y], h = [l.x - o.x, l.y - o.y], y = Math.atan2(u[1], u[0]), p = Math.sqrt(h[0] * h[0] + h[1] * h[1]), b = Math.sqrt(u[0] * u[0] + u[1] * u[1]), w = [
...
function Fn(a) {
  ...
  let n = a.coordinates();
  const e = n.inner ? n.inner.map((i) => ft(i)) : void 0;
  return n = ft(n.outer || n), fn.extend(t, {
    type: "polyline",
    closed: !0,
    points: n,
    holes: e
...
const mn = girder._;
function yn(a) {
  const t = ut(a, "polyline"), n = ft(a.coordinates());
  return mn.extend(t, {
    type: "polyline",
...
const Lt = girder.$, Dt = girder._, { restRequest: On } = girder.rest, { wrap: Sn } = girder.utilities.PluginUtils, ne = girder.views.widgets.ItemListWidget;
Sn(ne, "render", function(a) {
  a.apply(this, Dt.rest(arguments));
  function t(n, e, i, o) {
  ...
  nt.getSettings((n) => {
    ...
    if (!Dt.some(e, (g) => g.has("largeImage")) || this._inFetch || this._needsFetch)
      return;
...
const In = girder.$, k = girder._, Rn = girder.Backbone, tt = girder.events, { wrap: Mn } = girder.utilities.PluginUtils, { restRequest: Pn, getApiRoot: dt } = girder.rest;
function Vt() {
  function a() {
  ...
  return Mn(a, "initialize", function(t) {
    ...
    drawAnnotation: function(t, n) {
      ...
      if (l && (k.each(this._annotations[t.id].features, (h, y) => {
        ...
        const y = this._annotations[t.id].overlays.map((b) => b.id), p = o.map((b) => b.id);
        k.each(y, (b) => {
          if (!p.includes(b)) {
        ...
        if (t._centroids && !g) {
          ...
          h._centroidFeature = !0, u.push(h), h.data(t._centroids.data).position((y, p) => ({
            x: t._centroids.centroids.x[p],
            y: t._centroids.centroids.y[p]
          })).style({
            radius: (y, p) => {
              let b = t._centroids.centroids.r[p];
              return b ? (b /= 2.5 * this.viewer.unitsPerPixel(this.viewer.zoom()), b) : 8;
            },
            stroke: (y, p) => !t._shownIds || t._centroids.centroids.id[p] && !t._shownIds.has(t._centroids.centroids.id[p]),
            strokeColor: (y, p) => {
              const b = t._centroids.centroids.s[p];
            ...
            fill: (y, p) => !t._shownIds || t._centroids.centroids.id[p] && !t._shownIds.has(t._centroids.centroids.id[p]),
            fillColor: (y, p) => {
              const b = t._centroids.centroids.s[p];
            ...
            if (this.viewer.zoom() !== t._centroidLastZoom)
              if (t._centroidLastZoom = this.viewer.zoom(), h.verticesPerFeature) {
                ...
                for (var y = 0, p = 0; y < R; y += 1) {
                  let W = t._centroids.centroids.r[y];
                  W ? W /= w : W = 8;
                  for (var b = 0; b < L; b += 1, p += 1)
                    S[p] = W;
                }
        ...
        this.getUnclampBoundsForOverlay() && this._annotations[t.id].overlays.length > 0 && (this.viewer.clampBoundsY(!1), this.viewer.clampBoundsX(!1)), k.each(this._annotations[t.id].overlays, (h) => {
          ...
          Pn({
            ...
            const w = this._generateOverlayLayerParams(p, y, h), L = h.type === "pixelmap" ? "pixelmap" : "osm", R = this._getOverlayTransformProjString(h), S = this.viewer.createLayer(L, Object.assign({}, w, { id: h.id, gcs: R }));
          ...
          h.length === 0 && (h = t.non_geojson(this.featureLayer), h.length && this.featureLayer.map().draw()), k.each(h || [], (p) => {
            var b = e.event.feature;
            u.push(p), p.selectionAPI(this._hoverEvents), p.geoOn(
              [
                b.mousedown,
                b.mouseup,
                b.mouseclick,
            ...
            ), t._centroids && (t._shownIds = new Set(p.data().map((w) => w.id))), this._featureOpacity[t.id][p.featureType] = p.data().map(({ id: w, properties: L }) => ({
              id: w,
              fillOpacity: L.fillOpacity,
              strokeOpacity: L.strokeOpacity
            }));
          }), this._mutateFeaturePropertiesForHighlight(t.id, h);
          const y = u.find((p) => p._centroidFeature);
          t._centroids && y && (y.verticesPerFeature ? this.viewer.scheduleAnimationFrame(() => {
            const p = u.find((L) => L._centroidFeature), b = p.data().length, w = new Float32Array(b);
            for (let L = 0; L < b; L += 1)
              w[L] = t._shownIds.has(t._centroids.centroids.id[L]) ? 0 : 1;
            p.updateStyleFromArray({
              stroke: w,
              fill: w
            }, void 0, !0);
    ...
    _mutateFeaturePropertiesForHighlight: function(t, n) {
      k.each(n, (i) => {
        ...
        for (let u = 0; u < o.length; u += 1) {
          const h = o[u].id, y = o[u].fillOpacity * this._globalAnnotationFillOpacity, p = o[u].strokeOpacity;
          this._hideAnnotation && t === this._hideAnnotation && h === this._hideElement ? (g[u] = 0, d[u] = 0) : !this._highlightAnnotation || !this._highlightElement && t === this._highlightAnnotation || this._highlightElement === h ? (g[u] = y, d[u] = p) : (g[u] = y * 0.25, d[u] = p * 0.25);
        }
      ...
      return this.startDrawMode(l, { trigger: !1, signalModeChange: !0 }).then((g) => {
        ...
        switch (n) {
          ...
          case "polygon":
            ...
            break;
          default:
            var h = Math.round(d.center[0] - d.width / 2), y = Math.round(d.center[1] - d.height / 2), p = Math.round(d.width), b = Math.round(d.height);
            u = [h, y, p, b];
            break;
        }
    ...
    startDrawMode: function(t, n) {
      var e = this.annotationLayer, i = [], o = [], l = In.Deferred(), g;
