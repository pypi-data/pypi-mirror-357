...
def main() -> None:  # pylint: disable=[R0912,R0914,R0915]
    ...
    list_parser = subparsers.add_parser('list', parents=[no_case_parser, select_parser, dialog_parser], help='Matching and display list of the installed packages.')
    ...
    search_parser = subparsers.add_parser('search', parents=[no_case_parser, pkg_version_parser, select_parser, dialog_parser, color_parser, repository_parser],
