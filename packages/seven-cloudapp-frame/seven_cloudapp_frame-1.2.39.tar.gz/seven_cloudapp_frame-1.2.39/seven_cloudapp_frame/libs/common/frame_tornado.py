...
@LastEditTime: 2025-06-25 11:14:36
...
# nacos配置获取
nacos_share_config = share_config.get_value(f"nacos_{environment}", None)
if nacos_share_config:
    ...
    try:
        ...
        share_config.init_config_from_nacos(config_file, config_content, environment)
    ...
    try:
        nacos_share_client.add_config_watcher(data_id=nacos_share_data_id, group=nacos_share_group, cb=lambda cfg: share_config.init_config_from_nacos(config_file, cfg["content"], environment))
    except:
        pass
