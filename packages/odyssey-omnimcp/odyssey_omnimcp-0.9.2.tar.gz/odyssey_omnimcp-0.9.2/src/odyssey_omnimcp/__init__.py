...
def create_physics_scene(
    ...
    """Create a complete physics scene with floor, gravity and multiple objects. 
    For creating single objects, use omni_kit_command instead.
    This is primarily for setting up physics simulations, not for creating individual shapes.
