...
class TestBlaskAPIAgentManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_query = (
            ...
            # "Compare the performance of top 5 brands in South Africa for the first quarter of 2023 and in the frist quater 2025?"
            ...
            # "What is the top 7 Asian brands now?"
            ...
            # "What is the total GGR for the last 3 months in Bangladesh market for the top 10 brands?"
        )
