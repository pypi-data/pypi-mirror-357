...
from .io import load_par_file, save_geometry_and_lattice_par_file
...
def tmp_grain_processing_files(
    ubi_init_data_url: str, geo_init_data_url: str, lat_init_data_url: str
) -> Generator[Tuple[str, str], None, None]:
    _, tmp_ubi_file = tempfile.mkstemp()
    _, tmp_par_file = tempfile.mkstemp()
    ...
    try:
        ...
        lat_url = DataUrl(lat_init_data_url)
