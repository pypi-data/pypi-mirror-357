...
class FilterByLattice(
    ...
    def run(self):
        ...
        lattice_file = copy_par_file(
            inputs.lattice_par_file, Path(nexus_file_path).parent
        )
        ...
        self.outputs.copied_lattice_par_file = str(lattice_file)
