...
from ..indexing import run_grid_indexing
from ..io import find_omega_slope
from ..models import GridIndexParameters, InputsWithOverwrite, SampleConfig
...
class GridIndexGrains(
    ...
    def run(self):
        ...
        folder_file_config = read_nx_collection_parameters(
            filename=filename,
            process_group_name=process_group_name,
            sub_folder="parameters/FolderFileSettings",
        )
        omega_slop = find_omega_slope(SampleConfig(**folder_file_config))
        ...
        grid_indexed_grains = run_grid_indexing(
            ...
            translations=generate_translations(
                inputs.grid_abs_x_limit,
                inputs.grid_abs_y_limit,
                inputs.grid_abs_z_limit,
                inputs.grid_step,
            ),
        )
