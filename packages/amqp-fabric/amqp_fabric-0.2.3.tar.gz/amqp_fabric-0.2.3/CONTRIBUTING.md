...
Welcome to `amqp-fabric` contributor's guide.
...
If you experience bugs or general issues with `amqp-fabric`, please have a look
...
You can help improve `amqp-fabric` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`amqp-fabric` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `amqp-fabric`'s files. While this mechanism can
...
```
conda create -n amqp-fabric python=3 six virtualenv pytest pytest-cov
conda activate amqp-fabric
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/amqp-fabric.git
   cd amqp-fabric
   ```
...
5. Install [pre-commit]:
   ...
   `amqp-fabric` comes with a lot of hooks configured to automatically help the
