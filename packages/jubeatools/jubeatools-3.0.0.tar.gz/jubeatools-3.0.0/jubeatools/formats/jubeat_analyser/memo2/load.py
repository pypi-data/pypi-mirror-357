...
class Memo2Parser(JubeatAnalyserParser):
    current_chart_lines: List[Memo2ChartLine] = field(default_factory=list)
    frames: List[Memo2Frame] = field(default_factory=list)
    FORMAT_TAG: ClassVar[str] = "#memo2"
            ...
            for pos, unfinished_long in unfinished_longs.items():
                ...
                if self.circle_free and symbol in CIRCLE_FREE_SYMBOLS:
                    ...
                    try:
                        ...
                        raise SyntaxError(
                            "Chart section positional part contains the circle free "
