...
class DeeployService:
    ...
    def completions(self, workspace_id: str, deployment_id: str, request_body: dict, explain: bool = False) -> dict:
    ...
    def chat_completions(self, workspace_id: str, deployment_id: str, request_body: dict) -> dict:
        ...
        if not self.__request_is_successful(chat_completion_response):
            raise Exception(f"Failed to fetch chat completion from model: {chat_completion_response.json()}")
    ...
    def get_request_logs(
        self, workspace_id: str, deployment_id: str, params: GetRequestLogsOptions, include_raw_body: bool = False
    ) -> dict:
