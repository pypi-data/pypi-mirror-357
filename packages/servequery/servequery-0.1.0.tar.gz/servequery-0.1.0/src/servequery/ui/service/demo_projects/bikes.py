...
from servequery import Regression
...
from servequery.sdk.panels import counter_panel
from servequery.sdk.panels import line_plot_panel
from servequery.sdk.panels import text_panel
from servequery.ui.service.demo_projects import DemoProject
    ...
    if is_create_dashboard:
        ...
        project.dashboard.add_panel(
            counter_panel(
                ...
                size="half",
                values=[
                    PanelMetric(legend="count", metric="servequery:metric_v2:RowCount", metric_labels={}),
                ],
                aggregation="sum",
            )
        )
        project.dashboard.add_panel(
            counter_panel(
                ...
                values=[
                    PanelMetric(
                        legend="share",
                        metric="servequery:metric_v2:DriftedColumnsCount",
            ...
            line_plot_panel(
                ...
                values=[
                    PanelMetric(
                        ...
                        metric="servequery:metric_v2:MeanValue",
        ...
        project.dashboard.add_panel(
            line_plot_panel(
                ...
                values=[
                    PanelMetric(
                        metric="servequery:metric_v2:MAE",
        ...
        project.dashboard.add_panel(
            line_plot_panel(
                ...
                values=[
                    PanelMetric(
                        metric="servequery:metric_v2:MAPE",
                        legend="MAPE\nvalue type: {{value_type}}",
                    ),
                ],
            )
        ...
        project.dashboard.add_panel(
            line_plot_panel(
                ...
                values=[
                    PanelMetric(
                        legend="temp",
                        metric="servequery:metric_v2:ValueDrift",
