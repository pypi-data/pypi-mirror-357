...
from servequery.llm.prompts.content import PromptContentType
from servequery.llm.prompts.content import TextPromptContent
...
class RemotePromptManager:
    ...
    def get_or_create_prompt(self, project_id: ProjectID, name: str) -> RemotePrompt:
        try:
            ...
            if not e.get_message() == "ServeQueryError: prompt not found":
                raise e
    ...
    def bump_prompt_version(self, prompt_id: PromptID, content: str) -> PromptVersion:
        ...
        try:
            ...
            if e.get_message() != "ServeQueryError: prompt version not found":
                raise e
            version = 1
