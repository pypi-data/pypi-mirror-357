...
from servequery.core.metric_types import metric_tests_widget
from servequery.core.metric_types import render_widgets
from servequery.core.serialization import ReportModel
...
from servequery.legacy.suite.base_suite import _discover_dependencies
from servequery.legacy.suite.base_suite import find_metric_renderer
...
from servequery.pydantic_utils import Fingerprint
...
class Snapshot:
    ...
    def get_html_str(self, as_iframe: bool):
        from servequery.legacy.renderers.html_widgets import group_widget
