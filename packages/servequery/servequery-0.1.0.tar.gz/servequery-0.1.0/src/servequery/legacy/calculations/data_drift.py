...
from servequery.legacy.utils.data_drift_utils import get_text_data_for_plots
...
class DriftStatsField(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:DriftStatsField"
...
class ColumnDataDriftMetrics(ColumnMetricResult):
    class Config:
        ...
        type_alias = "servequery:metric_result:ColumnDataDriftMetrics"
...
class DatasetDriftMetrics(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:DatasetDriftMetrics"
