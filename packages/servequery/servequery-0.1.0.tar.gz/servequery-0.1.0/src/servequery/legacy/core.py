...
from servequery._pydantic_compat import SHAPE_DICT
from servequery._pydantic_compat import SHAPE_LIST
from servequery._pydantic_compat import SHAPE_SET
from servequery._pydantic_compat import SHAPE_TUPLE
from servequery._pydantic_compat import ModelField
from servequery.pydantic_utils import IncludeTags
from servequery.pydantic_utils import pydantic_type_validator

if TYPE_CHECKING:
    from servequery._pydantic_compat import AbstractSetIntStr
    from servequery._pydantic_compat import MappingIntStrAny

from enum import Enum

from servequery._pydantic_compat import BaseConfig
            ...
            if isinstance(field_value, dict):
                ...
                if all(isinstance(v, BaseResult) for v in field_value.values()):
                    raise NotImplementedError(
                        f"{self.__class__.__name__} does not support dataframe rendering. Please submit an issue to https://github.com/Rixy-Ai/ServeQuery/issues"
                    )
