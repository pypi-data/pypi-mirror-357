...
from servequery.legacy.base_metric import ErrorResult
...
from servequery.legacy.renderers.base_renderer import RenderersDefinitions
...
from servequery.legacy.ui.datasets import inject_feature_types_in_column_mapping
from servequery.legacy.ui.type_aliases import ComputationConfigID
...
from servequery.legacy.utils import data_preprocessing
from servequery.legacy.utils.dashboard import SaveMode
from servequery.legacy.utils.dashboard import SaveModeMap
from servequery.legacy.utils.dashboard import TemplateParams
from servequery.legacy.utils.dashboard import file_html_template
from servequery.legacy.utils.dashboard import inline_iframe_html_template
from servequery.legacy.utils.dashboard import save_data_file
from servequery.legacy.utils.dashboard import save_lib_files
...
def _discover_dependencies(test: Union[Metric, Test]) -> Generator[Tuple[str, Union[Metric, Test]], None, None]:
    if hasattr(test, "__servequery_dependencies__"):
        yield from test.__servequery_dependencies__()  # type: ignore[union-attr]
        return
...
class Display:
    ...
    def _get_json_content(
        ...
        **kwargs,
        ...
        result = {"version": servequery.__version__}
        result.update(
            self.as_dict(
