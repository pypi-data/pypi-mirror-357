...
from servequery.legacy.utils.llm.errors import LLMResponseParseError
...
class PromptBlock(ServeQueryBaseModel):
    class Config:
        is_base_type = True
...
class Anchor(PromptBlock):
    class Config:
        type_alias = "servequery:prompt_block:Anchor"
...
class SimpleBlock(PromptBlock):
    class Config:
        type_alias = "servequery:prompt_block:SimpleBlock"
...
class NoopOutputFormat(OutputFormatBlock[str]):
    class Config:
        type_alias = "servequery:prompt_block:NoopOutputFormat"
...
class JsonOutputFormatBlock(OutputFormatBlock[Dict[str, Any]]):
    class Config:
        type_alias = "servequery:prompt_block:JsonOutputFormatBlock"
...
class StringListFormatBlock(OutputFormatBlock[List[str]]):
    class Config:
        type_alias = "servequery:prompt_block:StringListFormatBlock"
...
class StringFormatBlock(OutputFormatBlock[str]):
    class Config:
        type_alias = "servequery:prompt_block:StringFormatBlock"
...
class PromptTemplate(ServeQueryBaseModel):
    class Config:
        is_base_type = True
...
class BlockPromptTemplate(PromptTemplate):
    class Config:
        type_alias = "servequery:prompt_template:BlockPromptTemplate"
