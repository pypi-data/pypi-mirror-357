...
from servequery.legacy.metrics.classification_performance.confusion_matrix_metric import (
    ClassificationConfusionMatrixParameters,
)
from servequery.legacy.metrics.classification_performance.objects import ClassMetric
...
from servequery.legacy.tests.utils import plot_boxes
from servequery.legacy.tests.utils import plot_conf_mtrx
from servequery.legacy.tests.utils import plot_rates
...
class TestAccuracyScore(SimpleClassificationTestTopK):
    class Config:
        type_alias = "servequery:test:TestAccuracyScore"
...
class TestPrecisionScore(SimpleClassificationTestTopK):
    class Config:
        type_alias = "servequery:test:TestPrecisionScore"
...
class TestF1Score(SimpleClassificationTestTopK):
    class Config:
        type_alias = "servequery:test:TestF1Score"
...
class TestRecallScore(SimpleClassificationTestTopK):
    class Config:
        type_alias = "servequery:test:TestRecallScore"
...
class TestRocAuc(SimpleClassificationTest):
    class Config:
        type_alias = "servequery:test:TestRocAuc"
...
class TestLogLoss(SimpleClassificationTest):
    class Config:
        type_alias = "servequery:test:TestLogLoss"
...
class TestTPR(SimpleClassificationTestTopK):
    class Config:
        type_alias = "servequery:test:TestTPR"
...
class TestTNR(SimpleClassificationTestTopK):
    class Config:
        type_alias = "servequery:test:TestTNR"
...
class TestFPR(SimpleClassificationTestTopK):
    class Config:
        type_alias = "servequery:test:TestFPR"
...
class TestFNR(SimpleClassificationTestTopK):
    class Config:
        type_alias = "servequery:test:TestFNR"
...
class ByClassParameters(CheckValueParameters):
    class Config:
        type_alias = "servequery:test_parameters:ByClassParameters"
...
class TestPrecisionByClass(ByClassClassificationTest):
    class Config:
        type_alias = "servequery:test:TestPrecisionByClass"
...
class TestRecallByClass(ByClassClassificationTest):
    class Config:
        type_alias = "servequery:test:TestRecallByClass"
...
class TestF1ByClass(ByClassClassificationTest):
    class Config:
        type_alias = "servequery:test:TestF1ByClass"
