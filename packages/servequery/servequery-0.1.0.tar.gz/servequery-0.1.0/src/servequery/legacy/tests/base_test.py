...
from servequery.legacy.base_metric import BaseResult
...
from servequery.pydantic_utils import ExcludeNoneMixin
...
class TestParameters(ServeQueryBaseModel, BaseResult):  # type: ignore[misc] # pydantic Config
    class Config:
        type_alias = "servequery:test_parameters:TestParameters"
...
class TestResult(EnumValueMixin, MetricResult):  # todo: create common base class
    ...
    class Config:
        type_alias = "servequery:metric_result:TestResult"
...
class ConditionTestParameters(TestParameters):
    class Config:
        type_alias = "servequery:test_parameters:ConditionTestParameters"
...
class CheckValueParameters(ConditionTestParameters):
    class Config:
        type_alias = "servequery:test_parameters:CheckValueParameters"
...
class ColumnCheckValueParameters(CheckValueParameters):
    class Config:
        type_alias = "servequery:test_parameters:ColumnCheckValueParameters"
