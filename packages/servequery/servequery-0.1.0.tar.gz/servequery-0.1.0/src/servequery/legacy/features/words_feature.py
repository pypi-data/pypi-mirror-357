...
from servequery.legacy.features.generated_features import ApplyColumnGeneratedFeature
...
class WordsPresence(ApplyColumnGeneratedFeature):
    class Config:
        type_alias = "servequery:feature:WordsPresence"
...
class IncludesWords(WordsPresence):
    class Config:
        type_alias = "servequery:feature:IncludesWords"
...
class ExcludesWords(WordsPresence):
    class Config:
        type_alias = "servequery:feature:ExcludesWords"
...
class RowWordPresence(GeneratedFeature):
    class Config:
        type_alias = "servequery:feature:RowWordPresence"
...
class WordMatch(RowWordPresence):
    class Config:
        type_alias = "servequery:feature:WordMatch"
...
class WordNoMatch(RowWordPresence):
    class Config:
        type_alias = "servequery:feature:WordNoMatch"
