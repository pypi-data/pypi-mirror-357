...
from servequery.legacy.features.generated_features import FeatureTypeFieldMixin
...
from servequery.pydantic_utils import FingerprintPart


class CustomFeature(FeatureTypeFieldMixin, GeneratedFeature):
    class Config:
        type_alias = "servequery:feature:CustomFeature"
...
class CustomSingleColumnFeature(FeatureTypeFieldMixin, GeneratedFeature):
    class Config:
        type_alias = "servequery:feature:CustomSingleColumnFeature"
...
class CustomPairColumnFeature(FeatureTypeFieldMixin, GeneratedFeature):
    class Config:
        type_alias = "servequery:feature:CustomPairColumnFeature"
