...
from servequery.legacy.ui.components.base import SECTION_COMPONENT_TYPE_MAPPING
...
from servequery.legacy.ui.components.base import T
...
def load_config_from_file(cls: Type[TConfig], path: str, envvar_prefix: str = "SERVEQUERY") -> TConfig:
