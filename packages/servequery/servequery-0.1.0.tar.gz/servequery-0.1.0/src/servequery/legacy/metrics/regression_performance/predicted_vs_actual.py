...
from servequery.legacy.metrics.regression_performance.objects import scatter_as_dict
...
from servequery.legacy.utils.visualizations import plot_scatter


class AggPredActualScatter(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:AggPredActualScatter"
        dict_include = False
...
class RegressionPredictedVsActualScatterResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:RegressionPredictedVsActualScatterResults"
        dict_include = False
        tags = {IncludeTags.Render}
...
class RegressionPredictedVsActualScatter(UsesRawDataMixin, Metric[RegressionPredictedVsActualScatterResults]):
    class Config:
        type_alias = "servequery:metric:RegressionPredictedVsActualScatter"
