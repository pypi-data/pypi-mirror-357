...
class DriftMethod(ServeQueryBaseModel):
    class Config:
        is_base_type = True
...
class DistanceDriftMethod(DriftMethod):
    class Config:
        type_alias = "servequery:drift_method:DistanceDriftMethod"
...
class ModelDriftMethod(DriftMethod):
    class Config:
        type_alias = "servequery:drift_method:ModelDriftMethod"
...
class RatioDriftMethod(DriftMethod):
    class Config:
        type_alias = "servequery:drift_method:RatioDriftMethod"
...
def ratio(
    ...
    Args:
        ...
        for a numerical feature implemented in servequery
...
class MMDDriftMethod(DriftMethod):
    class Config:
        type_alias = "servequery:drift_method:MMDDriftMethod"
