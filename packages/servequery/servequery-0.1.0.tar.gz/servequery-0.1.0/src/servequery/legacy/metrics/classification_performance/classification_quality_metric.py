...
from servequery.legacy.calculations.classification_performance import calculate_metrics
from servequery.legacy.core import IncludeTags
from servequery.legacy.metric_results import DatasetClassificationQuality
...
from servequery.legacy.metrics.classification_performance.confusion_matrix_metric import ClassificationConfusionMatrix
...
class ClassificationQualityMetricResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ClassificationQualityMetricResult"
        field_tags = {
...
class ClassificationQualityMetric(ThresholdClassificationMetric[ClassificationQualityMetricResult]):
    class Config:
        type_alias = "servequery:metric:ClassificationQualityMetric"
