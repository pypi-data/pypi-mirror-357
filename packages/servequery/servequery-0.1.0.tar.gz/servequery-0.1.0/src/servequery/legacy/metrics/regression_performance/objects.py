...
class PredActualScatter(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:PredActualScatter"
...
class RegressionScatter(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:RegressionScatter"
...
class IntervalSeries(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:IntervalSeries"
...
class RegressionMetricScatter(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:RegressionMetricScatter"
        smart_union = True
...
class RegressionMetricsScatter(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:RegressionMetricsScatter"
