...
from servequery.legacy.calculations.classification_performance import calculate_pr_table
...
class ClassificationPRTableResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ClassificationPRTableResults"
        pd_include = False
...
class ClassificationPRTable(Metric[ClassificationPRTableResults]):
    class Config:
        type_alias = "servequery:metric:ClassificationPRTable"
