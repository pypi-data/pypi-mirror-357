...
from servequery.legacy.renderers.html_widgets import histogram
...
class DatasetMissingValues(MetricResult):
    ...
    class Config:
        type_alias = "servequery:metric_result:DatasetMissingValues"
        pd_exclude_fields = {
...
class DatasetMissingValuesMetricResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:DatasetMissingValuesMetricResult"
...
class DatasetMissingValuesMetric(Metric[DatasetMissingValuesMetricResult]):
    class Config:
        type_alias = "servequery:metric:DatasetMissingValuesMetric"
