...
from servequery.legacy.base_metric import ColumnMetric
...
from servequery.legacy.calculations.data_quality import MAX_CATEGORIES
from servequery.legacy.calculations.data_quality import FeatureQualityStats
from servequery.legacy.calculations.data_quality import get_features_stats
from servequery.legacy.calculations.utils import choose_agg_period
...
from servequery.legacy.utils.visualizations import plot_distr
from servequery.legacy.utils.visualizations import plot_distr_with_log_button
...
from servequery.legacy.utils.visualizations import plot_time_feature_distr


class ColumnCharacteristics(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ColumnCharacteristics"
...
class NumericCharacteristics(ColumnCharacteristics):
    class Config:
        type_alias = "servequery:metric_result:NumericCharacteristics"
...
class CategoricalCharacteristics(ColumnCharacteristics):
    class Config:
        type_alias = "servequery:metric_result:CategoricalCharacteristics"
...
class DatetimeCharacteristics(ColumnCharacteristics):
    class Config:
        type_alias = "servequery:metric_result:DatetimeCharacteristics"
...
class TextCharacteristics(ColumnCharacteristics):
    class Config:
        type_alias = "servequery:metric_result:TextCharacteristics"
...
class DataInTimePlots(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:DataInTimePlots"
...
class DataInTime(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:DataInTime"
...
class DataByTarget(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:DataByTarget"
        smart_union = True
...
class DataQualityPlot(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:DataQualityPlot"
        dict_include = False
        pd_include = False
...
class ColumnSummaryResult(ColumnMetricResult):
    class Config:
        type_alias = "servequery:metric_result:ColumnSummaryResult"
        pd_name_mapping = {
...
class ColumnSummaryMetric(UsesRawDataMixin, ColumnMetric[ColumnSummaryResult]):
    class Config:
        type_alias = "servequery:metric:ColumnSummaryMetric"
