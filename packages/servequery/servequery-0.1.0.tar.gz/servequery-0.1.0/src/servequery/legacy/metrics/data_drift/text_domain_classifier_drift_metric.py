...
class TextDomainField(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:TextDomainField"
...
class TextDomainClassifierDriftResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:TextDomainClassifierDriftResult"
        field_tags = {
...
class TextDomainClassifierDriftMetric(Metric[TextDomainClassifierDriftResult]):
    class Config:
        type_alias = "servequery:metric:TextDomainClassifierDriftMetric"
