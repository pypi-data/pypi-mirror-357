...
from servequery.legacy.utils.visualizations import choose_agg_period
...
class ColumnValuePlotResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ColumnValuePlotResults"
        dict_include = False
        pd_include = False
...
class ColumnValuePlot(UsesRawDataMixin, Metric[ColumnValuePlotResults]):
    class Config:
        type_alias = "servequery:metric:ColumnValuePlot"
