...
from servequery.legacy.calculations.data_quality import calculate_category_correlation
...
class ColumnCorrelationsMetricResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ColumnCorrelationsMetricResult"
        field_tags = {
...
class ColumnCorrelationsMetric(Metric[ColumnCorrelationsMetricResult]):
    class Config:
        type_alias = "servequery:metric:ColumnCorrelationsMetric"
