...
class ConflictPredictionData(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ConflictPredictionData"
...
class ConflictPredictionMetricResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ConflictPredictionMetricResults"
...
class ConflictPredictionMetric(Metric[ConflictPredictionMetricResults]):
    class Config:
        type_alias = "servequery:metric:ConflictPredictionMetric"
