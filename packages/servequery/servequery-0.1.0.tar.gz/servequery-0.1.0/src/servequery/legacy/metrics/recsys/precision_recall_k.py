...
from servequery.legacy.calculations.recommender_systems import get_curr_and_ref_df
...
class PrecisionRecallCalculationResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:PrecisionRecallCalculationResult"
        pd_include = False
...
class PrecisionRecallCalculation(Metric[PrecisionRecallCalculationResult]):
    class Config:
        type_alias = "servequery:metric:PrecisionRecallCalculation"
