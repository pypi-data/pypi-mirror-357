...
class CategoryStat(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:CategoryStat"
...
class CountOfValues(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:CountOfValues"
...
class ColumnCategoryMetricResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ColumnCategoryMetricResult"
...
class ColumnCategoryMetric(Metric[ColumnCategoryMetricResult]):
    ...
    class Config:
        type_alias = "servequery:metric:ColumnCategoryMetric"
        smart_union = True
