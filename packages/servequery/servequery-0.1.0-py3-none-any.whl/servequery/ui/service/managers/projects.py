...
from servequery.ui.service.managers.auth import AuthManager
from servequery.ui.service.managers.auth import DefaultRole
from servequery.ui.service.managers.auth import Permission
from servequery.ui.service.managers.base import BaseManager
...
from servequery.ui.service.type_aliases import TeamID
...
class ProjectManager(BaseManager):
    ...
    async def save_project_dashboard(self, user_id: UserID, project_id: ProjectID, dashboard: DashboardModel):
        ...
        if len(dashboard.tabs) > 1:
            raise HTTPException(status_code=400, detail="Multiple tabs are not supported in ServeQuery OSS")
