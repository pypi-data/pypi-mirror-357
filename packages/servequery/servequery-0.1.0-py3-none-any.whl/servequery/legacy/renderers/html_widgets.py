...
from servequery.legacy.metric_results import LiftCurve
from servequery.legacy.metric_results import PRCurve
from servequery.legacy.metric_results import ROCCurve
from servequery.legacy.model.widget import BaseWidgetInfo
from servequery.legacy.model.widget import PlotlyGraphInfo
from servequery.legacy.model.widget import TabInfo
from servequery.legacy.model.widget import WidgetType
...
def get_lift_plot_data(
    ...
    color_options: ColorOptions
        Standard ServeQuery class-collection of colors for data visualization
