...
from servequery.legacy.base_metric import ColumnMetricResult
...
class QuantileStats(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:QuantileStats"
...
class ColumnQuantileMetricResult(ColumnMetricResult):
    class Config:
        type_alias = "servequery:metric_result:ColumnQuantileMetricResult"
        field_tags = {
...
class ColumnQuantileMetric(Metric[ColumnQuantileMetricResult]):
    class Config:
        type_alias = "servequery:metric:ColumnQuantileMetric"
