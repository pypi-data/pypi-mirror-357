...
from servequery.legacy.calculations.data_quality import calculate_correlations
...
from servequery.legacy.renderers.html_widgets import HeatmapData
from servequery.legacy.renderers.html_widgets import TabData
from servequery.legacy.renderers.html_widgets import get_heatmaps_widget
...
class CorrelationStats(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:CorrelationStats"
        field_tags = {
...
class DatasetCorrelation(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:DatasetCorrelation"
...
class DatasetCorrelationsMetricResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:DatasetCorrelationsMetricResult"
...
class DatasetCorrelationsMetric(Metric[DatasetCorrelationsMetricResult]):
    class Config:
        type_alias = "servequery:metric:DatasetCorrelationsMetric"
