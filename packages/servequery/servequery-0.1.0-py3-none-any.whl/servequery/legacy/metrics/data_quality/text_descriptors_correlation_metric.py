...
from servequery.legacy.calculations.data_quality import calculate_numerical_correlation
...
from servequery.legacy.metric_results import ColumnCorrelations
...
from servequery.legacy.renderers.html_widgets import get_histogram_for_distribution
...
class TextDescriptorsCorrelationMetricResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:TextDescriptorsCorrelationMetricResult"
        pd_include = False
        field_tags = {
...
class TextDescriptorsCorrelationMetric(Metric[TextDescriptorsCorrelationMetricResult]):
    class Config:
        type_alias = "servequery:metric:TextDescriptorsCorrelationMetric"
