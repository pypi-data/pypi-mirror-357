...
from servequery.legacy.metric_results import DistributionIncluded
...
class ValueListStat(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ValueListStat"
        field_tags = {
...
class ColumnValueListMetricResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ColumnValueListMetricResult"
        field_tags = {
...
class ColumnValueListMetric(Metric[ColumnValueListMetricResult]):
    class Config:
        type_alias = "servequery:metric:ColumnValueListMetric"
