...
from servequery.legacy.utils.visualizations import plot_bias


class ItemBiasMetricResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ItemBiasMetricResult"
        field_tags = {
...
class ItemBiasMetric(Metric[ItemBiasMetricResult]):
    class Config:
        type_alias = "servequery:metric:ItemBiasMetric"
