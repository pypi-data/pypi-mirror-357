...
from servequery.legacy.calculations.regression_performance import calculate_regression_performance
...
from servequery.legacy.metrics.regression_performance.objects import RegressionMetricScatter
from servequery.legacy.metrics.regression_performance.objects import RegressionMetricsScatter
from servequery.legacy.metrics.regression_performance.regression_performance_metrics import RegressionMetrics
from servequery.legacy.metrics.regression_performance.utils import apply_func_to_binned_data
from servequery.legacy.metrics.utils import make_target_bins_for_reg_plots
from servequery.legacy.metrics.utils import root_mean_squared_error_compat
...
class MoreRegressionMetrics(RegressionMetrics):
    class Config:
        type_alias = "servequery:metric_result:MoreRegressionMetrics"
...
class RegressionQualityMetricResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:RegressionQualityMetricResults"
...
class RegressionQualityMetric(Metric[RegressionQualityMetricResults]):
    class Config:
        type_alias = "servequery:metric:RegressionQualityMetric"
