...
from servequery.legacy.calculations.regression_performance import error_bias_table
from servequery.legacy.calculations.regression_performance import error_with_quantiles
...
class RegressionErrorBiasTableResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:RegressionErrorBiasTableResults"
...
class RegressionErrorBiasTable(UsesRawDataMixin, Metric[RegressionErrorBiasTableResults]):
    ...
    class Config:
        type_alias = "servequery:metric:RegressionErrorBiasTable"
