...
from servequery.legacy.metric_results import raw_agg_properties
from servequery.legacy.metrics.regression_performance.objects import PredActualScatter
from servequery.legacy.metrics.regression_performance.objects import RegressionScatter
from servequery.legacy.metrics.regression_performance.visualization import plot_error_bias_colored_scatter
...
from servequery.legacy.utils.visualizations import get_gaussian_kde
from servequery.legacy.utils.visualizations import is_possible_contour
from servequery.legacy.utils.visualizations import plot_top_error_contours


class TopData(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:TopData"
...
class AggTopData(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:AggTopData"
...
class RegressionTopErrorMetricResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:RegressionTopErrorMetricResults"
        dict_include = False
        pd_include = False
...
class RegressionTopErrorMetric(UsesRawDataMixin, Metric[RegressionTopErrorMetricResults]):
    class Config:
        type_alias = "servequery:metric:RegressionTopErrorMetric"
