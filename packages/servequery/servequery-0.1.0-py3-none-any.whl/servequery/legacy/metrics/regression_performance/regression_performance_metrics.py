...
class RegressionMetrics(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:RegressionMetrics"
...
class RegressionPerformanceMetricsResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:RegressionPerformanceMetricsResults"
...
class RegressionPerformanceMetrics(Metric[RegressionPerformanceMetricsResults]):
    class Config:
        type_alias = "servequery:metric:RegressionPerformanceMetrics"
