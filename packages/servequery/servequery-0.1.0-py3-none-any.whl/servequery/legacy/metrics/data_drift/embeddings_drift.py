...
from servequery.legacy.metrics.data_drift.embedding_drift_methods import model
...
class EmbeddingsDriftMetricResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:EmbeddingsDriftMetricResults"
        dict_exclude_fields = {
            "reference",
            "current",
        }
...
class EmbeddingsDriftMetric(Metric[EmbeddingsDriftMetricResults]):
    class Config:
        type_alias = "servequery:metric:EmbeddingsDriftMetric"
