...
from servequery.legacy.calculations.data_drift import get_drift_for_columns
from servequery.legacy.calculations.stattests import PossibleStatTestType
from servequery.legacy.metrics.data_drift.base import WithDriftOptions
...
class DatasetDriftMetricResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:DatasetDriftMetricResults"
...
class DatasetDriftMetric(
    ...
    class Config:
        type_alias = "servequery:metric:DatasetDriftMetric"
