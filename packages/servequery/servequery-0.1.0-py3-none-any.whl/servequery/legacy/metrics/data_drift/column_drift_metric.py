...
from servequery.legacy.calculations.data_drift import get_distribution_for_column
from servequery.legacy.calculations.data_drift import get_stattest
from servequery.legacy.calculations.data_drift import get_text_data_for_plots
...
class ColumnDriftMetric(UsesRawDataMixin, ColumnMetric[ColumnDataDriftMetrics]):
    class Config:
        type_alias = "servequery:metric:ColumnDriftMetric"
