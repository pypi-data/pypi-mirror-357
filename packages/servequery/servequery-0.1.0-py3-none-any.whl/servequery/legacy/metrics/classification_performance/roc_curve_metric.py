...
from servequery.legacy.metric_results import ROCCurveData
...
from servequery.legacy.renderers.html_widgets import get_roc_auc_tab_data
...
class ClassificationRocCurveResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ClassificationRocCurveResults"
        pd_include = False
...
class ClassificationRocCurve(Metric[ClassificationRocCurveResults]):
    class Config:
        type_alias = "servequery:metric:ClassificationRocCurve"
