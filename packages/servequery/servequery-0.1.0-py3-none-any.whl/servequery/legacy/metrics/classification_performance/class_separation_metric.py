...
from servequery.legacy.metric_results import ColumnScatterOrAgg
from servequery.legacy.metric_results import column_scatter_from_df
from servequery.legacy.metric_results import df_from_column_scatter
...
from servequery.legacy.renderers.html_widgets import get_class_separation_plot_data
from servequery.legacy.renderers.html_widgets import get_class_separation_plot_data_agg
...
class ClassificationClassSeparationPlotResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ClassificationClassSeparationPlotResults"
...
class ClassificationClassSeparationPlot(UsesRawDataMixin, Metric[ClassificationClassSeparationPlotResults]):
    class Config:
        type_alias = "servequery:metric:ClassificationClassSeparationPlot"
