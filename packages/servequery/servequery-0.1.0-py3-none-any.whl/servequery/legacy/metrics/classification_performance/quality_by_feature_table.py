...
from servequery.legacy.metric_results import StatsByFeature
...
class ClassificationQualityByFeatureTableResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ClassificationQualityByFeatureTableResults"
        field_tags = {
...
class ClassificationQualityByFeatureTable(UsesRawDataMixin, Metric[ClassificationQualityByFeatureTableResults]):
    class Config:
        type_alias = "servequery:metric:ClassificationQualityByFeatureTable"
