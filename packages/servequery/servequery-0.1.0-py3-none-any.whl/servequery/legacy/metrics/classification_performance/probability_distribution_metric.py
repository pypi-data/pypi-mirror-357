...
from servequery.legacy.renderers.html_widgets import GraphData
from servequery.legacy.renderers.html_widgets import WidgetSize
from servequery.legacy.renderers.html_widgets import plotly_graph_tabs
...
class ClassificationProbDistributionResults(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ClassificationProbDistributionResults"
        dict_include = False
        pd_include = False
...
class ClassificationProbDistribution(Metric[ClassificationProbDistributionResults]):
    class Config:
        type_alias = "servequery:metric:ClassificationProbDistribution"
