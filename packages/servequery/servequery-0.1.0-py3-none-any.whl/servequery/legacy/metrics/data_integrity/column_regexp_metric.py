...
class DataIntegrityValueByRegexpStat(MetricResult):
    ...
    class Config:
        type_alias = "servequery:metric_result:DataIntegrityValueByRegexpStat"
...
class DataIntegrityValueByRegexpMetricResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:DataIntegrityValueByRegexpMetricResult"
        field_tags = {
...
class ColumnRegExpMetric(Metric[DataIntegrityValueByRegexpMetricResult]):
    class Config:
        type_alias = "servequery:metric:ColumnRegExpMetric"
