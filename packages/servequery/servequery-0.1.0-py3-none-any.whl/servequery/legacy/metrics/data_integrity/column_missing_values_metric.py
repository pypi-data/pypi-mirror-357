...
from servequery.legacy.metrics.data_integrity.dataset_missing_values_metric import MissingValue
...
class ColumnMissingValues(MetricResult):
    ...
    class Config:
        type_alias = "servequery:metric_result:ColumnMissingValues"
...
class ColumnMissingValuesMetricResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:ColumnMissingValuesMetricResult"
        field_tags = {
...
class ColumnMissingValuesMetric(Metric[ColumnMissingValuesMetricResult]):
    class Config:
        type_alias = "servequery:metric:ColumnMissingValuesMetric"
