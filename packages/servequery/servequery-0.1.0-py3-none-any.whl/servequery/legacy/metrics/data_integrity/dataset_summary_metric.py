...
from servequery.legacy.calculations.data_integration import get_number_of_constant_columns
from servequery.legacy.calculations.data_integration import get_number_of_duplicated_columns
from servequery.legacy.calculations.data_integration import get_number_of_empty_columns
...
class DatasetSummary(MetricResult):
    ...
    class Config:
        type_alias = "servequery:metric_result:DatasetSummary"
...
class DatasetSummaryMetricResult(MetricResult):
    class Config:
        type_alias = "servequery:metric_result:DatasetSummaryMetricResult"
        field_tags = {
...
class DatasetSummaryMetric(Metric[DatasetSummaryMetricResult]):
    class Config:
        type_alias = "servequery:metric:DatasetSummaryMetric"
