...
from servequery.legacy.features.llm_judge import BinaryClassificationPromptTemplate
from servequery.legacy.features.llm_judge import LLMJudge
from servequery.legacy.features.llm_judge import MulticlassClassificationPromptTemplate
...
class LLMEval(BaseLLMEval):
    class Config:
        type_alias = "servequery:descriptor:LLMEval"
...
class BinaryClassificationLLMEval(BaseLLMEval):
    class Config:
        type_alias = "servequery:descriptor:BinaryClassificationLLMEval"
...
class NegativityLLMEval(BinaryClassificationLLMEval):
    class Config:
        type_alias = "servequery:descriptor:NegativityLLMEval"
...
class PIILLMEval(BinaryClassificationLLMEval):
    class Config:
        type_alias = "servequery:descriptor:PIILLMEval"
...
class DeclineLLMEval(BinaryClassificationLLMEval):
    class Config:
        type_alias = "servequery:descriptor:DeclineLLMEval"
...
class ContextQualityLLMEval(BinaryClassificationLLMEval):
    class Config:
        type_alias = "servequery:descriptor:ContextQualityLLMEval"
...
class BiasLLMEval(BinaryClassificationLLMEval):
    class Config:
        type_alias = "servequery:descriptor:BiasLLMEval"
...
class ToxicityLLMEval(BinaryClassificationLLMEval):
    class Config:
        type_alias = "servequery:descriptor:ToxicityLLMEval"
...
class CorrectnessLLMEval(BinaryClassificationLLMEval):
    class Config:
        type_alias = "servequery:descriptor:CorrectnessLLMEval"
...
class FaithfulnessLLMEval(BinaryClassificationLLMEval):
    class Config:
        type_alias = "servequery:descriptor:FaithfulnessLLMEval"
...
class CompletenessLLMEval(BinaryClassificationLLMEval):
    class Config:
        type_alias = "servequery:descriptor:CompletenessLLMEval"
...
class MulticlassClassificationLLMEval(BaseLLMEval):
    class Config:
        type_alias = "servequery:descriptor:MulticlassClassificationLLMEval"
