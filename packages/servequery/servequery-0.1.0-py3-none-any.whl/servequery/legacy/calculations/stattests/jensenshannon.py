...
Import:
    ...
    >>> from servequery.legacy.calculations.stattests import jensenshannon_stat_test
...
from servequery.legacy.calculations.stattests.utils import get_binned_data
