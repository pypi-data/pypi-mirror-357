...
class TestFilter(BaseModel):
    ...
    test_args: Dict[str, Union[ServeQueryBaseModel, Any]] = {}
    ...
    def __init__(
        ...
        *,
        test_id: Optional[str] = None,
        test_fingerprint: Optional[str] = None,
        test_args: Dict[str, Union[ServeQueryBaseModel, Any]] = None,
...
class DashboardPanelTestSuite(DashboardPanel):
    class Config:
        type_alias = "servequery:dashboard_panel:DashboardPanelTestSuite"
...
class DashboardPanelTestSuiteCounter(DashboardPanel):
    class Config:
        type_alias = "servequery:dashboard_panel:DashboardPanelTestSuiteCounter"
