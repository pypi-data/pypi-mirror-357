...
from servequery.pydantic_utils import FieldPath
...
class PanelValue(BaseModel):
    ...
    metric_args: Dict[str, Union[ServeQueryBaseModel, Any]] = {}
    ...
    def __init__(
        ...
        *,
        ...
        metric_id: Optional[str] = None,
        metric_fingerprint: Optional[str] = None,
        metric_args: Dict[str, Union[ServeQueryBaseModel, Any]] = None,
        legend: Optional[str] = None,
...
class DashboardPanel(EnumValueMixin, PolymorphicModel):
    class Config:
        type_alias = "servequery:dashboard_panel:DashboardPanel"
        is_base_type = True
...
register_type_alias(
    DashboardPanel, "servequery.ui.backport.DashboardPanelV2", "servequery:dashboard_panel:DashboardPanelV2"
)
register_type_alias(
    DashboardPanel,
    "servequery.ui.backport.SingleValueDashboardPanel",
    "servequery:dashboard_panel:SingleValueDashboardPanel",
)
