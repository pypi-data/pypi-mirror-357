...
from servequery.legacy.ui.dashboards.base import assign_panel_id
from servequery.legacy.ui.dashboards.utils import CounterAgg
from servequery.legacy.ui.dashboards.utils import HistBarMode
...
from servequery.legacy.ui.dashboards.utils import _get_metric_hover
...
class DashboardPanelPlot(DashboardPanel):
    class Config:
        type_alias = "servequery:dashboard_panel:DashboardPanelPlot"
...
class DashboardPanelCounter(DashboardPanel):
    class Config:
        type_alias = "servequery:dashboard_panel:DashboardPanelCounter"
...
class DashboardPanelDistribution(DashboardPanel):
    class Config:
        type_alias = "servequery:dashboard_panel:DashboardPanelDistribution"
...
register_type_alias(
    DashboardPanel, DashboardPanelHistogram.__get_classpath__(), "servequery:dashboard_panel:DashboardPanelHistogram"
)
