...
from servequery.legacy.features.generated_features import DataFeature
...
class HuggingFaceFeature(FeatureTypeFieldMixin, DataFeature):
    class Config:
        type_alias = "servequery:feature:HuggingFaceFeature"
...
class HuggingFaceToxicityFeature(DataFeature):
    class Config:
        type_alias = "servequery:feature:HuggingFaceToxicityFeature"
