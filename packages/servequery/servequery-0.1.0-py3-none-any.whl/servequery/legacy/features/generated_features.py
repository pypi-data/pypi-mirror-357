...
class GeneratedFeatures(ServeQueryBaseModel):
    class Config:
        is_base_type = True
...
class BaseDescriptor(ServeQueryBaseModel):
    class Config:
        type_alias = "servequery:descriptor:BaseDescriptor"
        is_base_type = True
...
class MultiColumnFeatureDescriptor(BaseDescriptor):
    class Config:
        type_alias = "servequery:descriptor:MultiColumnFeatureDescriptor"
        is_base_type = True
