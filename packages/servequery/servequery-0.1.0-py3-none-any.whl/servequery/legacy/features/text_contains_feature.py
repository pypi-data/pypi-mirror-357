...
class Contains(GeneratedFeature):
    class Config:
        type_alias = "servequery:feature:Contains"
...
class DoesNotContain(GeneratedFeature):
    class Config:
        type_alias = "servequery:feature:DoesNotContain"
...
class ItemMatch(GeneratedFeature):
    class Config:
        type_alias = "servequery:feature:ItemMatch"
...
class ItemNoMatch(GeneratedFeature):
    class Config:
        type_alias = "servequery:feature:ItemNoMatch"
