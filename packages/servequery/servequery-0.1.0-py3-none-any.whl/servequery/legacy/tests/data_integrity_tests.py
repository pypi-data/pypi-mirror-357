...
from servequery.legacy.metrics import ColumnRegExpMetric
from servequery.legacy.metrics import ColumnSummaryMetric
from servequery.legacy.metrics import DatasetMissingValuesMetric
from servequery.legacy.metrics import DatasetSummaryMetric
from servequery.legacy.metrics.data_integrity.dataset_missing_values_metric import DatasetMissingValues
from servequery.legacy.metrics.data_integrity.dataset_missing_values_metric import DatasetMissingValuesMetricResult
from servequery.legacy.metrics.data_integrity.dataset_summary_metric import DatasetSummary
...
from servequery.legacy.tests.utils import dataframes_to_table
from servequery.legacy.tests.utils import plot_dicts_to_table
...
class TestNumberOfColumns(BaseIntegrityValueTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfColumns"
...
class TestNumberOfRows(BaseIntegrityValueTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfRows"
...
class TestNumberOfDifferentMissingValues(BaseIntegrityMissingValuesValuesTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfDifferentMissingValues"
...
class TestNumberOfMissingValues(BaseIntegrityMissingValuesValuesTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfMissingValues"
...
class TestShareOfMissingValues(BaseIntegrityMissingValuesValuesTest):
    class Config:
        type_alias = "servequery:test:TestShareOfMissingValues"
...
class TestNumberOfColumnsWithMissingValues(BaseIntegrityMissingValuesValuesTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfColumnsWithMissingValues"
...
class TestShareOfColumnsWithMissingValues(BaseIntegrityMissingValuesValuesTest):
    class Config:
        type_alias = "servequery:test:TestShareOfColumnsWithMissingValues"
...
class TestNumberOfRowsWithMissingValues(BaseIntegrityMissingValuesValuesTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfRowsWithMissingValues"
...
class TestShareOfRowsWithMissingValues(BaseIntegrityMissingValuesValuesTest):
    class Config:
        type_alias = "servequery:test:TestShareOfRowsWithMissingValues"
...
class TestColumnNumberOfDifferentMissingValues(BaseIntegrityColumnMissingValuesTest):
    class Config:
        type_alias = "servequery:test:TestColumnNumberOfDifferentMissingValues"
...
class TestColumnNumberOfMissingValues(BaseIntegrityColumnMissingValuesTest):
    class Config:
        type_alias = "servequery:test:TestColumnNumberOfMissingValues"
...
class TestColumnShareOfMissingValues(BaseIntegrityColumnMissingValuesTest):
    class Config:
        type_alias = "servequery:test:TestColumnShareOfMissingValues"
...
class TestNumberOfConstantColumns(BaseIntegrityValueTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfConstantColumns"
...
class TestNumberOfEmptyRows(BaseIntegrityValueTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfEmptyRows"
...
class TestNumberOfEmptyColumns(BaseIntegrityValueTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfEmptyColumns"
...
class TestNumberOfDuplicatedRows(BaseIntegrityValueTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfDuplicatedRows"
...
class TestNumberOfDuplicatedColumns(BaseIntegrityValueTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfDuplicatedColumns"
...
class TestColumnAllConstantValues(BaseIntegrityOneColumnTest):
    class Config:
        type_alias = "servequery:test:TestColumnAllConstantValues"
...
class TestColumnAllUniqueValues(BaseIntegrityOneColumnTest):
    class Config:
        type_alias = "servequery:test:TestColumnAllUniqueValues"
...
class ColumnTypeParameter(TestParameters):
    class Config:
        type_alias = "servequery:test_parameters:ColumnTypeParameter"
...
class ColumnTypesParameter(TestParameters):
    class Config:
        type_alias = "servequery:test_parameters:ColumnTypesParameter"
...
class TestColumnsType(Test):
    class Config:
        type_alias = "servequery:test:TestColumnsType"
