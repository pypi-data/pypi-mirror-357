...
from servequery.legacy.metrics import ColumnDriftMetric
from servequery.legacy.metrics import DataDriftTable
from servequery.legacy.metrics import EmbeddingsDriftMetric
from servequery.legacy.metrics.data_drift.base import WithDriftOptionsFields
from servequery.legacy.metrics.data_drift.data_drift_table import DataDriftTableResults
...
from servequery.legacy.tests.base_test import ConditionTestParameters
from servequery.legacy.tests.base_test import ExcludeNoneMixin
...
from servequery.legacy.utils.visualizations import plot_contour_single
...
class ColumnDriftParameter(ExcludeNoneMixin, TestParameters):  # type: ignore[misc] # pydantic Config
    class Config:
        type_alias = "servequery:test_parameters:ColumnDriftParameter"
...
class ColumnsDriftParameters(ConditionTestParameters):
    ...
    class Config:
        type_alias = "servequery:test_parameters:ColumnsDriftParameters"
...
class TestNumberOfDriftedColumns(BaseDataDriftMetricsTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfDriftedColumns"
...
class TestShareOfDriftedColumns(BaseDataDriftMetricsTest):
    class Config:
        type_alias = "servequery:test:TestShareOfDriftedColumns"
...
class TestColumnDrift(Test):
    class Config:
        type_alias = "servequery:test:TestColumnDrift"
...
class TestEmbeddingsDrift(Test):
    class Config:
        type_alias = "servequery:test:TestEmbeddingsDrift"
