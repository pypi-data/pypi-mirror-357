...
from servequery.legacy.calculations.data_quality import get_corr_method
from servequery.legacy.core import ColumnType
from servequery.legacy.metric_results import HistogramData
from servequery.legacy.metrics import ColumnCategoryMetric
from servequery.legacy.metrics import ColumnQuantileMetric
from servequery.legacy.metrics import ColumnSummaryMetric
from servequery.legacy.metrics import ColumnValueListMetric
from servequery.legacy.metrics import ColumnValueRangeMetric
from servequery.legacy.metrics import ConflictPredictionMetric
from servequery.legacy.metrics import ConflictTargetMetric
from servequery.legacy.metrics import DatasetCorrelationsMetric
from servequery.legacy.metrics.data_integrity.column_summary_metric import CategoricalCharacteristics
from servequery.legacy.metrics.data_integrity.column_summary_metric import ColumnCharacteristics
from servequery.legacy.metrics.data_integrity.column_summary_metric import ColumnSummaryResult
from servequery.legacy.metrics.data_integrity.column_summary_metric import DatetimeCharacteristics
from servequery.legacy.metrics.data_integrity.column_summary_metric import NumericCharacteristics
from servequery.legacy.metrics.data_integrity.column_summary_metric import TextCharacteristics
from servequery.legacy.metrics.data_quality.column_category_metric import CategoryStat
from servequery.legacy.metrics.data_quality.dataset_correlations_metric import DatasetCorrelation
from servequery.legacy.model.widget import BaseWidgetInfo
from servequery.legacy.renderers.base_renderer import DetailsInfo
...
from servequery.legacy.tests.base_test import CheckValueParameters
from servequery.legacy.tests.base_test import ColumnCheckValueParameters
from servequery.legacy.tests.base_test import ConditionFromReferenceMixin
...
from servequery.legacy.tests.base_test import TestResult
...
from servequery.legacy.tests.utils import plot_correlations
from servequery.legacy.tests.utils import plot_value_counts_tables
from servequery.legacy.tests.utils import plot_value_counts_tables_ref_curr
...
class TestConflictTarget(Test):
    class Config:
        type_alias = "servequery:test:TestConflictTarget"
...
class TestConflictPrediction(Test):
    class Config:
        type_alias = "servequery:test:TestConflictPrediction"
...
class TestTargetPredictionCorrelation(BaseDataQualityCorrelationsMetricsValueTest):
    class Config:
        type_alias = "servequery:test:TestTargetPredictionCorrelation"
...
class TestHighlyCorrelatedColumns(BaseDataQualityCorrelationsMetricsValueTest):
    class Config:
        type_alias = "servequery:test:TestHighlyCorrelatedColumns"
...
class TestTargetFeaturesCorrelations(BaseDataQualityCorrelationsMetricsValueTest):
    class Config:
        type_alias = "servequery:test:TestTargetFeaturesCorrelations"
...
class TestPredictionFeaturesCorrelations(BaseDataQualityCorrelationsMetricsValueTest):
    class Config:
        type_alias = "servequery:test:TestPredictionFeaturesCorrelations"
...
class TestCorrelationChanges(BaseDataQualityCorrelationsMetricsValueTest):
    class Config:
        type_alias = "servequery:test:TestCorrelationChanges"
...
class TestColumnValueMin(BaseFeatureDataQualityMetricsTest):
    class Config:
        type_alias = "servequery:test:TestColumnValueMin"
...
class TestColumnValueMax(BaseFeatureDataQualityMetricsTest):
    class Config:
        type_alias = "servequery:test:TestColumnValueMax"
...
class TestColumnValueMean(BaseFeatureDataQualityMetricsTest):
    class Config:
        type_alias = "servequery:test:TestColumnValueMean"
...
class TestColumnValueMedian(BaseFeatureDataQualityMetricsTest):
    class Config:
        type_alias = "servequery:test:TestColumnValueMedian"
...
class TestColumnValueStd(BaseFeatureDataQualityMetricsTest):
    class Config:
        type_alias = "servequery:test:TestColumnValueStd"
...
class TestNumberOfUniqueValues(BaseFeatureDataQualityMetricsTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfUniqueValues"
...
class TestUniqueValuesShare(BaseFeatureDataQualityMetricsTest):
    class Config:
        type_alias = "servequery:test:TestUniqueValuesShare"
...
class TestMostCommonValueShare(BaseFeatureDataQualityMetricsTest):
    class Config:
        type_alias = "servequery:test:TestMostCommonValueShare"
...
class MeanInNSigmasParameter(TestParameters):
    class Config:
        type_alias = "servequery:test_parameters:MeanInNSigmasParameter"
...
class TestMeanInNSigmas(Test):
    class Config:
        type_alias = "servequery:test:TestMeanInNSigmas"
...
class TestValueRange(Test):
    class Config:
        type_alias = "servequery:test:TestValueRange"
...
class TestNumberOfOutRangeValues(BaseDataQualityValueRangeMetricsTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfOutRangeValues"
...
class ShareOfOutRangeParameters(CheckValueParameters):
    class Config:
        type_alias = "servequery:test_parameters:ShareOfOutRangeParameters"
...
class TestShareOfOutRangeValues(BaseDataQualityValueRangeMetricsTest):
    class Config:
        type_alias = "servequery:test:TestShareOfOutRangeValues"
...
class ColumnValueListParameters(TestParameters):
    class Config:
        type_alias = "servequery:test_parameters:ColumnValueListParameters"
...
class TestValueList(Test):
    class Config:
        type_alias = "servequery:test:TestValueList"
...
class TestNumberOfOutListValues(BaseDataQualityValueListMetricsTest):
    class Config:
        type_alias = "servequery:test:TestNumberOfOutListValues"
...
class ValueListParameters(CheckValueParameters):
    # todo: typing
    class Config:
        type_alias = "servequery:test_parameters:ValueListParameters"
...
class TestShareOfOutListValues(BaseDataQualityValueListMetricsTest):
    class Config:
        type_alias = "servequery:test:TestShareOfOutListValues"
...
class TestColumnQuantile(BaseCheckValueTest):
    class Config:
        type_alias = "servequery:test:TestColumnQuantile"
...
class TestCategoryShare(BaseDataQualityCategoryMetricsTest):
    class Config:
        type_alias = "servequery:test:TestCategoryShare"
...
class TestCategoryCount(BaseDataQualityCategoryMetricsTest):
    class Config:
        type_alias = "servequery:test:TestCategoryCount"
