...
from servequery.legacy.metrics import ColumnCorrelationsMetric
from servequery.legacy.metrics import ColumnDriftMetric
from servequery.legacy.metrics import ColumnValuePlot
from servequery.legacy.metrics import TargetByFeaturesTable
...
class TargetDriftPreset(MetricPreset):
    class Config:
        type_alias = "servequery:metric_preset:TargetDriftPreset"
