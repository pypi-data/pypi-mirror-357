...
from servequery.legacy.descriptors.llm_judges import BaseLLMEval
from servequery.legacy.features.custom_feature import CustomFeature
...
REPLACES = {
    ...
    "servequery.utils.data_preprocessing.DataDefinition": "DataDefinition",
    "pandas.core.series.Series": "Series",
    "servequery.features.llm_judge.Uncertainty": "Uncertainty",
    "servequery.legacy.features.llm_judge.Uncertainty": "Uncertainty",
}
