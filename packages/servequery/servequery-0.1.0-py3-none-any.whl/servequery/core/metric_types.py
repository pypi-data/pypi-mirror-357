...
class MetricTest(AutoAliasMixin, ServeQueryBaseModel):
    class Config:
        is_base_type = True
...
class BoundTest(AutoAliasMixin, ServeQueryBaseModel, Generic[TResult], ABC):
    class Config:
        is_base_type = True
...
class Metric(AutoAliasMixin, ServeQueryBaseModel, Generic[TCalculation]):
