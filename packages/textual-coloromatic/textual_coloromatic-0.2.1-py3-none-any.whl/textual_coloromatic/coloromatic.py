...
class Coloromatic(Widget):
    ...
    def self_updated(self) -> None:
        ...
        # Explanation: This will ensure that any children inside the Coloromatic
        # will also be refreshed and re-rendered to take the new settings into account.
        # Mostly for size changes.
