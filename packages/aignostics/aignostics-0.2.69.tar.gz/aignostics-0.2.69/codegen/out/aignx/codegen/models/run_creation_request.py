...
class RunCreationRequest(BaseModel):
    """
    Application run payload. It describes which application version is chosen, and which user data should be processed.
    """ # noqa: E501
    application_version_id: StrictStr = Field(description="Application version ID")
    items: List[ItemCreationRequest] = Field(description="List of the items to process by the application")
    __properties: ClassVar[List[str]] = ["application_version_id", "items"]
