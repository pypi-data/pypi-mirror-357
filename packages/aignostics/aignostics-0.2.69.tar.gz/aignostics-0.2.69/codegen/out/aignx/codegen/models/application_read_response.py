...
class ApplicationReadResponse(BaseModel):
    ...
    regulatory_classes: List[StrictStr] = Field(description="Regulatory class, to which the applications compliance")
    description: StrictStr = Field(description="Application documentations")
    __properties: ClassVar[List[str]] = ["application_id", "name", "regulatory_classes", "description"]
