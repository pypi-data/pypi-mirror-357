...
from aignx.codegen.models.transfer_urls import TransferUrls
from typing import Optional, Set
from typing_extensions import Self

class PayloadOutputArtifact(BaseModel):
    """
    PayloadOutputArtifact
    """ # noqa: E501
    output_artifact_id: StrictStr
    data: TransferUrls
    metadata: TransferUrls
    __properties: ClassVar[List[str]] = ["output_artifact_id", "data", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PayloadOutputArtifact from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PayloadOutputArtifact from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": TransferUrls.from_dict(obj["data"]) if obj.get("data") is not None else None,
