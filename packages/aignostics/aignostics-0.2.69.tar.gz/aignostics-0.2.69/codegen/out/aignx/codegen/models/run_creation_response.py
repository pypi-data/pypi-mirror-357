...
class RunCreationResponse(BaseModel):
    ...
    RunCreationResponse
    """ # noqa: E501
    application_run_id: Optional[StrictStr] = 'Application run id'
    __properties: ClassVar[List[str]] = ["application_run_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RunCreationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RunCreationResponse from a dict"""
        if obj is None:
            return None
