#!/usr/bin/env python3
from .core import ask_gemini, unroll_prompt_from_file, unroll_prompt
...
def refactor_code(replace_map: Dict[str, str], directory: str) -> Tuple[str, str]:
    ...
    bash_file_code: str = ask_gemini(refactor_prompt, "pro")
    logger.info(
...
def summarize_work_done(replace_map: Dict[str, str], directory: str) -> str:
    ...
    summary: str = ask_gemini(summary_prompt, "pro")
    logger.info(
...
def checkpoint_next_action(replace_map: Dict[str, str], directory: str) -> str:
    ...
    result: str = ask_gemini(checkpoint_prompt, "pro")
