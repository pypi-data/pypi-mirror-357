...
from .core import unroll_prompt_from_file, ask_gemini
...
def reduce_review_input_content(
    input_content: str, reasoning_effort: str = "pro"
) -> str:
    ...
    reduced_input_content = ask_gemini(user_prompt, reasoning_effort)
...
def create_review_from_changes_input(
    ...
    review_message = ask_gemini(user_prompt, reasoning_effort)
