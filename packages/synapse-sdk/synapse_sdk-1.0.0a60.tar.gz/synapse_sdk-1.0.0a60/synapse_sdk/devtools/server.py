...
class DevtoolsServer:
    def __init__(self, host: str = '127.0.0.1', port: int = 8080, plugin_directory: str = None):
        self.host = host
        self.port = port
...
def create_devtools_server(host: str = '127.0.0.1', port: int = 8080, plugin_directory: str = None) -> DevtoolsServer:
