...
def get_framework(model: "SimpleCNN") -> str:
    """Determine the framework of the model."""
    return "numpy"  # Since we're using NumPy implementation


class FGSM:
    def __init__(self, model: "SimpleCNN", epsilon: float = 0.01):
        """
    ...
    def generate(self, x: np.ndarray, y: np.ndarray, 
        ...
        Returns:
            Tuple of (adversarial_examples, original_predictions, adversarial_predictions)
        """
