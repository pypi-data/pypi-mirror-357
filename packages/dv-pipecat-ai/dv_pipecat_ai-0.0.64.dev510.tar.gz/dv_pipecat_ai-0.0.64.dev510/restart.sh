...
# Step 1: Find the container ID of the running or stopped 'plivo-chatbot' container
...
if [ -n "$container_id" ]; then
    ...
    echo "No existing container found for plivo-chatbot. Please run the deployment script first."
fi