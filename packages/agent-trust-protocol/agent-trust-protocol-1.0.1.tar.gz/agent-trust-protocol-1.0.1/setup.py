...
setup(
    ...
    description="A comprehensive security and provenance framework for secure, trustworthy communication between autonomous AI agents",
    ...
    entry_points={
        "console_scripts": [
            "atp-demo=atp.examples.async_demo:main",
        ],
    },
