-- Generated Test Case: extreme_11
-- Complexity: extreme
-- Valid: False
-- Non-Idempotent: True
-- Features: polymorphic functions, circular dependencies

-- Example 2: Creating a table with a deeply nested structure and a dynamic SQL query
...
INSERT INTO customers (name, address) VALUES ('Jane Doe', '{"street": "123 Main St", "city": "Anytown", "state": "CA", "zip": "12345"}'::jsonb);
