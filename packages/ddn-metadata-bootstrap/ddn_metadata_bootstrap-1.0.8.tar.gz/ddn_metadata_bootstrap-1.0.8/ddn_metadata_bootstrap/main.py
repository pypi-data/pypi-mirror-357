...
Examples:
  ...
  python -m metadata_bootstrap
    ...
    gen_group.add_argument('--relationships-only', action='store_true',
...
def create_bootstrapper_from_args(args: argparse.Namespace) -> MetadataBootstrapper:
    ...
    api_key = args.api_key or config.api_key
    kwargs = {
        'use_case': args.use_case or config.get_io_config()['use_case'],
        'model': args.model,
        ...
        'relationships_only': args.relationships_only,  # Add this line
    }
...
def main():
    ...
    try:
        ...
        if mode == 'directory':
            ...
            bootstrapper.process_file(params['input_file'], params['output_file'])
