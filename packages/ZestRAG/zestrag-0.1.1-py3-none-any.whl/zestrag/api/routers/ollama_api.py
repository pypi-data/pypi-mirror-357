...
from zestrag.utils import logger
import time
import json
import re
...
from zestrag.utils import TiktokenTokenizer
from zestrag.api.utils_api import ollama_server_infos, get_combined_auth_dependency
from fastapi import Depends


# query mode according to query prefix (bypass is not ZestRAG quer mode)
...
class OllamaAPI:
    def __init__(self, rag: ZestRAG, top_k: int = 60, api_key: Optional[str] = None):
        self.rag = rag
    ...
    def setup_routes(self):
        ...
        async def generate(raw_request: Request):
            ...
            For compatibility purpose, the request is not processed by ZestRAG,
        ...
        async def chat(raw_request: Request):
            ...
            Routes user queries through ZestRAG by selecting query mode based on prefix indicators.
