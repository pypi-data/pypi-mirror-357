...
class OllamaServerInfos:
    ...
    LIGHTRAG_NAME = "zestrag"
    LIGHTRAG_TAG = os.getenv("OLLAMA_EMULATING_MODEL_TAG", "latest")
    LIGHTRAG_MODEL = f"{LIGHTRAG_NAME}:{LIGHTRAG_TAG}"
    LIGHTRAG_SIZE = 7365960935  # it's a dummy value
    LIGHTRAG_CREATED_AT = "2024-01-15T00:00:00Z"
    LIGHTRAG_DIGEST = "sha256:zestrag"
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="ZestRAG FastAPI Server with separate working and input directories"
    )
    ...
    parser.add_argument(
        ...
        help="API key for authentication. This protects zestrag server against unauthorized access",
    )
    ...
    args.token_secret = get_env_value("TOKEN_SECRET", "zestrag-jwt-default-secret")
