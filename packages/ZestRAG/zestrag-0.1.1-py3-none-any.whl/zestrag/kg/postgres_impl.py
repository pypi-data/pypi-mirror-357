...
from zestrag.types import KnowledgeGraph, KnowledgeGraphNode, KnowledgeGraphEdge
...
class PGGraphStorage(BaseGraphStorage):
    def __post_init__(self):
        self.graph_name = self.namespace or os.environ.get("AGE_GRAPH_NAME", "zestrag")
    ...
    async def upsert_edge(
        ...
        query = """SELECT * FROM cypher('%s', $$
            ...
            tgt_label,
            edge_properties,
            edge_properties,  # https://github.com/HKUDS/ZestRAG/issues/1438#issuecomment-2826000195
        )
