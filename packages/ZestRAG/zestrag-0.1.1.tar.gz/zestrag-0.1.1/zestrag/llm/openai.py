...
from zestrag.utils import (
    wrap_embedding_func_with_attrs,
    locate_json_string_body_from_string,
    safe_unicode_decode,
    logger,
)
from zestrag.types import GPTKeywordExtractionFormat
from zestrag.api import __api_version__
...
def create_openai_async_client(
    ...
    default_headers = {
        "User-Agent": f"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_8) ZestRAG/{__api_version__}",
