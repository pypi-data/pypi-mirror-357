#!/usr/bin/env python
"""
Start ZestRAG server with Gunicorn
"""
...
from zestrag.api.utils_api import display_splash_screen, check_env_file
from zestrag.api.config import global_args
from zestrag.utils import get_env_value
from zestrag.kg.shared_storage import initialize_share_data, finalize_share_data
...
def main():
    ...
    print("🚀 Starting ZestRAG with Gunicorn")
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from zestrag.api import gunicorn_config
        ...
        def load(self):
            ...
            from zestrag.api.zestrag_server import get_application
