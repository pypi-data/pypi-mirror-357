"""
Utility functions for the ZestRAG API.
"""
...
from zestrag.api import __api_version__ as api_version
from zestrag import __version__ as core_version
...
def display_splash_screen(args: argparse.Namespace) -> None:
    """
    Display a colorful splash screen showing ZestRAG server configuration
    ...
    ASCIIColors.cyan(f"""
    ╔══════════════════════════════════════════════════════════════╗
    ║                  🚀 ZestRAG Server v{core_version}/{api_version}              ║
