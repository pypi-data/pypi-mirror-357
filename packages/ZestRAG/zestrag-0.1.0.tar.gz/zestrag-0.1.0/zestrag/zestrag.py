...
@dataclass
class ZestRAG:
    """ZestRAG: Simple and Fast Retrieval-Augmented Generation."""

    # Directory
    # ---

    working_dir: str = field(
        default=f"./zestrag_cache_{datetime.now().strftime('%Y-%m-%d-%H:%M:%S')}"
    )
    ...
    """If True, zestrag will automatically calls initialize_storages and finalize_storages at the appropriate times."""
    ...
    def __post_init__(self):
        ...
        logger.debug(f"ZestRAG init with param:\n  {_print_config}\n")
