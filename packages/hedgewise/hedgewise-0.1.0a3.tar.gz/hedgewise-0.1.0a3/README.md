# Hedgewise Python API library

[![PyPI version](<https://img.shields.io/pypi/v/hedgewise.svg?label=pypi%20(stable)>)](https://pypi.org/project/hedgewise/)
...
```sh
# install from PyPI
pip install --pre hedgewise[aiohttp]
```
...
import os
import asyncio
from hedgewise import DefaultAioHttpClient
from hedgewise import AsyncHedgewise


async def main() -> None:
    async with AsyncHedgewise(
        api_key=os.environ.get("HEDGEWISE_API_KEY"),  # This is the default and can be omitted
