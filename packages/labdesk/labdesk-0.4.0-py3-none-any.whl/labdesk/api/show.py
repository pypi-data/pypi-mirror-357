...
DATABASE_FILE = os.path.join(PROJECT_DIR, ".labdesk", "database.txt")
...
def display_experiment_details():
    ...
    with open(DATABASE_FILE, 'r') as db_file:
        ...
        for line in db_file:
            ...
            STATUS_FILE = os.path.join(EXP_PATH, ".labdesk", "status.txt")
            ...
            COMMENT_FILE = os.path.join(EXP_PATH, ".labdesk", "description.txt")
