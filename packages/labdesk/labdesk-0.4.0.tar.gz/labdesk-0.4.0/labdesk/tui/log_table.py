...
import labdesk.utils.config as cfg
...
class LogViewerApp(App):
    ...
    def __init__(self):
        super().__init__()
        self.log_dir = Path.cwd() if cfg.labdesk_config is None or cfg.labdesk_config.Runner.logs_path is None else cfg.labdesk_config.Runner.logs_path
