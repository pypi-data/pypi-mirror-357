...
import labdesk
from labdesk.tui.log_table import log_table_tui
import labdesk.utils.config as cfg
import labdesk.utils.project as project

from labdesk import api
import typer
from typing_extensions import Annotated

from clearconf import BaseConfig

from labdesk.cli import manager
from labdesk.cli import runner
from labdesk.utils.logging import logger
# import debugpy
# debugpy.listen(5678)
...
def config(
    ...
    if project:
        ...
        rich.print(json.dumps(cfg.labdesk_config.to_dict(), indent=4))
...
def setup(verbose: bool = False):
    """
    labdesk CLI can be used to prepare
