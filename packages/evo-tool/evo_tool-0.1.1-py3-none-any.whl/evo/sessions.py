...
def load_sessions(project_filter: str | None = None) -> list[Session]:
    ...
    # Sort by last activity (oldest first, like usage data)
    session_list.sort(key=lambda s: s.last_activity or datetime.min)
...
def display_sessions(console: Console, project_name: str | None = None, limit: int = 10) -> None:
    ...
    # Load sessions
    sessions = load_sessions(project_filter=project_name)
