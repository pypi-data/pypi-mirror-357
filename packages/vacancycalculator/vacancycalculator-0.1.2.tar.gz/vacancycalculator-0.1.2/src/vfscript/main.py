...
def main():
    ...
    # Intenta buscar en el directorio actual del usuario (no en site-packages)
    json_path = os.path.abspath("input_params.json")

    if not os.path.exists(json_path):
        raise FileNotFoundError(f"No se encontró 'input_params.json' en el directorio de trabajo: {json_path}")
    ...
    json_params = os.path.join(os.getcwd(), "input_params.json")
