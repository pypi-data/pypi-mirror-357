    ...
    def start_bot(self):
        ...
        if self.process_data:
            ...
            if function_name == 'keep':
                ...
                excel_folder_path, excel_file_name, text_folder_path, text_file_name, sheet_name, save_column_names = (
                ...
                self.save_excel_data_into_text(excel_folder_path, excel_file_name, text_folder_path, text_file_name, sheet_name, save_column_names)
