...
AVAILABLE_FIELDS = {
    "id", "source_language", "target_language", "word", "transliteration", "additional_source_languages",
    "relations", "similar_words", "alternative_spellings", "multiple_spellings", "synonyms",
    "pronunciations", "abbreviations", "inflections", "definitions", "examples", "categories", "translations"
}
...
def main() -> None:
    ...
    try:
        result = sk.search(args.word, args.source, args.target)
        ...
        try:
            ...
            return print("\033[31mERROR\033[0m:", e)
