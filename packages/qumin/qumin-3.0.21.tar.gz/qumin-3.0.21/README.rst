...
- Beniamine & Bouton. (2025). Qumin (v\ 2.<version used>). [Python package]. doi: `10.5281/zenodo.15008373 <https://doi.org/10.5281/zenodo.15008373>`_ `https://pypi.org/project/qumin/ <https://pypi.org/project/qumin/>`_
...
`patterns` provides more details on patterns.
