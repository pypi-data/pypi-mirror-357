...
def find_all_local_file_names(source_folder_name: str="" , base_directory:str=".") -> List[str]:
    """
    ...
    search_pattern = os.path.normpath(os.path.join(base_directory,source_folder_name, "**"))
