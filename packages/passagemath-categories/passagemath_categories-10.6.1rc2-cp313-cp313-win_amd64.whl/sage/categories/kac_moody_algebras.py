...
class KacMoodyAlgebras(Category_over_base_ring):
    ...
    def example(self, n=2):
        ...
        EXAMPLES::
            ...
            sage: from sage.categories.kac_moody_algebras import KacMoodyAlgebras
            sage: KacMoodyAlgebras(QQ).example()                                        # needs sage.combinat sage.graphs sage.modules
            Lie algebra of ['A', 2] in the Chevalley basis

        We can specify the rank of the example::

            sage: KacMoodyAlgebras(QQ).example(4)                                       # needs sage.combinat sage.graphs sage.modules
    ...
    class ParentMethods:
        def cartan_type(self):
            ...
            EXAMPLES::
                ...
                sage: L = LieAlgebra(QQ, cartan_type=['A', 2])                          # needs sage.combinat sage.graphs sage.modules
                sage: L.cartan_type()                                                   # needs sage.combinat sage.graphs sage.modules
                ['A', 2]
            """
        ...
        def weyl_group(self):
            ...
            EXAMPLES::
                ...
                sage: L = LieAlgebra(QQ, cartan_type=['A', 2])                          # needs sage.combinat sage.graphs sage.modules
                sage: L.weyl_group()                                                    # needs sage.combinat sage.graphs sage.modules
