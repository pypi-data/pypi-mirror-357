...
class EntitiesSearchBuilder(SearchBuilderBase, SearchBuilder):
    ...
    def build_execute(self):
        ...
        Example:
            ~~~python
                new_entities_search_builder.with_format("csv").with_organization_name(organization).build_execute()
    ...
    def execute(self):
        ...
        Example:
            ~~~python
                new_entities_search_builder.with_format("csv").with_organization_name(organization).build().execute()
