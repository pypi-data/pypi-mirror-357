...
class OpenGateClient:
    ...
    def __init__(self, url: str | None = None, user: str | None = None, password: str | None = None,
        ...
        if self.user and self.password:
            ...
            raise ValueError('You must provide either a user and password or an API key or JWT Token, either as a parameter or in the environment variable API_KEY, or TOKEN_JWT')
