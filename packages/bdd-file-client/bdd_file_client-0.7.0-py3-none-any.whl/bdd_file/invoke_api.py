...
def list_files_in_directory(
    service_url: str, directory_id: int, user_id: str, sort_by: FileSortBy | None, page_size: int, page_number: int
) -> requests.Response:
    return requests.get(
        f"{service_url}/listFilesInDirectory",
        params={"directory_id": directory_id, "sort_by": sort_by, "page_size": page_size, "page_number": page_number},
        headers={"X-User-Id": user_id},
    )
