...
def __bootstrap__():
   ...
   so_file = os.path.join(os.path.dirname(__file__),f"lleidaseeker.cpython-{py_version}-{os_name}.so")
   spec = importlib.util.spec_from_file_location("lleidaseeker", so_file)
