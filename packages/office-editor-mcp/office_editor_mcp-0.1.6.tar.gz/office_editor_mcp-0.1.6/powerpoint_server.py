...
@mcp.tool()
def add_slide(prs_id: str, layout_name: str = "Title and Content") -> str:
    """
...
@mcp.tool()
def add_slides_bulk(prs_id: str, layouts: List[str]) -> str:
    """
    一次性添加多张幻灯片。
    layouts: 每张幻灯片的布局名称列表。
    """
    if prs_id not in presentations:
