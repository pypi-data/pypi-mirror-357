...
import pytest
import numpy as np
from algomake.base import BaseEstimator, ClassifierMixin, RegressorMixin, TransformerMixin
from algomake.metrics.classification import accuracy_score # Add this
from algomake.metrics.regression import mean_absolute_error # Add this
...
def test_classifier_mixin_score(dummy_classifier, monkeypatch):
    ...
    monkeypatch.setattr('algomake.metrics.classification', MockAccuracy())
...
def test_regressor_mixin_score(dummy_regressor, monkeypatch):
    ...
    monkeypatch.setattr('algomake.metrics.regression', MockMAE())
