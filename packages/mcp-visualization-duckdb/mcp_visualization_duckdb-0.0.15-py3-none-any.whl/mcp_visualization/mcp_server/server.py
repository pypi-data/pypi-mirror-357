    ...
    async def initialize(self):
        ...
        try:
            ...
            try:
                ...
                print("🔄 Using mock database manager for testing...", file=sys.stderr)
                # Create a mock database manager that doesn't use DuckDB
                self.db_manager = None
                print("✅ Mock database manager ready", file=sys.stderr)
