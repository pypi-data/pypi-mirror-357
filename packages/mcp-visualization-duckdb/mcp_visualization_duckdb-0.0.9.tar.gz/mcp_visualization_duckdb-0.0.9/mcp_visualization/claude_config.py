        ...
        if database_path is not None:
            ...
            if create_sample_db:
                ...
                try:
                    ...
                    print(f"❌ {error_msg}")
                    print(f"⚠️  Continuing without sample database - you can connect to existing databases via Claude Desktop")
                    # Remove the database environment variable if creation failed
