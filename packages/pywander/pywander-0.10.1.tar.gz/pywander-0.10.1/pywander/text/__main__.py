...
from pywander.text.encoding import print_encoding_convert_tab
from pywander.text.pinyin import create_pinyin_string
...
def convert(infile, outputformat, metadata, resource):
    ...
    if outputformat == 'epub':
        from pywander.text.pandoc import convert_tex_to_epub
