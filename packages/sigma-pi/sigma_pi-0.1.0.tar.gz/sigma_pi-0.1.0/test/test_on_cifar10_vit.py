...
def main():
    ...
    model = timm.create_model('vit_tiny_patch16_224', pretrained=False, num_classes=10, img_size=32).to(device)
    ...
    plot_metrics(step_metrics, epoch_metrics, output_dir, model_name="ViT-CIFAR10-OOD_Step")
