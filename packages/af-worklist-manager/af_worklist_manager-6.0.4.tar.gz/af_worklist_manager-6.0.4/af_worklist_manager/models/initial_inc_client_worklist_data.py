...
class InitialIncClientWorklistData(DummyParent):
    ...
    def __init__(self, sub_class=None, inc_wl_id=None, rem_alive_time=None, closed=None, worklist_id=None, agent=None, revision=None, user_attributes=None, client_worklist_id=None, wu_conf=None, cw_items=None, *args, **kwargs):  # noqa: E501
