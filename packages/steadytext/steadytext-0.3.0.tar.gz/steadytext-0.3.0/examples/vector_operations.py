...
def demo_similarity():
    ...
    # Similar texts
    result = run_command('st vector similarity "machine learning" "artificial intelligence"')
...
def demo_search():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        result = run_command(f'st vector search "software development" {tmpdir}/*.txt --json')
        data = json.loads(result)
