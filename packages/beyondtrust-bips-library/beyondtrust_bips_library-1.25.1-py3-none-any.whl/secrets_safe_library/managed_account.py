    ...
    def get_create_schema(self):
        ...
        return {
            **self.common_schema,
            ...
            "change_frequency_days": {"type": "integer", "min": 1, "max": 999},
            "change_time": {
                "type": "string",
...
class ManagedAccount(
    APIObject, DeleteByIdMixin, GetByIdMixin, _ManagedAccountValidator
):
    """
    ...
    def __init__(self, authentication, logger=None, separator="/"):
        super().__init__(authentication, logger, endpoint="/managedaccounts")
    ...
    def create_managed_account(
        ...
        *,
        ...
        utils.print_log(
            self._logger,
            f"Calling create_managed_account endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_post_request(
            endpoint,
    ...
    def assign_attribute(self, managed_account_id: int, attribute_id: int) -> dict:
        ...
        utils.print_log(
            self._logger,
            f"Calling assign_attribute endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_post_request(
    ...
    def delete_attribute(self, managed_account_id: int, attribute_id: int) -> None:
        ...
        utils.print_log(
            self._logger,
            f"Calling delete_attribute endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def delete_all_attributes(self, managed_account_id: int) -> dict:
        ...
        utils.print_log(
            self._logger,
            f"Calling delete_all_attributes endpoint: {endpoint}",
            logging.DEBUG,
        )
        self._run_delete_request(endpoint)
