...
addon_info = {
	...
	"addon_summary": _("${addon_name}"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("""${addon_description}"""),
	# version
	"addon_version": "${version}",
	# Author(s)
	"addon_author": "${username}",
	...
	"addon_minimumNVDAVersion": "${addon_minimumNVDAVersion}",
	# Last NVDA version supported/tested (e.g. "2018.4.0", ideally more recent than minimum version)
	"addon_lastTestedNVDAVersion": "${addon_lastTestedNVDAVersion}",
