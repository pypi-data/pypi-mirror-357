...
""" Runner for standalone program tests of nexium.
...
# Find qutayba package relative to us. The replacement is for POSIX python
...
from qutayba.tools.testing.RuntimeTracing import (
...
from qutayba.utils.Utils import isBSD, isLinux, isMacOS, isWin32Windows
