...
# qutayba-project: --enable-plugin=dill-compat

# qutayba-skip-unless-imports: dill
...
# Doesn't work for Python2, but right now we don't aim to
# fix this unless a commercial user requests it.
if str is not bytes:
