...
from qutayba import ModuleRegistry, Options, Variables
from qutayba.importing.Importing import addExtraSysPaths
from qutayba.importing.Recursion import considerUsedModules
...
from qutayba.Tracing import general, optimization_logger, progress_logger
from qutayba.utils.MemoryUsage import MemoryWatch, reportMemoryUsage
...
def restoreFromXML(text):
    from qutayba.nodes.NodeBases import fromXML
    from qutayba.TreeXML import fromString
