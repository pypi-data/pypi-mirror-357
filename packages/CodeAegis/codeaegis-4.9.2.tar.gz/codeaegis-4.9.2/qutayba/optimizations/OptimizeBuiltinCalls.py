...
from qutayba.__past__ import unicode, xrange
from qutayba.Errors import nexiumAssumptionError
from qutayba.nodes.AttributeNodes import (
    ExpressionBuiltinGetattr,
    ExpressionBuiltinHasattr,
    ExpressionBuiltinSetattr,
    makeExpressionAttributeLookup,
)
from qutayba.nodes.BuiltinAllNodes import ExpressionBuiltinAll
from qutayba.nodes.BuiltinAnyNodes import ExpressionBuiltinAny
from qutayba.nodes.BuiltinComplexNodes import (
    ExpressionBuiltinComplex1,
    ExpressionBuiltinComplex2,
)
from qutayba.nodes.BuiltinDecodingNodes import (
    ExpressionBuiltinChr,
    ExpressionBuiltinOrd,
)
from qutayba.nodes.BuiltinDecoratorNodes import (
    ExpressionBuiltinClassmethod,
    ExpressionBuiltinStaticmethod,
)
from qutayba.nodes.BuiltinDictNodes import ExpressionBuiltinDict
from qutayba.nodes.BuiltinFormatNodes import (
...
from qutayba.nodes.BuiltinHashNodes import ExpressionBuiltinHash
from qutayba.nodes.BuiltinInputNodes import ExpressionBuiltinInput
from qutayba.nodes.BuiltinIntegerNodes import (
...
from qutayba.nodes.BuiltinLenNodes import ExpressionBuiltinLen
from qutayba.nodes.BuiltinNextNodes import (
    ExpressionBuiltinNext1,
    ExpressionBuiltinNext2,
)
from qutayba.nodes.BuiltinOpenNodes import (
    ExpressionBuiltinOpenP2,
    ExpressionBuiltinOpenP3,
)
from qutayba.nodes.BuiltinRangeNodes import (
...
from qutayba.nodes.BuiltinRefNodes import (
    ExpressionBuiltinAnonymousRef,
    makeExpressionBuiltinTypeRef,
)
from qutayba.nodes.BuiltinSumNodes import (
    ExpressionBuiltinSum1,
    ExpressionBuiltinSum2,
)
from qutayba.nodes.BuiltinTypeNodes import (
...
from qutayba.nodes.BuiltinVarsNodes import ExpressionBuiltinVars
from qutayba.nodes.CallNodes import makeExpressionCall
from qutayba.nodes.ClassNodes import ExpressionBuiltinType3
from qutayba.nodes.ComparisonNodes import ExpressionComparisonIs
from qutayba.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from qutayba.nodes.ConstantRefNodes import makeConstantRefNode
from qutayba.nodes.ContainerMakingNodes import makeExpressionMakeTupleOrConstant
from qutayba.nodes.ExecEvalNodes import (
    ExpressionBuiltinCompile,
    ExpressionBuiltinEval,
)
from qutayba.nodes.GlobalsLocalsNodes import (
    ExpressionBuiltinDir1,
    ExpressionBuiltinGlobals,
)
from qutayba.nodes.ImportNodes import ExpressionBuiltinImport
from qutayba.nodes.KeyValuePairNodes import (
...
from qutayba.nodes.OperatorNodes import ExpressionOperationBinaryDivmod
from qutayba.nodes.OperatorNodesUnary import (
    ExpressionOperationNot,
    ExpressionOperationUnaryAbs,
    ExpressionOperationUnaryRepr,
)
from qutayba.nodes.OutlineNodes import ExpressionOutlineBody
from qutayba.nodes.ReturnNodes import makeStatementReturn
from qutayba.nodes.SliceNodes import makeExpressionBuiltinSlice
from qutayba.nodes.TypeNodes import (
...
from qutayba.nodes.VariableAssignNodes import (
    makeStatementAssignmentVariable,
    makeStatementDelVariable,
)
from qutayba.nodes.VariableRefNodes import (
    ExpressionTempVariableRef,
    ExpressionVariableRef,
)
from qutayba.PythonVersions import python_version
from qutayba.specs import BuiltinParameterSpecs
from qutayba.tree.ReformulationExecStatements import wrapEvalGlobalsAndLocals
from qutayba.tree.ReformulationTryFinallyStatements import (
    makeTryFinallyStatement,
)
from qutayba.tree.TreeHelpers import (
    makeCallNode,
...
def range_extractor(node):
    ...
    def makeRange0(source_ref):
        ...
        try:
            ...
            raise nexiumAssumptionError("range without argument is expected to raise")
...
if python_version < 0x300:
    from qutayba.nodes.ExecEvalNodes import ExpressionBuiltinExecfile
...
if python_version >= 0x300:
    from qutayba.nodes.ExecEvalNodes import ExpressionBuiltinExec
...
def open_extractor(node):
    def makeOpen0(source_ref):
        ...
        try:
            ...
            raise nexiumAssumptionError("open without argument is expected to raise")
...
def check():
    from qutayba.Builtins import builtin_names
