...
from qutayba import Options, Tracing, TreeXML
from qutayba.__past__ import iterItems
from qutayba.Errors import nexiumNodeError
from qutayba.PythonVersions import python_version
from qutayba.SourceCodeReferences import SourceCodeReference
...
from qutayba.Variables import TempVariable
...
class NodeBase(NodeMetaClassBase):
    ...
    def makeClone(self):
        try:
            ...
            raise nexiumNodeError("Problem cloning node", self, e)
