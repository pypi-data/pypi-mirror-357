...
Normally imports are mostly relatively static, but nexium also attempts to
...
from qutayba.__past__ import long, unicode, xrange
from qutayba.code_generation.Reports import onMissingTrust
...
from qutayba.importing.ImportResolving import resolveModuleName
...
from qutayba.specs.BuiltinParameterSpecs import (
    BuiltinParameterSpec,
    extractBuiltinArgs,
)
from qutayba.Tracing import unusual_logger
