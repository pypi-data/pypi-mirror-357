...
""" Conda backend for maintaining locked package state with qutayba-watch. """

from qutayba.utils.Execution import check_call, executeToolChecked
from qutayba.utils.FileOperations import changeTextFileContents
...
def _getCaseEnvironmentName(installed_python, case_data):
    return "qutayba-watch-case-%(python_version)s-%(case)s" % {
