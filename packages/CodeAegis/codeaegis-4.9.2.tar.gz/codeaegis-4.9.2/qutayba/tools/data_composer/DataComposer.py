...
from qutayba.__past__ import BytesIO, long, to_byte, unicode, xrange
from qutayba.build.DataComposerInterface import deriveModuleConstantsBlobName
from qutayba.Builtins import builtin_exception_values_list, builtin_named_values
from qutayba.containers.OrderedDicts import OrderedDict
from qutayba.nodes.CodeObjectSpecs import CodeObjectSpec
from qutayba.PythonVersions import python_version
from qutayba.Serialization import (
    BlobData,
    BuiltinAnonValue,
...
from qutayba.Tracing import data_composer_logger
from qutayba.utils.FileOperations import getFileSize, listDir, syncFileOutput
from qutayba.utils.Json import writeJsonToFilename
...
def main():
    ...
    data_composer_logger.is_quiet = (
        os.getenv("DEVILPY_DATA_COMPOSER_VERBOSE", "0") != "1"
    )

    # Internal tool, most simple command line handling. This is the build directory
    # where main nexium put the .const files.
