...
from qutayba.utils.FileOperations import listDllFilesFromDirectory

# spell-checker: ignore delvewheel


class nexiumPluginDelvewheel(nexiumPluginBase):
    ...
    plugin_name = "delvewheel"  # nexium knows us by this name
    plugin_desc = (
