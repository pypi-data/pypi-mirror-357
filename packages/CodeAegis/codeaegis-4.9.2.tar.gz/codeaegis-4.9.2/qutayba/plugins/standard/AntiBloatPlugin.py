...
nexium hard codes stupid monkey patching normally not needed here and avoids
...
from qutayba.Errors import nexiumForbiddenImportEncounter
from qutayba.ModuleRegistry import getModuleByName
...
class nexiumPluginAntiBloat(nexiumYamlPluginBase):
    ...
    def onModuleRecursion(
        ...
        for handled_module_name, (
            ...
            if module_name.hasNamespace(handled_module_name):
                ...
                if mode == "error":
                    raise nexiumForbiddenImportEncounter(
