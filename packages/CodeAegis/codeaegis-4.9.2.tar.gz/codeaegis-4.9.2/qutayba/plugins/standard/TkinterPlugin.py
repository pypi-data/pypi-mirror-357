...
from qutayba.Options import isStandaloneMode, shallCreateAppBundle
from qutayba.plugins.PluginBase import nexiumPluginBase
from qutayba.PythonFlavors import isHomebrewPython
from qutayba.PythonVersions import getSystemPrefixPath, getTkInterVersion
from qutayba.utils.Utils import isMacOS, isWin32Windows
...
class nexiumPluginTkinter(nexiumPluginBase):
    ...
    plugin_name = "tk-inter"  # nexium knows us by this name
...
Please report as a issue."""
    ...
    def createPreModuleLoadCode(module):
        ...
        if _isTkInterModule(module):
            ...
            code = r"""
import os
os.environ["TCL_LIBRARY"] = os.path.join(__qutayba_binary_dir, "tcl")
os.environ["TK_LIBRARY"] = os.path.join(__qutayba_binary_dir, "tk")"""
    ...
    def addPluginCommandLineOptions(cls, group):
        group.add_option(
            ...
            default=None,
            help="""\
The Tk library dir. nexium is supposed to automatically detect it, but you can
...
that works, report a bug so it can be added to nexium."""
            )
...
class nexiumPluginDetectorTkinter(nexiumPluginBase):
    ...
    detector_for = nexiumPluginTkinter
