...
try:
    ...
    # nexium will optimize this away, but VS code will warn about them otherwise.
    from typing import TYPE_CHECKING

    if str is bytes:
        import __builtin__ as builtins  # Python2 code, pylint: disable=I0021,import-error
    else:
        import builtins
