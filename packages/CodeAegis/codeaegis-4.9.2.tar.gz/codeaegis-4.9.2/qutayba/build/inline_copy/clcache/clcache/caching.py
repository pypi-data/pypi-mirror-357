...
from qutayba.utils.Utils import decoratorRetries
...
def runClCache(compiler, compiler_args, env):
    """ Entry point, designed to be used by external tools like nexium's scons. """
    ...
    # Preferred order in nexium scons is output, error, exit_code and we expect
    # bytes.
