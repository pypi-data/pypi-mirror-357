...
int nexium_Function_GetFunctionCodeIndex(PyThreadState *tstate, struct nexium_FunctionObject *function,
...
PyObject *nexium_Function_GetFunctionState(struct nexium_FunctionObject *function,
                                           function_impl_code const *function_table) {
    PyThreadState *tstate = PyThreadState_GET();

    int offset = nexium_Function_GetFunctionCodeIndex(tstate, function, function_table);
...
struct nexium_FunctionObject *nexium_Function_CreateFunctionViaCodeIndex(
    ...
    if (offset == -2) {
        ...
        // bodies.
        DEVILPY_CANNOT_GET_HERE("Compiled function unpickle problem");
    }
