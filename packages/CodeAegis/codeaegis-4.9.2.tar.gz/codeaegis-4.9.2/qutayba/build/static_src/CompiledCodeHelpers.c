...
#if _DEVILPY_EXE_MODE || _DEVILPY_DLL_MODE
...
#if _DEVILPY_EXE_MODE || _DEVILPY_ONEFILE_DLL_MODE
...
void _initBuiltinModule(void) {
    ...
    {
#if _DEVILPY_EXE_MODE
        PyObject *qutayba_binary_dir = getBinaryDirectoryObject(true);
#else
        PyObject *qutayba_binary_dir = getDllDirectoryObject();
#endif
        DEVILPY_MAY_BE_UNUSED int res =
            PyDict_SetItemString((PyObject *)dict_builtin, "__qutayba_binary_dir", qutayba_binary_dir);
        assert(res == 0);
