...
what fortran version we have installed to compile with nexium.
...
from qutayba.Tracing import scons_details_logger
from qutayba.utils.Execution import executeProcess
from qutayba.utils.FileOperations import openTextFile
from qutayba.utils.Utils import isLinux, isMacOS
