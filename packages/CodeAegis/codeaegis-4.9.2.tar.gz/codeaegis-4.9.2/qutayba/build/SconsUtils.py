...
def createEnvironment(
    ...
    if env.standalone_mode:
        env.Append(CPPDEFINES=["_DEVILPY_STANDALONE_MODE"])
    ...
    if env.onefile_mode:
        env.Append(CPPDEFINES=["_DEVILPY_ONEFILE_MODE"])
    ...
    if env.onefile_dll_mode:
        env.Append(CPPDEFINES=["_DEVILPY_ONEFILE_DLL_MODE"])
