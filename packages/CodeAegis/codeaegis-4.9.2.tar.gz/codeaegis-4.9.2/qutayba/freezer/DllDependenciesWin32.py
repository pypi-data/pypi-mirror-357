...
from qutayba.build.SconsUtils import readSconsReport
from qutayba.containers.OrderedSets import OrderedSet
from qutayba.Options import isExperimental, isShowProgress
from qutayba.plugins.Plugins import Plugins
from qutayba.PythonFlavors import isAnacondaPython
from qutayba.PythonVersions import getSystemPrefixPath
...
from qutayba.utils.Hashing import Hash
from qutayba.utils.SharedLibraries import getPEFileUsedDllNames, getPyWin32Dir
from qutayba.utils.Utils import getArchitecture
from qutayba.Version import version_string
...
def _getCacheFilename(
    ...
    # Take nexium version into account as well, ought to catch code changes.
