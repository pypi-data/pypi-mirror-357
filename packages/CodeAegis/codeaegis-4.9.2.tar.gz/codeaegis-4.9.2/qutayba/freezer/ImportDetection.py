...
from qutayba.importing.StandardLibrary import (
...
from qutayba.Tracing import general, printError
from qutayba.utils.Execution import executeProcess
from qutayba.utils.FileOperations import areSamePaths
...
print("\\n".join(sorted(
    ...
    # Make sure the right import path (the one nexium binary is running with)
    # is used.
    command = (
