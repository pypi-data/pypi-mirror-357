...
DLLs or extension modules, these need to be seen by nexium as entry points
...
from qutayba.OutputDirectories import getStandaloneDirectoryPath
from qutayba.Tracing import general, inclusion_logger, options_logger
...
def addIncludedDataFilesFromPlugins():
    # Cyclic dependency
    from qutayba import ModuleRegistry
    from qutayba.plugins.Plugins import Plugins
