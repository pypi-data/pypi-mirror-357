...
class ConnectionConfig:
    ...
    @staticmethod
    def _domain():
        return os.getenv("AGENT_SPHERE_DOMAIN", "agent_sphere.app")

    @staticmethod
    def _debug():
        return os.getenv("AGENT_SPHERE_DEBUG", "false").lower() == "true"

    @staticmethod
    def _api_key():
        return os.getenv("AGENT_SPHERE_API_KEY")

    @staticmethod
    def _access_token():
        return os.getenv("AGENT_SPHERE_ACCESS_TOKEN")
