...
from agent_sphere_base.api.client.types import Unset
from agent_sphere_base.connection_config import ConnectionConfig, ProxyTypes
from agent_sphere_base.envd.api import ENVD_API_HEALTH_ROUTE, handle_envd_api_exception
from agent_sphere_base.exceptions import SandboxException, format_request_timeout_error
from agent_sphere_base.sandbox.main import SandboxSetup
from agent_sphere_base.sandbox.utils import class_method_variant
from agent_sphere_base.sandbox_sync.filesystem.filesystem import Filesystem
from agent_sphere_base.sandbox_sync.commands.command import Commands
from agent_sphere_base.sandbox_sync.commands.pty import Pty
from agent_sphere_base.sandbox_sync.sandbox_api import SandboxApi, SandboxInfo
...
class Sandbox(SandboxSetup, SandboxApi):
    ...
    def __init__(
        ...
        :param api_key: AGENT_SPHERE API Key to use for authentication, defaults to `AGENT_SPHERE_API_KEY` environment variable
