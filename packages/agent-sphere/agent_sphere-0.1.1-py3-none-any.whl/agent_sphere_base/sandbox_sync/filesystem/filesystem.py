...
import agent_sphere_connect
import httpcore
import httpx
from packaging.version import Version

from agent_sphere_base.envd.versions import ENVD_VERSION_RECURSIVE_WATCH
from agent_sphere_base.exceptions import TemplateException, InvalidArgumentException
...
from agent_sphere_base.envd.api import ENVD_API_FILES_ROUTE, handle_envd_api_exception
...
from agent_sphere_base.sandbox_sync.filesystem.watch_handle import WatchHandle
...
class Filesystem:
    ...
    def exists(
        ...
        try:
            ...
            if isinstance(e, agent_sphere_connect.ConnectException):
                if e.status == agent_sphere_connect.Code.not_found:
                    return False
            raise handle_rpc_exception(e)
    ...
    def make_dir(
        ...
        try:
            ...
            if isinstance(e, agent_sphere_connect.ConnectException):
                if e.status == agent_sphere_connect.Code.already_exists:
                    return False
            raise handle_rpc_exception(e)
