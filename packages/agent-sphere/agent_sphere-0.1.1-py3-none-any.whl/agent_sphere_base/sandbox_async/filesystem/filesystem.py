...
from agent_sphere_base.sandbox.filesystem.filesystem import WriteEntry
import agent_sphere_connect as connect
from agent_sphere_base.connection_config import (
    ConnectionConfig,
    Username,
    KEEPALIVE_PING_HEADER,
    KEEPALIVE_PING_INTERVAL_SEC,
)
from agent_sphere_base.envd.api import ENVD_API_FILES_ROUTE, ahandle_envd_api_exception
from agent_sphere_base.envd.filesystem import filesystem_connect, filesystem_pb2
from agent_sphere_base.envd.rpc import authentication_header, handle_rpc_exception
from agent_sphere_base.envd.versions import ENVD_VERSION_RECURSIVE_WATCH
from agent_sphere_base.exceptions import SandboxException, TemplateException, InvalidArgumentException
from agent_sphere_base.sandbox.filesystem.filesystem import EntryInfo, map_file_type
from agent_sphere_base.sandbox.filesystem.watch_handle import FilesystemEvent
from agent_sphere_base.sandbox_async.filesystem.watch_handle import AsyncWatchHandle
from agent_sphere_base.sandbox_async.utils import OutputHandler
...
class Filesystem:
    ...
    def __init__(
        ...
        self._rpc = filesystem_connect.FilesystemClient(
            ...
            # compressor=agent_sphere_connect.GzipCompressor,
            async_pool=pool,
            json=True,
    ...
    async def watch_dir(
        ...
        if (
            ...
            raise TemplateException(
                ...
                "You can do this by running `agent_sphere template build` in the directory with the template."
            )
