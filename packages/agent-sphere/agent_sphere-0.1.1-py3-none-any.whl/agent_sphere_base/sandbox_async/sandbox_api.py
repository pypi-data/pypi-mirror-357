...
from agent_sphere_base.sandbox.sandbox_api import SandboxInfo, SandboxApiBase, SandboxQuery, ListedSandbox
from agent_sphere_base.exceptions import TemplateException
from agent_sphere_base.api import AsyncApiClient, SandboxCreateResponse
from agent_sphere_base.api.client.models import NewSandbox, PostSandboxesSandboxIDTimeoutBody
from agent_sphere_base.api.client.api.sandboxes import (
...
from agent_sphere_base.connection_config import ConnectionConfig, ProxyTypes
from agent_sphere_base.api import handle_api_exception
...
class SandboxApi(SandboxApiBase):
    ...
    async def list(
        ...
        :param api_key: API key to use for authentication, defaults to `AGENT_SPHERE_API_KEY` environment variable
    ...
    async def get_info(
        ...
        :param api_key: API key to use for authentication, defaults to `AGENT_SPHERE_API_KEY` environment variable
        :param domain: Domain to use for the request, defaults to `AGENT_SPHERE_DOMAIN` environment variable
        :param debug: Debug mode, defaults to `AGENT_SPHERE_DEBUG` environment variable
        :param request_timeout: Timeout for the request in **seconds**
        :param headers: Additional headers to send with the request
        :param proxy: Proxy to use for the request
