...
from agent_sphere_base import Sandbox as BaseSandbox, InvalidArgumentException

from agent_sphere.constants import (
    DEFAULT_TEMPLATE,
    JUPYTER_PORT,
    DEFAULT_TIMEOUT,
)
from agent_sphere.models import (
    ExecutionError,
    Execution,
    Context,
    Result,
...
from agent_sphere.exceptions import (
...
class Sandbox(BaseSandbox):
    """
    AGENT_SPHERE cloud sandbox is a secure and isolated cloud environment.
    ...
    Example:
    ```python
    from agent_sphere import Sandbox
