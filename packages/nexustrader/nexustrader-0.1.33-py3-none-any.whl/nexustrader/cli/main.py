...
from nexustrader.cli.app import run_monitor
...
def status():
    ...
    try:
        ...
        running_strategies = redis_client.hgetall("nexustrader:running_strategies")
...
def main():
    """Main entry point for nexustrader-cli command"""
    cli()
