...
class ExsitedSDK:
    ...
    def _init_endpoints(self, shared_token_mgr=None):
        self.account = Account(request_token_dto=self._request_token_dto, shared_token_mgr=shared_token_mgr)
        self.order = Order(request_token_dto=self._request_token_dto, shared_token_mgr=shared_token_mgr)
        self.invoice = Invoice(request_token_dto=self._request_token_dto, shared_token_mgr=shared_token_mgr)
        self.setting = Setting(request_token_dto=self._request_token_dto, shared_token_mgr=shared_token_mgr)
        self.payment = Payment(request_token_dto=self._request_token_dto, shared_token_mgr=shared_token_mgr)
        self.express = Express(request_token_dto=self._request_token_dto, shared_token_mgr=shared_token_mgr)
        self.refund = Refund(request_token_dto=self._request_token_dto, shared_token_mgr=shared_token_mgr)
        self.purchase_order = PurchaseOrder(request_token_dto=self._request_token_dto,
                                            shared_token_mgr=shared_token_mgr)
        ...
        self.gift_certificates = GiftCertificates(request_token_dto=self._request_token_dto,
                                                  shared_token_mgr=shared_token_mgr)
        self.credit_note = CreditNote(request_token_dto=self._request_token_dto, shared_token_mgr=shared_token_mgr)
        self.return_merchandise_authorisations = ReturnMerchandiseAuthorisations(
            request_token_dto=self._request_token_dto, shared_token_mgr=shared_token_mgr)
        self.purchase_payments = PurchasePayments(request_token_dto=self._request_token_dto,
                                                  shared_token_mgr=shared_token_mgr)

    def init_sdk(self, request_token_dto: RequestTokenDTO, shared_token_mgr=None) -> 'ExsitedSDK':
        self._request_token_dto = request_token_dto
        self._init_endpoints(shared_token_mgr=shared_token_mgr)
        return self
