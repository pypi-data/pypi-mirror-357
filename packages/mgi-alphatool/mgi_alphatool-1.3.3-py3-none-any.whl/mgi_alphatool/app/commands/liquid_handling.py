...
class TransferCommand(BaseCommand):
    ...
    # Delay settings
    aspirate_delay_seconds: Optional[int] = Field(default=None, description="Delay after aspiration")
    ...
    dispense_delay_seconds: Optional[int] = Field(default=None, description="Delay after dispensing")
