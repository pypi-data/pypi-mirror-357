...
class Dual(klovve.builtin.drivers.viwid.ViewMaterialization[klovve.views.responsive.Dual]):
    ...
    async def __handle_resized(self, viwid_split):
        ...
        item_1_current_width = viwid_widget_1.compute_width_for_height(height) if viwid_widget_1 else 0
        item_2_current_width = viwid_widget_2.compute_width_for_height(height) if viwid_widget_2 else 0
