...
class _View[TMaterialization](klovve.event._EventHandlingObject, klovve.timer._TimingObject, klovve.object.Object,
    ...
    application: "klovve.app.BaseApplication|None" = property(is_settable=False)
...
class _BaseView[TMaterialization](View[TMaterialization], abc.ABC):
    ...
    def _materialize(self, materializer):
        ...
        application = self
        while not isinstance(application, klovve.app.BaseApplication):
            application = self._materialization.application_tree.parent_node(application)
        self._introspect.set_property_value(View.application, application)
