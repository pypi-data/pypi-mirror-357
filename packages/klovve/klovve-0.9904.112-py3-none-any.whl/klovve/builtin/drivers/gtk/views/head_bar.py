...
class HeadBar(klovve.builtin.drivers.gtk.ViewMaterialization[klovve.views.HeadBar]):
    ...
    def create_native(self):
        ...
        gtk_inner_center_box.append(self.new_native(Gtk.Spinner, visible=self.bind(two_way=False)._is_spinner_visible,  # TODO is .bind to "__..." private variables broken?
                                                    spinning=self.bind(two_way=False)._is_spinner_visible))
