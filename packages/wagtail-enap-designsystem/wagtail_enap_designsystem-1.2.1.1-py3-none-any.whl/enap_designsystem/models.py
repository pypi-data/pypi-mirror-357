...
class EnapSearchElastic(Page):
	...
	def get_context(self, request, *args, **kwargs):
		...
		endpoints = {
			...
			"noticias": "/busca/portal/noticias",
			"eventos": "/busca/eventos-oficinas/pesquisa",
			"servicos": "/busca/portal/servicos",
		...
		if tipo in endpoints:
			try:
				...
				results = [self.parse_datas(item) for item in raw_results]
