def initialize_model(s_r_filepath = None, degree = 1, iterations = 100, n_s_values = 50, s_value_range_factor = [1 / 16, 1 / 8], *, weight_conv_window = 101, val_split = 0.1, s_value_increase = 1.01):
