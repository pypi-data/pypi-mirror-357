def initialize_model(inputs_save_path = None, trace_path = None):
    ...
    erm.create_trace(x_obs, x_err, y_true, y_err, inputs_save_path = inputs_save_path, trace_path = trace_path)
