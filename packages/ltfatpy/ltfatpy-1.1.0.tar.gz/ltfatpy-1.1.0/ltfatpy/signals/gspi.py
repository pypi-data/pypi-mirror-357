...
import importlib_resources  # not importlib.resources
...
def gspi():
    ...
    # ref = ref = importlib.resources.files(__name__).joinpath("gspi.wav")
    ref = importlib_resources.files(__package__).joinpath("gspi.wav")
