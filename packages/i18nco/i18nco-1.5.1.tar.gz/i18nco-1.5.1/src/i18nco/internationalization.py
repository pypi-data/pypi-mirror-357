...
import json
import threading
from typing import Tuple, List, Dict, Optional, Union, SupportsIndex
...
class I18nString (str):
    ...
    def __getitem__(self, __name) -> "I18nString":
        """
        Dynamically resolve nested translation keys.
...
class Internationalization (object):
    ...
    def __getitem__(self, __name: str) -> I18nString:
        return self.ctrl.translation(__name)
...
class I18nControl (object):
    ...
    def load_lang_content(self, content: str, locale: Optional[Union[LocaleCode, List[LocaleCode]]] = None,
    ...
    def load_dict(self, dictionary: Dict[TextKey, str], locale: Optional[LocaleCode] = None, superiors: Optional[str] = None) -> None:
        """
    ...
    def load_json(self, file_path: str, locale: Optional[LocaleCode] = None, superiors: Optional[str] = None, *, encoding: str = DEFAULT_ENCODING) -> None:
        """
