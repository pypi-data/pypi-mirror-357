...
class TeamsFormatter(FormatterInterface):
    """Formatter for Microsoft Teams messages."""
    ...
    def _format_header(self, date_str: str, is_report: bool) -> str:
        """Format message header for Teams.
