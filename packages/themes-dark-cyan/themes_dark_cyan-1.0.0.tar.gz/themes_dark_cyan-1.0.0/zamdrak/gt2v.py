...
def send_pixverse_request(token, prompt, model, duration, quality, aspect_ratio, style, seed, camera_movement, credit_change, seed_select):
...
# Ejemplo de uso:
def gen_t2v(prompt, model_version, duration, quality, aspect_ratio, style_selected, seed, camera_selected, seed_select):
    ...
    if valido:
        ...
        if creditos_utilizados <= creditos_paquete:
            ...
            prompts()
            gen_t2v(prompt, model_version, duration, quality, aspect_ratio, style, seed, camera_movement, seed_select)
