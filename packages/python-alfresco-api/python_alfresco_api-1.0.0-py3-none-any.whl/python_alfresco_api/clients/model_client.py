"""
AlfrescoModelClient - Individual client for Alfresco MODEL API
...
raw_client_path = Path(__file__).parent.parent / "raw_clients" / "alfresco_model_client"
...
class AlfrescoModelClient:
    """
    Individual client for Alfresco MODEL API.
    ...
    def _init_generated_client(self):
        ...
        try:
            ...
            print(f"⚠️  Generated client not available for model: {e}")
            self.client = None
