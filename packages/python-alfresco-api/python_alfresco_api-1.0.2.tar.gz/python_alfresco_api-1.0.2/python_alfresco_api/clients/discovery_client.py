"""
AlfrescoDiscoveryClient - Individual client for Alfresco DISCOVERY API
...
raw_client_path = Path(__file__).parent.parent / "raw_clients" / "alfresco_discovery_client"
...
class AlfrescoDiscoveryClient:
    """
    Individual client for Alfresco DISCOVERY API.
    ...
    def _init_generated_client(self):
        ...
        try:
            ...
            print(f"⚠️  Generated client not available for discovery: {e}")
            self.client = None
