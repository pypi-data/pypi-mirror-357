...
# ./pypiUploadVer EXISTED -- forPypiVersion=0.68 -- forLocalVersion=0.43 -- constant=NA
def pkgVersion():
        return '0.68'
...
####+BEGINNOT: b:py3:pypi:setup/dataFiles :comment "Instead of ./MANIFEST.in or in pyproject.toml"
