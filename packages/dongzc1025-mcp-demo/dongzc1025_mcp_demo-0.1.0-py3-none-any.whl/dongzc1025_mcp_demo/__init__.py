...
# API 密钥
OPENWEATHER_API_KEY = "79dbdc1d534c4a1ca4fa9115fd2864f6"
# API 调用的身份识别
...
async def get_weather(city: str, country_code: str = "", state_code: str = "", units: str = "metric", lang: str = "zh_cn") -> str:
...
@mcp.tool()
async def get_forecast(city: str, country_code: str = "", state_code: str = "", units: str = "metric", lang: str = "zh_cn") -> str:
...
@mcp.tool()
async def weather_report(city: str, country_code: str = "", state_code: str = "", units: str = "metric", lang: str = "zh_cn") -> dict:
    """获取指定城市的天气信息并提供报告模板
