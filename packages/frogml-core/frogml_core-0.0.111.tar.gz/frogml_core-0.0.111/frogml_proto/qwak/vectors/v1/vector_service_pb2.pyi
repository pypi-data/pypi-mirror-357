...
import frogml_proto.qwak.vectors.v1.filters_pb2
import frogml_proto.qwak.vectors.v1.vector_pb2
import sys
import typing
...
class SearchSimilarVectorsRequest(google.protobuf.message.Message):
    ...
    @property
    def reference_vector(self) -> frogml_proto.qwak.vectors.v1.vector_pb2.DoubleVector:
        """Reference vector"""
    @property
    def properties(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
        """properties to retrieve"""
    @property
    def filter(self) -> frogml_proto.qwak.vectors.v1.filters_pb2.Filter: ...
    ...
    def __init__(
        ...
        *,
        collection_name: builtins.str = ...,
        reference_vector: frogml_proto.qwak.vectors.v1.vector_pb2.DoubleVector | None = ...,
        properties: collections.abc.Iterable[builtins.str] | None = ...,
        filter: frogml_proto.qwak.vectors.v1.filters_pb2.Filter | None = ...,
        max_results: builtins.int = ...,
        include_vector: builtins.bool = ...,
        include_distance: builtins.bool = ...,
        include_id: builtins.bool = ...,
...
class FetchVectorRequest(google.protobuf.message.Message):
    ...
    @property
    def vector_identifier(self) -> frogml_proto.qwak.vectors.v1.vector_pb2.VectorIdentifier:
    ...
    def __init__(
        ...
        *,
        collection_name: builtins.str = ...,
        vector_id: builtins.str = ...,
        vector_identifier: frogml_proto.qwak.vectors.v1.vector_pb2.VectorIdentifier | None = ...,
    ) -> None: ...
...
class FetchVectorResponse(google.protobuf.message.Message):
    ...
    VECTOR_FIELD_NUMBER: builtins.int
    @property
    def vector(self) -> frogml_proto.qwak.vectors.v1.vector_pb2.StoredVector:
        """Fetched vector"""
    def __init__(
        self,
        *,
        vector: frogml_proto.qwak.vectors.v1.vector_pb2.StoredVector | None = ...,
    ) -> None: ...
