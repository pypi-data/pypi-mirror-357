...
from frogml_proto.qwak.feature_store.entities.entity_pb2 import (
    EntityDefinition,
    EntitySpec,
)
from frogml_proto.qwak.feature_store.features.feature_set_pb2 import FeatureSetSpec
from frogml_core.feature_store._common.feature_set_utils import generate_key_unique_name
from frogml_core.feature_store.entities.entity import Entity
from frogml_core.feature_store.validations.validation_response import (
...
class BaseFeatureSet(ABC):
    ...
    def get_sample(
        ...
        """
        from frogml_core.feature_store.validations.validator import (
