...
def aveytenseVersion(asString = True):
    ...
    from .._ᴧv_collection import _constants
    
    if asString:
        return _constants.VERSION_INFO
    else:
        return _constants.VERSION
...
class Math:
    ...
    def isInRange(self, x: __.Union[_FloatOrInteger, __.Sequence[_FloatOrInteger]], a: _FloatOrInteger, b: _FloatOrInteger, /, mode = "c"):
        """
        @lifetime >= 0.3.36 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.isInRange
    ...
    def fact(self, n: int, /):
        """
        @lifetime >= 0.3.26rc3 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.fact
        ```
        # created 20.08.2024
    ...
    def log(self, x: _FloatOrInteger, /, base: _OptionalFloatOrInteger = ...): # slash since 0.3.39
        """
        @lifetime >= 0.3.25 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.log
        ```
        # created 05.07.2024
        ```
    ...
    def sqrt(self, x: _FloatOrInteger, /):
        """
        @lifetime >= 0.3.25 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.sqrt
        ```
        # created 05.07.2024
        ```
        Square root of `x`.
    ...
    def cbrt(self, x: _FloatOrInteger, /):
        """
        @lifetime >= 0.3.25 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.cbrt
        ```
        # created 05.07.2024
        ```
    ...
    def abs(self, x: __.Absolute[_T_fi], /) -> _T_fi:
        ...
        https://aveyzan.glitch.me/aveytense#aveytense.Math.abs
    ...
    def triangular(self, n: int, /):
        """
        @lifetime >= 0.3.27a4 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.triangular
    ...
    def pentagonal(self, n: int, /):
        """
        @lifetime >= 0.3.27a4 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.pentagonal
    ...
    def hexagonal(self, n: int, /):
        """
        @lifetime >= 0.3.27a4 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.hexagonal
    ...
    def heptagonal(self, n: int, /):
        """
        @lifetime >= 0.3.27a4 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.heptagonal
    ...
    def octagonal(self, n: int, /):
        """
        @lifetime >= 0.3.27a4 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.octagonal
    ...
    def nonagonal(self, n: int, /):
        """
        @lifetime >= 0.3.27a4 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.nonagonal
    ...
    def decagonal(self, n: int, /):
        """
        @lifetime >= 0.3.27a4 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.decagonal
    ...
    def polygonal(self, n: int, s: int, /):
        """
        @lifetime >= 0.3.27a4 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.polygonal
    ...
    def lcm(self, *i: int):
        """
        @lifetime >= 0.3.31 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.lcm
    ...
    def gcd(self, *i: int):
        """
        @lifetime >= 0.3.31 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.gcd
    ...
    def toDigits(self, n: int, /):
        """
        @lifetime >= 0.3.39 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.toDigits
    ...
    def minDigit(self, n: int, /):
        """
        @lifetime >= 0.3.39 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.minDigit
    ...
    def maxDigit(self, n: int, /):
        """
        @lifetime >= 0.3.39 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.maxDigit
    ...
    def lwdp(self, n: int, /):
        """
        @lifetime >= 0.3.39 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.lwdp
    ...
    def perm(self, n: int, k: _OptionalInteger = ..., /): # <- slash since 0.3.40
        """
        @lifetime >= 0.3.39 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.perm
    ...
    def mean(self, *n: _FloatOrInteger, mode = "a"):
        """
        @lifetime >= 0.3.40 \\
        https://aveyzan.glitch.me/aveytense#aveytense.Math.mean
