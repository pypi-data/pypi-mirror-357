...
class TenseOptions(_util.AbstractFinal): # 0.3.27a5
    ...
    """
    @lifetime >= 0.3.27b1 https://aveyzan.glitch.me/aveytense#aveytense.TenseOptions
...
class Tense( # 0.3.24
    ...
    def append(self, i, /, *items):
        ...
        https://aveyzan.glitch.me/aveytense#aveytense.Tense.append
    ...
    if _version.VERSION_INFO >= (0, 3, 40) or True:
        ...
        def clear(self, *v: _Clearable): # 0.3.27a4
            """
            @lifetime >= 0.3.27a4 \\
            https://aveyzan.glitch.me/aveytense#aveytense.Tense.clear
            ...
            for _v in v:
                ...
                if self.isString(_v):
                    ...
                    if _version.VERSION_INFO >= (0, 3, 48) and False:
...
class RGB(_util.Final):
    ...
    def __str__(self):
        """
        @lifetime >= 0.3.28 \\
        [doc](https://aveyzan.glitch.me/aveytense#aveytense.RGB.__str__)
        """
    ...
    def __repr__(self):
        """
        @lifetime >= 0.3.28 \\
        [doc](https://aveyzan.glitch.me/aveytense#aveytense.RGB.__repr__)
        """
    ...
    def __hex__(self):
        """
        @lifetime >= 0.3.28 \\
        https://aveyzan.glitch.me/aveytense#aveytense.RGB.?hexadecimal_conversion
    ...
    def __int__(self):
        """
        @lifetime >= 0.3.28 \\
        https://aveyzan.glitch.me/aveytense#aveytense.RGB.?integer_conversion
    ...
    def __lt__(self, other): 
        """
        @lifetime >= 0.3.28 \\
        https://aveyzan.glitch.me/aveytense#aveytense.RGB.?comparison_operators
    ...
    def __pos__(self):
        ...
        https://aveyzan.glitch.me/aveytense#aveytense.RGB.tuple
    ...
    def __bytes__(self):
        """
        @lifetime >= 0.3.41 \\
        https://aveyzan.glitch.me/aveytense#aveytense.RGB.?bytes_conversion
    ...
    def __hash__(self):
        """
        @lifetime >= 0.3.41 \\
        https://aveyzan.glitch.me/aveytense#aveytense.RGB.__hash__
    ...
    def __bool__(self):
        """
        @lifetime >= 0.3.41 \\
        https://aveyzan.glitch.me/aveytense#aveytense.RGB.__bool__
    ...
    def __bin__(self):
        """
        @lifetime >= 0.3.41 \\
        https://aveyzan.glitch.me/aveytense#aveytense.RGB.?binary_conversion
    ...
    def __oct__(self):
        """
        @lifetime >= 0.3.41 \\
        https://aveyzan.glitch.me/aveytense#aveytense.RGB.?octal_conversion
    ...
    def r(self):
        """
        @lifetime >= 0.3.45 \\
        https://aveyzan.glitch.me/aveytense#aveytense.RGB.?values
    ...
    def fromValue(n: _uni[int, str, _util.MutableString], /):
        """
        @lifetime >= 0.3.36 \\
        https://aveyzan.glitch.me/aveytense#aveytense.RGB.fromValue
