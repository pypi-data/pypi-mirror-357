    ...
    def authenticate_drive(self):
        ...
        if not creds_path.exists():
            raise FileNotFoundError(
                f"❌ Credential file not found at '{creds_path.resolve()}'.\n"
                f"Please place 'service_account.json' in the root of your project directory."
            )
        ...
        try:
            ...
            raise RuntimeError(
                f"❌ Failed to load credentials from '{creds_path.resolve()}': {str(e)}"
            )
