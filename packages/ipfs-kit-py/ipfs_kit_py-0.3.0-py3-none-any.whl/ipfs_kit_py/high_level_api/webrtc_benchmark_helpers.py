...
class WebRTCBenchmarkIntegration:
    """Integration helpers for WebRTC benchmarking with IPFSSimpleAPI."""
    ...
    async def run_benchmark(api, cid: str, **kwargs):
        ...
        try:
            ...
            if report_result.get("success", False) and report_result.get("reports", []):
                ...
                if visualize:
                    vis_result = await WebRTCBenchmarkIntegration.visualize_benchmark(api, report_path)
        ...
        try:
            ...
            if visualize:
                ...
                try:
                    ...
                    WebRTCBenchmarkIntegration._generate_comparison_visualizations(
