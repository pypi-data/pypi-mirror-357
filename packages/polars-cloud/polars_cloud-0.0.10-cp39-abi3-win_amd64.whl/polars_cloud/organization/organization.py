...
class Organization:
    ...
    def _load_by_name(self) -> None:
        ...
        organizations = pcr.get_organizations(self._name)
    ...
    def _load_by_id(self) -> None:
        ...
        assert self._id is not None
        organization = pcr.get_organization(self._id)
    ...
    def delete(self) -> None:
        ...
        """
        pcr.delete_organization(self.id)
    ...
    def setup(cls, name: str) -> Self:
        ...
        Organization(id=UUID('xxxxxxxx-xxxx-74e0-9de7-6e2014821b44'),
            name='organization-name',
        """
        organization = pcr.create_organization(name)
    ...
    def list(cls, name: str | None = None) -> list[Organization]:
        ...
        """
        return [cls._from_api_schema(s) for s in pcr.get_organizations(name)]
