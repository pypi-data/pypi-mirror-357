...
from .config import OUTPUT_DIR, IOU_THRESHOLD, TEXT_LABELS, CONTAINER_THRESHOLD, DEFAULT_EMBEDDING_MODEL
...
class PDFParser: 
    ...
    def __init__(self, yolo_model_path = None, 
        ...
        Args:
            ...
            azure_openai_api_key (str, optional): API key for Azure OpenAI service (for embeddings).
            azure_openai_api_version (str, optional): API version for Azure OpenAI service.
            azure_openai_endpoint (str, optional): Endpoint URL for Azure OpenAI service (for embeddings).
        """
