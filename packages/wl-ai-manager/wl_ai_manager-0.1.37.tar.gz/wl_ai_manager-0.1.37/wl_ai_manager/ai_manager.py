...
from .prompts import get_prompts, prompt_template
...
class AIManager:
    ...
    def prompt_template(self, name, data, flatten=False, user_only=False):
        """
        ...
        Returns:
            str: Formatted prompt text (for standard prompts, when flatten=True, or when user_only=True)
            dict: Dictionary with 'system' and/or 'user' keys (for multi-part prompts when both flags are False)
