...
function ProjectSidebarContent({ projectId, app, documentManager }) {
    // 使用 useState 管理步骤
...
class ProjectSidebarWidget extends _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.ReactWidget {
    constructor(app, documentManager) {
        ...
        this.app = app;
        this.documentManager = documentManager;
        const envConfig = JSON.parse(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_3__.PageConfig.getOption('env') || '{}');
        console.log('Environment Config:', envConfig);
        const project_id = envConfig['PROJECT_ID'] || '';
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(ProjectSidebarContent, { app: this.app, projectId: this.projectId, documentManager: this.documentManager }));
    }
}
...
const apiUrl = 'http://119.3.188.233:5173/api';
...
//# sourceMappingURL=lib_index_js.4a07c31540cd7aca3bd9.js.map