...
with open(DATA_DIR / "distributions" / "nbu_arwen_ver01.json") as f:
    arwen_dist = json.load(f)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            {"v1": 16 * MiB, "v2": 32 * MiB, "hybrid": 4 * MiB},
            id="1001-100gb-one-big-file",
        ),
        pytest.param(
            [100 * GiB] + [1 * KiB for _ in range(100000)],
            {"v1": 16 * MiB, "v2": 128 * MiB, "hybrid": 128 * KiB},
        ...
        pytest.param(
            arwen_dist, {"v1": 256 * KiB, "v2": 512 * KiB, "hybrid": 256 * KiB}, id="chronam-arwen"
        ),
    ],
)
