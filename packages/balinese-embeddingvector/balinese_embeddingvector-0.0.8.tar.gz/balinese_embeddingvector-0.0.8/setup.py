...
setup(
    name='balinese_embeddingvector',  # The name users will use to pip install
    version='0.0.8',  # last version v0.0.8
    # Automatically finds 'balipkg' and any sub-packages
    packages=find_packages(),

    # Crucial for including non-code files like models and data
    package_data={
        'balinese_embeddingvector': [
            'models/*.pkl',
    ...
    description='A Python package for utilizing Pretrained Balinese Word Embedding Model using FastText, Word2Vec, Glove, and BERT',
    ...
    keywords=['Balinese', 'NLP', 'Text Preprocessing', 'Semantic Feature Extraction',
              'Word Embedding', 'FastText', 'Glove', 'Word2Vec', 'BERT'],
    classifiers=[
