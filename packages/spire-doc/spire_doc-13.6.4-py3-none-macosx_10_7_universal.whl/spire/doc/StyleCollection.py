...
class StyleCollection (  DocumentSerializableCollection, IStyleCollection) :
    ...
    def ApplyDocDefaultsToNormalStyle(self):
        ...
        """
        warnings.warn("'StyleCollection.ApplyDocDefaultsToNormalStyle()' is obsolete, please use 'Document.KeepSameFormat' property instead", DeprecationWarning)
    ...
    def FindByName(self ,name:str)-> TypingUnion[Style, None]:
        """
