...
class NomadicML:
    ...
    def my_videos(self) -> list[dict]:
        """Proxy to `client.video.my_videos()`."""
        return self.video.my_videos()
    ...
    #TODO: Implement `upload_and_analyze` if needed
    #def upload_and_analyze(self, *args, **kwargs):
    #    """Proxy to `client.video.upload_and_analyze()`."""
    #    return self.video.upload_and_analyze(*args, **kwargs)
