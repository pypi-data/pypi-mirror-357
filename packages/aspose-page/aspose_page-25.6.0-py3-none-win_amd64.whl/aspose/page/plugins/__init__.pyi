...
class PsConverterOptions:
    ...
    @property
    def data_collection(self) -> list[aspose.page.plugins.IDataSource]:
        '''Returns PsConverterOptions plugin data collection.'''
        ...
    
    @property
    def save_targets_collection(self) -> list[aspose.page.plugins.IDataSource]:
...
class ResultContainer:
    ...
    @property
    def result_collection(self) -> list[aspose.page.plugins.IOperationResult]:
