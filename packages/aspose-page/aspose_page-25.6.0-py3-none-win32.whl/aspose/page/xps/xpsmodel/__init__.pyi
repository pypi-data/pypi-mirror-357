...
class XpsGradientBrush(aspose.page.xps.xpsmodel.XpsTransformableBrush):
    ...
    @property
    def gradient_stops(self) -> list[aspose.page.xps.xpsmodel.XpsGradientStop]:
        '''Returns/sets list of gradient stops that comprise the gradient.'''
        ...
    
    @gradient_stops.setter
    def gradient_stops(self, value: list[aspose.page.xps.xpsmodel.XpsGradientStop]):
        ...
...
class XpsPathFigure(aspose.page.xps.xpsmodel.XpsObject):
    ...
    @property
    def segments(self) -> list[aspose.page.xps.xpsmodel.XpsPathSegment]:
...
class XpsPathGeometry(aspose.page.xps.xpsmodel.XpsObject):
    ...
    @property
    def path_figures(self) -> list[aspose.page.xps.xpsmodel.XpsPathFigure]:
