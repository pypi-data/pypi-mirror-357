...
from agentsphere_base import Sandbox as BaseSandbox, InvalidArgumentException

from agentsphere.constants import (
    DEFAULT_TEMPLATE,
    JUPYTER_PORT,
    DEFAULT_TIMEOUT,
)
from agentsphere.models import (
    ExecutionError,
    Execution,
    Context,
    Result,
...
from agentsphere.exceptions import (
...
class Sandbox(BaseSandbox):
    ...
    Example:
    ```python
    from agentsphere_code_interpreter import Sandbox
