...
from agentsphere_base.api.client.types import Unset
from agentsphere_base.connection_config import ConnectionConfig, ProxyTypes
from agentsphere_base.envd.api import ENVD_API_HEALTH_ROUTE, ahandle_envd_api_exception
from agentsphere_base.exceptions import format_request_timeout_error
from agentsphere_base.sandbox.main import SandboxSetup
from agentsphere_base.sandbox.utils import class_method_variant
from agentsphere_base.sandbox_async.filesystem.filesystem import Filesystem
from agentsphere_base.sandbox_async.commands.command import Commands
from agentsphere_base.sandbox_async.commands.pty import Pty
from agentsphere_base.sandbox_async.sandbox_api import SandboxApi, SandboxInfo
...
class AsyncSandbox(SandboxSetup, SandboxApi):
    """
    AGENTSPHERE cloud sandbox is a secure and isolated cloud environment.
    ...
    Check docs [here](https://docs.agentsphere.run/).
    ...
    async def create(
        ...
        :param api_key: AGENTSPHERE API Key to use for authentication, defaults to `AGENTSPHERE_API_KEY` environment variable
        :param request_timeout: Timeout for the request in **seconds**
