...
# With machine learning features (NEW in v2.4.0)
...
- **Machine learning metadata curation** with pattern recognition (NEW v2.4.0)
- **Community pattern analysis** leveraging repository insights (NEW v2.4.0)
- **Automated metadata pre-population** with contextual suggestions (NEW v2.4.0)
- **Resource relationship discovery** and mapping (NEW v2.4.0)  
...
- **Machine learning curation** with pattern recognition (NEW v2.4.0)
- **Community-driven insights** from repository analysis (NEW v2.4.0)
- **Automated metadata pre-population** with contextual suggestions (NEW v2.4.0)
...
### 🔬 **Machine Learning Features** (NEW v2.4.0)
...
- [🔬 ML-Enhanced Curation](docs/user-guides/06-ml-enhanced-curation.md) - Machine learning features (NEW v2.4.0)
...
> **📝 Note**: The examples below use a public test API key for demonstration purposes. Find the current test key in [api/test_keys.md](api/test_keys.md). For production use, create your own API key at https://nakala.fr.
...
# Set API key (see api/test_keys.md for test key)
export NAKALA_API_KEY="[see-api/test_keys.md]"

# Run the complete workflow (v2.4.0 with ML features)
...
# Quality analysis with ML insights (v2.4.0)
...
```bash
# Required - Get test key from api/test_keys.md
export NAKALA_API_KEY="your-api-key"
