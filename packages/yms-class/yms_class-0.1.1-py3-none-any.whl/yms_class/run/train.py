...
from yms_class.models.autoencoder import PureFCResNet, create_dataloader
...
def parse_args(args=None):
    ...
    parser.add_argument('--data_dir', default=r'/data/coding/data/Nscales(1-3)')
    parser.add_argument('--save_dir', default=r'/data/coding/output/1-3_resnet-1')
