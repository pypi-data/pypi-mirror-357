...
<CardGroup cols={2}>
  <Card title="Discord Community" icon="discord" href="https://discord.gg/kubiya">
    Join our community for integration help and best practices
  </Card>
  <Card title="GitHub Examples" icon="github" href="https://github.com/kubiya-sandbox/workflows">
