...
description: Real-time streaming for workflow generation and execution
icon: stream
---

<Note>
  Streaming enables real-time feedback during workflow generation and execution, providing a better user experience and enabling reactive applications.
</Note>

## Overview

The ADK provider supports streaming at multiple levels:

1. **Generation Streaming**: See the AI's thought process as it generates workflows
2. **Execution Streaming**: Monitor workflow execution in real-time
3. **Combined Streaming**: Both generation and execution in one stream
...
<CardGroup cols={2}>
  ...
  <Card title="AI Automation" icon="plug" href="/tutorials/ai-powered-automation">
    AI automation tutorial
  </Card>
  <Card title="Getting Started" icon="rocket" href="/providers/adk/getting-started">
