...
<CardGroup cols={2}>
  <Card title="API Reference" icon="gear" href="/api-reference/compose">
    Deep dive into the compose API
  </Card>
  ...
  <Card title="Streaming" icon="puzzle" href="/providers/adk/streaming">
