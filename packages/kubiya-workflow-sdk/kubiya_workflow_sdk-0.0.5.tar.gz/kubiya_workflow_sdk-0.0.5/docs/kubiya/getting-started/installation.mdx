...
<CardGroup cols={2}>
  <Card title="Python 3.8+" icon="python">
    Kubiya SDK requires Python 3.8 or higher
  </Card>
  <Card title="Docker (Optional)" icon="docker">
    For local workflow testing and development
  </Card>
</CardGroup>
...
<Tabs>
  ...
  <Tab title="poetry">
    ```bash
    poetry add kubiya-workflow-sdk
    ```
  </Tab>
  
  <Tab title="pipenv">
    ```bash
    pipenv install kubiya-workflow-sdk
    ```
  </Tab>
  
  <Tab title="conda">
    ```bash
    conda install -c conda-forge kubiya-workflow-sdk
    ```
  </Tab>
</Tabs>
...
<CardGroup cols={3}>
  ...
  <Card title="GitHub" icon="github" href="https://github.com/kubiya-sandbox/workflows">
    Report issues
  </Card>
