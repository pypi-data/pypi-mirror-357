...
<CardGroup cols={2}>
  <Card title="Deploy with Helm" icon="rocket" href="/deployment/helm-chart">
    Step-by-step runner deployment
  </Card>
  <Card title="Platform Overview" icon="shield" href="/concepts/platform-overview">
    Understand the complete architecture
  </Card>
  <Card title="Getting Started" icon="laptop" href="/getting-started/quickstart">
    Set up your first workflow
  </Card>
  <Card title="Workflows" icon="chart-line" href="/workflows/overview">
    Learn about workflow creation
  </Card>
</CardGroup> 