...
<CardGroup cols={2}>
  <Card title="API Reference" icon="plug" href="/api-reference/compose">
    Complete API documentation
  </Card>
  <Card title="Getting Started" icon="key" href="/getting-started/quickstart">
    Quick start guide
  </Card>
  <Card title="ADK Streaming" icon="rss" href="/providers/adk/streaming">
