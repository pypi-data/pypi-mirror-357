...
from pfip.base.constant import TAtomItem, TFileExt, TSentence
...
class NoItemSentenceSplitter(SentenceSplitter):
    def support(self, file_ext: str) -> bool:
        return True

    def __call__(self, chunk: Chunk) -> List[Sentence]:
        return [Sentence(item_type=TSentence.TEXT, content=chunk.content)]
