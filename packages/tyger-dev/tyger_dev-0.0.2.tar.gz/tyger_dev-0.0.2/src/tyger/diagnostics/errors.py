...
class TygerError(TygerDiagnostic, ABC):
    ...
    code: str = "TYG100: Generic Tyger error"
...
class CriticalTypeCheckError(TygerError):
    ...
    code = "TYG101: Critical type check error"
...
class TypeMismatchError(TygerError):
    ...
    code = "TYG102: Type mismatch error"
...
class NotFoundBinOpTypeError(TygerError):
    ...
    code = "TYG103: Not found operation type error"
...
class NotFoundUnOpTypeError(TygerError):
    ...
    code = "TYG104: Not found unary operation type error"
...
class AttributeNotFoundError(TygerError):
    ...
    code = "TYG105: Attribute not found error"
...
class NotFoundTypeError(TygerError):
    ...
    code = "TYG106: Type not found error"
...
class ArityMismatchError(TygerError):
    ...
    code: str = "TYG107: Arity mismatch error"
