...
def plot_sw_hf(eeg, eeg_start_time, sf_eeg, eeg_path, idx):
    ...
    # point
    plot_point(ax2, t, eeg_start_time, stim_points=stim_idx)

    # sw
    plot_wave(ax3, eeg, sf_eeg, stim_idx)
    # save
...
def plot_wave(ax, eeg, sf_eeg, stim_indicator):
...
if __name__ == '__main__':
    ...
    plot_sw_hf(eeg_, datetime.now(), 100, './eeg.eeg', idx_)
    plt.show()
