...
if __name__ == "__main__":
    # Ejemplo de uso
    ob08 = OB08(base_url='https://saplgdqa.losgrobo.com:44302/sap/bc/ui5_ui5/ui2/ushell/shells/abap', driver=None, dev=False)
    
    # DataFrame de ejemplo
    data = {
        '24-06-2025': ['Dólar U.S.A', 'Euro'],
        'compra': [100.00, 101.00],
        'venta': [105.00, 106.00]
    }
    df_divisas = pd.DataFrame(data)
    
    ob08.set_credenciales_usuario('gabriel.bellome@losgrobo.com', 'Junio2025')
    ob08.navegar_inicio_SAP()
    ob08.ir_a_transaccion('#Shell-startGUI?sap-ui2-tcode=OB08&sap-system=FIORI_MENU')
