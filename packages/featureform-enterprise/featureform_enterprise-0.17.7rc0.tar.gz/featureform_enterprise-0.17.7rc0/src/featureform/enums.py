...
class ResourceType(Enum):
    ...
    FEATURE_VIEW = 12
    STREAM_CHANNEL = 13
    STREAMING_FEATURE_VIEW_UPDATE = 14
    ...
    def _get_proto_map(cls):
        return {
            ...
            cls.STREAM_CHANNEL: pb.ResourceType.STREAM_CHANNEL,
            cls.STREAMING_FEATURE_VIEW_UPDATE: pb.ResourceType.STREAMING_FEATURE_VIEW_UPDATE,
        }
    ...
    def is_deletable(cls, resource_type):
        return resource_type in [
            ...
            cls.FEATURE_VIEW,
            cls.STREAM_CHANNEL,
            # TODO: determine if streaming feature view updates should be deletable
        ]
