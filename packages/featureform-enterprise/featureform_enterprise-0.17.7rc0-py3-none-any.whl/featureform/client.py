...
class Client(ResourceClient, ServingClient):
    ...
    **Using the Client:**
    ...
    def get_kafka(self, name) -> KafkaProvider:
        """
        ...
        **Examples**:
        ...
        Returns:
            KafkaProvider: A provider for managing Kafka-related resources.
        """
        provider = self.__get_provider(name)
        config_bytes = provider.serialized_config
        ...
        return KafkaProvider(global_registrar, offline_provider)
    ...
    def get_streaming_feature_view_update(self, name):
        """
        Get a streaming feature view update by name.

        Args:
            name (str): The name of the streaming feature view update.

        Returns:
            StreamingFeatureViewUpdate: The streaming feature view update.
        """
        return StreamingFeatureViewUpdate.get(self._stub, name)
