...
def get(host, cert, insecure, resource_type, name, variant):
    ...
    resource_get_functions = {
        ...
        "feature-view": client._get_feature_view,
        "streaming-feature-view-update": client._get_streaming_feature_view_update,
    }
...
def list(host, cert, insecure, resource_type):
    ...
    resource_list_functions = {
        ...
        "streaming-feature-view-updates": client.list_streaming_feature_view_updates,
    }
