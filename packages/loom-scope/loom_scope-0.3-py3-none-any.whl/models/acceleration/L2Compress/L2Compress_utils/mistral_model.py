...
from .L2Compress_util import init_L2Compress
...
def mistral_attn_forward_L2Compress(
    self,
...
def mistral_sdpa_attn_forward_L2Compress(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
def mistral_flash_attn2_forward_L2Compress(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
