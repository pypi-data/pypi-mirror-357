...
class InstanceManager:
    ...
    def _setup_env_credentials(
        ...
        manual_instance_info = {
            ...
            "INSTANCE_ID": instance_id or os.environ.get("INSTANCE_ID") or auto_instance_id,
            "MATRICE_ENCRYPTION_KEY": encryption_key or os.environ.get("MATRICE_ENCRYPTION_KEY"),
        ...
        if ( # Keys are not encrypted
            self.encryption_key and access_key and secret_key
    ...
    def _decrypt_access_key_pair(
        ...
        """
        return get_encrypted_access_key_pair(
            enc_access_key,
            enc_secret_key,
            encryption_key,
        )
    ...
    def start(self):
        ...
        """
        instance_manager_thread = threading.Thread(target=self.start_instance_manager).start()
