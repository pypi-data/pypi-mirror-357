...
class VehicleMonitoringConfig(BaseConfig):
    ...
    vehicle_categories: List[str] = field(
        default_factory=lambda: ['ambulance', 'army vehicle', 'auto rickshaw', 'bicycle', 'bus', 'car', 'garbagevan', 'human hauler', 'minibus', 'minivan', 'motorbike', 'pickup', 'policecar', 'rickshaw', 'scooter', 'suv', 'taxi', 'three wheelers -CNG-', 'truck', 'van', 'wheelbarrow']
    )
...
class VehicleMonitoringUseCase(BaseProcessor):
        ...
        return {
            ...
            "properties": {
                ...
                "vehicle_categories": {
                    "type": "array",
                    "items": {"type": "string"},
                    "default": ['ambulance', 'army vehicle', 'auto rickshaw', 'bicycle', 'bus', 'car', 'garbagevan', 'human hauler', 'minibus', 'minivan', 'motorbike', 'pickup', 'policecar', 'rickshaw', 'scooter', 'suv', 'taxi', 'three wheelers -CNG-', 'truck', 'van', 'wheelbarrow'],
    ...
    def create_default_config(self, **overrides) -> VehicleMonitoringConfig:
        ...
        defaults = {
            ...
            "vehicle_categories": ['ambulance', 'army vehicle', 'auto rickshaw', 'bicycle', 'bus', 'car', 'garbagevan', 'human hauler', 'minibus', 'minivan', 'motorbike', 'pickup', 'policecar', 'rickshaw', 'scooter', 'suv', 'taxi', 'three wheelers -CNG-', 'truck', 'van', 'wheelbarrow'],
        }
