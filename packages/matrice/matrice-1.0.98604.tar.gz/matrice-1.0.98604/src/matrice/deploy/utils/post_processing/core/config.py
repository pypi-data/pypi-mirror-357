...
class VehicleMonitoringConfig(BaseConfig):
    ...
    # Category mapping
    vehicle_categories: List[str] = field(default_factory=lambda: ["car", "truck", "bus", "motorbike", "microbus", "pickup van"])
    index_to_category: Optional[Dict[int, str]] = None
...
class ConfigManager:
    ...
    def __init__(self):
        ...
        self._config_classes = {
            ...
            "video_color_classification": None
        }
    ...
    def create_config(self, usecase: str, category: Optional[str] = None, **kwargs) -> BaseConfig:
        ...
        if usecase == "vehicle_monitoring":
            ...
            from ..usecases.color_mapper import VideoColorConfig
            config = VideoColorConfig(
    ...
    def get_config_template(self, usecase: str) -> Dict[str, Any]:
        ...
        if usecase == "basic_counting_tracking":
            ...
            from ..usecases.color_mapper import VideoColorConfig
            default_config = VideoColorConfig()
            return default_config.to_dict()
        elif usecase == "ppe_compliance_detection":
            # Import here to avoid circular import
            from ..usecases.ppe_compliance import PPEComplianceConfig
