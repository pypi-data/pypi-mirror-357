...
from ..core.config import VehicleMonitoringConfig, ZoneConfig, AlertConfig
from ..utils import (
...
class VehicleMonitoringUseCase(BaseProcessor):
        ...
        return {
            ...
            "properties": {
                ...
                "vehicle_categories": {
                    "type": "array",
                    "items": {"type": "string"},
                    "default": ["car", "truck", "bus","motorbike","microbus","pickup van"],
    ...
    def create_default_config(self, **overrides) -> VehicleMonitoringConfig:
        ...
        defaults = {
            ...
            "vehicle_categories": ["car", "truck", "bus","motorbike","microbus","pickup van"],
        }
