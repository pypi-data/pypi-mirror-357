...
def debt_direct_model_example(client, customer_id):
    ...
    try:
        ...
        created_debt.reference_code = "REF-001-UPDATED"
        ...
        if API_CALL:
            ...
            print(f"✅ Debt updated: Reference changed to {updated_debt.reference_code}")
        else:
            print(f"🔍 [DEMO MODE] Would update debt: Reference changed to {created_debt.reference_code}")
...
def main():
    ...
    try:
        ...
        if customer:
            ...
            if debt:
                payment = payment_direct_model_example(client, debt.id)
