...
class TestUnit(unittest.TestCase):
    ...
    def test_has_unit(self):
        self.assertTrue(self.unit.has_unit("kg"))
        self.assertTrue(self.unit.has_unit("g"))
        self.assertTrue(self.unit.has_unit("lb"))
        self.assertFalse(self.unit.has_unit("kilo"))
        self.assertFalse(self.unit.has_unit("KG"))

    def test_get_factor(self):
        self.assertEqual(self.unit.get_factor("kg"), 1)
        self.assertEqual(self.unit.get_factor("g"), 1000)
        self.assertEqual(self.unit.get_factor("lb"), 2.20462)
