...
class Case3SummaryBuilder(BaseSummaryBuilderMixin):
    ...
    def __init__(self):
        ...
        self.block_summary_builder: Optional[BlockSummaryBuilder] = None
    ...
    def run(self, dataset: xr.Dataset, reference_datetime: Datetime) -> dict:
        ...
        self.block_summary_builder = summary_builder_class(self.blocks_builder.blocks)
        self._summary.update(
            self.block_summary_builder.compute(reference_datetime, dataset)
        )
