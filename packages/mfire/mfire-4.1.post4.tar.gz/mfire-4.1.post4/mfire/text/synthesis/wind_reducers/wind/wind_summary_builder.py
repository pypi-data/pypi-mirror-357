...
class WindSummaryBuilder(BaseSummaryBuilderMixin, BaseParamSummaryBuilder):
    ...
    WF_TYPE_SEPARATORS: list[float] = [15.0, 25.0]
    ...
    def __init__(self, compo: SynthesisModule, dataset: xr.Dataset):
        ...
        self.dataset: xr.Dataset = dataset[["wind", "direction"]]
    ...
    def _generate_summary(self, reference_datetime: Datetime) -> dict:
        ...
        if case_family == WindCase.CASE_1:
            ...
            # Initialize summary
            self._summary = {"units": self.units["wind"]}
            sub_summary: dict
