...
from .engine import preview_moves, organize_files  # Changed organize_directory to organize_files
...
def main():
    ...
    if target_path:
        ...
        if confirm_moves(target_path, moves):
            organize_files(target_path)  # Changed organize_directory to organize_files
    else:
