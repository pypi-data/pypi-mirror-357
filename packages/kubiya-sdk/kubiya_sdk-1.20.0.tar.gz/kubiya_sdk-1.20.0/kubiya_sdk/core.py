...
def load_workflows_and_tools(source: str, dynamic_config: Dict[str, Any]) -> Dict[str, List[Dict[str, Any]]]:
    return discover_workflows_and_tools(source=source, dynamic_config=dynamic_config)
