...
import webbrowser
import os, math
import xy_color, xy_re, xy_util, xy_common, xy_map_common
...
class xy_map:
	...
	def change_address_to_cxy(self, input_address=""):
		...
		for address_part in all_address_l1d[::-1]:
			...
			found_num = self.rex.search_with_xsql("[숫자:1~]", address_part)
	...
	def draw_circle(self, input_cxy_list, input_size_meter, popup_text=None, line_xcolor=None, fill_xcolor=None):
		"""
		원을 만드는 방법
	...
	def draw_colorline(self, input_cxy_list, input_xcolor_list):
		"""
		색을 입히면서 만드는 라인
		:return:
		"""
	...
	def draw_line(self, input_cxy_list, input_xcolor, thickness_1to10=5, tooltip=None, opacity_oto1=1):
		"""
	...
	def draw_marker_with_list_2d_as_cx_cy_tooltip_menu(self, input_l2d):
		...
		"""
		input_l2d = self.utilx.change_any_data_to_list_2d(input_l2d)
		print(input_l2d)
