...
import pandas as pd
from .schemas.processed_absence import ProcessedAbsenceSchema

class ProcessedAbsence:
    """
    Handles processed absence operations for Visma Lon HR API.
    ProcessedAbsence holds information about payroll processed absence.
    """

    def __init__(self, visma_instance):
        """
        Initialize the ProcessedAbsence class.
    ...
    def get(self, 
        ...
        """
        Get processed absence data from Visma.
        ...
        Returns:
            pd.DataFrame: DataFrame with processed absence data
        """
        return self.visma.get(
            entity_type="ProcessedAbsence",
            filter=filter,
            select=select,
            orderby=orderby,
            top=top,
