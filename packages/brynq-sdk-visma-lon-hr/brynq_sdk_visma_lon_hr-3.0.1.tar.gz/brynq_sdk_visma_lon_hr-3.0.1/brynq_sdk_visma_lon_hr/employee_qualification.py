...
import pandas as pd
from .schemas.employee_qualification import EmployeeQualificationSchema
...
class EmployeeQualification:
    ...
    def get(self, 
        ...
        Returns:
            pd.DataFrame: DataFrame with employee qualification data
        """
        return self.visma.get(
            ...
            skiptoken=skiptoken,
            max_pages=max_pages,
            schema=EmployeeQualificationSchema
        ) 