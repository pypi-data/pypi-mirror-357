...
import pandas as pd
from .schemas.visma_loen_work_calendar import VismaLoenWorkCalendarSchema

class VismaLoenWorkCalendar:
    """
    Handles work calendar operations for Visma Lon HR API.
    VismaLoenWorkCalendar holds information about work calendar.
    """

    def __init__(self, visma_instance):
        """
        Initialize the VismaLoenWorkCalendar class.
    ...
    def get(self, 
        ...
        """
        Get work calendar data from Visma.
        ...
        Returns:
            pd.DataFrame: DataFrame with work calendar data
        """
        return self.visma.get(
            entity_type="VismaLoenWorkCalendar",
            filter=filter,
            select=select,
            orderby=orderby,
            top=top,
            ...
            skiptoken=skiptoken,
            max_pages=max_pages,
            schema=VismaLoenWorkCalendarSchema
        ) 