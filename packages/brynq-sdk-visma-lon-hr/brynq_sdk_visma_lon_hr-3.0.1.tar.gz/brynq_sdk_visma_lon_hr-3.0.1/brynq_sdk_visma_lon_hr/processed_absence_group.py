...
import pandas as pd
from .schemas.processed_absence_group import ProcessedAbsenceGroupSchema
...
class ProcessedAbsenceGroup:
    ...
    def get(self, 
        ...
        Returns:
            pd.DataFrame: DataFrame with processed absence group data
        """
        return self.visma.get(
            ...
            skiptoken=skiptoken,
            max_pages=max_pages,
            schema=ProcessedAbsenceGroupSchema
        ) 