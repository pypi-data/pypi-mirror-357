...
class Payroll:
    """
    Handles payroll operations for Visma Lon HR API.
    Payroll holds information about payrolls and also works as a time dimension for output from the payroll.
    """
    ...
    def get(self, 
        ...
        Returns:
            pd.DataFrame: DataFrame with payroll data
        """
