...
class Employment:
    """
    Handles employment operations for Visma Lon HR API.
    Employment holds information about the personal employments from the VISMALØN table ANSFORHOLD.
    """

    def __init__(self, visma_instance):
        """
        Initialize the Employment class.
    ...
    def get(self, 
        ...
        """
        Get employment data from Visma.
        ...
        Returns:
            pd.DataFrame: DataFrame with employment data
        """
