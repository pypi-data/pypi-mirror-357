...
from constants import TRUNCATION_STEPS_CHOICES, BOM
...
class TestBuildStructuredPrefix(unittest.TestCase):
    ...
    def test_production_raw_template_with_continuations(self):
        ...
        use_cases = [
            {
                ...
                "reply_prompt": "Balderdash:",
                "expected_reply_prompt": "Balderdash:",
                "messages": """[
                    {
                        "author": "Balderdash",
            ...
            },
            {
                ...
                "reply_prompt": "Balderdash:",
                "expected_reply_prompt": "Balderdash: Character Message 2",
                "messages": """[
                    {
                        "author": "Balderdash",
                        "text": "Character Message 1",
            ...
            {
                "name": "last message belongs to the character, but has image attachment",
                "reply_prompt": "Balderdash:",
                "expected_reply_prompt": "Balderdash:",
                "messages": """[
                    {
                    ...
                    },
                    {
                        ...
                        "type": 2,
                        "is_pinned": false,
                        "attachments_content": "some attachment"
                    }
                ]""",
                "expected_messages": 3,
            },
        ...
        for use_case in use_cases:
            ...
            self.assertEqual(len(res["prompt"].messages), messages_without_chat_history + use_case["expected_messages"], use_case["name"])
            self.assertTrue(result.endswith(f"{BOM}{use_case['expected_reply_prompt']}"), f"{use_case['name']}: Expected reply prompt")
