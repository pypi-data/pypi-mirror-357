...
# ------------------------------------------------------------------------- #
# [2] Create a new class Sensor that inherits from ToyV2
# ------------------------------------------------------------------------- #
class BOLTPLUS(ToyV2):
    ...
    drive_with_heading = partialmethod(Drive.drive_with_heading,
                                                      proc=Processors.PRIMARY) #DriveWithHeadingCommand
    reset_yaw = partialmethod(Drive.reset_yaw,
                                                      proc=Processors.PRIMARY) #ResetYawCommand
    set_pitch_torque_modification_value = partialmethod(Drive.set_pitch_torque_modification_value,
                                                      proc=Processors.PRIMARY) #SetPitchTorqueModificationValueCommand
    set_raw_motors = partialmethod(Drive.set_raw_motors,
                                                      proc=Processors.PRIMARY) #SetRawMotorsCommand
    set_stabilization = partialmethod(Drive.set_stabilization,
                                                      proc=Processors.PRIMARY) #SetStabilizationCommand
    ...
    assign_compressed_frame_player_frames_to_animation = partialmethod(
        ...
        proc=Processors.PRIMARY)  # AssignCompressedFramePlayerFramesToAnimationCommand
    ...
    override_compressed_frame_player_animation_global_settings = partialmethod(
        ...
        proc=Processors.PRIMARY)  # OverrideCompressedFramePlayerAnimationGlobalSettingsCommand
    pause_compressed_frame_player_animation = partialmethod(IO.pause_compressed_frame_player_animation,
                                                            proc=Processors.PRIMARY)  # PauseCompressedFramePlayerAnimationCommand
    play_compressed_frame_player_animation = partialmethod(IO.play_compressed_frame_player_animation,
                                                           proc=Processors.PRIMARY)  # PlayCompressedFramePlayerAnimationCommand
    ...
    save_compressed_frame_player_animation_without_frames = partialmethod(
        ...
        proc=Processors.PRIMARY)  # SaveCompressedFramePlayerAnimationWithoutFramesCommand
    ...
    remove_compressed_frame_player_animation_complete_notify_listener = partialmethod(
        Toy._remove_listener,
        IO.set_compressed_frame_player_text_scrolling_notify)  # SetCompressedFramePlayerTextScrollingNotifyCommand
    set_led = partialmethod(IO.set_led, proc=Processors.PRIMARY)  # SetLedCommand
    ...
    get_sensor_streaming_mask = partialmethod(Sensor.get_sensor_streaming_mask, proc=Processors.PRIMARY)  # GetSensorStreamingMaskCommand
    set_sensor_streaming_mask = partialmethod(Sensor.set_sensor_streaming_mask, proc=Processors.PRIMARY)  # SetSensorStreamingMaskCommand
    get_extended_sensor_streaming_mask = partialmethod(Sensor.get_extended_sensor_streaming_mask, proc=Processors.PRIMARY)  # GetExtendedSensorStreamingMaskCommand
    set_extended_sensor_streaming_mask = partialmethod(Sensor.set_extended_sensor_streaming_mask, proc=Processors.PRIMARY)  # SetExtendedSensorStreamingMaskCommand
    ...
    listen_for_robot_to_robot_infrared_message = partialmethod(Sensor.listen_for_robot_to_robot_infrared_message, proc=Processors.PRIMARY)  # ListenForRobotToRobotInfraredMessageCommand
    ...
    remove_magnetometer_north_yaw_notify_listener = partialmethod(Toy._remove_listener,
                                                                  Sensor.magnetometer_north_yaw_notify)  # MagnetometerNorthYawNotifyCommand
    reset_locator_x_and_y = partialmethod(Sensor.reset_locator_x_and_y, proc=Processors.PRIMARY)  # ResetLocationXAndYCommand
    ...
    send_robot_to_robot_infrared_message = partialmethod(Sensor.send_robot_to_robot_infrared_message, proc=Processors.PRIMARY)  # SendRobotToRobotInfraredMessageCommand
    ...
    remove_sensor_streaming_data_notify_listener = partialmethod(Toy._remove_listener,
                                                                 Sensor.sensor_streaming_data_notify)  # SensorStreamingDataNotifyCommand
    set_locator_flags = partialmethod(Sensor.set_locator_flags, proc=Processors.PRIMARY)  # SetLocatorFlagsCommand
    start_robot_to_robot_infrared_broadcasting = partialmethod(Sensor.start_robot_to_robot_infrared_broadcasting, proc=Processors.PRIMARY)  # StartRobotToRobotInfraredBroadcastingCommand
    start_robot_to_robot_infrared_evading = partialmethod(Sensor.start_robot_to_robot_infrared_evading, proc=Processors.PRIMARY)  # StartRobotToRobotInfraredEvadingCommand
    start_robot_to_robot_infrared_following = partialmethod(Sensor.start_robot_to_robot_infrared_following, proc=Processors.PRIMARY)  # StartRobotToRobotInfraredFollowingCommand
    stop_robot_to_robot_infrared_broadcasting = partialmethod(Sensor.stop_robot_to_robot_infrared_broadcasting, proc=Processors.PRIMARY)  # StopRobotToRobotInfraredBroadcastingCommand
    stop_robot_to_robot_infrared_evading = partialmethod(Sensor.stop_robot_to_robot_infrared_evading, proc=Processors.PRIMARY)  # StopRobotToRobotInfraredEvadingCommand
    stop_robot_to_robot_infrared_following = partialmethod(Sensor.stop_robot_to_robot_infrared_following, proc=Processors.PRIMARY)  # StopRobotToRobotInfraredFollowingCommand
