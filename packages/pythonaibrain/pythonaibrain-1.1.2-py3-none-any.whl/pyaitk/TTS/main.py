...
class TTS:
    ...
    def say(self, voice: str = 'male') -> None:
        engine = pyttsx3.init()
        ...
        voice = voice.lower()
        if voice == 'male':
            selected_voice = voice_name_help[self.OsType()][0]

        elif voice == 'female':
            selected_voice = voice_name_help[self.OsType()][1]
...
def speak(text: str = 'Hi', voice: str = voice_name_help[OsType()][0]) -> None:
