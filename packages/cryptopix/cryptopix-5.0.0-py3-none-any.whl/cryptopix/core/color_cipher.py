...
class ColorCipher:
    ...
    def _encrypt_fast(self, plaintext: bytes, password: str) -> Tuple[str, ColorKey]:
        ...
        color_sequence = ''.join(f'{r:02x}{g:02x}{b:02x}' for r, g, b in colors)
        ...
        return color_sequence, color_key
    ...
    def _decrypt_fast(self, color_sequence: str, color_key: ColorKey, 
                     password: str) -> bytes:
