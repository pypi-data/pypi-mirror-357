...
def download_sharded_checkpoint(source: str, dest_dir: str | Path) -> Path:
...
def download_checkpoint(source: str, dest_dir: str | Path) -> Path:
    ...
    if source.endswith(".safetensors.index.json"):
        return download_sharded_checkpoint(source, dest_dir)
