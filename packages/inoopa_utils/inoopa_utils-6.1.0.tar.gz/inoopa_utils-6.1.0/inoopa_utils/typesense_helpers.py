...
class TypesenseManager:
    ...
    :attribute collection_companies_description: companies_description. (embedded description for all companies)
    """
    ...
    def __init__(
        ...
        self.collection_companies_description: Collection = cast(
            Collection, self.client.collections["companies_description"]
        )
...
companies_description_schema = {
    ...
    "fields": [
        # ---- Imported data ----
        {"optional": False, "name": "company_id", "type": "string"},
