...
class Building():
    ...
    def __init__(self,Name):
        ...
        if not os.path.isfile(Name):
            print("[INFO] No existing file found with name '"+os.path.basename(Name)+"'. A new empty Case is created")
            ...
            print('[INFO] Case loaded from file : ' + os.path.basename(Name))
    ...
    def ReadResults(self, GiveDict = False, Vars = [], Steps = 1, StartTime = 0):
        ...
        print('[INFO] Reading output files for Case '+self.Misc.JOBNAME+'...')
