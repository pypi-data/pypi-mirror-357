...
class CreateTranslatedTTSRequestPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["text", "voice_id", "age", "formality", "gender", "source_language", "target_language", "chosen_dictionaries"]
