...
class CreateTranslatedStoryRequestPayload(BaseModel):
    """
    CreateTranslatedStoryRequestPayload
    """ # noqa: E501
    target_language: Optional[Languages] = Field(default=None, description="The lang")
    __properties: ClassVar[List[str]] = ["target_language"]
