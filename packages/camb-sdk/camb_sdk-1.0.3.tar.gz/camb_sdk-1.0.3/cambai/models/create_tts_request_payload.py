...
class CreateTTSRequestPayload(BaseModel):
    """
    CreateTTSRequestPayload
    """ # noqa: E501
    text: StrictStr = Field(description="The text to be converted to speech")
    voice_id: StrictInt = Field(description="The voice ID to be used to generate speech.")
    language: Languages = Field(description="The language in which the provided text is written in.")
    gender: Optional[Gender] = None
    age: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["text", "voice_id", "language", "gender", "age"]
