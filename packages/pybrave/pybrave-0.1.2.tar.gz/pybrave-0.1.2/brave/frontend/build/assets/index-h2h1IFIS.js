import{j as e,B as n,F as t,az as s,T as r,A as l}from"./index-COCGZQB3.js";const o=({record:a,plot:i})=>e.jsx(e.Fragment,{children:a?e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:()=>{i({moduleName:"prokka_txt_plot",params:{file_path:a.content.txt}})},children:"基因预测统计"}),e.jsx(n,{onClick:()=>{i({moduleName:"genome_circos_plot_gbk",params:{file_path:a.content.gbk},tableDesc:`
