...
class KyvosClient:
    ...
    async def list_semantic_models(self, folder_name_or_id: Optional[str] = None, auth_token: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Checking the headers for fetch models: {headers}")
        logger.info(f"Check the url for semantic models: url -> {url}")
    ...
    async def list_semantic_model_columns(self, table_name: str, folder_name: Optional[str] = None, auth_token: Optional[str] = None) -> Dict[str, Any]:
        ...
        logger.info(f"Checking the headers for fetch model columns: {headers}")
        logger.info(f"Check the url for semantic model columns: url -> {url}")
    ...
    async def execute_query(self, query: str, auth_token: Optional[str] = None) -> Dict[str, Any]:
        ...
        logger.info(f"Checking the headers for query execution: {headers}")
        logger.info(f"Check the url for query execution: url -> {url}")
