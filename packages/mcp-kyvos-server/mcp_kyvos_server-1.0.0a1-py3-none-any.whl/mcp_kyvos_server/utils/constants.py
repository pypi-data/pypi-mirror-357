class InfoLogs:
    ...
    INIT_MCP_SERVER = "Initializing Kyvos MCP Server application..."
...
class KyvosEndpoints:
    ENTITY_SEARCH = "/kyvos/rest/entitySearch?version={version}"
    FOLDER_MODELS = "/kyvos/rest/smodels/folder/{folder}?queryableModelsOnly=true&version={version}"
    SQL_METADATA = "/kyvos/rest/smodels/sqlMetadata?version={version}"
    EXPORT_QUERY = "/kyvos/rest/export/query?version={version}"
