...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_labels=None, hidden=False, prn=None, base_path=None, pulp_created=None, pulp_last_updated=None, content_guard=None, no_content_change_since=None, name=None, base_url=None, local_vars_configuration=None):  # noqa: E501
