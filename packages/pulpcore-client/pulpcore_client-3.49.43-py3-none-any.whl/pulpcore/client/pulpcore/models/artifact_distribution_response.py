...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, pulp_last_updated=None, content_guard=None, name=None, pulp_href=None, hidden=False, pulp_labels=None, pulp_created=None, base_path=None, local_vars_configuration=None):  # noqa: E501
