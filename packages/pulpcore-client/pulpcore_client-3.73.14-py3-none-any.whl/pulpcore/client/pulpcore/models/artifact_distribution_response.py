...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "hidden", "pulp_href", "pulp_last_updated", "pulp_labels", "prn", "content_guard", "pulp_created", "base_path", "base_url", "name"]
