...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "pulp_last_updated", "no_content_change_since", "hidden", "name", "content_guard", "pulp_labels", "prn", "pulp_created", "base_path", "base_url"]
