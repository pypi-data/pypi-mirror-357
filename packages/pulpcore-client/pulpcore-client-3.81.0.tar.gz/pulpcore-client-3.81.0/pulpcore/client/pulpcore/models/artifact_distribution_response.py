...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_last_updated", "hidden", "pulp_href", "no_content_change_since", "pulp_created", "name", "pulp_labels", "base_url", "content_guard", "prn", "base_path"]
