...
def create_test_data():
    ...
    books_data = [
        {"id": "book1", "title": "Python Programming", "content": "Learn Python programming with examples", "author": "John Doe"},
        {"id": "book2", "title": "Data Science", "content": "Analyze data using Python and R", "author": "Jane Smith"},
        {"id": "book3", "title": "Web Development", "content": "Build modern web applications", "author": "Bob Johnson"}
    ]
    
    # Test data for second index (articles)
    articles_data = [
        {"doc_id": "art1", "headline": "AI Revolution", "body": "Artificial intelligence is transforming industries", "category": "Technology"},
        {"doc_id": "art2", "headline": "Climate Change", "body": "Global warming effects on the environment", "category": "Environment"},
        {"doc_id": "art3", "headline": "Space Exploration", "body": "Mars mission planning and execution", "category": "Science"}
    ]
...
def test_multi_index():
    ...
    try:
        ...
        result = server.read_documents(["book1", "book2"], "books")
        print(result)
        
        # Test reading documents from articles index
        print("\n=== Testing Read Documents from Articles ===")
        result = server.read_documents(["art1"], "articles")
        print(result)
        
        # Test error handling - non-existent index
        print("\n=== Testing Error Handling ===")
        result = server.search("test", "nonexistent")
        print(result)
