...
def create_test_data_and_config():
    ...
    # Test data
    books_data = [
        {"id": "book1", "title": "Python Programming", "content": "Learn Python programming", "author": "John Doe"},
        {"id": "book2", "title": "Data Science", "content": "Analyze data with Python", "author": "Jane Smith"}
    ]
...
def test_cli_yaml():
    ...
    try:
        ...
        # Test loading config
        server_name, server_description, index_configs, server_config = load_config_from_yaml(yaml_file)
        ...
        # Test help message
        print("\nTesting CLI help...")
        result = subprocess.run([sys.executable, "-m", "src.full_text_search.mcp", "--help"], 
