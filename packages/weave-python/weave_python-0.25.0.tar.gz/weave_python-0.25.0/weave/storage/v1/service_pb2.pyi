...
import typing
import weave.storage.v1.storage_pb2
...
class StorageDetails(google.protobuf.message.Message):
    ...
    @property
    def storage_connection(self) -> weave.storage.v1.storage_pb2.StorageConnection:
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str = ...,
        description: builtins.str = ...,
        storage_connection: weave.storage.v1.storage_pb2.StorageConnection | None = ...,
    ) -> None: ...
    def HasField(
