...
import typing
import weave.storage.v1.auth_pb2
...
class DynamoDB(google.protobuf.message.Message):
    ...
    @property
    def credentials(self) -> weave.storage.v1.auth_pb2.AwsCredentials: ...
    def __init__(
        self,
        *,
        region: builtins.str = ...,
        table: builtins.str = ...,
        credentials: weave.storage.v1.auth_pb2.AwsCredentials | None = ...,
        use_instance_profile: builtins.bool = ...,
    ) -> None: ...
    def HasField(
        self,
