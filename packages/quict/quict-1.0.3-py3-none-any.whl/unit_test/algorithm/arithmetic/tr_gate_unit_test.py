...
from QuICT.algorithm.arithmetic.adder.utils.hl_TR import HLTR1, HLTR2


class TestPeresGate(unittest.TestCase):

    def test_tr1_correctness(self):
        ...
        for i in range(8):
            ...
            self.assertEqual(res0, (a & (not b)) ^ c, f"res0 is not correct for input state: {c}{b}{a}")
    ...
    def test_tr2_correctness(self):
        ...
        for i in range(8):
            ...
            # check the result according to definition
            self.assertEqual(res0, (a & (not b)) ^ c, f"res0 is not correct for input state: {c}{b}{a}")
            self.assertEqual(res1, b, f"res1 is not correct for input state: {c}{b}{a}")
            self.assertEqual(res2, a ^ b, f"res0 is not correct for input state: {c}{b}{a}")
