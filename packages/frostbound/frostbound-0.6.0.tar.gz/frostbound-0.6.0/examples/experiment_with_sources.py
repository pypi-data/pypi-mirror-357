"""
Experiment with frostbound.pydanticonf.sources

This is a simple playground file where you can experiment with the sources
and see how they work. Modify the configurations below and run the script
to see how the merging works!
...
# Define your configuration models
