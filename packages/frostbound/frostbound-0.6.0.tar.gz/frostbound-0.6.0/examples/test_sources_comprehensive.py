"""
Comprehensive test and demonstration of frostbound.pydanticonf.sources module.

This file demonstrates and tests all the functionality of the sources.py module:
- YamlConfigSource: Loading from YAML files
- EnvironmentConfigSource: Loading from environment variables with prefixes and nested structures
- CompositeConfigSource: Combining multiple sources with deep merging

Run this file to see how each source works and how they can be combined.
"""
