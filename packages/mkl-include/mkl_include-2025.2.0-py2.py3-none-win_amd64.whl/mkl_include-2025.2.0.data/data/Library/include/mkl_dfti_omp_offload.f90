...
MODULE MKL_DFTI_OMP_OFFLOAD
  ...
  INTERFACE
     FUNCTION mkl_dfti_commit_descriptor_external_omp_offload(desc,interop)
       USE MKL_DFT_TYPE
  ...
  INTERFACE
     ...
     FUNCTION mkl_dfti_compute_forward_s_omp_offload(desc,sSrcDst,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_forward_c_omp_offload(desc,cSrcDst,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_forward_ss_omp_offload(desc,sSrcDstRe,sSrcDstIm,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_forward_sc_omp_offload(desc,sSrc,cDst,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_forward_cc_omp_offload(desc,cSrc,cDst,interop)
       USE MKL_DFT_TYPE
     ...
     ! complex)
     FUNCTION mkl_dfti_compute_forward_ssss_omp_offload(desc,sSrcRe,sSrcIm,sDstRe,sDstIm,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_forward_d_omp_offload(desc,dSrcDst,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_forward_z_omp_offload(desc,zSrcDst,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_forward_dd_omp_offload(desc,dSrcDstRe,dSrcDstIm,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_forward_dz_omp_offload(desc,dSrc,zDst,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_forward_zz_omp_offload(desc,zSrc,zDst,interop)
       USE MKL_DFT_TYPE
     ...
     ! complex)
     FUNCTION mkl_dfti_compute_forward_dddd_omp_offload(desc,dSrcRe,dSrcIm,dDstRe,dDstIm,interop)
       USE MKL_DFT_TYPE
  ...
  INTERFACE
     ...
     FUNCTION mkl_dfti_compute_backward_s_omp_offload(desc,sSrcDst,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_backward_c_omp_offload(desc,cSrcDst,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_backward_ss_omp_offload(desc,sSrcDstRe,sSrcDstIm,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_backward_cs_omp_offload(desc,cSrc,sDst,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_backward_cc_omp_offload(desc,cSrc,cDst,interop)
       USE MKL_DFT_TYPE
     ...
     ! complex)
     FUNCTION mkl_dfti_compute_backward_ssss_omp_offload(desc,sSrcRe,sSrcIm,sDstRe,sDstIm,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_backward_d_omp_offload(desc,dSrcDst,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_backward_z_omp_offload(desc,zSrcDst,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_backward_dd_omp_offload(desc,dSrcDstRe,dSrcDstIm,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_backward_zd_omp_offload(desc,zSrc,dDst,interop)
       USE MKL_DFT_TYPE
     ...
     FUNCTION mkl_dfti_compute_backward_zz_omp_offload(desc,zSrc,zDst,interop)
       USE MKL_DFT_TYPE
     ...
     ! complex)
     FUNCTION mkl_dfti_compute_backward_dddd_omp_offload(desc,dSrcRe,dSrcIm,dDstRe,dDstIm,interop)
       USE MKL_DFT_TYPE
