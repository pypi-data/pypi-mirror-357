...
def usecase_validator(usecase_config: os.PathLike[str]):
    usecase_schema = os.path.join(os.path.dirname(__file__), "usecase_schema.yaml")
    validator = SettingsValidator(usecase_schema)
    return validator.validated(usecase_config, True)
