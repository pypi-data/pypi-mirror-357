...
class IOTEQRegistryManager():
    def __init__(self) -> None:
        self._cb_config = IOTEQConfigManager()
    ...
    def create(self,
        ...
        sync_client = SyncClient(ioteq_config=self._cb_config.admin_config)
    ...
    async def create_async(self,
        ...
        body = self._create_registry_body(request.device_registry)
        params = {'parent':request.parent}
        async_client = AsyncClient(ioteq_config=self._cb_config.admin_config)
    ...
    def get(self,
        ...
        ioteq_config = self._cb_config.regional_config(request.name)
    ...
    async def get_async(self,
        ...
        ioteq_config=await self._cb_config.regional_config_async(request.name)
