...
def find_project_region_registry_from_parent(parent):
    ...
    if "registries" in list and len(list) >= 4:
        project_region_registry_dict['registry'] = list[3]
    if "devices" in list and len(list) >= 6:
        project_region_registry_dict['device'] = list[5]
