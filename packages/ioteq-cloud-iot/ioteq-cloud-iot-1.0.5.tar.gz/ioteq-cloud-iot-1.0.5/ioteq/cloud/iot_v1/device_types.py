...
from .resources import LogLevel
...
class Device():
    """
    Data class for IO-TEQ's Device
    """
    ...
    def __init__(self, id: str, num_id: str = None,
                ...
                last_heartbeat_time: str = None, last_event_time: str = None,
    ...
    def from_json(json):
        ...
        convert_times_to_datetime_with_nanoseconds = (False if os.environ.get("BINARYDATA_AND_TIME_IOTEQ_FORMAT") == None else os.environ.get("BINARYDATA_AND_TIME_IOTEQ_FORMAT").lower() == "true")
        ...
        theDevice = Device(
            ...
            credentials=get_value(json, 'auth'),
...
class DeviceState():
    ...
    def from_json(response_json):
        ...
        if (binaryDataFromJson not in [None, ""]):
            convert_binarydata_to_bytes = (False if os.environ.get("BINARYDATA_AND_TIME_IOTEQ_FORMAT") == None else os.environ.get("BINARYDATA_AND_TIME_IOTEQ_FORMAT").lower() == "true")
